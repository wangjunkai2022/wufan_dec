...
public class ReportFragment extends Fragment {
    ...
    private static final String f6293b = "androidx.lifecycle.LifecycleDispatcher.report_fragment_tag";

    /* renamed from: a  reason: collision with root package name */
    private ActivityInitializationListener f6294a;
    ...
    public static ReportFragment f(Activity activity) {
        return (ReportFragment) activity.getFragmentManager().findFragmentByTag(f6293b);
    }
    ...
    public static void injectIfNeededIn(Activity activity) {
        ...
        if (fragmentManager.findFragmentByTag(f6293b) == null) {
            fragmentManager.beginTransaction().add(new ReportFragment(), f6293b).commit();
            fragmentManager.executePendingTransactions();
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void g(ActivityInitializationListener activityInitializationListener) {
        this.f6294a = activityInitializationListener;
    }
