...
public abstract class FragmentTransitionImpl {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void i(ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void j(View view, final ArrayList<View> arrayList, final Map<String, String> map) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void k(View view, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        OneShotPreDrawListener.add(view, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.1
            ...
            public void run() {
                for (int i5 = 0; i5 < size; i5++) {
                    ViewCompat.setTransitionName((View) arrayList2.get(i5), (String) arrayList3.get(i5));
                    ViewCompat.setTransitionName((View) arrayList.get(i5), (String) arrayList4.get(i5));
                }
            }
        });
    }
