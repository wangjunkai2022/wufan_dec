...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    public LayoutInflater onGetLayoutInflater() {
        return LayoutInflater.from(this.f5861b);
    }
    ...
    @Deprecated
    public void onStartIntentSenderFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i2, @Nullable Intent intent, int i4, int i5, int i6, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i2 == -1) {
            ActivityCompat.startIntentSenderForResult(this.f5860a, intentSender, i2, intent, i4, i5, i6, bundle);
            return;
        }
    ...
    public void onStartActivityFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) Intent intent, int i2, @Nullable Bundle bundle) {
        if (i2 == -1) {
            ContextCompat.startActivity(this.f5861b, intent, bundle);
            return;
        }
    ...
    FragmentHostCallback(@Nullable Activity activity, @NonNull Context context, @NonNull Handler handler, int i2) {
        this.f5864e = new FragmentManagerImpl();
        this.f5860a = activity;
        this.f5861b = (Context) Preconditions.checkNotNull(context, "context == null");
        this.f5862c = (Handler) Preconditions.checkNotNull(handler, "handler == null");
        this.f5863d = i2;
    }
}
