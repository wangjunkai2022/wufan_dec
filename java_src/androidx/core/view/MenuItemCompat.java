...
public final class MenuItemCompat {
    ...
    private static final String f4803a = "MenuItemCompat";
    ...
    public static void setAlphabeticShortcut(MenuItem menuItem, char c4, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c4, i2);
    ...
    public static void setNumericShortcut(MenuItem menuItem, char c4, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c4, i2);
        } else if (Build.VERSION.SDK_INT >= 26) {
    ...
    public static void setShortcut(MenuItem menuItem, char c4, char c5, int i2, int i4) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c4, c5, i2, i4);
        } else if (Build.VERSION.SDK_INT >= 26) {
            menuItem.setShortcut(c4, c5, i2, i4);
        }
    }
