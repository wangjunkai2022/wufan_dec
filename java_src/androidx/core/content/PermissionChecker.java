...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i2, int i4, @Nullable String str2) {
        int noteProxyOpNoThrow;
        if (context.checkPermission(str, i2, i4) == -1) {
            return -1;
        }
        ...
        if (Process.myUid() == i4 && ObjectsCompat.equals(context.getPackageName(), str2)) {
            noteProxyOpNoThrow = AppOpsManagerCompat.checkOrNoteProxyOp(context, i4, permissionToOp, str2);
        } else {
