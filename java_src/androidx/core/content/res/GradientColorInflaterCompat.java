...
public final class GradientColorInflaterCompat {
    ...
    private static final int f4216a = 0;

    /* renamed from: b  reason: collision with root package name */
    private static final int f4217b = 1;

    /* renamed from: c  reason: collision with root package name */
    private static final int f4218c = 2;

    private GradientColorInflaterCompat() {
    }

    private static ColorStops a(@Nullable ColorStops colorStops, @ColorInt int i2, @ColorInt int i4, boolean z3, @ColorInt int i5) {
        if (colorStops != null) {
            return colorStops;
        }
        if (z3) {
            return new ColorStops(i2, i5, i4);
        }
        return new ColorStops(i2, i4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Shader c(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        if (name.equals("gradient")) {
            ...
            ColorStops a4 = a(d(resources, xmlPullParser, attributeSet, theme), namedColor, namedColor3, hasAttribute, namedColor2);
            if (namedInt != 1) {
                if (namedInt != 2) {
                    return new LinearGradient(namedFloat, namedFloat2, namedFloat3, namedFloat4, a4.f4219a, a4.f4220b, e(namedInt2));
                }
                return new SweepGradient(namedFloat5, namedFloat6, a4.f4219a, a4.f4220b);
            } else if (namedFloat7 > 0.0f) {
                return new RadialGradient(namedFloat5, namedFloat6, namedFloat7, a4.f4219a, a4.f4220b, e(namedInt2));
            } else {
    ...
    */
    ...
    public static final class ColorStops {
        ...
        ColorStops(@NonNull List<Integer> list, @NonNull List<Float> list2) {
            int size = list.size();
            this.f4219a = new int[size];
            this.f4220b = new float[size];
            for (int i2 = 0; i2 < size; i2++) {
                this.f4219a[i2] = list.get(i2).intValue();
                this.f4220b[i2] = list2.get(i2).floatValue();
            }
        }

        ColorStops(@ColorInt int i2, @ColorInt int i4) {
            this.f4219a = new int[]{i2, i4};
            this.f4220b = new float[]{0.0f, 1.0f};
        }

        ColorStops(@ColorInt int i2, @ColorInt int i4, @ColorInt int i5) {
            this.f4219a = new int[]{i2, i4, i5};
            this.f4220b = new float[]{0.0f, 0.5f, 1.0f};
        }
    }
}
