...
public final class PackageManagerCompat {
    ...
    public static boolean areUnusedAppRestrictionsAvailable(@NonNull PackageManager packageManager) {
        ...
        boolean z3 = i2 >= 30;
        boolean z4 = i2 >= 23 && i2 < 30;
        boolean z5 = getPermissionRevocationVerifierApp(packageManager) != null;
        if (z3) {
            return true;
        }
        return z4 && z5;
    ...
    @NonNull
    public static e1.a<Integer> getUnusedAppRestrictionsStatus(@NonNull Context context) {
        ...
        if (!UserManagerCompat.isUserUnlocked(context)) {
            ...
            if (i4 >= 31) {
                ...
                create.set(Integer.valueOf(Api30Impl.a(context) ? 4 : 2));
                return create;
            } else {
