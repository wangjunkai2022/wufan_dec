...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    private int clampApplyScroll(int i2, int i4) {
        int i5 = i2 - i4;
        if (i2 * i5 <= 0) {
            return 0;
        }
    ...
    protected void onSeekTargetStep(int i2, int i4, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
        this.mInterimTargetDx = clampApplyScroll(this.mInterimTargetDx, i2);
        int clampApplyScroll = clampApplyScroll(this.mInterimTargetDy, i4);
