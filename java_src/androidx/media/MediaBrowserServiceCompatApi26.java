...
class MediaBrowserServiceCompatApi26 {
    ...
    private static final String f6572a = "MBSCompatApi26";
    ...
    static class MediaBrowserServiceAdaptor extends MediaBrowserServiceCompatApi23.MediaBrowserServiceAdaptor {
        ...
        public void onLoadChildren(String str, MediaBrowserService.Result<List<MediaBrowser.MediaItem>> result, Bundle bundle) {
            ...
            ((ServiceCompatProxy) this.f6570a).onLoadChildren(str, new ResultWrapper(result), bundle);
        }
    }
    ...
    static class ResultWrapper {
        ...
        /* renamed from: a  reason: collision with root package name */
        MediaBrowserService.Result f6574a;
        ...
        public void sendResult(List<Parcel> list, int i2) {
            try {
                MediaBrowserServiceCompatApi26.f6573b.setInt(this.f6574a, i2);
            } catch (IllegalAccessException unused) {
            }
            this.f6574a.sendResult(a(list));
        }
    }
