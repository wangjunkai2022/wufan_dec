...
public class VectorEnabledTintResources extends ResourcesWrapper {
    ...
    private final WeakReference<Context> f1557b;

    public VectorEnabledTintResources(@NonNull Context context, @NonNull Resources resources) {
        super(resources);
        this.f1557b = new WeakReference<>(context);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    @RequiresApi(15)
    public /* bridge */ /* synthetic */ Drawable getDrawableForDensity(int i2, int i4) throws Resources.NotFoundException {
        return super.getDrawableForDensity(i2, i4);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ float getFraction(int i2, int i4, int i5) {
        return super.getFraction(i2, i4, i5);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ String getQuantityString(int i2, int i4) throws Resources.NotFoundException {
        return super.getQuantityString(i2, i4);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ CharSequence getQuantityText(int i2, int i4) throws Resources.NotFoundException {
        return super.getQuantityText(i2, i4);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValue(int i2, TypedValue typedValue, boolean z3) throws Resources.NotFoundException {
        super.getValue(i2, typedValue, z3);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    @RequiresApi(15)
    public /* bridge */ /* synthetic */ void getValueForDensity(int i2, int i4, TypedValue typedValue, boolean z3) throws Resources.NotFoundException {
        super.getValueForDensity(i2, i4, typedValue, z3);
    }
    ...
    public Drawable getDrawable(int i2) throws Resources.NotFoundException {
        Context context = this.f1557b.get();
        if (context != null) {
            return ResourceManagerInternal.get().p(context, this, i2);
        }
        return a(i2);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    @RequiresApi(21)
    public /* bridge */ /* synthetic */ Drawable getDrawableForDensity(int i2, int i4, Resources.Theme theme) {
        return super.getDrawableForDensity(i2, i4, theme);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ String getQuantityString(int i2, int i4, Object[] objArr) throws Resources.NotFoundException {
        return super.getQuantityString(i2, i4, objArr);
    }
