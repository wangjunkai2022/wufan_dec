...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                generateDefaultLayoutParams.f1502a = 2;
        ...
        public void initForMenu(Context context, MenuBuilder menuBuilder) {
            ...
            MenuBuilder menuBuilder2 = this.f1475a;
            if (menuBuilder2 != null && (menuItemImpl = this.f1476b) != null) {
                menuBuilder2.collapseItemActionView(menuItemImpl);
            }
            this.f1475a = menuBuilder;
        }
        ...
        public void updateMenuView(boolean z3) {
            if (this.f1476b != null) {
                MenuBuilder menuBuilder = this.f1475a;
                boolean z4 = false;
                if (menuBuilder != null) {
                    ...
                    while (true) {
                        if (i2 >= size) {
                            break;
                        } else if (this.f1475a.getItem(i2) == this.f1476b) {
                            z4 = true;
                            break;
                        } else {
                            i2++;
                ...
                collapseItemActionView(this.f1475a, this.f1476b);
            }
        }
    }
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<Toolbar> {
        ...
        public void mapProperties(@NonNull PropertyMapper propertyMapper) {
            this.f1479b = propertyMapper.mapObject("collapseContentDescription", R.attr.collapseContentDescription);
            this.f1480c = propertyMapper.mapObject("collapseIcon", R.attr.collapseIcon);
            this.f1481d = propertyMapper.mapInt("contentInsetEnd", R.attr.contentInsetEnd);
            this.f1482e = propertyMapper.mapInt("contentInsetEndWithActions", R.attr.contentInsetEndWithActions);
            this.f1483f = propertyMapper.mapInt("contentInsetLeft", R.attr.contentInsetLeft);
            this.f1484g = propertyMapper.mapInt("contentInsetRight", R.attr.contentInsetRight);
            this.f1485h = propertyMapper.mapInt("contentInsetStart", R.attr.contentInsetStart);
            this.f1486i = propertyMapper.mapInt("contentInsetStartWithNavigation", R.attr.contentInsetStartWithNavigation);
            this.f1487j = propertyMapper.mapObject("logo", R.attr.logo);
            this.f1488k = propertyMapper.mapObject("logoDescription", R.attr.logoDescription);
            this.f1489l = propertyMapper.mapObject("menu", R.attr.menu);
            this.f1490m = propertyMapper.mapObject("navigationContentDescription", R.attr.navigationContentDescription);
            this.f1491n = propertyMapper.mapObject("navigationIcon", R.attr.navigationIcon);
            this.f1492o = propertyMapper.mapResourceId("popupTheme", R.attr.popupTheme);
            this.f1493p = propertyMapper.mapObject("subtitle", R.attr.subtitle);
            this.f1494q = propertyMapper.mapObject("title", R.attr.title);
            this.f1495r = propertyMapper.mapInt("titleMarginBottom", R.attr.titleMarginBottom);
            this.f1496s = propertyMapper.mapInt("titleMarginEnd", R.attr.titleMarginEnd);
            this.f1497t = propertyMapper.mapInt("titleMarginStart", R.attr.titleMarginStart);
            this.f1498u = propertyMapper.mapInt("titleMarginTop", R.attr.titleMarginTop);
            this.f1478a = true;
        }
        ...
        public void readProperties(@NonNull Toolbar toolbar, @NonNull PropertyReader propertyReader) {
            if (this.f1478a) {
                propertyReader.readObject(this.f1479b, toolbar.getCollapseContentDescription());
                propertyReader.readObject(this.f1480c, toolbar.getCollapseIcon());
                propertyReader.readInt(this.f1481d, toolbar.getContentInsetEnd());
                propertyReader.readInt(this.f1482e, toolbar.getContentInsetEndWithActions());
                propertyReader.readInt(this.f1483f, toolbar.getContentInsetLeft());
                propertyReader.readInt(this.f1484g, toolbar.getContentInsetRight());
                propertyReader.readInt(this.f1485h, toolbar.getContentInsetStart());
                propertyReader.readInt(this.f1486i, toolbar.getContentInsetStartWithNavigation());
                propertyReader.readObject(this.f1487j, toolbar.getLogo());
                propertyReader.readObject(this.f1488k, toolbar.getLogoDescription());
                propertyReader.readObject(this.f1489l, toolbar.getMenu());
                propertyReader.readObject(this.f1490m, toolbar.getNavigationContentDescription());
                propertyReader.readObject(this.f1491n, toolbar.getNavigationIcon());
                propertyReader.readResourceId(this.f1492o, toolbar.getPopupTheme());
                propertyReader.readObject(this.f1493p, toolbar.getSubtitle());
                propertyReader.readObject(this.f1494q, toolbar.getTitle());
                propertyReader.readInt(this.f1495r, toolbar.getTitleMarginBottom());
                propertyReader.readInt(this.f1496s, toolbar.getTitleMarginEnd());
                propertyReader.readInt(this.f1497t, toolbar.getTitleMarginStart());
                propertyReader.readInt(this.f1498u, toolbar.getTitleMarginTop());
                return;
            }
    ...
    private void addCustomViewsWithGravity(List<View> list, int i2) {
        ...
        if (!z3) {
            for (int i4 = 0; i4 < childCount; i4++) {
                ...
                if (layoutParams.f1502a == 0 && shouldLayout(childAt) && getChildHorizontalGravity(layoutParams.gravity) == absoluteGravity) {
                    list.add(childAt);
                }
            }
            return;
        ...
        for (int i5 = childCount - 1; i5 >= 0; i5--) {
            ...
            if (layoutParams2.f1502a == 0 && shouldLayout(childAt2) && getChildHorizontalGravity(layoutParams2.gravity) == absoluteGravity) {
                list.add(childAt2);
            }
        }
    }
    ...
    private int layoutChildLeft(View view, int i2, int[] iArr, int i4) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
    ...
    private int layoutChildRight(View view, int i2, int[] iArr, int i4) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
    ...
    private int measureChildCollapseMargins(View view, int i2, int i4, int i5, int i6, int[] iArr) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    private void measureChildConstrained(View view, int i2, int i4, int i5, int i6, int i7) {
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    public void collapseActionView() {
        ...
        MenuItemImpl menuItemImpl = expandedActionViewMenuPresenter == null ? null : expandedActionViewMenuPresenter.f1476b;
    ...
    public boolean hasExpandedActionView() {
        ExpandedActionViewMenuPresenter expandedActionViewMenuPresenter = this.mExpandedMenuPresenter;
        return (expandedActionViewMenuPresenter == null || expandedActionViewMenuPresenter.f1476b == null) ? false : true;
    }
    ...
    */
    ...
    protected void onMeasure(int i2, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            measureChildConstrained(this.mNavButtonView, i2, 0, i4, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            measureChildConstrained(this.mCollapseButtonView, i2, 0, i4, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mMenuView)) {
            measureChildConstrained(this.mMenuView, i2, max, i4, 0, this.mMaxButtonHeight);
        ...
        if (shouldLayout(this.mExpandedActionView)) {
            max2 += measureChildCollapseMargins(this.mExpandedActionView, i2, max2, i4, 0, iArr);
        ...
        if (shouldLayout(this.mLogoView)) {
            max2 += measureChildCollapseMargins(this.mLogoView, i2, max2, i4, 0, iArr);
        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).f1502a == 0 && shouldLayout(childAt)) {
                max2 += measureChildCollapseMargins(childAt, i2, max2, i4, 0, iArr);
        ...
        if (shouldLayout(this.mTitleTextView)) {
            measureChildCollapseMargins(this.mTitleTextView, i2, max2 + i15, i4, i14, iArr);
            int measuredWidth = this.mTitleTextView.getMeasuredWidth() + getHorizontalMargins(this.mTitleTextView);
            i11 = this.mTitleTextView.getMeasuredHeight() + getVerticalMargins(this.mTitleTextView);
            i9 = View.combineMeasuredStates(i7, this.mTitleTextView.getMeasuredState());
            i10 = measuredWidth;
        } else {
            i9 = i7;
            i10 = 0;
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i10 = Math.max(i10, measureChildCollapseMargins(this.mSubtitleTextView, i2, max2 + i15, i4, i11 + i14, iArr));
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(max2 + i10 + getPaddingLeft() + getPaddingRight(), getSuggestedMinimumWidth()), i2, (-16777216) & i9), shouldCollapse() ? 0 : View.resolveSizeAndState(Math.max(max3 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight()), i4, i9 << 16));
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        ExpandedActionViewMenuPresenter expandedActionViewMenuPresenter = this.mExpandedMenuPresenter;
        if (expandedActionViewMenuPresenter != null && (menuItemImpl = expandedActionViewMenuPresenter.f1476b) != null) {
            savedState.f1503a = menuItemImpl.getItemId();
        }
        savedState.f1504b = isOverflowMenuShowing();
        return savedState;
    }
    ...
    void removeChildrenForExpandedActionView() {
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).f1502a != 2 && childAt != this.mMenuView) {
    ...
    public void setContentInsetsAbsolute(int i2, int i4) {
        ensureContentInsets();
        this.mContentInsets.setAbsolute(i2, i4);
    }

    public void setContentInsetsRelative(int i2, int i4) {
        ensureContentInsets();
        this.mContentInsets.setRelative(i2, i4);
    }
    ...
    public void setTitleMargin(int i2, int i4, int i5, int i6) {
    ...
    public static class LayoutParams extends ActionBar.LayoutParams {
        ...
        /* renamed from: b  reason: collision with root package name */
        static final int f1499b = 0;

        /* renamed from: c  reason: collision with root package name */
        static final int f1500c = 1;

        /* renamed from: d  reason: collision with root package name */
        static final int f1501d = 2;
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        dimensionPixelOffset = obtainStyledAttributes.hasValue(i4) ? obtainStyledAttributes.getDimensionPixelOffset(i4, dimensionPixelOffset) : dimensionPixelOffset;
        ...
        if (obtainStyledAttributes.hasValue(i5)) {
            setTitleTextColor(obtainStyledAttributes.getColorStateList(i5));
        }
