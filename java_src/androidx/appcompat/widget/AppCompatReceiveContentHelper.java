...
final class AppCompatReceiveContentHelper {
    ...
    private static final String f1032a = "ReceiveContent";
            ...
            if (c4 == null) {
                ...
                if (dragEvent.getAction() == 3) {
                    if (view instanceof TextView) {
                        return OnDropApi24Impl.a(dragEvent, (TextView) view, c4);
                    }
                    return OnDropApi24Impl.b(dragEvent, view, c4);
                }
            }
        }
        return false;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean b(@NonNull TextView textView, int i2) {
