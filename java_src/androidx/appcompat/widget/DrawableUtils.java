...
public class DrawableUtils {
    ...
    private static final int[] f1152a = {16842912};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f1153b = new int[0];
    ...
    static class Api18Impl {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final boolean f1154a;

        /* renamed from: b  reason: collision with root package name */
        private static final Method f1155b;

        /* renamed from: c  reason: collision with root package name */
        private static final Field f1156c;

        /* renamed from: d  reason: collision with root package name */
        private static final Field f1157d;

        /* renamed from: e  reason: collision with root package name */
        private static final Field f1158e;

        /* renamed from: f  reason: collision with root package name */
        private static final Field f1159f;
        ...
        static {
            ...
            L49:
                if (r8 == 0) goto L58
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1155b = r4
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1156c = r5
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1157d = r6
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1158e = r7
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1159f = r3
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1154a = r0
                goto L64
            L58:
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1155b = r2
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1156c = r2
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1157d = r2
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1158e = r2
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1159f = r2
                androidx.appcompat.widget.DrawableUtils.Api18Impl.f1154a = r1
            L64:
                return
            */
        ...
        static Rect a(@NonNull Drawable drawable) {
            if (Build.VERSION.SDK_INT < 29 && f1154a) {
                try {
                    Object invoke = f1155b.invoke(drawable, new Object[0]);
                    if (invoke != null) {
                        return new Rect(f1156c.getInt(invoke), f1157d.getInt(invoke), f1158e.getInt(invoke), f1159f.getInt(invoke));
                    }
    ...
    private static void b(Drawable drawable) {
        ...
        if (state != null && state.length != 0) {
            drawable.setState(f1153b);
        } else {
            drawable.setState(f1152a);
        }
    ...
    public static Rect getOpticalBounds(@NonNull Drawable drawable) {
        int i2 = Build.VERSION.SDK_INT;
        if (i2 >= 29) {
            Insets a4 = Api29Impl.a(drawable);
