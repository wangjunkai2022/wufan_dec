...
class AppCompatProgressBarHelper {
    ...
    private static final int[] f1019c = {16843067, 16843068};

    /* renamed from: a  reason: collision with root package name */
    private final ProgressBar f1020a;
    ...
    private Drawable e(Drawable drawable) {
        if (drawable instanceof AnimationDrawable) {
            ...
            for (int i2 = 0; i2 < numberOfFrames; i2++) {
                Drawable d4 = d(animationDrawable.getFrame(i2), true);
                d4.setLevel(10000);
                animationDrawable2.addFrame(d4, animationDrawable.getDuration(i2));
            }
    ...
    public void c(AttributeSet attributeSet, int i2) {
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.f1020a.getContext(), attributeSet, f1019c, i2, 0);
        Drawable drawableIfKnown = obtainStyledAttributes.getDrawableIfKnown(0);
        if (drawableIfKnown != null) {
            this.f1020a.setIndeterminateDrawable(e(drawableIfKnown));
        }
        Drawable drawableIfKnown2 = obtainStyledAttributes.getDrawableIfKnown(1);
        if (drawableIfKnown2 != null) {
            this.f1020a.setProgressDrawable(d(drawableIfKnown2, false));
        }
    ...
    Drawable d(Drawable drawable, boolean z3) {
        if (drawable instanceof WrappedDrawable) {
            ...
            if (wrappedDrawable2 != null) {
                wrappedDrawable.setWrappedDrawable(d(wrappedDrawable2, z3));
            }
