...
public abstract class AppCompatDelegate {
    ...
    static final boolean f178a = false;

    /* renamed from: b  reason: collision with root package name */
    static final String f179b = "AppCompatDelegate";

    /* renamed from: c  reason: collision with root package name */
    private static int f180c = -100;

    /* renamed from: d  reason: collision with root package name */
    private static final ArraySet<WeakReference<AppCompatDelegate>> f181d = new ArraySet<>();

    /* renamed from: e  reason: collision with root package name */
    private static final Object f182e = new Object();
    ...
    public static void a(@NonNull AppCompatDelegate appCompatDelegate) {
        synchronized (f182e) {
            d(appCompatDelegate);
            f181d.add(new WeakReference<>(appCompatDelegate));
        }
    }

    private static void b() {
        synchronized (f182e) {
            Iterator<WeakReference<AppCompatDelegate>> it2 = f181d.iterator();
            while (it2.hasNext()) {
    ...
    public static void setDefaultNightMode(int i2) {
        if ((i2 == -1 || i2 == 0 || i2 == 1 || i2 == 2 || i2 == 3) && f180c != i2) {
            f180c = i2;
            b();
        }
    }
