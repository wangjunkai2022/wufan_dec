...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        private final AlertController.AlertParams f174a;
        ...
        public AlertDialog create() {
            AlertDialog alertDialog = new AlertDialog(this.f174a.mContext, this.f175b);
            this.f174a.apply(alertDialog.mAlert);
            alertDialog.setCancelable(this.f174a.mCancelable);
            if (this.f174a.mCancelable) {
                alertDialog.setCanceledOnTouchOutside(true);
            }
            alertDialog.setOnCancelListener(this.f174a.mOnCancelListener);
            alertDialog.setOnDismissListener(this.f174a.mOnDismissListener);
            DialogInterface.OnKeyListener onKeyListener = this.f174a.mOnKeyListener;
        ...
        public Context getContext() {
            return this.f174a.mContext;
        }

        public Builder setAdapter(ListAdapter listAdapter, DialogInterface.OnClickListener onClickListener) {
            AlertController.AlertParams alertParams = this.f174a;
        ...
        public Builder setCustomTitle(@Nullable View view) {
            this.f174a.mCustomTitleView = view;
            return this;
        }

        public Builder setIcon(@DrawableRes int i2) {
            this.f174a.mIconId = i2;
            return this;
        }

        public Builder setIconAttribute(@AttrRes int i2) {
            TypedValue typedValue = new TypedValue();
            this.f174a.mContext.getTheme().resolveAttribute(i2, typedValue, true);
            this.f174a.mIconId = typedValue.resourceId;
            return this;
        }

        @Deprecated
        public Builder setInverseBackgroundForced(boolean z3) {
            this.f174a.mForceInverseBackground = z3;
            return this;
        }
        ...
        public Builder setItems(@ArrayRes int i2, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f174a.mOnClickListener = onClickListener;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(@ArrayRes int i2, boolean[] zArr, DialogInterface.OnMultiChoiceClickListener onMultiChoiceClickListener) {
            AlertController.AlertParams alertParams = this.f174a;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i2);
            AlertController.AlertParams alertParams2 = this.f174a;
        ...
        public Builder setNegativeButton(@StringRes int i2, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f174a.mNegativeButtonListener = onClickListener;
            return this;
        }

        public Builder setNegativeButtonIcon(Drawable drawable) {
            this.f174a.mNegativeButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNeutralButton(@StringRes int i2, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f174a.mNeutralButtonListener = onClickListener;
            return this;
        }

        public Builder setNeutralButtonIcon(Drawable drawable) {
            this.f174a.mNeutralButtonIcon = drawable;
            return this;
        }

        public Builder setOnCancelListener(DialogInterface.OnCancelListener onCancelListener) {
            this.f174a.mOnCancelListener = onCancelListener;
            return this;
        }

        public Builder setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
            this.f174a.mOnDismissListener = onDismissListener;
            return this;
        }

        public Builder setOnItemSelectedListener(AdapterView.OnItemSelectedListener onItemSelectedListener) {
            this.f174a.mOnItemSelectedListener = onItemSelectedListener;
            return this;
        }

        public Builder setOnKeyListener(DialogInterface.OnKeyListener onKeyListener) {
            this.f174a.mOnKeyListener = onKeyListener;
            return this;
        }
        ...
        public Builder setPositiveButton(@StringRes int i2, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f174a.mPositiveButtonListener = onClickListener;
            return this;
        }

        public Builder setPositiveButtonIcon(Drawable drawable) {
            this.f174a.mPositiveButtonIcon = drawable;
            return this;
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public Builder setRecycleOnMeasureEnabled(boolean z3) {
            this.f174a.mRecycleOnMeasure = z3;
            return this;
        }

        public Builder setSingleChoiceItems(@ArrayRes int i2, int i4, DialogInterface.OnClickListener onClickListener) {
            AlertController.AlertParams alertParams = this.f174a;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i2);
            AlertController.AlertParams alertParams2 = this.f174a;
        ...
        public Builder(@NonNull Context context, @StyleRes int i2) {
            this.f174a = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i2)));
            this.f175b = i2;
        }

        public Builder setIcon(@Nullable Drawable drawable) {
            this.f174a.mIcon = drawable;
            return this;
        }

        public Builder setMessage(@Nullable CharSequence charSequence) {
            this.f174a.mMessage = charSequence;
            return this;
        }

        public Builder setTitle(@Nullable CharSequence charSequence) {
            this.f174a.mTitle = charSequence;
            return this;
        }
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        @Deprecated
        public Builder setView(View view, int i2, int i4, int i5, int i6) {
            AlertController.AlertParams alertParams = this.f174a;
            alertParams.mView = view;
            alertParams.mViewLayoutResId = 0;
    ...
    public void setView(View view, int i2, int i4, int i5, int i6) {
        this.mAlert.setView(view, i2, i4, i5, i6);
    }
