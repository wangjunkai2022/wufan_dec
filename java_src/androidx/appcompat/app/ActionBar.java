...
public abstract class ActionBar {
    ...
    public interface OnNavigationListener {
        boolean onNavigationItemSelected(int i2, long j4);
    }
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int i2, boolean z3);
    ...
    public abstract void setDisplayOptions(int i2, int i4);
