...
class ActionBarDrawerToggleHoneycomb {
    ...
    private static final String f117a = "ActionBarDrawerToggleHC";

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f118b = {16843531};
    ...
    public static Drawable getThemeUpIndicator(Activity activity) {
        TypedArray obtainStyledAttributes = activity.obtainStyledAttributes(f118b);
