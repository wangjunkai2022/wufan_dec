...
public final class Compatibility {
    ...
    public static class Api15Impl {
        ...
        @DoNotInline
        public static void getValueForDensity(@NonNull Resources resources, int i2, int i4, @NonNull TypedValue typedValue, boolean z3) {
            resources.getValueForDensity(i2, i4, typedValue, z3);
        }
    }
    ...
    public static class Api18Impl {
        ...
        @DoNotInline
        public static void setAutoCancel(@NonNull ObjectAnimator objectAnimator, boolean z3) {
