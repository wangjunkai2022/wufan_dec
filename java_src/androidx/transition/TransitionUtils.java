...
class TransitionUtils {
    ...
    private static final int f7758a = 1048576;

    /* renamed from: b  reason: collision with root package name */
    private static final boolean f7759b;

    /* renamed from: c  reason: collision with root package name */
    private static final boolean f7760c;

    /* renamed from: d  reason: collision with root package name */
    private static final boolean f7761d;

    /* loaded from: classes2.dex */
    static class MatrixEvaluator implements TypeEvaluator<Matrix> {

        /* renamed from: a  reason: collision with root package name */
        final float[] f7762a = new float[9];

        /* renamed from: b  reason: collision with root package name */
        final float[] f7763b = new float[9];

        /* renamed from: c  reason: collision with root package name */
        final Matrix f7764c = new Matrix();

        @Override // android.animation.TypeEvaluator
        public Matrix evaluate(float f4, Matrix matrix, Matrix matrix2) {
            matrix.getValues(this.f7762a);
            matrix2.getValues(this.f7763b);
            for (int i2 = 0; i2 < 9; i2++) {
                float[] fArr = this.f7763b;
                float f5 = fArr[i2];
                float[] fArr2 = this.f7762a;
                fArr[i2] = fArr2[i2] + ((f5 - fArr2[i2]) * f4);
            }
            this.f7764c.setValues(this.f7763b);
            return this.f7764c;
        }
    }
    ...
    */
    private static android.graphics.Bitmap b(android.view.View r9, android.graphics.Matrix r10, android.graphics.RectF r11, android.view.ViewGroup r12) {
        /*
            boolean r0 = androidx.transition.TransitionUtils.f7759b
            r1 = 0
            if (r0 == 0) goto L13
        ...
        L14:
            r2 = 0
        L15:
            boolean r3 = androidx.transition.TransitionUtils.f7760c
            r4 = 0
            if (r3 == 0) goto L31
            if (r0 == 0) goto L31
            if (r2 != 0) goto L1f
        ...
        L33:
            ...
            r10.postScale(r4, r4)
            boolean r11 = androidx.transition.TransitionUtils.f7761d
            if (r11 == 0) goto L88
