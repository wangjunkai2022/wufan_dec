...
public class TransitionInflater {
    ...
    private static final Class<?>[] f7736b = {Context.class, AttributeSet.class};

    /* renamed from: c  reason: collision with root package name */
    private static final ArrayMap<String, Constructor<?>> f7737c = new ArrayMap<>();
    ...
    private Object a(AttributeSet attributeSet, Class<?> cls, String str) {
        ...
        if (attributeValue != null) {
            try {
                ArrayMap<String, Constructor<?>> arrayMap = f7737c;
                synchronized (arrayMap) {
                    Constructor<?> constructor = arrayMap.get(attributeValue);
                    if (constructor == null && (asSubclass = Class.forName(attributeValue, false, this.f7738a.getClassLoader()).asSubclass(cls)) != 0) {
                        constructor = asSubclass.getConstructor(f7736b);
                        constructor.setAccessible(true);
                        arrayMap.put(attributeValue, constructor);
                    }
                    newInstance = constructor.newInstance(this.f7738a, attributeSet);
                }
                return newInstance;
            } catch (Exception e4) {
    ...
    */
        ...
        while (true) {
            ...
            if (next == 2) {
                if (xmlPullParser.getName().equals(TypedValues.AttributesType.S_TARGET)) {
                    TypedArray obtainStyledAttributes = this.f7738a.obtainStyledAttributes(attributeSet, Styleable.f7684a);
    ...
    private void e(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        TypedArray obtainStyledAttributes = this.f7738a.obtainStyledAttributes(attributeSet, Styleable.f7685b);
        ...
        Scene sceneForLayout = namedResourceId2 < 0 ? null : Scene.getSceneForLayout(viewGroup, namedResourceId2, this.f7738a);
        int namedResourceId3 = TypedArrayUtils.getNamedResourceId(obtainStyledAttributes, xmlPullParser, "toScene", 1, -1);
        Scene sceneForLayout2 = namedResourceId3 >= 0 ? Scene.getSceneForLayout(viewGroup, namedResourceId3, this.f7738a) : null;
    ...
    public Transition inflateTransition(int i2) {
        XmlResourceParser xml = this.f7738a.getResources().getXml(i2);
        try {
            try {
