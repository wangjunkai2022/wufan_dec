...
public class Constraints extends ViewGroup {
    ...
    public ConstraintSet getConstraintSet() {
        if (this.f3635a == null) {
            this.f3635a = new ConstraintSet();
        }
        this.f3635a.clone(this);
        return this.f3635a;
    }
    ...
    protected ViewGroup.LayoutParams generateLayoutParams(ViewGroup.LayoutParams p3) {
        return new ConstraintLayout.LayoutParams(p3);
    }
    ...
    public static class LayoutParams extends ConstraintLayout.LayoutParams {
        ...
        public LayoutParams(Context c4, AttributeSet attrs) {
            ...
            this.translationY = 0.0f;
            this.translationZ = 0.0f;
            TypedArray obtainStyledAttributes = c4.obtainStyledAttributes(attrs, R.styleable.ConstraintSet);
