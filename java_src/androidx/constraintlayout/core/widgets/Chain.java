...
public class Chain {
    ...
    private static final boolean f2434a = false;
    ...
    */
    static void a(androidx.constraintlayout.core.widgets.ConstraintWidgetContainer r38, androidx.constraintlayout.core.LinearSystem r39, int r40, int r41, androidx.constraintlayout.core.widgets.ChainHead r42) {
        /*
    ...
    public static void applyChainConstraints(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, ArrayList<ConstraintWidget> arrayList, int i2) {
        ...
        if (i2 == 0) {
            ...
            chainHeadArr = constraintWidgetContainer.C0;
            i5 = 0;
        } else {
            int i6 = constraintWidgetContainer.mVerticalChainsSize;
            chainHeadArr = constraintWidgetContainer.B0;
            i4 = i6;
            i5 = 2;
        }
        for (int i7 = 0; i7 < i4; i7++) {
            ...
            chainHead.define();
            if (arrayList == null || arrayList.contains(chainHead.f2435a)) {
                a(constraintWidgetContainer, linearSystem, i2, i5, chainHead);
            }
        }
    }
}
