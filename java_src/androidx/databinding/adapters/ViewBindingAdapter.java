...
public class ViewBindingAdapter {
    ...
    public static void setPaddingEnd(View view, float f4) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            view.setPaddingRelative(view.getPaddingStart(), view.getPaddingTop(), a4, view.getPaddingBottom());
        } else {
            view.setPadding(view.getPaddingLeft(), view.getPaddingTop(), a4, view.getPaddingBottom());
        }
    }
    ...
    public static void setPaddingStart(View view, float f4) {
        int a4 = a(f4);
        if (Build.VERSION.SDK_INT >= 17) {
            view.setPaddingRelative(a4, view.getPaddingTop(), view.getPaddingEnd(), view.getPaddingBottom());
        } else {
            view.setPadding(a4, view.getPaddingTop(), view.getPaddingRight(), view.getPaddingBottom());
        }
    }
