...
public class DataBindingUtil {
    ...
    private static DataBinderMapper f5224a = new DataBinderMapperImpl();

    /* renamed from: b  reason: collision with root package name */
    private static DataBindingComponent f5225b = null;
    ...
    public static <T extends ViewDataBinding> T a(DataBindingComponent dataBindingComponent, View view, int i2) {
        return (T) f5224a.getDataBinder(dataBindingComponent, view, i2);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T extends ViewDataBinding> T b(DataBindingComponent dataBindingComponent, View[] viewArr, int i2) {
        return (T) f5224a.getDataBinder(dataBindingComponent, viewArr, i2);
    }

    @Nullable
    public static <T extends ViewDataBinding> T bind(@NonNull View view) {
        return (T) bind(view, f5225b);
    }

    private static <T extends ViewDataBinding> T c(DataBindingComponent dataBindingComponent, ViewGroup viewGroup, int i2, int i4) {
    ...
    public static String convertBrIdToString(int i2) {
        return f5224a.convertBrIdToString(i2);
    }
    ...
    */
    public static <T extends androidx.databinding.ViewDataBinding> T findBinding(@androidx.annotation.NonNull android.view.View r9) {
        ...
        L0:
            r0 = 0
            if (r9 == 0) goto L5a
            androidx.databinding.ViewDataBinding r1 = androidx.databinding.ViewDataBinding.r(r9)
            if (r1 == 0) goto La
            return r1
        La:
    ...
    public static <T extends ViewDataBinding> T getBinding(@NonNull View view) {
        return (T) ViewDataBinding.r(view);
    }
    ...
    public static <T extends ViewDataBinding> T inflate(@NonNull LayoutInflater layoutInflater, int i2, @Nullable ViewGroup viewGroup, boolean z3) {
        return (T) inflate(layoutInflater, i2, viewGroup, z3, f5225b);
    }

    public static <T extends ViewDataBinding> T setContentView(@NonNull Activity activity, int i2) {
        return (T) setContentView(activity, i2, f5225b);
    }

    public static void setDefaultComponent(@Nullable DataBindingComponent dataBindingComponent) {
        f5225b = dataBindingComponent;
    }
    ...
    public static <T extends ViewDataBinding> T bind(@NonNull View view, DataBindingComponent dataBindingComponent) {
        ...
        if (tag instanceof String) {
            int layoutId = f5224a.getLayoutId((String) tag);
            if (layoutId != 0) {
                return (T) f5224a.getDataBinder(dataBindingComponent, view, layoutId);
            }
    ...
    public static <T extends ViewDataBinding> T inflate(@NonNull LayoutInflater layoutInflater, int i2, @Nullable ViewGroup viewGroup, boolean z3, @Nullable DataBindingComponent dataBindingComponent) {
        ...
        if (z4) {
            return (T) c(dataBindingComponent, viewGroup, childCount, i2);
        }
        return (T) a(dataBindingComponent, inflate, i2);
    }
    ...
    public static <T extends ViewDataBinding> T setContentView(@NonNull Activity activity, int i2, @Nullable DataBindingComponent dataBindingComponent) {
        ...
        return (T) c(dataBindingComponent, (ViewGroup) activity.getWindow().getDecorView().findViewById(16908290), 0, i2);
    }
}
