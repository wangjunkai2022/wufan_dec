...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() {
        ...
        if (httpClientConnectionManager == null) {
            ...
            PoolingHttpClientConnectionManager poolingHttpClientConnectionManager2 = new PoolingHttpClientConnectionManager(RegistryBuilder.create().register(f.f11765a, PlainConnectionSocketFactory.getSocketFactory()).register("https", connectionSocketFactory).build());
            ...
            if (i2 > 0) {
                poolingHttpClientConnectionManager2.setMaxTotal(i2);
            }
            int i4 = this.maxConnPerRoute;
            if (i4 > 0) {
                poolingHttpClientConnectionManager2.setDefaultMaxPerRoute(i4);
            }
