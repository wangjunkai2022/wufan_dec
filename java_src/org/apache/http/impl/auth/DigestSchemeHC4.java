...
public class DigestSchemeHC4 extends RFC2617SchemeHC4 {
    ...
    private String f73198a1;

    /* renamed from: a2  reason: collision with root package name */
    private String f73199a2;
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest httpRequest) throws AuthenticationException {
        ...
        if (parameter7 != null) {
            ...
            if ((httpRequest instanceof HttpEntityEnclosingRequest) && hashSet.contains("auth-int")) {
                ...
                c4 = hashSet.contains("auth") ? (char) 2 : (char) 65535;
            }
        } else {
            str = "qop";
            c4 = 0;
        ...
        if (c4 != 65535) {
            ...
            try {
                ...
                String encode2 = encode(messageDigest.digest(EncodingUtils.getBytes(this.f73198a1, parameter8)));
                if (c4 == 2) {
                    ...
                    if (c4 == 1) {
                        ...
                        if (entity != null && !entity.isRepeatable()) {
                            ...
                            this.f73199a2 = parameter5 + ':' + str4 + ':' + encode(httpEntityDigester.getDigest());
                            c5 = c4;
                        }
                        c4 = c5;
                    } else {
                ...
                String encode3 = encode(messageDigest.digest(EncodingUtils.getBytes(this.f73199a2, parameter8)));
                if (c4 == 0) {
                    sb2.setLength(0);
                    sb2.append(encode2);
                    sb2.append(':');
                ...
                arrayList.add(new BasicNameValuePair(GrantCredentialsPermissionActivity.f64044h, encode4));
                if (c4 != 0) {
                    if (c4 == 1) {
                        str5 = str2;
                    }
    ...
    String getA1() {
        return this.f73198a1;
    }

    String getA2() {
        return this.f73199a2;
    }
