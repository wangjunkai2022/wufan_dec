...
public abstract class AbstractMessageParserHC4<T extends HttpMessage> implements HttpMessageParser {
    ...
    public static Header[] parseHeaders(SessionInputBuffer sessionInputBuffer, int i2, int i4, LineParser lineParser) throws HttpException, IOException {
        ArrayList arrayList = new ArrayList();
        if (lineParser == null) {
            lineParser = BasicLineParserHC4.INSTANCE;
        }
        return parseHeaders(sessionInputBuffer, i2, i4, lineParser, arrayList);
    }
    ...
    public static Header[] parseHeaders(SessionInputBuffer sessionInputBuffer, int i2, int i4, LineParser lineParser, List<CharArrayBuffer> list) throws HttpException, IOException {
        int i5;
        char charAt;
        Args.notNull(sessionInputBuffer, "Session input buffer");
