...
public class ContentLengthInputStreamHC4 extends InputStream {
    ...
    private SessionInputBuffer f73202in;
    private long pos = 0;
    private boolean closed = false;

    public ContentLengthInputStreamHC4(SessionInputBuffer sessionInputBuffer, long j4) {
        this.f73202in = null;
        this.f73202in = (SessionInputBuffer) Args.notNull(sessionInputBuffer, "Session input buffer");
        this.contentLength = Args.notNegative(j4, "Content length");
    }

    @Override // java.io.InputStream
    public int available() throws IOException {
        BufferInfo bufferInfo = this.f73202in;
    ...
    public int read(byte[] bArr, int i2, int i4) throws IOException {
        if (!this.closed) {
            ...
            int read = this.f73202in.read(bArr, i2, i4);
