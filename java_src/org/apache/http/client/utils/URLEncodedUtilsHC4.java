...
public class URLEncodedUtilsHC4 {
    ...
    private static String urlDecode(String str, Charset charset, boolean z3) {
        if (str == null) {
            return null;
        }
    ...
    private static String urlEncode(String str, Charset charset, BitSet bitSet, boolean z3) {
        if (str == null) {
            return null;
        }
    ...
    public static String format(List<? extends NameValuePair> list, char c4, String str) {
        StringBuilder sb = new StringBuilder();
    ...
    public static String format(Iterable<? extends NameValuePair> iterable, char c4, Charset charset) {
        StringBuilder sb = new StringBuilder();
