...
public class a implements org.jboss.netty.util.b {
    ...
    public Object d(String str) {
        ...
        return this.f73353d.get(str);
    }

    public Map<String, Object> e() {
        return new TreeMap(this.f73353d);
    }
    ...
    public void k(String str, Object obj) {
        Objects.requireNonNull(str, "key");
        if (obj == null) {
            this.f73353d.remove(str);
        } else {
            this.f73353d.put(str, obj);
        }
    }

    public void l(Map<String, Object> map) {
        Objects.requireNonNull(map, "options");
        this.f73353d = new HashMap(map);
    }

    public void m(n nVar) {
        Objects.requireNonNull(nVar, "pipeline");
        this.f73351b = nVar;
        this.f73352c = s.T(nVar);
    }
    ...
    public void n(Map<String, ChannelHandler> map) {
        ...
        throw new IllegalArgumentException("pipelineMap is not an ordered map. Please use " + LinkedHashMap.class.getName() + d.f65364a);
    }
