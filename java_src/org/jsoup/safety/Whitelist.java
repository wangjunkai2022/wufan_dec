...
public class Whitelist {
    ...
    public static Whitelist basic() {
        return new Whitelist().addTags("a", "b", "blockquote", "br", "cite", "code", "dd", "dl", "dt", "em", ai.aA, "li", "ol", ai.av, "pre", "q", "small", "strike", "strong", "sub", "sup", ai.aE, "ul").addAttributes("a", "href").addAttributes("blockquote", "cite").addAttributes("q", "cite").addProtocols("a", "href", "ftp", f.f11765a, "https", "mailto").addProtocols("blockquote", "cite", f.f11765a, "https").addProtocols("cite", "cite", f.f11765a, "https").addEnforcedAttribute("a", "rel", "nofollow");
    }

    public static Whitelist basicWithImages() {
        return basic().addTags("img").addAttributes("img", "align", "alt", "height", "src", "title", "width").addProtocols("img", "src", f.f11765a, "https");
    }
    ...
    public static Whitelist relaxed() {
        return new Whitelist().addTags("a", "b", "blockquote", "br", "caption", "cite", "code", "col", "colgroup", "dd", "div", "dl", "dt", "em", "h1", ApplicationProtocolNames.HTTP_2, "h3", "h4", "h5", "h6", ai.aA, "img", "li", "ol", ai.av, "pre", "q", "small", "strike", "strong", "sub", "sup", "table", "tbody", "td", "tfoot", "th", "thead", "tr", ai.aE, "ul").addAttributes("a", "href", "title").addAttributes("blockquote", "cite").addAttributes("col", "span", "width").addAttributes("colgroup", "span", "width").addAttributes("img", "align", "alt", "height", "src", "title", "width").addAttributes("ol", "start", "type").addAttributes("q", "cite").addAttributes("table", "summary", "width").addAttributes("td", "abbr", "axis", "colspan", "rowspan", "width").addAttributes("th", "abbr", "axis", "colspan", "rowspan", "scope", "width").addAttributes("ul", "type").addProtocols("a", "href", "ftp", f.f11765a, "https", "mailto").addProtocols("blockquote", "cite", f.f11765a, "https").addProtocols("img", "src", f.f11765a, "https").addProtocols("q", "cite", f.f11765a, "https");
    }
    ...
    public Whitelist preserveRelativeLinks(boolean z3) {
