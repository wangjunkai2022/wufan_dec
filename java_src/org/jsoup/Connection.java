...
public interface Connection {
    ...
    public interface Request extends Base<Request> {
        ...
        Request followRedirects(boolean z3);

        boolean followRedirects();

        Request ignoreContentType(boolean z3);

        boolean ignoreContentType();

        Request ignoreHttpErrors(boolean z3);
    ...
    Connection followRedirects(boolean z3);

    Document get() throws IOException;

    Connection header(String str, String str2);

    Connection ignoreContentType(boolean z3);

    Connection ignoreHttpErrors(boolean z3);
