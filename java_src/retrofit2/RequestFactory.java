...
public final class RequestFactory {
    ...
    public static final class Builder {
        ...
        @Nullable
        private ParameterHandler<?> parseParameter(int i2, Type type, @Nullable Annotation[] annotationArr, boolean z3) {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i2, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    Headers of = Headers.of("Content-Disposition", "form-data; name=\"" + value5 + m.a.f72569g, HttpHeaders.Names.CONTENT_TRANSFER_ENCODING, part.encoding());
                    if (Iterable.class.isAssignableFrom(rawType8)) {
                        if (type instanceof ParameterizedType) {
                ...
                if (!this.isFormEncoded && !this.isMultipart) {
                    if (!this.gotBody) {
                        try {
                            ...
                            throw Utils.parameterError(this.method, e4, i2, "Unable to create @Body converter for %s", type);
                        }
                    }
                ...
                for (int i4 = i2 - 1; i4 >= 0; i4--) {
                    ...
                    if ((parameterHandler instanceof ParameterHandler.Tag) && ((ParameterHandler.Tag) parameterHandler).cls.equals(rawType10)) {
                        throw Utils.parameterError(this.method, i2, "@Tag type " + rawType10.getName() + " is duplicate of parameter #" + (i4 + 1) + " and would always overwrite its value.", new Object[0]);
                    }
                }
        ...
        RequestFactory build() {
            ...
            if (this.httpMethod != null) {
                ...
                while (true) {
                    ...
                    Type type = this.parameterTypes[i4];
                    Annotation[] annotationArr = this.parameterAnnotationsArray[i4];
                    if (i4 != i2) {
                        z3 = false;
                    }
                    parameterHandlerArr[i4] = parseParameter(i4, type, annotationArr, z3);
                    i4++;
                }
