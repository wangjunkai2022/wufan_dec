...
@Metadata(bv = {1, 0, 3}, d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0006\n\u0000\n\u0002\u0010\u0007\n\u0000\n\u0002\u0010\u0012\n\u0002\b\t\b'\u0018\u0000 \u00182\u00020\u0001:\u0001\u0018B\u0007¢\u0006\u0004\b\u0016\u0010\u0017J\u0010\u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u0002H&J\b\u0010\u0005\u001a\u00020\u0002H\u0016J\u0010\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0002H\u0016J\u0018\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u0002H\u0016J\b\u0010\t\u001a\u00020\bH\u0016J\u0010\u0010\t\u001a\u00020\b2\u0006\u0010\u0006\u001a\u00020\bH\u0016J\u0018\u0010\t\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\u0006\u001a\u00020\bH\u0016J\b\u0010\u000b\u001a\u00020\nH\u0016J\b\u0010\r\u001a\u00020\fH\u0016J\u0010\u0010\r\u001a\u00020\f2\u0006\u0010\u0006\u001a\u00020\fH\u0016J\u0018\u0010\r\u001a\u00020\f2\u0006\u0010\u0007\u001a\u00020\f2\u0006\u0010\u0006\u001a\u00020\fH\u0016J\b\u0010\u000f\u001a\u00020\u000eH\u0016J$\u0010\u0014\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00102\b\b\u0002\u0010\u0012\u001a\u00020\u00022\b\b\u0002\u0010\u0013\u001a\u00020\u0002H\u0016J\u0010\u0010\u0014\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0010H\u0016J\u0010\u0010\u0014\u001a\u00020\u00102\u0006\u0010\u0015\u001a\u00020\u0002H\u0016¨\u0006\u0019"}, d2 = {"Lkotlin/random/Random;", "", "", "bitCount", "nextBits", "nextInt", "until", "from", "", "nextLong", "", "nextBoolean", "", "nextDouble", "", "nextFloat", "", "array", MyAccountLoginActivity_.J, "toIndex", "nextBytes", "size", "<init>", "()V", "Default", "kotlin-stdlib"}, k = 1, mv = {1, 5, 1})
...
public abstract class Random {
    ...
    public static final class Default extends Random implements Serializable {
        ...
        @Override // kotlin.random.Random
        @NotNull
        public byte[] nextBytes(@NotNull byte[] array, int i2, int i4) {
            Intrinsics.checkNotNullParameter(array, "array");
            return Random.defaultRandom.nextBytes(array, i2, i4);
        }
        ...
        public int nextInt(int i2, int i4) {
            return Random.defaultRandom.nextInt(i2, i4);
        }
    ...
    public static /* synthetic */ byte[] nextBytes$default(Random random, byte[] bArr, int i2, int i4, int i5, Object obj) {
        if (obj == null) {
            if ((i5 & 2) != 0) {
                i2 = 0;
            }
            ...
            return random.nextBytes(bArr, i2, i4);
        }
    ...
    */
    ...
    public int nextInt(int i2, int i4) {
        ...
        int i5;
        int i6;
        RandomKt.checkRangeBounds(i2, i4);
        int i7 = i4 - i2;
        if (i7 > 0 || i7 == Integer.MIN_VALUE) {
            if (((-i7) & i7) == i7) {
                i6 = nextBits(RandomKt.fastLog2(i7));
            } else {
                do {
                    nextInt = nextInt() >>> 1;
                    i5 = nextInt % i7;
                } while ((nextInt - i5) + (i7 - 1) < 0);
                i6 = i5;
            }
            return i2 + i6;
        }
        ...
        if (j8 > 0) {
            if (((-j8) & j8) == j8) {
                ...
                if (i2 != 0) {
                    ...
                    j7 = (nextBits(RandomKt.fastLog2(i4)) << 32) + nextInt();
                }
