...
public final class SequencesKt___SequencesKt$minus$1<T> implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        ...
        filter = SequencesKt___SequencesKt.filter(this.$this_minus, new Function1<T, Boolean>() { // from class: kotlin.sequences.SequencesKt___SequencesKt$minus$1$iterator$1
            /* JADX INFO: Access modifiers changed from: package-private */
            ...
            public final boolean invoke2(T t3) {
                if (booleanRef.element || !Intrinsics.areEqual(t3, SequencesKt___SequencesKt$minus$1.this.$element)) {
                    return true;
                }
