    ...
    private static final Object[] toArrayImpl(Collection<?> collection, Function0<Object[]> function0, Function1<? super Integer, Object[]> function1, Function2<? super Object[], ? super Integer, Object[]> function2) {
        ...
        while (true) {
            ...
            if (i4 >= r3.length) {
                ...
                r3 = Arrays.copyOf((Object[]) r3, i5);
                Intrinsics.checkNotNullExpressionValue(r3, "Arrays.copyOf(result, newSize)");
            } else if (!it2.hasNext()) {
                return function2.invoke(r3, Integer.valueOf(i4));
            }
            i2 = i4;
            r3 = r3;
        }
