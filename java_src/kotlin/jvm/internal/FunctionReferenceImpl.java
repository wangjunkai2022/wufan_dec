...
public class FunctionReferenceImpl extends FunctionReference {
    ...
    public FunctionReferenceImpl(int i2, Class cls, String str, String str2, int i4) {
        super(i2, CallableReference.NO_RECEIVER, cls, str, str2, i4);
    }

    @SinceKotlin(version = "1.4")
    public FunctionReferenceImpl(int i2, Object obj, Class cls, String str, String str2, int i4) {
        super(i2, obj, cls, str, str2, i4);
    }
}
