...
public class StringsKt__StringNumberConversionsKt extends StringsKt__StringNumberConversionsJVMKt {
    ...
    @SinceKotlin(version = "1.1")
    @Nullable
    public static final Byte toByteOrNull(@NotNull String toByteOrNull, int i2) {
        int intValue;
        Intrinsics.checkNotNullParameter(toByteOrNull, "$this$toByteOrNull");
    ...
    @SinceKotlin(version = "1.1")
    @Nullable
    public static final Integer toIntOrNull(@NotNull String toIntOrNull, int i2) {
        boolean z3;
        int i4;
        Intrinsics.checkNotNullParameter(toIntOrNull, "$this$toIntOrNull");
        ...
        int i8 = -59652323;
        while (i7 < length) {
            int digitOf = CharsKt__CharJVMKt.digitOf(toIntOrNull.charAt(i7), i2);
            if (digitOf < 0) {
                return null;
            }
            if ((i5 < i8 && (i8 != -59652323 || i5 < (i8 = i6 / i2))) || (i4 = i5 * i2) < i6 + digitOf) {
                return null;
            }
            i5 = i4 - digitOf;
            i7++;
    ...
    */
    ...
    @SinceKotlin(version = "1.1")
    @Nullable
    public static final Short toShortOrNull(@NotNull String toShortOrNull, int i2) {
        int intValue;
        Intrinsics.checkNotNullParameter(toShortOrNull, "$this$toShortOrNull");
