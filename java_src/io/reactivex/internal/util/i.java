...
public final class i<T> implements w2.c<List<T>, List<T>, List<T>> {

    /* renamed from: a  reason: collision with root package name */
    final Comparator<? super T> f70100a;

    public i(Comparator<? super T> comparator) {
        this.f70100a = comparator;
    }
    ...
    */
    public java.util.List<T> apply(java.util.List<T> r6, java.util.List<T> r7) throws java.lang.Exception {
        ...
        L37:
            if (r0 == 0) goto L61
            if (r3 == 0) goto L61
            java.util.Comparator<? super T> r4 = r5.f70100a
