...
public abstract class AbstractPooledDerivedByteBuf extends AbstractReferenceCountedByteBuf {
    ...
    public static final class PooledNonRetainedDuplicateByteBuf extends UnpooledDuplicatedByteBuf {
        ...
        public ByteBuf slice(int i2, int i4) {
            checkIndex(i2, i4);
            return new PooledNonRetainedSlicedByteBuf(this.referenceCountDelegate, unwrap(), i2, i4);
        }
    ...
    public static final class PooledNonRetainedSlicedByteBuf extends UnpooledSlicedByteBuf {
        ...
        PooledNonRetainedSlicedByteBuf(ReferenceCounted referenceCounted, AbstractByteBuf abstractByteBuf, int i2, int i4) {
            super(abstractByteBuf, i2, i4);
            this.referenceCountDelegate = referenceCounted;
        }
        ...
        public ByteBuf slice(int i2, int i4) {
            checkIndex(i2, i4);
            return new PooledNonRetainedSlicedByteBuf(this.referenceCountDelegate, unwrap(), idx(i2), i4);
        }
        ...
        @Override // io.netty.buffer.AbstractByteBuf, io.netty.buffer.ByteBuf
        public ByteBuf retainedSlice(int i2, int i4) {
            return PooledSlicedByteBuf.newInstance(unwrap(), this, idx(i2), i4);
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: Multi-variable type inference failed */
    public final <U extends AbstractPooledDerivedByteBuf> U init(AbstractByteBuf abstractByteBuf, ByteBuf byteBuf, int i2, int i4, int i5) {
        byteBuf.retain();
        this.parent = byteBuf;
    ...
    public ByteBuf slice(int i2, int i4) {
        ensureAccessible();
        return new PooledNonRetainedSlicedByteBuf(this, unwrap(), i2, i4);
    }
