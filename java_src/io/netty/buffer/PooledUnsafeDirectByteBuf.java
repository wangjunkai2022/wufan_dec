...
public final class PooledUnsafeDirectByteBuf extends PooledByteBuf<ByteBuffer> {
    ...
    public void _setByte(int i2, int i4) {
        UnsafeByteBufUtil.setByte(addr(i2), (byte) i4);
    }
    ...
    public void init(PoolChunk<ByteBuffer> poolChunk, ByteBuffer byteBuffer, long j4, int i2, int i4, int i5, PoolThreadCache poolThreadCache) {
        super.init(poolChunk, byteBuffer, j4, i2, i4, i5, poolThreadCache);
        initMemoryAddress();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // io.netty.buffer.PooledByteBuf
    public void initUnpooled(PoolChunk<ByteBuffer> poolChunk, int i2) {
    ...
    private PooledUnsafeDirectByteBuf(ObjectPool.Handle<PooledUnsafeDirectByteBuf> handle, int i2) {
        super(handle, i2);
    }
