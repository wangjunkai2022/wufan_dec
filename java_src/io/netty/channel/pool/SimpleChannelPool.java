...
public class SimpleChannelPool implements ChannelPool {
    ...
    private Future<Channel> acquireHealthyFromPoolOrNew(final Promise<Channel> promise) {
        ...
        if (pollChannel == null) {
            Bootstrap mo17clone = this.bootstrap.mo17clone();
            mo17clone.attr(POOL_KEY, this);
            ChannelFuture connectChannel = connectChannel(mo17clone);
    ...
    public SimpleChannelPool(Bootstrap bootstrap, ChannelPoolHandler channelPoolHandler, ChannelHealthChecker channelHealthChecker, boolean z3) {
        this(bootstrap, channelPoolHandler, channelHealthChecker, z3, true);
    }

    public SimpleChannelPool(Bootstrap bootstrap, final ChannelPoolHandler channelPoolHandler, ChannelHealthChecker channelHealthChecker, boolean z3, boolean z4) {
        ...
        Bootstrap mo17clone = ((Bootstrap) ObjectUtil.checkNotNull(bootstrap, "bootstrap")).mo17clone();
        this.bootstrap = mo17clone;
        mo17clone.handler(new ChannelInitializer<Channel>() { // from class: io.netty.channel.pool.SimpleChannelPool.1
            static final /* synthetic */ boolean $assertionsDisabled = false;
