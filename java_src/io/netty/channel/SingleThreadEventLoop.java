...
public abstract class SingleThreadEventLoop extends SingleThreadEventExecutor implements EventLoop {
    ...
    public final void executeAfterEventLoopIteration(Runnable runnable) {
        ...
        if ((runnable instanceof AbstractEventExecutor.a) || !wakesUpForTask(runnable)) {
            return;
        }
        wakeup(inEventLoop());
    }
    ...
    protected SingleThreadEventLoop(EventLoopGroup eventLoopGroup, ThreadFactory threadFactory, boolean z3, int i2, RejectedExecutionHandler rejectedExecutionHandler) {
        super(eventLoopGroup, threadFactory, z3, i2, rejectedExecutionHandler);
    ...
    protected SingleThreadEventLoop(EventLoopGroup eventLoopGroup, Executor executor, boolean z3, int i2, RejectedExecutionHandler rejectedExecutionHandler) {
        super(eventLoopGroup, executor, z3, i2, rejectedExecutionHandler);
        this.tailTasks = newTaskQueue(i2);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public SingleThreadEventLoop(EventLoopGroup eventLoopGroup, Executor executor, boolean z3, Queue<Runnable> queue, Queue<Runnable> queue2, RejectedExecutionHandler rejectedExecutionHandler) {
        super(eventLoopGroup, executor, z3, queue, rejectedExecutionHandler);
