...
public final class Buffer {
    ...
    public static ByteBuffer allocateDirectWithNativeOrder(int i2) {
        return ByteBuffer.allocateDirect(i2).order(PlatformDependent.BIG_ENDIAN_NATIVE_ORDER ? ByteOrder.BIG_ENDIAN : ByteOrder.LITTLE_ENDIAN);
    }
