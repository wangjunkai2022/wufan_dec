...
public abstract class NioUdtAcceptorChannel extends AbstractNioMessageChannel implements a {
    ...
    protected int doReadMessages(List<Object> list) throws Exception {
        SocketChannelUDT socketChannelUDT = (SocketChannelUDT) SocketUtils.accept(mo18javaChannel());
    ...
    public boolean isActive() {
        return mo18javaChannel().socket().isBound();
    }
    ...
    public ServerSocketChannelUDT mo18javaChannel() {
