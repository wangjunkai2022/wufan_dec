...
public final class SctpMessage extends DefaultByteBufHolder {
    ...
    public SctpMessage(int i2, int i4, ByteBuf byteBuf) {
        this(i2, i4, false, byteBuf);
    }
    ...
    public SctpMessage(int i2, int i4, boolean z3, ByteBuf byteBuf) {
        super(byteBuf);
    ...
    @Override // io.netty.buffer.DefaultByteBufHolder, io.netty.util.ReferenceCounted
    public SctpMessage retain(int i2) {
        super.retain(i2);
        return this;
    }
