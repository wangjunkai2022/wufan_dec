...
public class NioSctpServerChannel extends AbstractNioMessageChannel implements SctpServerChannel {
    ...
    public NioSctpServerChannel() {
        ...
        this.config = new NioSctpServerChannelConfig(this, mo18javaChannel());
    }
    ...
    protected int doReadMessages(List<Object> list) throws Exception {
        SctpChannel accept = mo18javaChannel().accept();
        if (accept == null) {
            return 0;
        }
    ...
    public com.sun.nio.sctp.SctpServerChannel mo18javaChannel() {
