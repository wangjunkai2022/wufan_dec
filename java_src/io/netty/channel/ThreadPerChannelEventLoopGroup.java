...
public class ThreadPerChannelEventLoopGroup extends AbstractEventExecutorGroup implements EventLoopGroup {
    ...
    private final io.netty.util.concurrent.a<Object> childTerminationListener;
    ...
    public ThreadPerChannelEventLoopGroup(int i2, Executor executor, Object... objArr) {
        ...
        this.childTerminationListener = new io.netty.util.concurrent.a<Object>() { // from class: io.netty.channel.ThreadPerChannelEventLoopGroup.1
        ...
        ObjectUtil.checkPositiveOrZero(i2, "maxChannels");
        ...
        this.tooManyChannels = (ChannelException) ThrowableUtil.unknownStackTrace(ChannelException.newStatic("too many channels (max: " + i2 + ')', null), ThreadPerChannelEventLoopGroup.class, "nextChild()");
    }
