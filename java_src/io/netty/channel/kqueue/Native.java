...
final class Native {
    ...
    public static native int keventAddUserEvent(int i2, int i4);

    /* JADX INFO: Access modifiers changed from: package-private */
    public static native int keventTriggerUserEvent(int i2, int i4);

    private static native int keventWait(int i2, long j4, int i4, long j5, int i5, int i6, int i7);

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int keventWait(int i2, KQueueEventArray kQueueEventArray, KQueueEventArray kQueueEventArray2, int i4, int i5) throws IOException {
        int keventWait = keventWait(i2, kQueueEventArray.memoryAddress(), kQueueEventArray.size(), kQueueEventArray2.memoryAddress(), kQueueEventArray2.capacity(), i4, i5);
        if (keventWait >= 0) {
            return keventWait;
        }
