...
public final class KQueueSocketChannelConfig extends KQueueChannelConfig implements SocketChannelConfig {
    ...
    @Override // io.netty.channel.socket.SocketChannelConfig
    public KQueueSocketChannelConfig setPerformancePreferences(int i2, int i4, int i5) {
        return this;
    }

    public void setSndLowAt(int i2) {
        try {
            ((KQueueSocketChannel) this.channel).socket.setSndLowAt(i2);
        } catch (IOException e4) {
            throw new ChannelException(e4);
        }
    }
    ...
    @Override // io.netty.channel.socket.SocketChannelConfig
    public KQueueSocketChannelConfig setReceiveBufferSize(int i2) {
        try {
            ((KQueueSocketChannel) this.channel).socket.setReceiveBufferSize(i2);
            return this;
        } catch (IOException e4) {
            throw new ChannelException(e4);
        }
    ...
    @Override // io.netty.channel.socket.SocketChannelConfig
    public KQueueSocketChannelConfig setSendBufferSize(int i2) {
        try {
            ((KQueueSocketChannel) this.channel).socket.setSendBufferSize(i2);
            calculateMaxBytesPerGatheringWrite();
            return this;
        } catch (IOException e4) {
            throw new ChannelException(e4);
    ...
    @Override // io.netty.channel.socket.SocketChannelConfig
    public KQueueSocketChannelConfig setSoLinger(int i2) {
        try {
            ((KQueueSocketChannel) this.channel).socket.setSoLinger(i2);
            return this;
        } catch (IOException e4) {
            throw new ChannelException(e4);
        }
    ...
    @Override // io.netty.channel.socket.SocketChannelConfig
    public KQueueSocketChannelConfig setTrafficClass(int i2) {
        try {
            ((KQueueSocketChannel) this.channel).socket.setTrafficClass(i2);
            return this;
        } catch (IOException e4) {
            throw new ChannelException(e4);
        }
    ...
    @Override // io.netty.channel.kqueue.KQueueChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    @Deprecated
    public KQueueSocketChannelConfig setWriteBufferHighWaterMark(int i2) {
    ...
    @Override // io.netty.channel.kqueue.KQueueChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    @Deprecated
    public KQueueSocketChannelConfig setWriteBufferLowWaterMark(int i2) {
    ...
    @Override // io.netty.channel.kqueue.KQueueChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    public KQueueSocketChannelConfig setConnectTimeoutMillis(int i2) {
    ...
    @Override // io.netty.channel.kqueue.KQueueChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    @Deprecated
    public KQueueSocketChannelConfig setMaxMessagesPerRead(int i2) {
    ...
    @Override // io.netty.channel.kqueue.KQueueChannelConfig, io.netty.channel.DefaultChannelConfig, io.netty.channel.ChannelConfig
    public KQueueSocketChannelConfig setWriteSpinCount(int i2) {
