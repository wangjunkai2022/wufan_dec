...
public final class EpollDomainSocketChannel extends AbstractEpollStreamChannel implements DomainSocketChannel {
    ...
    public final class EpollDomainUnsafe extends AbstractEpollStreamChannel.EpollStreamUnsafe {
        ...
        public void epollInReady() {
            int i2 = AnonymousClass1.$SwitchMap$io$netty$channel$unix$DomainSocketReadMode[EpollDomainSocketChannel.this.config().getReadMode().ordinal()];
            if (i2 == 1) {
                super.epollInReady();
            } else if (i2 == 2) {
                epollInReadFd();
    ...
    public EpollDomainSocketChannel(int i2) {
        super(i2);
        this.config = new EpollDomainSocketChannelConfig(this);
    }
    ...
    public EpollDomainSocketChannel(int i2, boolean z3) {
        super(new LinuxSocket(i2), z3);
        this.config = new EpollDomainSocketChannelConfig(this);
    }
}
