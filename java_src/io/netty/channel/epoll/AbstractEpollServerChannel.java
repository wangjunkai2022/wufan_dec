...
public abstract class AbstractEpollServerChannel extends AbstractEpollChannel implements b {
    ...
    public AbstractEpollServerChannel(int i2) {
    ...
    abstract Channel newChildChannel(int i2, byte[] bArr, int i4, int i5) throws Exception;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractEpollServerChannel(LinuxSocket linuxSocket, boolean z3) {
