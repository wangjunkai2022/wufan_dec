...
public abstract class AbstractChannelHandlerContext implements ChannelHandlerContext, ResourceLeakHint {
    ...
    public static final class WriteTask implements Runnable {
        ...
        protected static void init(WriteTask writeTask, AbstractChannelHandlerContext abstractChannelHandlerContext, Object obj, ChannelPromise channelPromise, boolean z3) {
        ...
        static WriteTask newInstance(AbstractChannelHandlerContext abstractChannelHandlerContext, Object obj, ChannelPromise channelPromise, boolean z3) {
            WriteTask writeTask = RECYCLER.get();
            init(writeTask, abstractChannelHandlerContext, obj, channelPromise, z3);
            return writeTask;
        }
    ...
    public AbstractChannelHandlerContext(DefaultChannelPipeline defaultChannelPipeline, EventExecutor eventExecutor, String str, Class<? extends ChannelHandler> cls) {
        ...
        this.ordered = (eventExecutor == null || (eventExecutor instanceof io.netty.util.concurrent.b)) ? true : true;
    }

    private AbstractChannelHandlerContext findContextInbound(int i2) {
        AbstractChannelHandlerContext abstractChannelHandlerContext = this;
        do {
            abstractChannelHandlerContext = abstractChannelHandlerContext.next;
        } while ((abstractChannelHandlerContext.executionMask & i2) == 0);
        return abstractChannelHandlerContext;
    }

    private AbstractChannelHandlerContext findContextOutbound(int i2) {
        AbstractChannelHandlerContext abstractChannelHandlerContext = this;
        do {
    ...
    private boolean isNotValidPromise(ChannelPromise channelPromise, boolean z3) {
    ...
    private static boolean safeExecute(EventExecutor eventExecutor, Runnable runnable, ChannelPromise channelPromise, Object obj, boolean z3) {
        if (z3) {
            try {
    ...
    private void write(Object obj, boolean z3, ChannelPromise channelPromise) {
        ...
        try {
            ...
            AbstractChannelHandlerContext findContextOutbound = findContextOutbound(z3 ? 98304 : 32768);
            ...
            WriteTask newInstance = WriteTask.newInstance(findContextOutbound, obj2, channelPromise, z3);
            if (safeExecute(executor, newInstance, channelPromise, obj2, !z3)) {
                return;
            }
            newInstance.cancel();
