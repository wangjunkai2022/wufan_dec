...
public abstract class AbstractNioChannel extends AbstractChannel {
    ...
    protected void doRegister() throws Exception {
        ...
        while (true) {
            try {
                this.selectionKey = mo18javaChannel().register(eventLoop().unwrappedSelector(), 0, this);
                return;
    ...
    public SelectableChannel mo18javaChannel() {
        return this.ch;
    }
    ...
    public abstract class AbstractNioUnsafe extends AbstractChannel.AbstractUnsafe implements NioUnsafe {
        ...
        public final SelectableChannel ch() {
            return AbstractNioChannel.this.mo18javaChannel();
        }
        ...
        */
        ...
        public final void removeReadOp() {
            ...
            if (selectionKey.isValid()) {
                int interestOps = selectionKey.interestOps();
                int i2 = AbstractNioChannel.this.readInterestOp;
                if ((interestOps & i2) != 0) {
