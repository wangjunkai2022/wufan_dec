...
public final class ChannelMatchers {
    ...
    private static final ChannelMatcher SERVER_CHANNEL_MATCHER = isInstanceOf(b.class);
    private static final ChannelMatcher NON_SERVER_CHANNEL_MATCHER = isNotInstanceOf(b.class);
