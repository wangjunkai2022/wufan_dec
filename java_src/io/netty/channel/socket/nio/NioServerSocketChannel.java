...
public class NioServerSocketChannel extends AbstractNioMessageChannel implements ServerSocketChannel {
    ...
    private final class NioServerSocketChannelConfig extends DefaultServerSocketChannelConfig {
        private java.nio.channels.ServerSocketChannel jdkChannel() {
            return ((NioServerSocketChannel) this.channel).mo18javaChannel();
        }
    ...
    protected void doBind(SocketAddress socketAddress) throws Exception {
        if (PlatformDependent.javaVersion() >= 7) {
            mo18javaChannel().bind(socketAddress, this.config.getBacklog());
        } else {
            mo18javaChannel().socket().bind(socketAddress, this.config.getBacklog());
        }
    }
    ...
    protected int doReadMessages(List<Object> list) throws Exception {
        SocketChannel accept = SocketUtils.accept(mo18javaChannel());
        if (accept != null) {
            try {
    ...
    public boolean isActive() {
        return isOpen() && mo18javaChannel().socket().isBound();
    }

    @Override // io.netty.channel.AbstractChannel
    protected SocketAddress localAddress0() {
        return SocketUtils.localSocketAddress(mo18javaChannel().socket());
    }
    ...
    public java.nio.channels.ServerSocketChannel mo18javaChannel() {
        return (java.nio.channels.ServerSocketChannel) super.mo18javaChannel();
    }
    ...
    public NioServerSocketChannel(java.nio.channels.ServerSocketChannel serverSocketChannel) {
        ...
        this.config = new NioServerSocketChannelConfig(this, mo18javaChannel().socket());
    }
}
