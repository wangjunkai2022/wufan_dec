...
public class DefaultDnsCache implements DnsCache {
    ...
    public DefaultDnsCache(int i2, int i4, int i5) {
        ...
        this.minTtl = Math.min(i6, ObjectUtil.checkPositiveOrZero(i2, "minTtl"));
        this.maxTtl = Math.min(i6, ObjectUtil.checkPositiveOrZero(i4, "maxTtl"));
        if (i2 <= i4) {
            this.negativeTtl = ObjectUtil.checkPositiveOrZero(i5, "negativeTtl");
            return;
        }
        throw new IllegalArgumentException("minTtl: " + i2 + ", maxTtl: " + i4 + " (expected: 0 <= minTtl <= maxTtl)");
    }
