...
public class DefaultAuthoritativeDnsServerCache implements AuthoritativeDnsServerCache {
    ...
    public DefaultAuthoritativeDnsServerCache(int i2, int i4, Comparator<InetSocketAddress> comparator) {
        ...
        int i5 = Cache.MAX_SUPPORTED_TTL_SECS;
        this.minTtl = Math.min(i5, ObjectUtil.checkPositiveOrZero(i2, "minTtl"));
        this.maxTtl = Math.min(i5, ObjectUtil.checkPositive(i4, "maxTtl"));
        if (i2 <= i4) {
