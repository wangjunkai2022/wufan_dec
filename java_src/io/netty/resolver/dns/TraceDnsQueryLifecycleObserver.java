...
final class TraceDnsQueryLifecycleObserver implements DnsQueryLifecycleObserver {
    ...
    public void queryCancelled(int i2) {
        ...
        if (inetSocketAddress != null) {
            this.logger.log(this.level, "from {} : {} cancelled with {} queries remaining", inetSocketAddress, this.question, Integer.valueOf(i2));
        } else {
            this.logger.log(this.level, "{} query never written and cancelled with {} queries remaining", this.question, Integer.valueOf(i2));
        }
    }
