...
public final class DnsRecordResolveContext extends DnsResolveContext<DnsRecord> {
    ...
    @Override // io.netty.resolver.dns.DnsResolveContext
    DnsResolveContext<DnsRecord> newResolverContext(DnsNameResolver dnsNameResolver, String str, int i2, DnsRecordType[] dnsRecordTypeArr, DnsRecord[] dnsRecordArr, DnsServerAddressStream dnsServerAddressStream) {
        return new DnsRecordResolveContext(dnsNameResolver, str, i2, dnsRecordTypeArr, dnsRecordArr, dnsServerAddressStream);
    }
    ...
    private DnsRecordResolveContext(DnsNameResolver dnsNameResolver, String str, int i2, DnsRecordType[] dnsRecordTypeArr, DnsRecord[] dnsRecordArr, DnsServerAddressStream dnsServerAddressStream) {
        super(dnsNameResolver, str, i2, dnsRecordTypeArr, dnsRecordArr, dnsServerAddressStream);
    }
}
