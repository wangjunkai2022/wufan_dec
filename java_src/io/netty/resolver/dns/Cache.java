...
public abstract class Cache<E> {
    ...
    private final class Entries extends AtomicReference<List<E>> implements Runnable {
        ...
        private void scheduleCacheExpirationIfNeeded(int i2, EventLoop eventLoop) {
            while (true) {
                ...
                c<?> schedule = eventLoop.schedule((Runnable) this, i2, TimeUnit.SECONDS);
        ...
        void add(E e4, int i2, EventLoop eventLoop) {
            if (Cache.this.shouldReplaceAll(e4)) {
                set(Collections.singletonList(e4));
                scheduleCacheExpirationIfNeeded(i2, eventLoop);
                return;
            }
            while (true) {
                List<E> list = get();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void cache(String str, E e4, int i2, EventLoop eventLoop) {
