...
public final class DnsQueryContextManager {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public DnsQueryContext remove(InetSocketAddress inetSocketAddress, int i2) {
