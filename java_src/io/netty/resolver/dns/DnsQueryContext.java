...
public abstract class DnsQueryContext implements a<AddressedEnvelope<DnsResponse, InetSocketAddress>> {
    ...
    protected abstract DnsQuery newQuery(int i2);

    @Override // io.netty.util.concurrent.GenericFutureListener
    public void operationComplete(Future<AddressedEnvelope<DnsResponse, InetSocketAddress>> future) {
        c<?> cVar = this.timeoutFuture;
        if (cVar != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean tryFailure(String str, Throwable th, boolean z3) {
