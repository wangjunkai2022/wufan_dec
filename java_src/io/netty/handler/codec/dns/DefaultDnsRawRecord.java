...
public class DefaultDnsRawRecord extends AbstractDnsRecord implements DnsRawRecord {
    ...
    public DefaultDnsRawRecord(String str, DnsRecordType dnsRecordType, int i2, long j4, ByteBuf byteBuf) {
        super(str, dnsRecordType, i2, j4);
    ...
    @Override // io.netty.util.ReferenceCounted
    public DnsRawRecord retain(int i2) {
        content().retain(i2);
        return this;
    }
