...
public class DatagramDnsQueryDecoder extends MessageToMessageDecoder<DatagramPacket> {
    ...
    private void decodeQuestions(DnsQuery dnsQuery, ByteBuf byteBuf, int i2) throws Exception {
        while (i2 > 0) {
    ...
    private void decodeRecords(DnsQuery dnsQuery, DnsSection dnsSection, ByteBuf byteBuf, int i2) throws Exception {
        while (i2 > 0) {
