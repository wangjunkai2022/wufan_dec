...
abstract class DnsResponseDecoder<A extends SocketAddress> {
    ...
    private void decodeQuestions(DnsResponse dnsResponse, ByteBuf byteBuf, int i2) throws Exception {
        while (i2 > 0) {
    ...
    private boolean decodeRecords(DnsResponse dnsResponse, DnsSection dnsSection, ByteBuf byteBuf, int i2) throws Exception {
        while (i2 > 0) {
    ...
    protected abstract DnsResponse newResponse(A a4, A a5, int i2, DnsOpCode dnsOpCode, DnsResponseCode dnsResponseCode) throws Exception;
}
