...
public final class RtspResponseStatuses {
    ...
    public static final HttpResponseStatus UNSUPPORTED_TRANSPORT = new HttpResponseStatus(f.f58922n, "Unsupported transport");
    public static final HttpResponseStatus DESTINATION_UNREACHABLE = new HttpResponseStatus(f.f58923o, "Destination unreachable");
                ...
                if (i2 != 505) {
                    if (i2 != 551) {
                        switch (i2) {
                            ...
                            default:
                                return HttpResponseStatus.valueOf(i2);
                        }
                    }
