...
public class HAProxyMessageDecoder extends ByteToMessageDecoder {
    ...
    public abstract class HeaderExtractor {
        ...
        protected HeaderExtractor(int i2) {
            this.maxHeaderSize = i2;
        }

        protected abstract int delimiterLength(ByteBuf byteBuf, int i2);
    ...
    public final class LineHeaderExtractor extends HeaderExtractor {
        LineHeaderExtractor(int i2) {
            super(i2);
        }

        @Override // io.netty.handler.codec.haproxy.HAProxyMessageDecoder.HeaderExtractor
        protected int delimiterLength(ByteBuf byteBuf, int i2) {
            return byteBuf.getByte(i2) == 13 ? 2 : 1;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void failOverLimit(ChannelHandlerContext channelHandlerContext, int i2) {
    ...
    private static boolean match(byte[] bArr, ByteBuf byteBuf, int i2) {
        for (int i4 = 0; i4 < bArr.length; i4++) {
            if (byteBuf.getByte(i2 + i4) != bArr[i4]) {
                return false;
            }
        }
        return true;
    ...
    public HAProxyMessageDecoder(boolean z3) {
        this.version = -1;
    ...
    public void failOverLimit(ChannelHandlerContext channelHandlerContext, String str) {
        int i2 = this.version == 1 ? 108 : this.v2MaxHeaderSize;
        fail(channelHandlerContext, "header length (" + str + ") exceeds the allowed maximum (" + i2 + ')', null);
    }
    ...
    public HAProxyMessageDecoder(int i2, boolean z3) {
        this.version = -1;
        if (i2 < 1) {
            this.v2MaxHeaderSize = V2_MIN_LENGTH;
        } else if (i2 > V2_MAX_TLV) {
            this.v2MaxHeaderSize = V2_MAX_LENGTH;
        } else {
            int i4 = i2 + V2_MIN_LENGTH;
            if (i4 > V2_MAX_LENGTH) {
                this.v2MaxHeaderSize = V2_MAX_LENGTH;
            } else {
                this.v2MaxHeaderSize = i4;
            }
        }
        this.failFast = z3;
    }
