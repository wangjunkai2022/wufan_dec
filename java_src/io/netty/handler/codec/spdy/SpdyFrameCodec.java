...
public class SpdyFrameCodec extends ByteToMessageDecoder implements SpdyFrameDecoderDelegate, ChannelOutboundHandler {
    ...
    public void readDataFrame(int i2, boolean z3, ByteBuf byteBuf) {
        this.read = true;
    ...
    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readGoAwayFrame(int i2, int i4) {
        this.read = true;
        this.ctx.fireChannelRead((Object) new DefaultSpdyGoAwayFrame(i2, i4));
    }
    ...
    */
    ...
    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readHeadersFrame(int i2, boolean z3) {
        DefaultSpdyHeadersFrame defaultSpdyHeadersFrame = new DefaultSpdyHeadersFrame(i2, this.validateHeaders);
    ...
    public void readPingFrame(int i2) {
        this.read = true;
        this.ctx.fireChannelRead((Object) new DefaultSpdyPingFrame(i2));
    }

    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readRstStreamFrame(int i2, int i4) {
        this.read = true;
        this.ctx.fireChannelRead((Object) new DefaultSpdyRstStreamFrame(i2, i4));
    }

    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readSetting(int i2, int i4, boolean z3, boolean z4) {
        this.spdySettingsFrame.setValue(i2, i4, z3, z4);
    }
    ...
    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readSynReplyFrame(int i2, boolean z3) {
        DefaultSpdySynReplyFrame defaultSpdySynReplyFrame = new DefaultSpdySynReplyFrame(i2, this.validateHeaders);
        defaultSpdySynReplyFrame.setLast(z3);
        this.spdyHeadersFrame = defaultSpdySynReplyFrame;
    }

    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readSynStreamFrame(int i2, int i4, byte b4, boolean z3, boolean z4) {
        DefaultSpdySynStreamFrame defaultSpdySynStreamFrame = new DefaultSpdySynStreamFrame(i2, i4, b4, this.validateHeaders);
    ...
    @Override // io.netty.handler.codec.spdy.SpdyFrameDecoderDelegate
    public void readWindowUpdateFrame(int i2, int i4) {
        this.read = true;
        this.ctx.fireChannelRead((Object) new DefaultSpdyWindowUpdateFrame(i2, i4));
    }
    ...
    public SpdyFrameCodec(SpdyVersion spdyVersion, int i2, int i4, int i5, int i6, int i7) {
        this(spdyVersion, i2, i4, i5, i6, i7, true);
    }

    public SpdyFrameCodec(SpdyVersion spdyVersion, int i2, int i4, int i5, int i6, int i7, boolean z3) {
        this(spdyVersion, i2, SpdyHeaderBlockDecoder.newInstance(spdyVersion, i4), SpdyHeaderBlockEncoder.newInstance(spdyVersion, i5, i6, i7), z3);
    }

    protected SpdyFrameCodec(SpdyVersion spdyVersion, int i2, SpdyHeaderBlockDecoder spdyHeaderBlockDecoder, SpdyHeaderBlockEncoder spdyHeaderBlockEncoder, boolean z3) {
        this.spdyFrameDecoder = new SpdyFrameDecoder(spdyVersion, this, i2);
