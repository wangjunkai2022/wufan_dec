...
public class DefaultSpdyHeaders extends DefaultHeaders<CharSequence, CharSequence, SpdyHeaders> implements SpdyHeaders {
    ...
    public DefaultSpdyHeaders(boolean z3) {
        super(AsciiString.CASE_INSENSITIVE_HASHER, z3 ? HeaderValueConverterAndValidator.INSTANCE : CharSequenceValueConverter.INSTANCE, z3 ? SpdyNameValidator : DefaultHeaders.NameValidator.NOT_NULL);
    }
