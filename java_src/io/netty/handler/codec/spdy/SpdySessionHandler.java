...
public class SpdySessionHandler extends ChannelDuplexHandler {
    ...
    private boolean acceptStream(int i2, byte b4, boolean z3, boolean z4) {
        ...
        this.spdySession.acceptStream(i2, b4, z3, z4, this.initialSendWindowSize, this.initialReceiveWindowSize, isRemoteInitiatedId);
    ...
    private void halfCloseStream(int i2, boolean z3, ChannelFuture channelFuture) {
        if (z3) {
    ...
    private boolean isRemoteInitiatedId(int i2) {
        boolean isServerId = SpdyCodecUtil.isServerId(i2);
    ...
    private void issueStreamError(ChannelHandlerContext channelHandlerContext, int i2, SpdyStreamStatus spdyStreamStatus) {
        boolean z3 = !this.spdySession.isRemoteSideClosed(i2);
    ...
    private void updateInitialReceiveWindowSize(int i2) {
        int i4 = i2 - this.initialReceiveWindowSize;
    ...
    private void updateInitialSendWindowSize(int i2) {
        int i4 = i2 - this.initialSendWindowSize;
        this.initialSendWindowSize = i2;
        this.spdySession.updateAllSendWindowSizes(i4);
    }

    private void updateSendWindowSize(final ChannelHandlerContext channelHandlerContext, int i2, int i4) {
        this.spdySession.updateSendWindowSize(i2, i4);
        while (true) {
        ...
        if (obj instanceof SpdyDataFrame) {
            ...
            if (!this.spdySession.isActiveStream(streamId)) {
                ...
                if (updateReceiveWindowSize2 <= this.initialReceiveWindowSize / 2 && !spdyDataFrame.isLast()) {
                    int i4 = this.initialReceiveWindowSize - updateReceiveWindowSize2;
                    this.spdySession.updateReceiveWindowSize(streamId, i4);
                    channelHandlerContext.writeAndFlush(new DefaultSpdyWindowUpdateFrame(streamId, i4));
                }
                if (spdyDataFrame.isLast()) {
    ...
    public void setSessionReceiveWindowSize(int i2) {
        ObjectUtil.checkPositiveOrZero(i2, "sessionReceiveWindowSize");
