...
final class SpdyCodecUtil {
    ...
    public static int getSignedInt(ByteBuf byteBuf, int i2) {
        return (byteBuf.getByte(i2 + 3) & 255) | ((byteBuf.getByte(i2) & 255) << 24) | ((byteBuf.getByte(i2 + 1) & 255) << 16) | ((byteBuf.getByte(i2 + 2) & 255) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedInt(ByteBuf byteBuf, int i2) {
        return (byteBuf.getByte(i2 + 3) & 255) | ((byteBuf.getByte(i2) & ByteCompanionObject.MAX_VALUE) << 24) | ((byteBuf.getByte(i2 + 1) & 255) << 16) | ((byteBuf.getByte(i2 + 2) & 255) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedMedium(ByteBuf byteBuf, int i2) {
        return (byteBuf.getByte(i2 + 2) & 255) | ((byteBuf.getByte(i2) & 255) << 16) | ((byteBuf.getByte(i2 + 1) & 255) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int getUnsignedShort(ByteBuf byteBuf, int i2) {
        return (byteBuf.getByte(i2 + 1) & 255) | ((byteBuf.getByte(i2) & 255) << 8);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean isServerId(int i2) {
        return i2 % 2 == 0;
    }
