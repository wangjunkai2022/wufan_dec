...
public class SpdyHttpDecoder extends MessageToMessageDecoder<a> {
    ...
    protected FullHttpMessage getMessage(int i2) {
        return this.messageMap.get(Integer.valueOf(i2));
    }

    protected FullHttpMessage putMessage(int i2, FullHttpMessage fullHttpMessage) {
        return this.messageMap.put(Integer.valueOf(i2), fullHttpMessage);
    }

    protected FullHttpMessage removeMessage(int i2) {
        return this.messageMap.remove(Integer.valueOf(i2));
    }

    public SpdyHttpDecoder(SpdyVersion spdyVersion, int i2, boolean z3) {
        this(spdyVersion, i2, new HashMap(), z3);
    }
    ...
    protected SpdyHttpDecoder(SpdyVersion spdyVersion, int i2, Map<Integer, FullHttpMessage> map, boolean z3) {
        this.spdyVersion = ((SpdyVersion) ObjectUtil.checkNotNull(spdyVersion, "version")).getVersion();
        this.maxContentLength = ObjectUtil.checkPositive(i2, "maxContentLength");
        this.messageMap = map;
