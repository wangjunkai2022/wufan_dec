...
public interface SpdySettingsFrame extends a {
    ...
    SpdySettingsFrame removeValue(int i2);

    SpdySettingsFrame setClearPreviouslyPersistedSettings(boolean z3);

    SpdySettingsFrame setPersistValue(int i2, boolean z3);

    SpdySettingsFrame setPersisted(int i2, boolean z3);

    SpdySettingsFrame setValue(int i2, int i4);

    SpdySettingsFrame setValue(int i2, int i4, boolean z3, boolean z4);
}
