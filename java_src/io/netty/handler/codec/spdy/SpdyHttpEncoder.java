...
public class SpdyHttpEncoder extends MessageToMessageEncoder<HttpObject> {
    ...
    private SpdySynStreamFrame createSynStreamFrame(HttpRequest httpRequest) throws Exception {
        ...
        int i2 = headers.getInt(asciiString2, 0);
        ...
        headers.remove("Proxy-Connection");
        headers.remove(HttpHeaderNames.TRANSFER_ENCODING);
        DefaultSpdySynStreamFrame defaultSpdySynStreamFrame = new DefaultSpdySynStreamFrame(intValue, i2, (byte) headers.getInt(asciiString3, 0), this.validateHeaders);
