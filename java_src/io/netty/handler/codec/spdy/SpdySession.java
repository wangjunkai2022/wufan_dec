...
public final class SpdySession {
    ...
    public static final class StreamState {
        ...
        StreamState(byte b4, boolean z3, boolean z4, int i2, int i4) {
            this.priority = b4;
            this.remoteSideClosed = z3;
            this.localSideClosed = z4;
            this.sendWindowSize = new AtomicInteger(i2);
            this.receiveWindowSize = new AtomicInteger(i4);
        }
        ...
        void setReceiveWindowSizeLowerBound(int i2) {
            this.receiveWindowSizeLowerBound = i2;
        }

        int updateReceiveWindowSize(int i2) {
            return this.receiveWindowSize.addAndGet(i2);
        }

        int updateSendWindowSize(int i2) {
            return this.sendWindowSize.addAndGet(i2);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public SpdySession(int i2, int i4) {
        this.sendWindowSize = new AtomicInteger(i2);
        this.receiveWindowSize = new AtomicInteger(i4);
    }

    private StreamState removeActiveStream(int i2, boolean z3) {
        StreamState remove = this.activeStreams.remove(Integer.valueOf(i2));
        if (remove != null) {
            if (z3) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void acceptStream(int i2, byte b4, boolean z3, boolean z4, int i4, int i5, boolean z5) {
        if (!(z3 && z4) && this.activeStreams.put(Integer.valueOf(i2), new StreamState(b4, z3, z4, i4, i5)) == null) {
            if (z5) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void closeLocalSide(int i2, boolean z3) {
        StreamState streamState = this.activeStreams.get(Integer.valueOf(i2));
        if (streamState != null) {
            streamState.closeLocalSide();
            if (streamState.isRemoteSideClosed()) {
                removeActiveStream(i2, z3);
            }
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void closeRemoteSide(int i2, boolean z3) {
        StreamState streamState = this.activeStreams.get(Integer.valueOf(i2));
        if (streamState != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public PendingWrite getPendingWrite(int i2) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int getReceiveWindowSizeLowerBound(int i2) {
        StreamState streamState;
        if (i2 == 0 || (streamState = this.activeStreams.get(Integer.valueOf(i2))) == null) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public int getSendWindowSize(int i2) {
        if (i2 == 0) {
            return this.sendWindowSize.get();
        }
        StreamState streamState = this.activeStreams.get(Integer.valueOf(i2));
    ...
    public boolean isActiveStream(int i2) {
        return this.activeStreams.containsKey(Integer.valueOf(i2));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean putPendingWrite(int i2, PendingWrite pendingWrite) {
        StreamState streamState = this.activeStreams.get(Integer.valueOf(i2));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public PendingWrite removePendingWrite(int i2) {
        StreamState streamState = this.activeStreams.get(Integer.valueOf(i2));
        if (streamState != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void removeStream(int i2, Throwable th, boolean z3) {
        StreamState removeActiveStream = removeActiveStream(i2, z3);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void updateAllReceiveWindowSizes(int i2) {
        for (StreamState streamState : this.activeStreams.values()) {
            streamState.updateReceiveWindowSize(i2);
            if (i2 < 0) {
                streamState.setReceiveWindowSizeLowerBound(i2);
            }
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void updateAllSendWindowSizes(int i2) {
        for (StreamState streamState : this.activeStreams.values()) {
            streamState.updateSendWindowSize(i2);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int updateReceiveWindowSize(int i2, int i4) {
        if (i2 == 0) {
        ...
        return streamState.updateReceiveWindowSize(i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int updateSendWindowSize(int i2, int i4) {
        if (i2 == 0) {
            return this.sendWindowSize.addAndGet(i4);
        }
        StreamState streamState = this.activeStreams.get(Integer.valueOf(i2));
        if (streamState != null) {
            return streamState.updateSendWindowSize(i4);
        }
        return -1;
    }
}
