...
final class MqttCodecUtil {
    ...
    public static MqttFixedHeader validateFixedHeader(MqttFixedHeader mqttFixedHeader) {
        int i2 = AnonymousClass1.$SwitchMap$io$netty$handler$codec$mqtt$MqttMessageType[mqttFixedHeader.messageType().ordinal()];
        if ((i2 == 1 || i2 == 2 || i2 == 3) && mqttFixedHeader.qosLevel() != MqttQoS.AT_LEAST_ONCE) {
