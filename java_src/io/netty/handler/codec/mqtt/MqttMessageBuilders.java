...
public final class MqttMessageBuilders {
    ...
    public static final class ConnectBuilder {
        ...
        public ConnectBuilder keepAlive(int i2) {
            this.keepAliveSecs = i2;
            return this;
        }
    ...
    public static final class PublishBuilder {
        ...
        public PublishBuilder messageId(int i2) {
            this.messageId = i2;
            return this;
        }
    ...
    public static final class SubscribeBuilder {
        ...
        public SubscribeBuilder messageId(int i2) {
            this.messageId = i2;
            return this;
        }
    }
    ...
    public static final class UnsubscribeBuilder {
        ...
        public UnsubscribeBuilder messageId(int i2) {
            this.messageId = i2;
            return this;
        }
    }
