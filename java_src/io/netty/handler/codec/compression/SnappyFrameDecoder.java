...
public class SnappyFrameDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext channelHandlerContext, ByteBuf byteBuf, List<Object> list) throws Exception {
        ...
        try {
            ...
            int i2 = AnonymousClass1.$SwitchMap$io$netty$handler$codec$compression$SnappyFrameDecoder$ChunkType[mapChunkType.ordinal()];
            if (i2 == 1) {
                if (unsignedMediumLE != 6) {
                    ...
                    byteBuf.skipBytes(6);
                    int i4 = readerIndex2 + 1;
                    checkByte(byteBuf.getByte(readerIndex2), (byte) 115);
                    int i5 = i4 + 1;
                    checkByte(byteBuf.getByte(i4), (byte) 78);
                    int i6 = i5 + 1;
                    checkByte(byteBuf.getByte(i5), (byte) 97);
                    int i7 = i6 + 1;
                    checkByte(byteBuf.getByte(i6), (byte) 80);
                    checkByte(byteBuf.getByte(i7), (byte) 112);
                    checkByte(byteBuf.getByte(i7 + 1), (byte) 89);
                    this.started = true;
                }
            } else if (i2 == 2) {
                if (!this.started) {
