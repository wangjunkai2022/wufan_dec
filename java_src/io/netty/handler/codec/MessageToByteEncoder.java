...
public abstract class MessageToByteEncoder<I> extends ChannelOutboundHandlerAdapter {
    ...
    protected ByteBuf allocateBuffer(ChannelHandlerContext channelHandlerContext, I i2, boolean z3) throws Exception {
        if (z3) {
    ...
    protected abstract void encode(ChannelHandlerContext channelHandlerContext, I i2, ByteBuf byteBuf) throws Exception;
