...
public final class DefaultHttp2GoAwayFrame extends DefaultByteBufHolder implements Http2GoAwayFrame {
    ...
    @Override // io.netty.handler.codec.http2.Http2GoAwayFrame
    public Http2GoAwayFrame setExtraStreamIds(int i2) {
        ObjectUtil.checkPositiveOrZero(i2, "extraStreamIds");
        this.extraStreamIds = i2;
        return this;
    }
    ...
    public DefaultHttp2GoAwayFrame(int i2, long j4, ByteBuf byteBuf) {
        super(byteBuf);
        this.errorCode = j4;
    ...
    @Override // io.netty.buffer.DefaultByteBufHolder, io.netty.util.ReferenceCounted
    public Http2GoAwayFrame retain(int i2) {
        super.retain(i2);
        return this;
    }
