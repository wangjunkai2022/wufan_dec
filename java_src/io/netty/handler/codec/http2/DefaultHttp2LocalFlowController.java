...
public class DefaultHttp2LocalFlowController implements Http2LocalFlowController {
    ...
    private final class AutoRefillState extends DefaultState {
        AutoRefillState(Http2Stream http2Stream, int i2) {
    ...
    private class DefaultState implements FlowState {
        ...
        DefaultState(Http2Stream http2Stream, int i2) {
            this.stream = http2Stream;
            window(i2);
            this.streamWindowUpdateRatio = DefaultHttp2LocalFlowController.this.windowUpdateRatio;
        }

        private void returnProcessedBytes(int i2) throws Http2Exception {
            int i4 = this.processedWindow;
            if (i4 - i2 >= this.window) {
                this.processedWindow = i4 - i2;
                return;
            }
        ...
        private void writeWindowUpdate() throws Http2Exception {
            int i2 = this.initialStreamWindowSize - this.processedWindow;
            try {
                incrementFlowControlWindows(i2);
                DefaultHttp2LocalFlowController.this.frameWriter.writeWindowUpdate(DefaultHttp2LocalFlowController.this.ctx, this.stream.id(), i2, DefaultHttp2LocalFlowController.this.ctx.newPromise());
            } catch (Throwable th) {
        ...
        @Override // io.netty.handler.codec.http2.DefaultHttp2LocalFlowController.FlowState
        public void incrementFlowControlWindows(int i2) throws Http2Exception {
            if (i2 > 0 && this.window > Integer.MAX_VALUE - i2) {
        ...
        @Override // io.netty.handler.codec.http2.DefaultHttp2LocalFlowController.FlowState
        public void incrementInitialStreamWindow(int i2) {
            int min = (int) Math.min(2147483647L, Math.max(0L, this.initialStreamWindowSize + i2));
            int i4 = this.initialStreamWindowSize;
            this.initialStreamWindowSize = i4 + (min - i4);
        }
        ...
        @Override // io.netty.handler.codec.http2.DefaultHttp2LocalFlowController.FlowState
        public void window(int i2) {
            this.initialStreamWindowSize = i2;
            this.processedWindow = i2;
            this.window = i2;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean consumeAllBytes(FlowState flowState, int i2) throws Http2Exception {
        return flowState.consumeBytes(i2) | connectionState().consumeBytes(i2);
    }
    ...
    public boolean consumeBytes(Http2Stream http2Stream, int i2) throws Http2Exception {
        ...
        if (i2 == 0 || http2Stream == null || isClosed(http2Stream)) {
            return false;
        }
        if (http2Stream.id() != 0) {
            return consumeAllBytes(state(http2Stream), i2);
        }
    ...
    public void incrementWindowSize(Http2Stream http2Stream, int i2) throws Http2Exception {
        ...
        state.incrementInitialStreamWindow(i2);
    ...
    public void initialWindowSize(int i2) throws Http2Exception {
        ...
        WindowUpdateVisitor windowUpdateVisitor = new WindowUpdateVisitor(i2 - this.initialWindowSize);
