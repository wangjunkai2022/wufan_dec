...
public final class Http2MultiplexHandler extends Http2ChannelDuplexHandler {
    ...
    static /* synthetic */ int access$004(Http2MultiplexHandler http2MultiplexHandler) {
        int i2 = http2MultiplexHandler.idCount + 1;
        http2MultiplexHandler.idCount = i2;
        return i2;
    }

    private static boolean isServer(ChannelHandlerContext channelHandlerContext) {
        return channelHandlerContext.channel().parent() instanceof b;
    }
    ...
    public void userEventTriggered(ChannelHandlerContext channelHandlerContext, Object obj) throws Exception {
        ...
        if (obj instanceof Http2FrameStreamEvent) {
            ...
            if (http2FrameStreamEvent.type() == Http2FrameStreamEvent.Type.State) {
                int i2 = AnonymousClass3.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[defaultHttp2FrameStream.state().ordinal()];
                if (i2 != 1) {
                    if (i2 != 2 && i2 != 3) {
