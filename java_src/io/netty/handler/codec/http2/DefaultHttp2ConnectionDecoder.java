...
public class DefaultHttp2ConnectionDecoder implements Http2ConnectionDecoder {
    ...
    public final class FrameReadListener implements Http2FrameListener {
        ...
        private boolean shouldIgnoreHeadersOrDataFrame(ChannelHandlerContext channelHandlerContext, int i2, Http2Stream http2Stream, String str) throws Http2Exception {
            ...
            } else if (http2Stream.isResetSent() || streamCreatedAfterGoAwaySent(i2)) {
        ...
        private boolean streamCreatedAfterGoAwaySent(int i2) {
            ...
            return DefaultHttp2ConnectionDecoder.this.connection.goAwaySent() && remote.isValidStreamId(i2) && i2 > remote.lastStreamKnownByPeer();
        }
        ...
        public int onDataRead(ChannelHandlerContext channelHandlerContext, int i2, ByteBuf byteBuf, int i4, boolean z3) throws Http2Exception {
            Http2Stream stream = DefaultHttp2ConnectionDecoder.this.connection.stream(i2);
            ...
            try {
                if (shouldIgnoreHeadersOrDataFrame(channelHandlerContext, i2, stream, "DATA")) {
                    flowController.receiveFlowControlledFrame(stream, byteBuf, i4, z3);
                    ...
                    try {
                        ...
                        try {
                            if (http2Exception == null) {
                                int onDataRead = DefaultHttp2ConnectionDecoder.this.listener.onDataRead(channelHandlerContext, i2, byteBuf, i4, z3);
        ...
        public void onGoAwayRead(ChannelHandlerContext channelHandlerContext, int i2, long j4, ByteBuf byteBuf) throws Http2Exception {
            DefaultHttp2ConnectionDecoder.this.onGoAwayRead0(channelHandlerContext, i2, j4, byteBuf);
        }
        ...
        public void onHeadersRead(ChannelHandlerContext channelHandlerContext, int i2, Http2Headers http2Headers, int i4, boolean z3) throws Http2Exception {
            onHeadersRead(channelHandlerContext, i2, http2Headers, 0, (short) 16, false, i4, z3);
        }
        ...
        public void onPriorityRead(ChannelHandlerContext channelHandlerContext, int i2, int i4, short s3, boolean z3) throws Http2Exception {
            DefaultHttp2ConnectionDecoder.this.encoder.flowController().updateDependencyTree(i2, i4, s3, z3);
            DefaultHttp2ConnectionDecoder.this.listener.onPriorityRead(channelHandlerContext, i2, i4, s3, z3);
        }
        ...
        public void onPushPromiseRead(ChannelHandlerContext channelHandlerContext, int i2, int i4, Http2Headers http2Headers, int i5) throws Http2Exception {
            if (!DefaultHttp2ConnectionDecoder.this.connection().isServer()) {
                Http2Stream stream = DefaultHttp2ConnectionDecoder.this.connection.stream(i2);
                if (shouldIgnoreHeadersOrDataFrame(channelHandlerContext, i2, stream, "PUSH_PROMISE")) {
                    return;
                }
                if (stream == null) {
                    throw Http2Exception.connectionError(Http2Error.PROTOCOL_ERROR, "Stream %d does not exist", Integer.valueOf(i2));
                    ...
                    if (DefaultHttp2ConnectionDecoder.this.requestVerifier.isAuthoritative(channelHandlerContext, http2Headers)) {
                        if (DefaultHttp2ConnectionDecoder.this.requestVerifier.isCacheable(http2Headers)) {
                            if (DefaultHttp2ConnectionDecoder.this.requestVerifier.isSafe(http2Headers)) {
                                DefaultHttp2ConnectionDecoder.this.connection.remote().reservePushStream(i4, stream);
                                DefaultHttp2ConnectionDecoder.this.listener.onPushPromiseRead(channelHandlerContext, i2, i4, http2Headers, i5);
                                return;
                            }
                            throw Http2Exception.streamError(i4, Http2Error.PROTOCOL_ERROR, "Promised request on stream %d for promised stream %d is not known to be safe", Integer.valueOf(i2), Integer.valueOf(i4));
                        }
                        throw Http2Exception.streamError(i4, Http2Error.PROTOCOL_ERROR, "Promised request on stream %d for promised stream %d is not known to be cacheable", Integer.valueOf(i2), Integer.valueOf(i4));
                    }
                    throw Http2Exception.streamError(i4, Http2Error.PROTOCOL_ERROR, "Promised request on stream %d for promised stream %d is not authoritative", Integer.valueOf(i2), Integer.valueOf(i4));
                }
        ...
        public void onRstStreamRead(ChannelHandlerContext channelHandlerContext, int i2, long j4) throws Http2Exception {
            ...
            if (i4 != 4) {
                ...
                DefaultHttp2ConnectionDecoder.this.listener.onRstStreamRead(channelHandlerContext, i2, j4);
        ...
        public void onUnknownFrame(ChannelHandlerContext channelHandlerContext, byte b4, int i2, Http2Flags http2Flags, ByteBuf byteBuf) throws Http2Exception {
            DefaultHttp2ConnectionDecoder.this.onUnknownFrame0(channelHandlerContext, b4, i2, http2Flags, byteBuf);
        }

        @Override // io.netty.handler.codec.http2.Http2FrameListener
        public void onWindowUpdateRead(ChannelHandlerContext channelHandlerContext, int i2, int i4) throws Http2Exception {
            Http2Stream stream = DefaultHttp2ConnectionDecoder.this.connection.stream(i2);
            if (stream != null && stream.state() != Http2Stream.State.CLOSED && !streamCreatedAfterGoAwaySent(i2)) {
                DefaultHttp2ConnectionDecoder.this.encoder.flowController().incrementWindowSize(stream, i4);
                DefaultHttp2ConnectionDecoder.this.listener.onWindowUpdateRead(channelHandlerContext, i2, i4);
                return;
            }
            verifyStreamMayHaveExisted(i2);
        }
        ...
        public void onHeadersRead(ChannelHandlerContext channelHandlerContext, int i2, Http2Headers http2Headers, int i4, short s3, boolean z3, int i5, boolean z4) throws Http2Exception {
            ...
            boolean z5;
            Http2Stream stream = DefaultHttp2ConnectionDecoder.this.connection.stream(i2);
            if (stream != null || DefaultHttp2ConnectionDecoder.this.connection.streamMayHaveExisted(i2)) {
                http2Stream = stream;
                z5 = false;
            } else {
                Http2Stream createStream = DefaultHttp2ConnectionDecoder.this.connection.remote().createStream(i2, z4);
            ...
            if (((!z6 && z4) || !http2Stream.isHeadersReceived()) && !http2Stream.isTrailersReceived()) {
                int i6 = AnonymousClass1.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[http2Stream.state().ordinal()];
                if (i6 != 1 && i6 != 2) {
                    if (i6 != 3) {
                        if (i6 == 4) {
                ...
                DefaultHttp2ConnectionDecoder.this.encoder.flowController().updateDependencyTree(i2, i4, s3, z3);
                DefaultHttp2ConnectionDecoder.this.listener.onHeadersRead(channelHandlerContext, i2, http2Headers, i4, s3, z3, i5, z4);
                if (z4) {
            ...
            throw Http2Exception.streamError(i2, Http2Error.PROTOCOL_ERROR, "Stream %d received too many headers EOS: %s state: %s", Integer.valueOf(i2), Boolean.valueOf(z4), http2Stream.state());
        }
    }
    ...
    private final class PrefaceFrameListener implements Http2FrameListener {
        ...
        public int onDataRead(ChannelHandlerContext channelHandlerContext, int i2, ByteBuf byteBuf, int i4, boolean z3) throws Http2Exception {
            ...
            return DefaultHttp2ConnectionDecoder.this.internalFrameListener.onDataRead(channelHandlerContext, i2, byteBuf, i4, z3);
        }
        ...
        public void onHeadersRead(ChannelHandlerContext channelHandlerContext, int i2, Http2Headers http2Headers, int i4, boolean z3) throws Http2Exception {
            verifyPrefaceReceived();
            DefaultHttp2ConnectionDecoder.this.internalFrameListener.onHeadersRead(channelHandlerContext, i2, http2Headers, i4, z3);
        }
        ...
        public void onPriorityRead(ChannelHandlerContext channelHandlerContext, int i2, int i4, short s3, boolean z3) throws Http2Exception {
            verifyPrefaceReceived();
            DefaultHttp2ConnectionDecoder.this.internalFrameListener.onPriorityRead(channelHandlerContext, i2, i4, s3, z3);
        }

        @Override // io.netty.handler.codec.http2.Http2FrameListener
        public void onPushPromiseRead(ChannelHandlerContext channelHandlerContext, int i2, int i4, Http2Headers http2Headers, int i5) throws Http2Exception {
            verifyPrefaceReceived();
            DefaultHttp2ConnectionDecoder.this.internalFrameListener.onPushPromiseRead(channelHandlerContext, i2, i4, http2Headers, i5);
        }

        @Override // io.netty.handler.codec.http2.Http2FrameListener
        public void onRstStreamRead(ChannelHandlerContext channelHandlerContext, int i2, long j4) throws Http2Exception {
            verifyPrefaceReceived();
            DefaultHttp2ConnectionDecoder.this.internalFrameListener.onRstStreamRead(channelHandlerContext, i2, j4);
        }
        ...
        public void onWindowUpdateRead(ChannelHandlerContext channelHandlerContext, int i2, int i4) throws Http2Exception {
            verifyPrefaceReceived();
            DefaultHttp2ConnectionDecoder.this.internalFrameListener.onWindowUpdateRead(channelHandlerContext, i2, i4);
        }
        ...
        public void onHeadersRead(ChannelHandlerContext channelHandlerContext, int i2, Http2Headers http2Headers, int i4, short s3, boolean z3, int i5, boolean z4) throws Http2Exception {
            verifyPrefaceReceived();
            DefaultHttp2ConnectionDecoder.this.internalFrameListener.onHeadersRead(channelHandlerContext, i2, http2Headers, i4, s3, z3, i5, z4);
        }
    }
    ...
    void onGoAwayRead0(ChannelHandlerContext channelHandlerContext, int i2, long j4, ByteBuf byteBuf) throws Http2Exception {
        this.listener.onGoAwayRead(channelHandlerContext, i2, j4, byteBuf);
        this.connection.goAwayReceived(i2, j4, byteBuf);
    }

    void onUnknownFrame0(ChannelHandlerContext channelHandlerContext, byte b4, int i2, Http2Flags http2Flags, ByteBuf byteBuf) throws Http2Exception {
    ...
    public DefaultHttp2ConnectionDecoder(Http2Connection http2Connection, Http2ConnectionEncoder http2ConnectionEncoder, Http2FrameReader http2FrameReader, Http2PromisedRequestVerifier http2PromisedRequestVerifier, boolean z3) {
        this(http2Connection, http2ConnectionEncoder, http2FrameReader, http2PromisedRequestVerifier, z3, true);
    }

    public DefaultHttp2ConnectionDecoder(Http2Connection http2Connection, Http2ConnectionEncoder http2ConnectionEncoder, Http2FrameReader http2FrameReader, Http2PromisedRequestVerifier http2PromisedRequestVerifier, boolean z3, boolean z4) {
