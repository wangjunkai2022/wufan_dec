...
public abstract class AbstractHttp2ConnectionHandlerBuilder<T extends Http2ConnectionHandler, B extends AbstractHttp2ConnectionHandlerBuilder<T, B>> {
    ...
    public B autoAckPingFrame(boolean z3) {
        enforceNonCodecConstraints("autoAckPingFrame");
        this.autoAckPingFrame = z3;
        return self();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public B autoAckSettingsFrame(boolean z3) {
        enforceNonCodecConstraints("autoAckSettingsFrame");
        this.autoAckSettingsFrame = z3;
        return self();
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public B decoupleCloseAndGoAway(boolean z3) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public B encoderIgnoreMaxHeaderListSize(boolean z3) {
        enforceNonCodecConstraints("encoderIgnoreMaxHeaderListSize");
        this.encoderIgnoreMaxHeaderListSize = Boolean.valueOf(z3);
        return self();
    }
    ...
    public B decoderEnforceMaxConsecutiveEmptyDataFrames(int i2) {
        ...
        this.maxConsecutiveEmptyFrames = ObjectUtil.checkPositiveOrZero(i2, "maxConsecutiveEmptyFrames");
        return self();
    }
    ...
    public B encoderEnforceMaxQueuedControlFrames(int i2) {
        ...
        this.maxQueuedControlFrames = ObjectUtil.checkPositiveOrZero(i2, "maxQueuedControlFrames");
        return self();
    }
