...
public class Http2MultiplexCodec extends Http2FrameCodec {
    ...
    public Http2MultiplexCodec(Http2ConnectionEncoder http2ConnectionEncoder, Http2ConnectionDecoder http2ConnectionDecoder, Http2Settings http2Settings, ChannelHandler channelHandler, ChannelHandler channelHandler2, boolean z3) {
        super(http2ConnectionEncoder, http2ConnectionDecoder, http2Settings, z3);
    ...
    static /* synthetic */ int access$004(Http2MultiplexCodec http2MultiplexCodec) {
        int i2 = http2MultiplexCodec.idCount + 1;
        http2MultiplexCodec.idCount = i2;
        return i2;
    }
    ...
    final void onHttp2StreamStateChanged(ChannelHandlerContext channelHandlerContext, Http2FrameCodec.DefaultHttp2FrameStream defaultHttp2FrameStream) {
        ...
        int i2 = AnonymousClass2.$SwitchMap$io$netty$handler$codec$http2$Http2Stream$State[defaultHttp2FrameStream.state().ordinal()];
        if (i2 != 1) {
            if (i2 != 2 && i2 != 3) {
                if (i2 == 4 && (abstractHttp2StreamChannel = (AbstractHttp2StreamChannel) defaultHttp2FrameStream.attachment) != null) {
