...
final class HpackEncoder {
    ...
    public static final class HeaderEntry extends HpackHeaderField {
        ...
        HeaderEntry(int i2, CharSequence charSequence, CharSequence charSequence2, int i4, HeaderEntry headerEntry) {
    ...
    private void encodeHeadersEnforceMaxHeaderListSize(int i2, ByteBuf byteBuf, Http2Headers http2Headers, Http2HeadersEncoder.SensitivityDetector sensitivityDetector) throws Http2Exception {
        ...
        for (Map.Entry<CharSequence, CharSequence> entry : http2Headers) {
            ...
            if (j4 > j5) {
                Http2CodecUtil.headerListSizeExceeded(i2, j5, false);
            }
        }
    ...
    private static void encodeInteger(ByteBuf byteBuf, int i2, int i4, int i5) {
        encodeInteger(byteBuf, i2, i4, i5);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public HpackEncoder(boolean z3) {
        this(z3, 16, 512);
    }

    private static void encodeInteger(ByteBuf byteBuf, int i2, int i4, long j4) {
        int i5 = 255 >>> (8 - i4);
        long j5 = i5;
        if (j4 < j5) {
            byteBuf.writeByte((int) (i2 | j4));
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public HpackEncoder(boolean z3, int i2, int i4) {
