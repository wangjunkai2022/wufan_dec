...
public final class HttpConversionUtil {
    ...
    public static final class Http2ToHttpHeaderTranslator {
        ...
        Http2ToHttpHeaderTranslator(int i2, HttpHeaders httpHeaders, boolean z3) {
            this.streamId = i2;
    ...
    public static void addHttp2ToHttpHeaders(int i2, Http2Headers http2Headers, FullHttpMessage fullHttpMessage, boolean z3) throws Http2Exception {
        addHttp2ToHttpHeaders(i2, http2Headers, z3 ? fullHttpMessage.trailingHeaders() : fullHttpMessage.headers(), fullHttpMessage.protocolVersion(), z3, fullHttpMessage instanceof HttpRequest);
    }
    ...
    public static FullHttpRequest toFullHttpRequest(int i2, Http2Headers http2Headers, ByteBufAllocator byteBufAllocator, boolean z3) throws Http2Exception {
        ...
        try {
            addHttp2ToHttpHeaders(i2, http2Headers, defaultFullHttpRequest, false);
    ...
    public static FullHttpResponse toFullHttpResponse(int i2, Http2Headers http2Headers, ByteBufAllocator byteBufAllocator, boolean z3) throws Http2Exception {
        ...
        try {
            addHttp2ToHttpHeaders(i2, http2Headers, defaultFullHttpResponse, false);
    ...
    public static HttpRequest toHttpRequest(int i2, Http2Headers http2Headers, boolean z3) throws Http2Exception {
    ...
    public static HttpResponse toHttpResponse(int i2, Http2Headers http2Headers, boolean z3) throws Http2Exception {
        DefaultHttpResponse defaultHttpResponse = new DefaultHttpResponse(HttpVersion.HTTP_1_1, parseStatus(http2Headers.status()), z3);
        try {
            addHttp2ToHttpHeaders(i2, http2Headers, defaultHttpResponse.headers(), defaultHttpResponse.protocolVersion(), false, true);
    ...
    private static CharSequenceMap<AsciiString> toLowercaseMap(Iterator<? extends CharSequence> it2, int i2) {
        AsciiString asciiString;
        CharSequenceMap<AsciiString> charSequenceMap = new CharSequenceMap<>(true, UnsupportedValueConverter.instance(), i2);
        while (it2.hasNext()) {
            ...
            try {
                ...
                if (forEachByte != -1) {
                    int i4 = 0;
                    do {
                        AsciiString trim = lowerCase.subSequence(i4, forEachByte, false).trim();
                        ...
                        forEachByte = lowerCase.forEachByte(i4, lowerCase.length() - i4, ByteProcessor.FIND_COMMA);
                    } while (forEachByte != -1);
                    charSequenceMap.add((CharSequenceMap<AsciiString>) lowerCase.subSequence(i4, lowerCase.length(), false).trim(), asciiString);
                } else {
    ...
    public static void addHttp2ToHttpHeaders(int i2, Http2Headers http2Headers, HttpHeaders httpHeaders, HttpVersion httpVersion, boolean z3, boolean z4) throws Http2Exception {
        try {
            new Http2ToHttpHeaderTranslator(i2, httpHeaders, z4).translateHeaders(http2Headers);
            httpHeaders.remove(HttpHeaderNames.TRANSFER_ENCODING);
            httpHeaders.remove(HttpHeaderNames.TRAILER);
            if (z3) {
                return;
            }
            httpHeaders.setInt(ExtensionHeaderNames.STREAM_ID.text(), i2);
                        ...
                        try {
                            ...
                            if (forEachByte != -1) {
                                ...
                                do {
                                    ...
                                    http2Headers.add((Http2Headers) asciiString, of.subSequence(i2, forEachByte, false));
                                    i2 = forEachByte + 2;
                                    if (i2 >= of.length()) {
                                        break;
                                    }
                                    forEachByte = of.forEachByte(i2, of.length() - i2, ByteProcessor.FIND_SEMI_COLON);
                                } while (forEachByte != -1);
                                if (i2 < of.length()) {
                                    http2Headers.add((Http2Headers) asciiString, of.subSequence(i2, of.length(), false));
                                } else {
