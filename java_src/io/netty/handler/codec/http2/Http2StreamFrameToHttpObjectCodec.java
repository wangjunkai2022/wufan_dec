...
public class Http2StreamFrameToHttpObjectCodec extends MessageToMessageCodec<Http2StreamFrame, HttpObject> {
    ...
    private FullHttpMessage newFullMessage(int i2, Http2Headers http2Headers, ByteBufAllocator byteBufAllocator) throws Http2Exception {
        if (this.isServer) {
            return HttpConversionUtil.toFullHttpRequest(i2, http2Headers, byteBufAllocator, this.validateHeaders);
        }
        return HttpConversionUtil.toFullHttpResponse(i2, http2Headers, byteBufAllocator, this.validateHeaders);
    }

    private HttpMessage newMessage(int i2, Http2Headers http2Headers) throws Http2Exception {
        if (this.isServer) {
            return HttpConversionUtil.toHttpRequest(i2, http2Headers, this.validateHeaders);
        }
        return HttpConversionUtil.toHttpResponse(i2, http2Headers, this.validateHeaders);
    }
