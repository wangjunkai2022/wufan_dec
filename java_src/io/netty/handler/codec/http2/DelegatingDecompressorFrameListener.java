...
public class DelegatingDecompressorFrameListener extends Http2FrameListenerDecorator {
    ...
    public final class ConsumedBytesConverter implements Http2LocalFlowController {
        ...
        public boolean consumeBytes(Http2Stream http2Stream, int i2) throws Http2Exception {
            ...
            if (decompressor != null) {
                i2 = decompressor.consumeBytes(http2Stream.id(), i2);
            }
            try {
                return this.flowController.consumeBytes(http2Stream, i2);
        ...
        public void incrementWindowSize(Http2Stream http2Stream, int i2) throws Http2Exception {
            this.flowController.incrementWindowSize(http2Stream, i2);
        }

        @Override // io.netty.handler.codec.http2.Http2FlowController
        public void initialWindowSize(int i2) throws Http2Exception {
            this.flowController.initialWindowSize(i2);
        }

        @Override // io.netty.handler.codec.http2.Http2LocalFlowController
        public void receiveFlowControlledFrame(Http2Stream http2Stream, ByteBuf byteBuf, int i2, boolean z3) throws Http2Exception {
            this.flowController.receiveFlowControlledFrame(http2Stream, byteBuf, i2, z3);
        }
    ...
    public static final class Http2Decompressor {
        ...
        int consumeBytes(int i2, int i4) throws Http2Exception {
            ObjectUtil.checkPositiveOrZero(i4, "decompressedBytes");
            int i5 = this.decompressed;
            if (i5 - i4 >= 0) {
                double d4 = i4;
                double d5 = i5;
                Double.isNaN(d4);
                ...
                if (i7 - min >= 0) {
                    ...
                    this.compressed = i7 - min;
                    return min;
                }
                throw Http2Exception.streamError(i2, Http2Error.INTERNAL_ERROR, "overflow when converting decompressed bytes to compressed bytes for stream %d.decompressedBytes: %d decompressed: %d compressed: %d consumedCompressed: %d", Integer.valueOf(i2), Integer.valueOf(i4), Integer.valueOf(this.decompressed), Integer.valueOf(this.compressed), Integer.valueOf(min));
            }
            throw Http2Exception.streamError(i2, Http2Error.INTERNAL_ERROR, "Attempting to return too many bytes for stream %d. decompressed: %d decompressedBytes: %d", Integer.valueOf(i2), Integer.valueOf(this.decompressed), Integer.valueOf(i4));
        }
        ...
        void incrementCompressedBytes(int i2) {
            this.compressed += i2;
        }

        void incrementDecompressedBytes(int i2) {
    ...
    private void initDecompressor(ChannelHandlerContext channelHandlerContext, int i2, Http2Headers http2Headers, boolean z3) throws Http2Exception {
    ...
    public int onDataRead(ChannelHandlerContext channelHandlerContext, int i2, ByteBuf byteBuf, int i4, boolean z3) throws Http2Exception {
        ...
        try {
            ...
            if (nextReadableBuf == null) {
                if (z3) {
                    this.listener.onDataRead(channelHandlerContext, i2, Unpooled.EMPTY_BUFFER, i4, true);
                }
            ...
            try {
                ...
                decompressor.incrementDecompressedBytes(i4);
                int i5 = i4;
                ...
                while (true) {
                    try {
                        ...
                        flowController.consumeBytes(stream, this.listener.onDataRead(channelHandlerContext, i2, byteBuf2, i5, z4));
    ...
    public void onHeadersRead(ChannelHandlerContext channelHandlerContext, int i2, Http2Headers http2Headers, int i4, boolean z3) throws Http2Exception {
        initDecompressor(channelHandlerContext, i2, http2Headers, z3);
    ...
    public void onHeadersRead(ChannelHandlerContext channelHandlerContext, int i2, Http2Headers http2Headers, int i4, short s3, boolean z3, int i5, boolean z4) throws Http2Exception {
        initDecompressor(channelHandlerContext, i2, http2Headers, z4);
