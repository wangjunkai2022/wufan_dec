...
public class TextWebSocketFrame extends WebSocketFrame {
    ...
    public TextWebSocketFrame(boolean z3, int i2, String str) {
        super(z3, i2, fromText(str));
    }

    public TextWebSocketFrame(boolean z3, int i2, ByteBuf byteBuf) {
        super(z3, i2, byteBuf);
    }
    ...
    @Override // io.netty.handler.codec.http.websocketx.WebSocketFrame, io.netty.buffer.DefaultByteBufHolder, io.netty.util.ReferenceCounted
    public TextWebSocketFrame retain(int i2) {
        super.retain(i2);
        return this;
    }
