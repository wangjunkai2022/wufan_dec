...
public class WebSocketClientHandshaker08 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker08(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i2) {
        this(uri, webSocketVersion, str, z3, httpHeaders, i2, true, false, c.f47286a);
    }
    ...
    public WebSocketClientHandshaker08(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i2, boolean z4, boolean z5) {
    ...
    public WebSocketClientHandshaker08(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i2, boolean z4, boolean z5, long j4) {
        this(uri, webSocketVersion, str, z3, httpHeaders, i2, z4, z5, j4, false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public WebSocketClientHandshaker08(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i2, boolean z4, boolean z5, long j4, boolean z6) {
