...
public class WebSocketClientHandshaker00 extends WebSocketClientHandshaker {
    ...
    private static String insertRandomCharacters(String str) {
        ...
        for (int i4 = 0; i4 < randomNumber; i4++) {
            int randomNumber2 = WebSocketUtil.randomNumber(0, str.length());
            str = str.substring(0, randomNumber2) + cArr[i4] + str.substring(randomNumber2);
        }
        return str;
    }

    private static String insertSpaces(String str, int i2) {
    ...
    public WebSocketClientHandshaker00(URI uri, WebSocketVersion webSocketVersion, String str, HttpHeaders httpHeaders, int i2, long j4) {
    ...
    public WebSocketClientHandshaker00(URI uri, WebSocketVersion webSocketVersion, String str, HttpHeaders httpHeaders, int i2, long j4, boolean z3) {
        super(uri, webSocketVersion, str, httpHeaders, i2, j4, z3);
    }
}
