...
public class WebSocketClientProtocolHandshakeHandler extends ChannelInboundHandlerAdapter {
    ...
    private void applyHandshakeTimeout() {
        ...
        channelPromise.addListener((GenericFutureListener<? extends Future<? super Void>>) new io.netty.util.concurrent.a<Void>() { // from class: io.netty.handler.codec.http.websocketx.WebSocketClientProtocolHandshakeHandler.3
