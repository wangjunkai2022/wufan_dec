...
public class WebSocketServerHandshakerFactory {
    ...
    public WebSocketServerHandshakerFactory(String str, String str2, boolean z3, int i2) {
        this(str, str2, z3, i2, false);
    }
    ...
    public WebSocketServerHandshakerFactory(String str, String str2, boolean z3, int i2, boolean z4) {
        this(str, str2, WebSocketDecoderConfig.newBuilder().allowExtensions(z3).maxFramePayloadLength(i2).allowMaskMismatch(z4).build());
    }
