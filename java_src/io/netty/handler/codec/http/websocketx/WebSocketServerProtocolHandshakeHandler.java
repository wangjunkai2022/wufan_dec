...
class WebSocketServerProtocolHandshakeHandler extends ChannelInboundHandlerAdapter {
    ...
    private void applyHandshakeTimeout() {
        ...
        final c<?> schedule = this.ctx.executor().schedule(new Runnable() { // from class: io.netty.handler.codec.http.websocketx.WebSocketServerProtocolHandshakeHandler.2
        ...
        channelPromise.addListener((GenericFutureListener<? extends Future<? super Void>>) new io.netty.util.concurrent.a<Void>() { // from class: io.netty.handler.codec.http.websocketx.WebSocketServerProtocolHandshakeHandler.3
