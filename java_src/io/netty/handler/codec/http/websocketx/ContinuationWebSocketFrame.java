...
public class ContinuationWebSocketFrame extends WebSocketFrame {
    ...
    public ContinuationWebSocketFrame(boolean z3, int i2, ByteBuf byteBuf) {
        super(z3, i2, byteBuf);
    }
    ...
    public ContinuationWebSocketFrame(boolean z3, int i2, String str) {
        this(z3, i2, fromText(str));
    }
    ...
    @Override // io.netty.handler.codec.http.websocketx.WebSocketFrame, io.netty.buffer.DefaultByteBufHolder, io.netty.util.ReferenceCounted
    public ContinuationWebSocketFrame retain(int i2) {
        super.retain(i2);
        return this;
    }
