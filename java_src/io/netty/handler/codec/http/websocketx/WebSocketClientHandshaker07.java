...
public class WebSocketClientHandshaker07 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i2) {
    ...
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i2, boolean z4, boolean z5) {
    ...
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i2, boolean z4, boolean z5, long j4) {
        this(uri, webSocketVersion, str, z3, httpHeaders, i2, z4, z5, j4, false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public WebSocketClientHandshaker07(URI uri, WebSocketVersion webSocketVersion, String str, boolean z3, HttpHeaders httpHeaders, int i2, boolean z4, boolean z5, long j4, boolean z6) {
