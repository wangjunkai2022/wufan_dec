...
class PerMessageDeflateDecoder extends DeflateDecoder {
    ...
    PerMessageDeflateDecoder(boolean z3) {
        super(z3, WebSocketExtensionFilter.NEVER_SKIP);
    }
    ...
    public PerMessageDeflateDecoder(boolean z3, WebSocketExtensionFilter webSocketExtensionFilter) {
        super(z3, webSocketExtensionFilter);
    }
