...
public abstract class HttpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    @Deprecated
    public static void addIntHeader(HttpMessage httpMessage, String str, int i2) {
        httpMessage.headers().add(str, (Object) Integer.valueOf(i2));
    }
    ...
    private static boolean containsCommaSeparatedTrimmed(CharSequence charSequence, CharSequence charSequence2, boolean z3) {
        if (z3) {
            ...
            if (indexOf == -1) {
                ...
                int i2 = 0;
                while (!AsciiString.contentEqualsIgnoreCase(AsciiString.trim(charSequence.subSequence(i2, indexOf)), charSequence2)) {
                    i2 = indexOf + 1;
                    indexOf = AsciiString.indexOf(charSequence, StringUtil.COMMA, i2);
                    if (indexOf == -1) {
            ...
            if (indexOf2 == -1) {
                ...
                int i4 = 0;
                while (!AsciiString.contentEquals(AsciiString.trim(charSequence.subSequence(i4, indexOf2)), charSequence2)) {
                    i4 = indexOf2 + 1;
                    indexOf2 = AsciiString.indexOf(charSequence, StringUtil.COMMA, i4);
                    if (indexOf2 == -1) {
    ...
    @Deprecated
    public static void setIntHeader(HttpMessage httpMessage, String str, int i2) {
        httpMessage.headers().setInt(str, i2);
    }
    ...
    public abstract HttpHeaders addInt(CharSequence charSequence, int i2);
    ...
    public boolean containsValue(CharSequence charSequence, CharSequence charSequence2, boolean z3) {
        ...
        while (valueCharSequenceIterator.hasNext()) {
            if (containsCommaSeparatedTrimmed(valueCharSequenceIterator.next(), charSequence2, z3)) {
                return true;
            }
        }
        return false;
    ...
    public abstract HttpHeaders setInt(CharSequence charSequence, int i2);
    ...
    @Deprecated
    public static void addIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i2) {
        httpMessage.headers().addInt(charSequence, i2);
    }
    ...
    @Deprecated
    public static void setIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i2) {
        httpMessage.headers().setInt(charSequence, i2);
    }
    ...
    @Deprecated
    public static int getIntHeader(HttpMessage httpMessage, String str, int i2) {
        return httpMessage.headers().getInt(str, i2);
    }
    ...
    @Deprecated
    public static int getIntHeader(HttpMessage httpMessage, CharSequence charSequence, int i2) {
        return httpMessage.headers().getInt(charSequence, i2);
    }
