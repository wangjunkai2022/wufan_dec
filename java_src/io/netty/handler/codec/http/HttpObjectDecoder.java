...
public abstract class HttpObjectDecoder extends ByteToMessageDecoder {
    ...
    public static class HeaderParser implements ByteProcessor {
        ...
        public boolean process(byte b4) throws Exception {
            ...
            if (c4 == '\n') {
                ...
                if (length >= 1) {
                    int i2 = length - 1;
                    if (this.seq.charAtUnsafe(i2) == '\r') {
                        this.size--;
                        this.seq.setLength(i2);
                        return false;
                    }
                    return false;
                }
    ...
    private static int findNonWhitespace(AppendableCharSequence appendableCharSequence, int i2, boolean z3) {
        while (i2 < appendableCharSequence.length()) {
            char charAtUnsafe = appendableCharSequence.charAtUnsafe(i2);
            if (!Character.isWhitespace(charAtUnsafe)) {
                return i2;
            }
            if (z3 && !isOWS(charAtUnsafe)) {
    ...
    private static int findSPLenient(AppendableCharSequence appendableCharSequence, int i2) {
        while (i2 < appendableCharSequence.length()) {
            if (isSPLenient(appendableCharSequence.charAtUnsafe(i2))) {
                return i2;
            }
            i2++;
        }
    ...
    private static boolean isSPLenient(char c4) {
        return c4 == ' ' || c4 == '\t' || c4 == 11 || c4 == '\f' || c4 == '\r';
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public HttpObjectDecoder(int i2, int i4, int i5, boolean z3) {
        this(i2, i4, i5, z3, true);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public HttpObjectDecoder(int i2, int i4, int i5, boolean z3, boolean z4) {
        this(i2, i4, i5, z3, z4, 128);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public HttpObjectDecoder(int i2, int i4, int i5, boolean z3, boolean z4, int i6) {
        this.contentLength = Long.MIN_VALUE;
        this.currentState = State.SKIP_CONTROL_CHARS;
        ObjectUtil.checkPositive(i2, "maxInitialLineLength");
        ObjectUtil.checkPositive(i4, "maxHeaderSize");
        ObjectUtil.checkPositive(i5, "maxChunkSize");
        AppendableCharSequence appendableCharSequence = new AppendableCharSequence(i6);
        this.lineParser = new LineParser(appendableCharSequence, i2);
        this.headerParser = new HeaderParser(appendableCharSequence, i4);
