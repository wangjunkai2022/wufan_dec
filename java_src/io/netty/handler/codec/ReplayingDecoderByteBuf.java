...
final class ReplayingDecoderByteBuf extends ByteBuf {
    ...
    private void checkIndex(int i2, int i4) {
        if (i2 + i4 > this.buffer.writerIndex()) {
            throw REPLAY;
        }
    }
    ...
    public ByteBuf getBytes(int i2, byte[] bArr, int i4, int i5) {
        checkIndex(i2, i5);
        this.buffer.getBytes(i2, bArr, i4, i5);
        return this;
    }
    ...
    public CharSequence getCharSequence(int i2, int i4, Charset charset) {
        checkIndex(i2, i4);
        return this.buffer.getCharSequence(i2, i4, charset);
    }
    ...
    public int indexOf(int i2, int i4, byte b4) {
        ...
        if (Math.max(i2, i4) <= this.buffer.writerIndex()) {
            return this.buffer.indexOf(i2, i4, b4);
        }
        throw REPLAY;
    }
    ...
    public ByteBuffer internalNioBuffer(int i2, int i4) {
        checkIndex(i2, i4);
        return this.buffer.internalNioBuffer(i2, i4);
    }
    ...
    public ByteBuf readBytes(byte[] bArr, int i2, int i4) {
        ...
        this.buffer.readBytes(bArr, i2, i4);
        return this;
    }
    ...
    public String toString(int i2, int i4, Charset charset) {
        checkIndex(i2, i4);
        return this.buffer.toString(i2, i4, charset);
    }
    ...
    public ByteBuffer nioBuffer(int i2, int i4) {
        checkIndex(i2, i4);
        return this.buffer.nioBuffer(i2, i4);
    }

    @Override // io.netty.buffer.ByteBuf
    public ByteBuffer[] nioBuffers(int i2, int i4) {
        checkIndex(i2, i4);
        return this.buffer.nioBuffers(i2, i4);
    }
    ...
    public ByteBuf retainedSlice(int i2, int i4) {
        checkIndex(i2, i4);
        return this.buffer.slice(i2, i4);
    }
    ...
    public int bytesBefore(int i2, byte b4) {
        return bytesBefore(this.buffer.readerIndex(), i2, b4);
    }
    ...
    public int forEachByte(int i2, int i4, ByteProcessor byteProcessor) {
        ...
        if (i2 < writerIndex) {
            if (i2 <= writerIndex - i4) {
                return this.buffer.forEachByte(i2, i4, byteProcessor);
            }
            int forEachByte = this.buffer.forEachByte(i2, writerIndex - i2, byteProcessor);
            if (forEachByte >= 0) {
                return forEachByte;
            }
            throw REPLAY;
    ...
    public int bytesBefore(int i2, int i4, byte b4) {
        ...
        if (i2 < writerIndex) {
            if (i2 <= writerIndex - i4) {
                return this.buffer.bytesBefore(i2, i4, b4);
            }
            int bytesBefore = this.buffer.bytesBefore(i2, writerIndex - i2, b4);
            if (bytesBefore >= 0) {
                return bytesBefore;
            }
            throw REPLAY;
    ...
    public int forEachByteDesc(int i2, int i4, ByteProcessor byteProcessor) {
        if (i2 + i4 <= this.buffer.writerIndex()) {
            return this.buffer.forEachByteDesc(i2, i4, byteProcessor);
        }
        throw REPLAY;
    }
    ...
    public ByteBuf getBytes(int i2, ByteBuf byteBuf, int i4, int i5) {
        checkIndex(i2, i5);
        this.buffer.getBytes(i2, byteBuf, i4, i5);
        return this;
    }
    ...
    public ByteBuf readBytes(ByteBuf byteBuf, int i2, int i4) {
        checkReadableBytes(i4);
        this.buffer.readBytes(byteBuf, i2, i4);
        return this;
    }
    ...
    @Override // io.netty.buffer.ByteBuf
    public int writeBytes(FileChannel fileChannel, long j4, int i2) {
        throw reject();
    }

    @Override // io.netty.buffer.ByteBuf
    public int getBytes(int i2, GatheringByteChannel gatheringByteChannel, int i4) {
        throw reject();
    }

    @Override // io.netty.buffer.ByteBuf
    public int getBytes(int i2, FileChannel fileChannel, long j4, int i4) {
        throw reject();
    }
    ...
    @Override // io.netty.buffer.ByteBuf
    public ByteBuf getBytes(int i2, OutputStream outputStream, int i4) {
        throw reject();
    }

    @Override // io.netty.buffer.ByteBuf
    public int readBytes(FileChannel fileChannel, long j4, int i2) {
        throw reject();
    }
