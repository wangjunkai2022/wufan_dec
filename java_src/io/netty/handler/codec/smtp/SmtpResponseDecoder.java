...
public final class SmtpResponseDecoder extends LineBasedFrameDecoder {
    ...
    private static DecoderException newDecoderException(ByteBuf byteBuf, int i2, int i4) {
        return new DecoderException("Received invalid line: '" + byteBuf.toString(i2, i4, CharsetUtil.US_ASCII) + '\'');
    }
