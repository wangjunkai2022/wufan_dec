...
public final class DateFormatter {
    ...
    private static StringBuilder appendZeroLeftPadded(int i2, StringBuilder sb) {
        if (i2 < 10) {
            sb.append('0');
        }
        sb.append(i2);
    ...
    private boolean normalizeAndValidate() {
        ...
        if (i2 < 1 || i2 > 31 || this.hours > 23 || this.minutes > 59 || this.seconds > 59) {
            return false;
        }
        int i4 = this.year;
        if (i4 >= 70 && i4 <= 99) {
    ...
    private Date parse0(CharSequence charSequence, int i2, int i4) {
        if (parse1(charSequence, i2, i4) && normalizeAndValidate()) {
            return computeDate();
        }
        return null;
    }

    private boolean parse1(CharSequence charSequence, int i2, int i4) {
        int i5 = -1;
        while (i2 < i4) {
            if (isDelim(charSequence.charAt(i2))) {
                if (i5 == -1) {
                    continue;
                } else if (parseToken(charSequence, i5, i2)) {
                    return true;
                } else {
                    i5 = -1;
                }
        ...
        return i5 != -1 && parseToken(charSequence, i5, charSequence.length());
    }
    ...
    private boolean parseToken(CharSequence charSequence, int i2, int i4) {
        if (!this.timeFound) {
            boolean tryParseTime = tryParseTime(charSequence, i2, i4);
        ...
        if (!this.dayOfMonthFound) {
            boolean tryParseDayOfMonth = tryParseDayOfMonth(charSequence, i2, i4);
        ...
        if (!this.monthFound) {
            boolean tryParseMonth = tryParseMonth(charSequence, i2, i4);
        ...
        if (!this.yearFound) {
            this.yearFound = tryParseYear(charSequence, i2, i4);
        }
        return this.timeFound && this.dayOfMonthFound && this.monthFound && this.yearFound;
    }

    private boolean tryParseDayOfMonth(CharSequence charSequence, int i2, int i4) {
        int i5 = i4 - i2;
        if (i5 == 1) {
    ...
    private boolean tryParseMonth(CharSequence charSequence, int i2, int i4) {
        if (i4 - i2 != 3) {
            return false;
        }
    ...
    private boolean tryParseTime(CharSequence charSequence, int i2, int i4) {
        int i5 = i4 - i2;
        if (i5 >= 5 && i5 <= 8) {
            int i6 = 0;
            int i7 = 0;
    ...
    private boolean tryParseYear(CharSequence charSequence, int i2, int i4) {
        int i5 = i4 - i2;
        if (i5 == 2) {
            char charAt = charSequence.charAt(i2);
    ...
    public static Date parseHttpDate(CharSequence charSequence, int i2, int i4) {
        int i5 = i4 - i2;
        if (i5 == 0) {
            return null;
        }
        if (i5 >= 0) {
            if (i5 <= 64) {
                return formatter().parse0((CharSequence) ObjectUtil.checkNotNull(charSequence, "txt"), i2, i4);
            }
