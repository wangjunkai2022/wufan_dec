...
public class FlushConsolidationHandler extends ChannelDuplexHandler {
    ...
    public FlushConsolidationHandler(int i2, boolean z3) {
        this.explicitFlushAfterFlushes = ObjectUtil.checkPositive(i2, "explicitFlushAfterFlushes");
        this.consolidateWhenNoReadInProgress = z3;
        this.flushTask = z3 ? new Runnable() { // from class: io.netty.handler.flush.FlushConsolidationHandler.1
