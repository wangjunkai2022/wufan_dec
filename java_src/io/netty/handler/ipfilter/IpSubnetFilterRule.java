...
public final class IpSubnetFilterRule implements IpFilterRule {
    ...
    public static final class Ip4SubnetFilterRule implements IpFilterRule {
        ...
        private static int prefixToSubnetMask(int i2) {
        ...
        private Ip4SubnetFilterRule(Inet4Address inet4Address, int i2, IpFilterRuleType ipFilterRuleType) {
            if (i2 >= 0 && i2 <= 32) {
                int prefixToSubnetMask = prefixToSubnetMask(i2);
    ...
    public static final class Ip6SubnetFilterRule implements IpFilterRule {
        ...
        private static BigInteger prefixToSubnetMask(int i2) {
            return MINUS_ONE.shiftLeft(128 - i2);
        }
        ...
        private Ip6SubnetFilterRule(Inet6Address inet6Address, int i2, IpFilterRuleType ipFilterRuleType) {
            if (i2 >= 0 && i2 <= 128) {
                BigInteger prefixToSubnetMask = prefixToSubnetMask(i2);
                this.subnetMask = prefixToSubnetMask;
    ...
    public IpSubnetFilterRule(String str, int i2, IpFilterRuleType ipFilterRuleType) {
        try {
            this.filterRule = selectFilterRule(SocketUtils.addressByName(str), i2, ipFilterRuleType);
        } catch (UnknownHostException e4) {
            throw new IllegalArgumentException("ipAddress", e4);
        }
    }

    private static IpFilterRule selectFilterRule(InetAddress inetAddress, int i2, IpFilterRuleType ipFilterRuleType) {
        ObjectUtil.checkNotNull(inetAddress, "ipAddress");
        ObjectUtil.checkNotNull(ipFilterRuleType, "ruleType");
        if (inetAddress instanceof Inet4Address) {
            return new Ip4SubnetFilterRule((Inet4Address) inetAddress, i2, ipFilterRuleType);
        }
        if (inetAddress instanceof Inet6Address) {
            return new Ip6SubnetFilterRule((Inet6Address) inetAddress, i2, ipFilterRuleType);
        }
    ...
    public IpSubnetFilterRule(InetAddress inetAddress, int i2, IpFilterRuleType ipFilterRuleType) {
        this.filterRule = selectFilterRule(inetAddress, i2, ipFilterRuleType);
    }
}
