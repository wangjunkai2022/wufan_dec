...
public final class SslUtils {
    ...
    */
    ...
    public static boolean isValidHostNameForSNI(String str) {
        return (str == null || str.indexOf(46) <= 0 || str.endsWith(g0.f27568a) || NetUtil.isValidIpV4Address(str) || NetUtil.isValidIpV6Address(str)) ? false : true;
    }
    ...
    private static short shortBE(ByteBuffer byteBuffer, int i2) {
        return byteBuffer.order() == ByteOrder.BIG_ENDIAN ? byteBuffer.getShort(i2) : ByteBufUtil.swapShort(byteBuffer.getShort(i2));
    }

    private static int unsignedShortBE(ByteBuffer byteBuffer, int i2) {
        return shortBE(byteBuffer, i2) & UShort.MAX_VALUE;
    }
