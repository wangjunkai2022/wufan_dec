...
public class SslHandler extends ByteToMessageDecoder implements ChannelOutboundHandler {
    ...
    public static abstract class SslEngineType {
        ...
        static {
            ...
            SslEngineType sslEngineType = new SslEngineType("TCNATIVE", 0, true, cumulator) { // from class: io.netty.handler.ssl.SslHandler.SslEngineType.1
                ...
                ByteBuf allocateWrapBuffer(SslHandler sslHandler, ByteBufAllocator byteBufAllocator, int i2, int i4) {
                    return byteBufAllocator.directBuffer(((ReferenceCountedOpenSslEngine) sslHandler.engine).calculateMaxLengthForWrap(i2, i4));
                }
                ...
                @Override // io.netty.handler.ssl.SslHandler.SslEngineType
                SSLEngineResult unwrap(SslHandler sslHandler, ByteBuf byteBuf, int i2, int i4, ByteBuf byteBuf2) throws SSLException {
                    ...
                    if (nioBufferCount > 1) {
                        ...
                        try {
                            ...
                            unwrap = referenceCountedOpenSslEngine.unwrap(byteBuf.nioBuffers(i2, i4), sslHandler.singleBuffer);
                        } finally {
                            sslHandler.singleBuffer[0] = null;
                        }
                    } else {
                        unwrap = sslHandler.engine.unwrap(SslHandler.toByteBuffer(byteBuf, i2, i4), SslHandler.toByteBuffer(byteBuf2, writerIndex, byteBuf2.writableBytes()));
                    }
            ...
            SslEngineType sslEngineType2 = new SslEngineType("CONSCRYPT", 1, true, cumulator) { // from class: io.netty.handler.ssl.SslHandler.SslEngineType.2
                @Override // io.netty.handler.ssl.SslHandler.SslEngineType
                ByteBuf allocateWrapBuffer(SslHandler sslHandler, ByteBufAllocator byteBufAllocator, int i2, int i4) {
                    return byteBufAllocator.directBuffer(((ConscryptAlpnSslEngine) sslHandler.engine).calculateOutNetBufSize(i2, i4));
                }
                ...
                SSLEngineResult unwrap(SslHandler sslHandler, ByteBuf byteBuf, int i2, int i4, ByteBuf byteBuf2) throws SSLException {
                    ...
                    if (nioBufferCount > 1) {
                        try {
                            sslHandler.singleBuffer[0] = SslHandler.toByteBuffer(byteBuf2, writerIndex, byteBuf2.writableBytes());
                            unwrap = ((ConscryptAlpnSslEngine) sslHandler.engine).unwrap(byteBuf.nioBuffers(i2, i4), sslHandler.singleBuffer);
                        } finally {
                            sslHandler.singleBuffer[0] = null;
                        }
                    } else {
            ...
            SslEngineType sslEngineType3 = new SslEngineType("JDK", 2, false, ByteToMessageDecoder.MERGE_CUMULATOR) { // from class: io.netty.handler.ssl.SslHandler.SslEngineType.3
                ...
                SSLEngineResult unwrap(SslHandler sslHandler, ByteBuf byteBuf, int i2, int i4, ByteBuf byteBuf2) throws SSLException {
                    int position;
                    int writerIndex = byteBuf2.writerIndex();
                    ByteBuffer byteBuffer = SslHandler.toByteBuffer(byteBuf, i2, i4);
        ...
        abstract ByteBuf allocateWrapBuffer(SslHandler sslHandler, ByteBufAllocator byteBufAllocator, int i2, int i4);

        abstract int calculatePendingData(SslHandler sslHandler, int i2);

        abstract boolean jdkCompatibilityMode(SSLEngine sSLEngine);

        abstract SSLEngineResult unwrap(SslHandler sslHandler, ByteBuf byteBuf, int i2, int i4, ByteBuf byteBuf2) throws SSLException;

        private SslEngineType(String str, int i2, boolean z3, ByteToMessageDecoder.Cumulator cumulator) {
    ...
    public final class SslHandlerCoalescingBufferQueue extends AbstractCoalescingBufferQueue {
        SslHandlerCoalescingBufferQueue(Channel channel, int i2) {
            super(channel, i2);
        }
        ...
        protected ByteBuf compose(ByteBufAllocator byteBufAllocator, ByteBuf byteBuf, ByteBuf byteBuf2) {
            ...
            if (numComponents == 0 || !SslHandler.attemptCopyToCumulation(compositeByteBuf.internalComponent(numComponents - 1), byteBuf2, i2)) {
    ...
    public final class SslTasksRunner implements Runnable {
        ...
        public void resumeOnEventExecutor() {
            SslHandler.this.processTask = false;
            try {
                int i2 = AnonymousClass9.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[SslHandler.this.engine.getHandshakeStatus().ordinal()];
                if (i2 != 1) {
                    if (i2 == 2) {
                        ...
                        if (i2 == 4) {
                            ...
                            try {
                                ...
                                sslHandler5.handleUnwrapThrowable(sslHandler5.ctx, e4);
                                return;
                            }
                        } else {
    ...
    private ByteBuf allocate(ChannelHandlerContext channelHandlerContext, int i2) {
        ...
        return alloc.buffer(i2);
    }

    private ByteBuf allocateOutNetBuf(ChannelHandlerContext channelHandlerContext, int i2, int i4) {
        return this.engineType.allocateWrapBuffer(this, channelHandlerContext.alloc(), i2, i4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static ByteBuffer toByteBuffer(ByteBuf byteBuf, int i2, int i4) {
    ...
    */
    ...
    public boolean wrapNonAppData(final ChannelHandlerContext channelHandlerContext, boolean z3) throws SSLException {
        ...
        while (!channelHandlerContext.isRemoved()) {
            try {
                ...
                int i2 = AnonymousClass9.$SwitchMap$javax$net$ssl$SSLEngineResult$HandshakeStatus[handshakeStatus.ordinal()];
                if (i2 == 1) {
    ...
    public SslHandler(SSLEngine sSLEngine, boolean z3, Executor executor) {
        ...
        this.handshakeTimeoutMillis = com.join.mgps.data.c.f47286a;
