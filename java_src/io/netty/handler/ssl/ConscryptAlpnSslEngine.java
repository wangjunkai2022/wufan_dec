...
public abstract class ConscryptAlpnSslEngine extends JdkSslEngine {
    ...
    private static final class BufferAllocatorAdapter extends BufferAllocator {
        ...
        public AllocatedBuffer allocateDirectBuffer(int i2) {
            return new BufferAdapter(this.alloc.directBuffer(i2));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final int calculateOutNetBufSize(int i2, int i4) {
        return (int) Math.min(2147483647L, i2 + (org.conscrypt.Conscrypt.maxSealOverhead(getWrappedEngine()) * i4));
    }
