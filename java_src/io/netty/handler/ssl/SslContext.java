...
public abstract class SslContext {
    ...
    private static X509Certificate[] getCertificatesFromBuffers(ByteBuf[] byteBufArr) throws CertificateException {
        ...
        for (int i4 = 0; i4 < byteBufArr.length; i4++) {
            try {
                ByteBufInputStream byteBufInputStream = new ByteBufInputStream(byteBufArr[i4], false);
                x509CertificateArr[i4] = (X509Certificate) certificateFactory.generateCertificate(byteBufInputStream);
                try {
    ...
    public static SslContext newClientContextInternal(SslProvider sslProvider, Provider provider, X509Certificate[] x509CertificateArr, TrustManagerFactory trustManagerFactory, X509Certificate[] x509CertificateArr2, PrivateKey privateKey, String str, KeyManagerFactory keyManagerFactory, Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, ApplicationProtocolConfig applicationProtocolConfig, String[] strArr, long j4, long j5, boolean z3, String str2) throws SSLException {
        ...
        int i2 = AnonymousClass1.$SwitchMap$io$netty$handler$ssl$SslProvider[defaultClientProvider.ordinal()];
        if (i2 == 1) {
            if (!z3) {
    ...
    public static SslContext newServerContextInternal(SslProvider sslProvider, Provider provider, X509Certificate[] x509CertificateArr, TrustManagerFactory trustManagerFactory, X509Certificate[] x509CertificateArr2, PrivateKey privateKey, String str, KeyManagerFactory keyManagerFactory, Iterable<String> iterable, CipherSuiteFilter cipherSuiteFilter, ApplicationProtocolConfig applicationProtocolConfig, long j4, long j5, ClientAuth clientAuth, String[] strArr, boolean z3, boolean z4, String str2) throws SSLException {
        ...
        int i2 = AnonymousClass1.$SwitchMap$io$netty$handler$ssl$SslProvider[defaultServerProvider.ordinal()];
        if (i2 == 1) {
            if (!z4) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public SslHandler newHandler(ByteBufAllocator byteBufAllocator, boolean z3) {
    ...
    public final SslHandler newHandler(ByteBufAllocator byteBufAllocator, String str, int i2) {
        return newHandler(byteBufAllocator, str, i2, this.startTls);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public SslHandler newHandler(ByteBufAllocator byteBufAllocator, String str, int i2, boolean z3) {
        return new SslHandler(newEngine(byteBufAllocator, str, i2), z3);
    }
    ...
    public SslHandler newHandler(ByteBufAllocator byteBufAllocator, String str, int i2, Executor executor) {
        return newHandler(byteBufAllocator, str, i2, this.startTls, executor);
    }
    ...
    public SslHandler newHandler(ByteBufAllocator byteBufAllocator, String str, int i2, boolean z3, Executor executor) {
        return new SslHandler(newEngine(byteBufAllocator, str, i2), z3, executor);
    }
