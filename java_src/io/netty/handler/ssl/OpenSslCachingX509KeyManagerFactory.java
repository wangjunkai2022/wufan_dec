...
public final class OpenSslCachingX509KeyManagerFactory extends KeyManagerFactory {
    ...
    public OpenSslCachingX509KeyManagerFactory(final KeyManagerFactory keyManagerFactory, int i2) {
        ...
        this.maxCachedEntries = ObjectUtil.checkPositive(i2, "maxCachedEntries");
    }
}
