...
public final class HttpProxyHandler extends ProxyHandler {
    ...
    public HttpProxyHandler(SocketAddress socketAddress, HttpHeaders httpHeaders, boolean z3) {
        super(socketAddress);
        ...
        this.ignoreDefaultPortsInConnectHostHeader = z3;
    }
    ...
    public HttpProxyHandler(SocketAddress socketAddress, String str, String str2, HttpHeaders httpHeaders, boolean z3) {
        super(socketAddress);
        this.codec = new HttpClientCodec();
        this.username = (String) ObjectUtil.checkNotNull(str, "username");
        this.password = (String) ObjectUtil.checkNotNull(str2, GameRoomActivity_.f36433y2);
