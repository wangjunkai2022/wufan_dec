...
public class ByteObjectHashMap<V> implements ByteObjectMap<V> {
    ...
    public final class PrimitiveIterator implements Iterator<ByteObjectMap.PrimitiveEntry<V>>, ByteObjectMap.PrimitiveEntry<V> {
        ...
        private void scanNext() {
            do {
                ...
                this.nextIndex = i2;
                if (i2 == ByteObjectHashMap.this.values.length) {
                    return;
                }
        ...
        public void remove() {
            ...
            if (i2 != -1) {
                if (ByteObjectHashMap.this.removeAt(i2)) {
    ...
    public boolean equals(Object obj) {
        ...
        while (true) {
            ...
            V v3 = vArr[i2];
            if (v3 != null) {
                Object obj2 = byteObjectMap.get(this.keys[i2]);
                if (v3 == NULL_VALUE) {
                    if (obj2 != null) {
                        return false;
                    }
    ...
    public void putAll(Map<? extends Byte, ? extends V> map) {
        if (map instanceof ByteObjectHashMap) {
            ...
            while (true) {
                ...
                V v3 = vArr[i2];
                if (v3 != null) {
                    put(byteObjectHashMap.keys[i2], (byte) v3);
                }
                i2++;
            }
        } else {
    ...
    public ByteObjectHashMap(int i2, float f4) {
