...
public class ResourceLeakDetector<T> {
    ...
    public static final class DefaultResourceLeak<T> extends WeakReference<Object> implements ResourceLeakTracker<T>, ResourceLeak {
        ...
        private void record0(Object obj) {
            ...
            if (ResourceLeakDetector.TARGET_RECORDS > 0) {
                do {
                    ...
                    int i2 = record.pos + 1;
                    z3 = false;
                    if (i2 >= ResourceLeakDetector.TARGET_RECORDS) {
                        boolean z4 = PlatformDependent.threadLocalRandom().nextInt(1 << Math.min(i2 - ResourceLeakDetector.TARGET_RECORDS, 30)) != 0;
        ...
        public String toString() {
            ...
            int i2 = droppedRecordsUpdater.get(this);
            int i4 = 0;
            int i5 = 1;
            int i6 = andSet.pos + 1;
            StringBuilder sb = new StringBuilder(i6 * 2048);
    ...
    static {
        ...
        int i2 = SystemPropertyUtil.getInt(PROP_TARGET_RECORDS, 4);
        TARGET_RECORDS = i2;
        ...
        if (internalLoggerFactory.isDebugEnabled()) {
            ...
            internalLoggerFactory.debug("-D{}: {}", PROP_TARGET_RECORDS, Integer.valueOf(i2));
        }
    ...
    public static void setLevel(Level level2) {
        level = (Level) ObjectUtil.checkNotNull(level2, SimulatorExitPlayActivity_.E);
    }
    ...
    @Deprecated
    public ResourceLeakDetector(Class<?> cls, int i2, long j4) {
        this(cls, i2);
    }
    ...
    public ResourceLeakDetector(Class<?> cls, int i2) {
        this(StringUtil.simpleClassName(cls), i2, Long.MAX_VALUE);
    }

    @Deprecated
    public ResourceLeakDetector(String str, int i2, long j4) {
