...
public abstract class ResourceLeakDetectorFactory {
    ...
    @Deprecated
    public abstract <T> ResourceLeakDetector<T> newResourceLeakDetector(Class<T> cls, int i2, long j4);

    public <T> ResourceLeakDetector<T> newResourceLeakDetector(Class<T> cls, int i2) {
    ...
    private static final class DefaultResourceLeakDetectorFactory extends ResourceLeakDetectorFactory {
        ...
        public <T> ResourceLeakDetector<T> newResourceLeakDetector(Class<T> cls, int i2, long j4) {
            Constructor<?> constructor = this.obsoleteCustomClassConstructor;
            if (constructor != null) {
                try {
                    ResourceLeakDetector<T> resourceLeakDetector = (ResourceLeakDetector) constructor.newInstance(cls, Integer.valueOf(i2), Long.valueOf(j4));
            ...
            ResourceLeakDetector<T> resourceLeakDetector2 = new ResourceLeakDetector<>((Class<?>) cls, i2, j4);
