...
public final class NonStickyEventExecutorGroup implements EventExecutorGroup {
    ...
    /* loaded from: classes5.dex */
    public static final class NonStickyOrderedEventExecutor extends AbstractEventExecutor implements Runnable, b {
        ...
        NonStickyOrderedEventExecutor(EventExecutor eventExecutor, int i2) {
            super(eventExecutor);
            this.tasks = PlatformDependent.newMpscQueue();
            this.state = new AtomicInteger();
            this.executor = eventExecutor;
            this.maxTaskExecutePerRun = i2;
        }
        ...
        public void run() {
            ...
            while (true) {
                int i2 = 0;
                while (i2 < this.maxTaskExecutePerRun && (poll = this.tasks.poll()) != null) {
                    try {
    ...
    public NonStickyEventExecutorGroup(EventExecutorGroup eventExecutorGroup, int i2) {
        this.group = verify(eventExecutorGroup);
        this.maxTaskExecutePerRun = ObjectUtil.checkPositive(i2, "maxTaskExecutePerRun");
    }
