...
public final class UnorderedThreadPoolEventExecutor extends ScheduledThreadPoolExecutor implements EventExecutor {
    ...
    public UnorderedThreadPoolEventExecutor(int i2) {
        this(i2, new DefaultThreadFactory(UnorderedThreadPoolEventExecutor.class));
    }
    ...
    public UnorderedThreadPoolEventExecutor(int i2, ThreadFactory threadFactory) {
    ...
    public c<?> scheduleAtFixedRate(Runnable runnable, long j4, long j5, TimeUnit timeUnit) {
        return (c) super.scheduleAtFixedRate(runnable, j4, j5, timeUnit);
    }

    @Override // java.util.concurrent.ScheduledThreadPoolExecutor, java.util.concurrent.ScheduledExecutorService
    public c<?> scheduleWithFixedDelay(Runnable runnable, long j4, long j5, TimeUnit timeUnit) {
        return (c) super.scheduleWithFixedDelay(runnable, j4, j5, timeUnit);
    }
    ...
    public c<?> schedule(Runnable runnable, long j4, TimeUnit timeUnit) {
        return (c) super.schedule(runnable, j4, timeUnit);
    }

    @Override // java.util.concurrent.ScheduledThreadPoolExecutor, java.util.concurrent.ScheduledExecutorService
    public <V> c<V> schedule(Callable<V> callable, long j4, TimeUnit timeUnit) {
        return (c) super.schedule((Callable) callable, j4, timeUnit);
    }
    ...
    public UnorderedThreadPoolEventExecutor(int i2, java.util.concurrent.RejectedExecutionHandler rejectedExecutionHandler) {
        this(i2, new DefaultThreadFactory(UnorderedThreadPoolEventExecutor.class), rejectedExecutionHandler);
    }
    ...
    public UnorderedThreadPoolEventExecutor(int i2, ThreadFactory threadFactory, java.util.concurrent.RejectedExecutionHandler rejectedExecutionHandler) {
