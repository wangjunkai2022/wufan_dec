...
final class LocationAwareSlf4JLogger extends AbstractInternalLogger {
    ...
    private void log(int i2, String str) {
        this.logger.log((Marker) null, FQCN, i2, str, (Object[]) null, (Throwable) null);
    }
    ...
    private void log(int i2, String str, Throwable th) {
        this.logger.log((Marker) null, FQCN, i2, str, (Object[]) null, th);
    }

    private void log(int i2, org.slf4j.helpers.FormattingTuple formattingTuple) {
        this.logger.log((Marker) null, FQCN, i2, formattingTuple.getMessage(), formattingTuple.getArgArray(), formattingTuple.getThrowable());
    }
