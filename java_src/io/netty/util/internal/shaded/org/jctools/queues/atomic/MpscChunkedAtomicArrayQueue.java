...
public class MpscChunkedAtomicArrayQueue<E> extends MpscChunkedAtomicArrayQueueColdProducerFields<E> {
    ...
    public MpscChunkedAtomicArrayQueue(int i2) {
        super(Math.max(2, Math.min(1024, Pow2.roundToPowerOfTwo(i2 / 8))), i2);
    }
    ...
    public MpscChunkedAtomicArrayQueue(int i2, int i4) {
        super(i2, i4);
    }
