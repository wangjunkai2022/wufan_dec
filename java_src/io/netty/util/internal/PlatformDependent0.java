...
public final class PlatformDependent0 {
    ...
    public static boolean equals(byte[] bArr, int i2, byte[] bArr2, int i4, int i5) {
        int i6 = i5 & 7;
        long j4 = BYTE_ARRAY_BASE_OFFSET + i2;
        long j5 = i4 - i2;
        if (i5 >= 8) {
            long j6 = i6 + j4;
            long j7 = (j4 - 8) + i5;
        ...
        if (i6 >= 2) {
            ...
            if (unsafe3.getChar(bArr, j4) == unsafe3.getChar(bArr2, j10)) {
                return i6 == 2 || unsafe3.getByte(bArr, j4 + 2) == unsafe3.getByte(bArr2, j10 + 2);
            }
            return false;
        }
        if (i6 != 0) {
    ...
    public static int equalsConstantTime(byte[] bArr, int i2, byte[] bArr2, int i4, int i5) {
        long j4 = i5 & 7;
        long j5 = BYTE_ARRAY_BASE_OFFSET + i2;
        long j6 = j5 + j4;
        long j7 = i4 - i2;
        long j8 = 0;
        for (long j9 = (j5 - 8) + i5; j9 >= j6; j9 -= 8) {
            Unsafe unsafe = UNSAFE;
    ...
    public static int hashCodeAscii(byte[] bArr, int i2, int i4) {
        ...
        int i6 = i4 & 7;
        long j5 = i6 + j4;
        int i7 = HASH_CODE_ASCII_SEED;
        for (long j6 = (j4 - 8) + i4; j6 >= j5; j6 -= 8) {
            i7 = hashCodeAsciiCompute(UNSAFE.getLong(bArr, j6), i7);
        }
        if (i6 == 0) {
            return i7;
        }
        boolean z3 = (i6 != 2) & (i6 != 4) & (i6 != 6);
        int i8 = HASH_CODE_C2;
        if (z3) {
            i7 = (i7 * HASH_CODE_C1) + hashCodeAsciiSanitize(UNSAFE.getByte(bArr, j4));
            j4++;
            i5 = HASH_CODE_C2;
        } else {
            i5 = HASH_CODE_C1;
        ...
        if ((i6 != 5) & (i6 != 1) & (i6 != 4)) {
            i7 = (i7 * i5) + hashCodeAsciiSanitize(UNSAFE.getShort(bArr, j4));
            if (i5 != HASH_CODE_C1) {
                i8 = HASH_CODE_C1;
            }
            j4 += 2;
        ...
        return i6 >= 4 ? (i7 * i5) + hashCodeAsciiSanitize(UNSAFE.getInt(bArr, j4)) : i7;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int hashCodeAsciiCompute(long j4, int i2) {
        return (i2 * HASH_CODE_C1) + (hashCodeAsciiSanitize((int) j4) * HASH_CODE_C2) + ((int) ((j4 & 2242545357458243584L) >>> 32));
    }
    ...
    public static boolean isZero(byte[] bArr, int i2, int i4) {
        ...
        if (i5 >= 4) {
            i5 -= 4;
            if (UNSAFE.getInt(bArr, i5 + j4) != 0) {
                return false;
            }
        }
        return i5 >= 2 ? UNSAFE.getChar(bArr, j4) == 0 && (i5 == 2 || bArr[i2 + 2] == 0) : bArr[i2] == 0;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static ByteBuffer newDirectBuffer(long j4, int i2) {
        ObjectUtil.checkPositiveOrZero(i2, "capacity");
        try {
            return (ByteBuffer) DIRECT_BUFFER_CONSTRUCTOR.newInstance(Long.valueOf(j4), Integer.valueOf(i2));
        } catch (Throwable th) {
    ...
    public static void putByte(byte[] bArr, int i2, byte b4) {
        UNSAFE.putByte(bArr, BYTE_ARRAY_BASE_OFFSET + i2, b4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void putInt(byte[] bArr, int i2, int i4) {
        UNSAFE.putInt(bArr, BYTE_ARRAY_BASE_OFFSET + i2, i4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void putLong(byte[] bArr, int i2, long j4) {
        UNSAFE.putLong(bArr, i2 + BYTE_ARRAY_BASE_OFFSET, j4);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void putShort(byte[] bArr, int i2, short s3) {
        UNSAFE.putShort(bArr, BYTE_ARRAY_BASE_OFFSET + i2, s3);
    }
