...
public class HashedWheelTimer implements Timer {
    ...
    public static final class HashedWheelTimeout implements Timeout {
        private static final AtomicIntegerFieldUpdater<HashedWheelTimeout> STATE_UPDATER = AtomicIntegerFieldUpdater.newUpdater(HashedWheelTimeout.class, NoticeTopAnimActivityDialog_.f34402n);
        ...
        public boolean compareAndSetState(int i2, int i4) {
            return STATE_UPDATER.compareAndSet(this, i2, i4);
        }
            ...
            if (compareAndSetState(0, 2)) {
                try {
                    ...
                    if (internalLogger.isWarnEnabled()) {
                        internalLogger.warn("An exception was thrown by " + TimerTask.class.getSimpleName() + d.f65364a, th);
                    }
                }
            }
        }
        ...
        public void run() {
            ...
            do {
                ...
                if (waitForNextTick > 0) {
                    int i2 = (int) (this.tick & HashedWheelTimer.this.mask);
    ...
    private static HashedWheelBucket[] createWheel(int i2) {
        if (i2 <= 0) {
            ...
            for (int i4 = 0; i4 < normalizeTicksPerWheel; i4++) {
    ...
    public HashedWheelTimer(long j4, TimeUnit timeUnit, int i2) {
    ...
    public HashedWheelTimer(ThreadFactory threadFactory, long j4, TimeUnit timeUnit, int i2) {
        this(threadFactory, j4, timeUnit, i2, true);
    }

    public HashedWheelTimer(ThreadFactory threadFactory, long j4, TimeUnit timeUnit, int i2, boolean z3) {
        this(threadFactory, j4, timeUnit, i2, z3, -1L);
    }

    public HashedWheelTimer(ThreadFactory threadFactory, long j4, TimeUnit timeUnit, int i2, boolean z3, long j5) {
        ...
        HashedWheelBucket[] createWheel = createWheel(i2);
