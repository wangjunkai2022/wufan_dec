...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    public class AndroidMediaPlayerListenerHolder implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnTimedTextListener {
        ...
        public boolean onError(MediaPlayer mediaPlayer, int i2, int i4) {
            return this.mWeakMediaPlayer.get() != null && AndroidMediaPlayer.this.notifyOnError(i2, i4);
        }

        @Override // android.media.MediaPlayer.OnInfoListener
        public boolean onInfo(MediaPlayer mediaPlayer, int i2, int i4) {
            return this.mWeakMediaPlayer.get() != null && AndroidMediaPlayer.this.notifyOnInfo(i2, i4);
        }
        ...
        public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i2, int i4) {
            ...
            AndroidMediaPlayer.this.notifyOnVideoSizeChanged(i2, i4, 1, 1);
        }
    }
    ...
    private static class MediaDataSourceProxy extends MediaDataSource {
        ...
        public int readAt(long j4, byte[] bArr, int i2, int i4) throws IOException {
            return this.mMediaDataSource.readAt(j4, bArr, i2, i4);
        }
    }
    ...
    public MediaInfo getMediaInfo() {
        if (sMediaInfo == null) {
            ...
            mediaInfo.mVideoDecoder = a.f73954a;
            mediaInfo.mVideoDecoderImpl = "HW";
            mediaInfo.mAudioDecoder = a.f73954a;
    ...
    public void setDataSource(String str) throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        ...
        if (!TextUtils.isEmpty(scheme) && scheme.equalsIgnoreCase(f.f11767c)) {
