...
public class IjkMediaCodecInfo {
    ...
    public static String getProfileLevelName(int i2, int i4) {
        return String.format(Locale.US, " %s Profile Level %s (%d,%d)", getProfileName(i2), getLevelName(i4), Integer.valueOf(i2), Integer.valueOf(i4));
    }
    ...
    public void dumpProfileLevels(String str) {
        ...
        try {
            ...
            String.format(Locale.US, "%s", getProfileLevelName(i2, i4));
        } catch (Throwable unused) {
        }
    }
}
