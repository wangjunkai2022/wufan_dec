...
public interface IMediaPlayer {
    ...
    public interface OnErrorListener {
        boolean onError(IMediaPlayer iMediaPlayer, int i2, int i4);
    }

    /* loaded from: classes5.dex */
    public interface OnInfoListener {
        boolean onInfo(IMediaPlayer iMediaPlayer, int i2, int i4);
    }
    ...
    public interface OnVideoSizeChangedListener {
        void onVideoSizeChanged(IMediaPlayer iMediaPlayer, int i2, int i4, int i5, int i6);
    }
