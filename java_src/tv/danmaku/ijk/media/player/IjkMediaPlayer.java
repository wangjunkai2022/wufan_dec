...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener {
        ...
        @TargetApi(16)
        public String onMediaCodecSelect(IMediaPlayer iMediaPlayer, String str, int i2, int i4) {
            String[] supportedTypes;
            IjkMediaCodecInfo ijkMediaCodecInfo;
            if (Build.VERSION.SDK_INT >= 16 && !TextUtils.isEmpty(str)) {
                String unused = IjkMediaPlayer.TAG;
                String.format(Locale.US, "onSelectCodec: mime=%s, profile=%d, level=%d", str, Integer.valueOf(i2), Integer.valueOf(i4));
    ...
    public interface OnMediaCodecSelectListener {
        String onMediaCodecSelect(IMediaPlayer iMediaPlayer, String str, int i2, int i4);
    }
    ...
    private native float _getPropertyFloat(int i2, float f4);

    private native long _getPropertyLong(int i2, long j4);
    ...
    private native void _setFrameAtTime(String str, long j4, long j5, int i2, int i4) throws IllegalArgumentException, IllegalStateException;

    private native void _setLoopCount(int i2);

    private native void _setOption(int i2, String str, long j4);

    private native void _setOption(int i2, String str, String str2);

    private native void _setPropertyFloat(int i2, float f4);

    private native void _setPropertyLong(int i2, long j4);
            ...
            if (ijkMediaPlayer != null) {
                ...
                if (onNativeInvokeListener == null || !onNativeInvokeListener.onNativeInvoke(i2, bundle)) {
                    if (i2 == 131079 && (onControlMessageListener = ijkMediaPlayer.mOnControlMessageListener) != null) {
                        int i4 = bundle.getInt(OnNativeInvokeListener.ARG_SEGMENT_INDEX, -1);
                        if (i4 >= 0) {
                            String onControlResolveSegmentUrl = onControlMessageListener.onControlResolveSegmentUrl(i4);
    ...
    @CalledByNative
    private static String onSelectCodec(Object obj, String str, int i2, int i4) {
        ...
        return onMediaCodecSelectListener.onMediaCodecSelect(ijkMediaPlayer, str, i2, i4);
    }

    @CalledByNative
    private static void postEventFromNative(Object obj, int i2, int i4, int i5, Object obj2) {
        IjkMediaPlayer ijkMediaPlayer;
        ...
        if (eventHandler != null) {
            ijkMediaPlayer.mEventHandler.sendMessage(eventHandler.obtainMessage(i2, i4, i5, obj2));
        }
    }
    ...
    */
    ...
    public void setOption(int i2, String str, long j4) {
        _setOption(i2, str, j4);
    }
