...
public class UMConfigureInternation {
    ...
    public static void doSelfCheck(Context context) {
        try {
            ...
            UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f61151z, b.a(context).a(), null);
                        ...
                        new Thread(new Runnable() { // from class: com.umeng.commonsdk.UMConfigureInternation.1
                            ...
                            public void run() {
                                try {
                                    ...
                                    UMWorkDispatch.sendEvent(context2, com.umeng.commonsdk.internal.a.f61139n, b.a(context2).a(), null);
                                } catch (Throwable unused) {
                                }
                            }
                        }).start();
