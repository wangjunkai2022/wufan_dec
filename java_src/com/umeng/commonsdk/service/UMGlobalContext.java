...
public class UMGlobalContext {
    ...
    public static class a {
        ...
        private static final UMGlobalContext f61240a = new UMGlobalContext();
    ...
    public static Context getAppContext(Context context) {
        if (a.f61240a.mApplicationContext == null && context != null) {
            a.f61240a.mApplicationContext = context.getApplicationContext();
        }
        return a.f61240a.mApplicationContext;
    }

    public static UMGlobalContext getInstance(Context context) {
        if (a.f61240a.mApplicationContext == null && context != null) {
            a.f61240a.mApplicationContext = context;
        }
        return a.f61240a;
    }
    ...
    public String getProcessName(Context context) {
        if (TextUtils.isEmpty(this.mProcessName)) {
            if (context != null) {
                Context context2 = a.f61240a.mApplicationContext;
                if (context2 != null) {
                ...
                this.mProcessName = UMFrUtils.getCurrentProcessName(a.f61240a.mApplicationContext);
            }
        }
    ...
    public String toString() {
        if (a.f61240a.mApplicationContext != null) {
