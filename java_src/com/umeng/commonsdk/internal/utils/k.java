...
public class k {
    ...
    public static final String f61233a = "UM_PROBE_DATA";

    /* renamed from: b  reason: collision with root package name */
    public static final String f61234b = "_dsk_s";

    /* renamed from: c  reason: collision with root package name */
    public static final String f61235c = "_thm_z";

    /* renamed from: d  reason: collision with root package name */
    public static final String f61236d = "_gdf_r";

    /* renamed from: e  reason: collision with root package name */
    private static Object f61237e = new Object();
    ...
    public static boolean c(Context context) {
        ...
        return (context == null || (sharedPreferences = context.getApplicationContext().getSharedPreferences(f61233a, 0)) == null || TextUtils.isEmpty(sharedPreferences.getString(f61234b, ""))) ? false : true;
    }

    public static String a(Context context) {
        try {
            SharedPreferences sharedPreferences = context.getApplicationContext().getSharedPreferences(f61233a, 0);
            if (sharedPreferences != null) {
                JSONObject jSONObject = new JSONObject();
                synchronized (f61237e) {
                    jSONObject.put(f61234b, sharedPreferences.getString(f61234b, ""));
                    jSONObject.put(f61235c, sharedPreferences.getString(f61235c, ""));
                    jSONObject.put(f61236d, sharedPreferences.getString(f61236d, ""));
                }
    ...
    public static void b(Context context, String[] strArr) {
        SharedPreferences sharedPreferences;
        if (context == null || (sharedPreferences = context.getApplicationContext().getSharedPreferences(f61233a, 0)) == null) {
            return;
        }
        synchronized (f61237e) {
            sharedPreferences.edit().putString(f61234b, strArr[0]).putString(f61235c, strArr[1]).putString(f61236d, strArr[2]).commit();
        }
    }
