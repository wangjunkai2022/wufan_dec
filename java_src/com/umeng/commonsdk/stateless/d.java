...
public class d {
    ...
    public static int f61271a;

    /* renamed from: b  reason: collision with root package name */
    private static final byte[] f61272b = {10, 1, 11, 5, 4, 15, 7, 9, BinaryMemcacheOpcodes.QUITQ, 3, 1, 6, 8, 12, 13, 91};

    /* renamed from: c  reason: collision with root package name */
    private static Object f61273c = new Object();
    ...
    */
    ...
    public static File[] c(Context context) {
        ...
        try {
            synchronized (f61273c) {
                String str = context.getApplicationContext().getFilesDir() + File.separator + a.f61248f;
    ...
    public static String d(String str) {
        int lastIndexOf;
        int lastIndexOf2;
        return (!TextUtils.isEmpty(str) && str.indexOf("envelope") < 0 && (lastIndexOf = str.lastIndexOf("_")) >= 0 && (lastIndexOf2 = str.lastIndexOf(g0.f27568a)) >= 0) ? str.substring(lastIndexOf + 1, lastIndexOf2) : "";
    }
    ...
    */
    public static int a(android.content.Context r6, java.lang.String r7, java.lang.String r8, byte[] r9) {
        /*
            ...
            if (r6 == 0) goto L75
            r1 = 0
            java.lang.Object r2 = com.umeng.commonsdk.stateless.d.f61273c     // Catch: java.lang.Throwable -> L5d java.io.IOException -> L67
        ...
        try {
            synchronized (f61273c) {
                ...
                if (context != null && context.getApplicationContext() != null) {
                    String str = context.getApplicationContext().getFilesDir() + File.separator + a.f61247e;
                    if (!TextUtils.isEmpty(str)) {
    ...
    public static String a(Context context, boolean z3) {
        ...
        try {
            if (z3) {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f61247e;
            } else {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f61248f;
            }
            str2 = str;
            return str2;
        } catch (Throwable unused) {
                    ...
                    if (arrayList.size() >= i2) {
                        ...
                        if (ULog.DEBUG) {
                            for (int i4 = 0; i4 < arrayList.size(); i4++) {
                                ULog.i("AmapLBS", "[lbs-build] overrun native file is " + ((File) arrayList.get(i4)).getPath());
                            }
                        }
                        for (int i5 = 0; i5 <= arrayList.size() - i2; i5++) {
                            if (arrayList.get(i5) != null) {
                                ULog.i("AmapLBS", "[lbs-build] overrun remove file is " + ((File) arrayList.get(i5)).getPath());
                                try {
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2) throws Exception {
        ...
        cipher.init(1, new SecretKeySpec(bArr2, "AES"), new IvParameterSpec(f61272b));
