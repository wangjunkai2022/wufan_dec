...
public class UMWorkDispatch {
                ...
                if (mTaskHandler == null) {
                    mTaskHandler = new Handler(mNetTask.getLooper()) { // from class: com.umeng.commonsdk.framework.UMWorkDispatch.1
                        ...
                        public void handleMessage(Message message) {
                            ...
                            } else if (i2 != UMWorkDispatch.MSG_CHECKER_TIMER) {
                            } else {
                                UMWorkDispatch.handleEvent(message);
                            }
                        }
    ...
    public static void sendEventEx(Context context, int i2, UMLogDataProtocol uMLogDataProtocol, Object obj, long j4) {
        sendEventInternal(context, MSG_CHECKER_TIMER, i2, uMLogDataProtocol, obj, j4);
    }

    public static void sendEventInternal(Context context, int i2, int i4, UMLogDataProtocol uMLogDataProtocol, Object obj, long j4) {
        if (context != null && uMLogDataProtocol != null) {
            UMModuleRegister.registerAppContext(context.getApplicationContext());
            if (UMModuleRegister.registerCallback(i4, uMLogDataProtocol)) {
    ...
    public static void sendEvent(Context context, int i2, UMLogDataProtocol uMLogDataProtocol, Object obj, long j4) {
        sendEventInternal(context, 768, i2, uMLogDataProtocol, obj, j4);
    }
