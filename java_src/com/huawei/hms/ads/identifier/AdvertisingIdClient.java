...
public class AdvertisingIdClient {
    ...
    public static class XI implements Runnable {
        ...
        public final /* synthetic */ Context f16858XI;

        public XI(Context context) {
            this.f16858XI = context;
        }

        @Override // java.lang.Runnable
        public final void run() {
            try {
                AdvertisingIdClient.requestAdvertisingIdInfo(this.f16858XI);
    ...
    private static void updateAdvertisingIdInfo(Context context) {
        a.f8192a.execute(new XI(context));
    }
