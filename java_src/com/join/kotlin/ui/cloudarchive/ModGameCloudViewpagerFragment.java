...
public class ModGameCloudViewpagerFragment extends Fragment {
    ...
    private void addTagList() {
        ...
        f fVar = new f(getActivity(), this.tags);
        this.cloudArchiveTagAdapter = fVar;
        fVar.e(new f.b() { // from class: com.join.kotlin.ui.cloudarchive.b
            @Override // com.join.mgps.adapter.f.b
            public final void onSelected(int i2) {
                ModGameCloudViewpagerFragment.this.lambda$addTagList$0(i2);
            }
        });
    ...
    private void initViewPager() {
        ...
        while (it2.hasNext()) {
            ...
            this.fragments.add(new x.a(next.getName(), modgameCloudListFragment));
        }
        ...
        this.viewpager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() { // from class: com.join.kotlin.ui.cloudarchive.ModGameCloudViewpagerFragment.1
            ...
            public void onPageSelected(int i2) {
                ...
                while (it3.hasNext()) {
                    ...
                    boolean z3 = false;
                    if (ModGameCloudViewpagerFragment.this.tags.indexOf(modGameArchiveTagBean) == i2) {
                ...
                if (linearLayoutManager != null && (linearLayoutManager.findLastCompletelyVisibleItemPosition() < i2 || linearLayoutManager.findFirstCompletelyVisibleItemPosition() > i2)) {
                    ModGameCloudViewpagerFragment.this.subTabList.smoothScrollToPosition(i2);
                }
                if (ModGameCloudViewpagerFragment.this.lastSelectedTagIndex != i2) {
                    p.l(ModGameCloudViewpagerFragment.this.getContext()).K1(Event.clickCloudLabelButton, new Ext().setFrom(String.valueOf(((ModGameArchiveTagBean) ModGameCloudViewpagerFragment.this.tags.get(i2)).getType())).setGameId(ModGameCloudViewpagerFragment.this.gameId).setPosition(((ModGameArchiveTagBean) ModGameCloudViewpagerFragment.this.tags.get(i2)).getTagId()));
                }
            }
        });
    }
