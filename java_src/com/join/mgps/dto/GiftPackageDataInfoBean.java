...
public class GiftPackageDataInfoBean implements Serializable {
    ...
    public void setGift_package_count(int i2) {
        this.gift_package_count = i2;
    }
    ...
    public void setGift_package_overdue(int i2) {
        this.gift_package_overdue = i2;
    }
    ...
    public void setGift_package_status(int i2) {
        this.gift_package_status = i2;
    }

    public void setGift_package_surplus(int i2) {
        this.gift_package_surplus = i2;
    }
