...
public final class AppDownFinishDialogAcitivity_ extends AppDownFinishDialogAcitivity implements a, i3.a, b {
    ...
    public static class IntentBuilder_ extends org.androidannotations.api.builder.a<IntentBuilder_> {
        ...
        public IntentBuilder_(Context context) {
            super(context, AppDownFinishDialogAcitivity_.class);
        }
        ...
        public IntentBuilder_(Fragment fragment) {
            super(fragment.getActivity(), AppDownFinishDialogAcitivity_.class);
    ...
    public void onCreate(Bundle bundle) {
        ...
        c.c(c4);
        setContentView(R.layout.appdown_finish_dialog_layout);
    }
    ...
    public void onViewChanged(i3.a aVar) {
        ...
        View internalFindViewById = aVar.internalFindViewById(R.id.goMygame);
        if (internalFindViewById != null) {
            internalFindViewById.setOnClickListener(new View.OnClickListener() { // from class: com.join.mgps.activity.mygame.dialog.AppDownFinishDialogAcitivity_.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    AppDownFinishDialogAcitivity_.this.goMygame();
                }
            });
        }
        ImageView imageView = this.cancle;
        if (imageView != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.join.mgps.activity.mygame.dialog.AppDownFinishDialogAcitivity_.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    AppDownFinishDialogAcitivity_.this.cancle();
                }
            });
        }
        TextView textView = this.ok;
        if (textView != null) {
            textView.setOnClickListener(new View.OnClickListener() { // from class: com.join.mgps.activity.mygame.dialog.AppDownFinishDialogAcitivity_.3
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    AppDownFinishDialogAcitivity_.this.ok();
                }
            });
        }
        afterViews();
