...
public class LoginCfgsBean {
    ...
    public void setAd_id_force_status(int i2) {
        this.ad_id_force_status = i2;
    }

    public void setCertify_is_allow_skip(int i2) {
        this.certify_is_allow_skip = i2;
    }

    public void setDaily_show_count(int i2) {
        this.daily_show_count = i2;
    }

    public void setHow_times_open(int i2) {
        this.how_times_open = i2;
    }

    public void setIp_force_status(int i2) {
        this.ip_force_status = i2;
    }

    public void setIs_open_certify(int i2) {
        this.is_open_certify = i2;
    }

    public void setIs_open_login(int i2) {
        this.is_open_login = i2;
    }

    public void setIs_show_after_login(int i2) {
        this.is_show_after_login = i2;
    }

    public void setIs_use_police_api(int i2) {
        this.is_use_police_api = i2;
    }

    public void setLogin_is_allow_skip(int i2) {
        this.login_is_allow_skip = i2;
    }

    public void setOnekey_login_auth(int i2) {
        this.onekey_login_auth = i2;
    }

    public void setTimes_open_certify(int i2) {
        this.times_open_certify = i2;
    }

    public void setTimes_open_login(int i2) {
        this.times_open_login = i2;
    }
