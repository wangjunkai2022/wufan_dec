...
/* compiled from: ItemSimulatorTitleTwoViewBinding.java */
/* loaded from: classes3.dex */
public final class hs implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final RelativeLayout f20897a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final TextView f20898b;

    private hs(@NonNull RelativeLayout relativeLayout, @NonNull TextView textView) {
        this.f20897a = relativeLayout;
        this.f20898b = textView;
    }
    ...
    public static hs a(@NonNull View view) {
        ...
        if (textView != null) {
            return new hs((RelativeLayout) view, textView);
        }
    ...
    @NonNull
    public static hs d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
