...
/* compiled from: ItemPostingGroupTitleBinding.java */
/* loaded from: classes3.dex */
public final class mr implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final RelativeLayout f22604a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final TextView f22605b;

    private mr(@NonNull RelativeLayout relativeLayout, @NonNull TextView textView) {
        this.f22604a = relativeLayout;
    ...
    public static mr a(@NonNull View view) {
        ...
        if (textView != null) {
            return new mr((RelativeLayout) view, textView);
        }
    ...
    @NonNull
    public static mr d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
