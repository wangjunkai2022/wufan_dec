...
/* compiled from: SampleCommonListFooterEndBinding.java */
/* loaded from: classes3.dex */
public final class x90 implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f26493a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final TextView f26494b;

    private x90(@NonNull LinearLayout linearLayout, @NonNull TextView textView) {
    ...
    public static x90 a(@NonNull View view) {
        ...
        if (textView != null) {
            return new x90((LinearLayout) view, textView);
        }
    ...
    @NonNull
    public static x90 d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
