...
/* compiled from: MgForumPostActivityItemPostMessageBinding.java */
/* loaded from: classes3.dex */
public final class bz implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f18670a;
    @NonNull
    ...
    public final LinearLayout f18672c;

    private bz(@NonNull LinearLayout linearLayout, @NonNull TextView textView, @NonNull LinearLayout linearLayout2) {
        this.f18670a = linearLayout;
        this.f18671b = textView;
        this.f18672c = linearLayout2;
    }
    ...
    public static bz a(@NonNull View view) {
        ...
        if (textView != null) {
            ...
            return new bz(linearLayout, textView, linearLayout);
        }
    ...
    @NonNull
    public static bz c(@NonNull LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    @NonNull
    public static bz d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
