...
/* compiled from: GameDetailScreenshotItemBinding.java */
/* loaded from: classes3.dex */
public final class ui implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final RelativeLayout f25531a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final SimpleDraweeView f25532b;
    @NonNull
    ...
    private ui(@NonNull RelativeLayout relativeLayout, @NonNull SimpleDraweeView simpleDraweeView, @NonNull TextView textView, @NonNull TextView textView2) {
        this.f25531a = relativeLayout;
        this.f25532b = simpleDraweeView;
    ...
    public static ui a(@NonNull View view) {
        ...
        if (simpleDraweeView != null) {
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    return new ui((RelativeLayout) view, simpleDraweeView, textView, textView2);
                }
            }
        }
    ...
    @NonNull
    public static ui d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
