...
public class w30 extends v30 implements a.InterfaceC0141a {
    @Nullable
    ...
    private final LinearLayout f26040v0;
    @NonNull

    /* renamed from: w0  reason: collision with root package name */
    private final LinearLayout f26041w0;
    @NonNull

    /* renamed from: x0  reason: collision with root package name */
    private final View f26042x0;
    @NonNull

    /* renamed from: y0  reason: collision with root package name */
    private final RelativeLayout f26043y0;
    @NonNull
    ...
    public w30(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.T(dataBindingComponent, view, 20, J0, K0));
    }
    ...
    public final void a(int i2, View view) {
        switch (i2) {
            case 1:
                ArchiveData archiveData = this.f25720t0;
                OnClickArchiveListener onClickArchiveListener = this.f25721u0;
                ...
                return;
            case 2:
                ArchiveData archiveData2 = this.f25720t0;
                OnClickArchiveListener onClickArchiveListener2 = this.f25721u0;
                ...
                return;
            case 3:
                ArchiveData archiveData3 = this.f25720t0;
                OnClickArchiveListener onClickArchiveListener3 = this.f25721u0;
                ...
                return;
            case 4:
                OnClickArchiveListener onClickArchiveListener4 = this.f25721u0;
                ...
                return;
            case 5:
                ArchiveData archiveData4 = this.f25720t0;
                OnClickArchiveListener onClickArchiveListener5 = this.f25721u0;
                ...
                return;
            case 6:
                ArchiveData archiveData5 = this.f25720t0;
                OnClickArchiveListener onClickArchiveListener6 = this.f25721u0;
    ...
    @Override // com.join.android.app.mgsim.wufun.databinding.v30
    public void h1(@Nullable OnClickArchiveListener onClickArchiveListener) {
        this.f25721u0 = onClickArchiveListener;
        synchronized (this) {
            this.I0 |= 2;
        }
    ...
    protected void k() {
        ...
        if (j11 != 0) {
            ...
            Drawable drawable5 = AppCompatResources.getDrawable(this.f25717q0.getContext(), z5 ? R.drawable.mod_start_normal_back : R.drawable.mod_download_normal_back);
            i6 = z6 ? 0 : 8;
            i7 = z7 ? 8 : 0;
            if (z8) {
                context = this.f25715o0.getContext();
            ...
            i5 = equals2 ? 0 : 8;
            if (equals2) {
                context3 = this.f26041w0.getContext();
                j8 = j4;
        ...
        if (j12 != 0) {
            ...
            ViewBindingAdapter.setBackground(this.f26041w0, drawable);
            this.f26042x0.setVisibility(i5);
            this.f26043y0.setVisibility(i2);
            this.f26044z0.setVisibility(i6);
            this.A0.setVisibility(i7);
            SimpleDrawableViewKt.loadUrl(this.A0, str2, null, 0);
            this.B0.setVisibility(i4);
            this.f25714n0.setVisibility(i8);
            ImageViewBindingAdapter.setImageDrawable(this.f25715o0, drawable4);
            TextViewBindingAdapter.setText(this.f25716p0, str6);
            ViewBindingAdapter.setBackground(this.f25717q0, drawable3);
            TextViewBindingAdapter.setText(this.f25717q0, str5);
            this.f25718r0.setVisibility(i5);
            TextViewBindingAdapter.setText(this.f25719s0, str7);
        } else {
            j7 = j4;
        }
        if ((j7 & 4) != 0) {
            ...
            this.f25714n0.setOnClickListener(this.D0);
            this.f25715o0.setOnClickListener(this.F0);
            this.f25717q0.setOnClickListener(this.C0);
            this.f25718r0.setOnClickListener(this.G0);
        }
    }
    ...
    private w30(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        ...
        this.f26040v0 = linearLayout;
        linearLayout.setTag(null);
        LinearLayout linearLayout2 = (LinearLayout) objArr[1];
        this.f26041w0 = linearLayout2;
        linearLayout2.setTag(null);
        View view2 = (View) objArr[11];
        this.f26042x0 = view2;
        view2.setTag(null);
        RelativeLayout relativeLayout = (RelativeLayout) objArr[13];
        this.f26043y0 = relativeLayout;
        ...
        this.f25714n0.setTag(null);
        this.f25715o0.setTag(null);
        this.f25716p0.setTag(null);
        this.f25717q0.setTag(null);
        this.f25718r0.setTag(null);
        this.f25719s0.setTag(null);
        A0(view);
        this.C0 = new com.join.android.app.mgsim.wufun.generated.callback.a(this, 5);
        this.D0 = new com.join.android.app.mgsim.wufun.generated.callback.a(this, 6);
        this.E0 = new com.join.android.app.mgsim.wufun.generated.callback.a(this, 3);
        this.F0 = new com.join.android.app.mgsim.wufun.generated.callback.a(this, 2);
        this.G0 = new com.join.android.app.mgsim.wufun.generated.callback.a(this, 4);
        this.H0 = new com.join.android.app.mgsim.wufun.generated.callback.a(this, 1);
        invalidateAll();
    }
}
