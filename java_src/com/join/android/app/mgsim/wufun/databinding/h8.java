...
/* compiled from: CommitFooterBinding.java */
...
public final class h8 implements ViewBinding {
    ...
    private h8(@NonNull RelativeLayout relativeLayout, @NonNull RelativeLayout relativeLayout2, @NonNull TextView textView) {
    ...
    public static h8 a(@NonNull View view) {
        ...
        if (textView != null) {
            return new h8(relativeLayout, relativeLayout, textView);
        }
    ...
    @NonNull
    public static h8 d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
