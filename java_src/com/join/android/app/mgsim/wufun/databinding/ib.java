...
/* compiled from: DialogFightConnectServerBinding.java */
/* loaded from: classes3.dex */
public final class ib implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final RelativeLayout f21111a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final ImageView f21112b;
    @NonNull

    /* renamed from: c  reason: collision with root package name */
    public final TextView f21113c;

    private ib(@NonNull RelativeLayout relativeLayout, @NonNull ImageView imageView, @NonNull TextView textView) {
        this.f21111a = relativeLayout;
        this.f21112b = imageView;
        this.f21113c = textView;
    }
    ...
    public static ib a(@NonNull View view) {
        ...
        if (imageView != null) {
            ...
            if (textView != null) {
                return new ib((RelativeLayout) view, imageView, textView);
            }
        }
    ...
    @NonNull
    public static ib d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
