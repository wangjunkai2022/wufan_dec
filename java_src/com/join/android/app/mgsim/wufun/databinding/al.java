...
/* compiled from: GamedetailItemTipslayoutBinding.java */
/* loaded from: classes3.dex */
public final class al implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f18215a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final LinearLayout f18216b;

    private al(@NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2) {
        this.f18215a = linearLayout;
        this.f18216b = linearLayout2;
    }
    ...
    public static al a(@NonNull View view) {
        ...
        if (linearLayout != null) {
            return new al((LinearLayout) view, linearLayout);
        }
    ...
    @NonNull
    public static al d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
