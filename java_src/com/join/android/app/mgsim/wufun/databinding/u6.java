...
/* compiled from: CloudDownButnBinding.java */
...
public final class u6 implements ViewBinding {
    ...
    private u6(@NonNull LinearLayout linearLayout, @NonNull TextView textView) {
    ...
    public static u6 a(@NonNull View view) {
        ...
        if (textView != null) {
            return new u6((LinearLayout) view, textView);
        }
    ...
    @NonNull
    public static u6 d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
