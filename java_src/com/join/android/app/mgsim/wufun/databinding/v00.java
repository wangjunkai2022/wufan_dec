...
/* compiled from: MgForumWelcomeItemMyForumMoreFooterBinding.java */
...
public final class v00 implements ViewBinding {
    ...
    public final TextView f25665b;

    private v00(@NonNull LinearLayout linearLayout, @NonNull TextView textView) {
    ...
    public static v00 a(@NonNull View view) {
        ...
        if (textView != null) {
            return new v00((LinearLayout) view, textView);
        }
    ...
    @NonNull
    public static v00 d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
