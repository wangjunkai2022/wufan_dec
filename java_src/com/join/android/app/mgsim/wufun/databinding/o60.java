...
/* compiled from: NowWufunTopic2Binding.java */
/* loaded from: classes3.dex */
public final class o60 implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f23148a;
    @NonNull
    ...
    public final SimpleDraweeView f23151d;
    @NonNull

    /* renamed from: e  reason: collision with root package name */
    public final LinearLayout f23152e;
    @NonNull
    ...
    private o60(@NonNull LinearLayout linearLayout, @NonNull TextView textView, @NonNull TextView textView2, @NonNull SimpleDraweeView simpleDraweeView, @NonNull LinearLayout linearLayout2, @NonNull TextView textView3, @NonNull TextView textView4) {
        this.f23148a = linearLayout;
        this.f23149b = textView;
        this.f23150c = textView2;
        this.f23151d = simpleDraweeView;
        this.f23152e = linearLayout2;
        this.f23153f = textView3;
        this.f23154g = textView4;
    }

    @NonNull
    public static o60 a(@NonNull View view) {
                ...
                if (simpleDraweeView != null) {
                    ...
                    if (linearLayout != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            if (textView4 != null) {
                                return new o60((LinearLayout) view, textView, textView2, simpleDraweeView, linearLayout, textView3, textView4);
                            }
                        }
                    }
                }
    ...
    @NonNull
    public static o60 c(@NonNull LayoutInflater layoutInflater) {
        return d(layoutInflater, null, false);
    }

    @NonNull
    public static o60 d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
