...
/* compiled from: GameDetailEmusCloudListLayoutDatabindingBindingImpl.java */
/* loaded from: classes3.dex */
public class li extends ki {
    @Nullable

    /* renamed from: o0  reason: collision with root package name */
    private static final ViewDataBinding.IncludedLayouts f22148o0;
    @Nullable

    /* renamed from: p0  reason: collision with root package name */
    private static final SparseIntArray f22149p0;
    @NonNull
    ...
    private long f22150n0;

    static {
        ViewDataBinding.IncludedLayouts includedLayouts = new ViewDataBinding.IncludedLayouts(4);
        f22148o0 = includedLayouts;
    ...
    public li(@Nullable DataBindingComponent dataBindingComponent, @NonNull View view) {
        this(dataBindingComponent, view, ViewDataBinding.T(dataBindingComponent, view, 4, f22148o0, f22149p0));
    }
    ...
    private boolean m1(MutableLiveData<List<CloudListDataBean>> mutableLiveData, int i2) {
        if (i2 == 0) {
            synchronized (this) {
                this.f22150n0 |= 4;
            }
    ...
    @Override // com.join.android.app.mgsim.wufun.databinding.ki
    ...
    protected void k() {
        ...
        GameDetailEmusCloudViewModle gameDetailEmusCloudViewModle = this.G;
    ...
    @Override // com.join.android.app.mgsim.wufun.databinding.ki
    public void k1(@Nullable GameDetailEmusCloudViewModle gameDetailEmusCloudViewModle) {
        this.G = gameDetailEmusCloudViewModle;
        synchronized (this) {
            this.f22150n0 |= 8;
        }
    ...
    public boolean setVariable(int i2, @Nullable Object obj) {
        if (27 == i2) {
            k1((GameDetailEmusCloudViewModle) obj);
            return true;
        } else if (19 == i2) {
