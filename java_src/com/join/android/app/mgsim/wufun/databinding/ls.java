...
/* compiled from: ItemStandaloneCompanyViewBinding.java */
/* loaded from: classes3.dex */
public final class ls implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final RelativeLayout f22201a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final InterceptEventHorizontalScrollView f22202b;

    private ls(@NonNull RelativeLayout relativeLayout, @NonNull InterceptEventHorizontalScrollView interceptEventHorizontalScrollView) {
        this.f22201a = relativeLayout;
        this.f22202b = interceptEventHorizontalScrollView;
    }
    ...
    public static ls a(@NonNull View view) {
        ...
        if (interceptEventHorizontalScrollView != null) {
            return new ls((RelativeLayout) view, interceptEventHorizontalScrollView);
        }
    ...
    @NonNull
    public static ls d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
