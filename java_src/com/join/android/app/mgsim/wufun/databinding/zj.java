...
/* compiled from: GamedetailItemFactoryRecommendBinding.java */
/* loaded from: classes3.dex */
public final class zj implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f27249a;
    @NonNull
    ...
    public final LinearLayout f27251c;
    @NonNull
    ...
    public final MyGridView f27253e;

    private zj(@NonNull LinearLayout linearLayout, @NonNull TextView textView, @NonNull LinearLayout linearLayout2, @NonNull View view, @NonNull MyGridView myGridView) {
        this.f27249a = linearLayout;
        this.f27250b = textView;
        this.f27251c = linearLayout2;
        this.f27252d = view;
        this.f27253e = myGridView;
    }
        ...
        if (textView != null) {
            ...
            if (linearLayout != null) {
                ...
                if (findChildViewById != null) {
                    ...
                    if (myGridView != null) {
                        return new zj((LinearLayout) view, textView, linearLayout, findChildViewById, myGridView);
                    }
                }
            }
        }
    ...
    @NonNull
    public static zj d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
