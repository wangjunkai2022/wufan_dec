...
/* compiled from: ChoiceTitleLayoutBinding.java */
/* loaded from: classes3.dex */
public final class b6 implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f18393a;
    @NonNull
    ...
    private b6(@NonNull LinearLayout linearLayout, @NonNull TextView textView, @NonNull TextView textView2) {
        this.f18393a = linearLayout;
        this.f18394b = textView;
        this.f18395c = textView2;
    }
    ...
    @NonNull
    public static b6 d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
