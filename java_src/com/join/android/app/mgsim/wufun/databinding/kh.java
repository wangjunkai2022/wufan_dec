...
/* compiled from: FragmentMyGameItemUpdateBinding.java */
...
public final class kh implements ViewBinding {
    ...
    public final ImageView f21855d;

    private kh(@NonNull ConstraintLayout constraintLayout, @NonNull TextView textView, @NonNull ImageView imageView, @NonNull ImageView imageView2) {
        this.f21852a = constraintLayout;
        this.f21853b = textView;
        this.f21854c = imageView;
        this.f21855d = imageView2;
    }
    ...
    public static kh a(@NonNull View view) {
        ...
        if (textView != null) {
            ...
            if (imageView != null) {
                ...
                if (imageView2 != null) {
                    return new kh((ConstraintLayout) view, textView, imageView, imageView2);
                }
            }
        }
    ...
    @NonNull
    public static kh d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
