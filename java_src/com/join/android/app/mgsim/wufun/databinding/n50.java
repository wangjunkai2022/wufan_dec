...
/* compiled from: NewDownloadActivityLayoutBinding.java */
/* loaded from: classes3.dex */
public final class n50 implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f22755a;

    private n50(@NonNull LinearLayout linearLayout) {
        this.f22755a = linearLayout;
    }
