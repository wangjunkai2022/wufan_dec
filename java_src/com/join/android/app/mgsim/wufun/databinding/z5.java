...
/* compiled from: ChoiceTagItemLayoutBinding.java */
/* loaded from: classes3.dex */
public final class z5 implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f27121a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final TextView f27122b;

    private z5(@NonNull LinearLayout linearLayout, @NonNull TextView textView) {
        this.f27121a = linearLayout;
    ...
    @NonNull
    public static z5 d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
