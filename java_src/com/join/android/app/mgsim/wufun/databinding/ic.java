...
/* compiled from: DialogModDownloadBinding.java */
/* loaded from: classes3.dex */
public final class ic implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f21126a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final LinearLayout f21127b;
    @NonNull

    /* renamed from: c  reason: collision with root package name */
    public final ProgressBar f21128c;
    @NonNull

    /* renamed from: d  reason: collision with root package name */
    public final TextView f21129d;
    @NonNull
    ...
    public final TextView f21133h;

    private ic(@NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull ProgressBar progressBar, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4, @NonNull TextView textView5) {
        this.f21126a = linearLayout;
        this.f21127b = linearLayout2;
        this.f21128c = progressBar;
        this.f21129d = textView;
        this.f21130e = textView2;
        this.f21131f = textView3;
        this.f21132g = textView4;
        this.f21133h = textView5;
    }
                    ...
                    if (textView2 != null) {
                        ...
                        if (textView3 != null) {
                            ...
                            if (textView4 != null) {
                                ...
                                if (textView5 != null) {
                                    return new ic((LinearLayout) view, linearLayout, progressBar, textView, textView2, textView3, textView4, textView5);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static ic d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
