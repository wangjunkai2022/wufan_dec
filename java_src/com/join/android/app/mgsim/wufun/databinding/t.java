...
public final class t implements ViewBinding {
    ...
    private final RelativeLayout f25004a;
    @NonNull
    ...
    public final LinearLayout f25006c;
    @NonNull

    /* renamed from: d  reason: collision with root package name */
    public final ProgressBar f25007d;
    @NonNull
    ...
    private t(@NonNull RelativeLayout relativeLayout, @NonNull ImageView imageView, @NonNull LinearLayout linearLayout, @NonNull ProgressBar progressBar, @NonNull TextView textView, @NonNull TextView textView2, @NonNull TextView textView3) {
        this.f25004a = relativeLayout;
        this.f25005b = imageView;
        this.f25006c = linearLayout;
        this.f25007d = progressBar;
        this.f25008e = textView;
        this.f25009f = textView2;
        this.f25010g = textView3;
    }
                ...
                if (progressBar != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (textView3 != null) {
                                return new t((RelativeLayout) view, imageView, linearLayout, progressBar, textView, textView2, textView3);
                            }
                        }
                    }
                }
