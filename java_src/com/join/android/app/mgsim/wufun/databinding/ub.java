...
/* compiled from: DialogGameRoomToastBinding.java */
...
public final class ub implements ViewBinding {
    ...
    public final TextView f25487b;

    private ub(@NonNull LinearLayout linearLayout, @NonNull TextView textView) {
    ...
    public static ub a(@NonNull View view) {
        ...
        if (textView != null) {
            return new ub((LinearLayout) view, textView);
        }
    ...
    @NonNull
    public static ub d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
