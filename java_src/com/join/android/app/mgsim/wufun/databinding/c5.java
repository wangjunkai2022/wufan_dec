...
/* compiled from: ChioceItemDateLineBinding.java */
/* loaded from: classes3.dex */
public final class c5 implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f18781a;
    @NonNull
    ...
    private c5(@NonNull LinearLayout linearLayout, @NonNull TextView textView, @NonNull TextView textView2) {
        this.f18781a = linearLayout;
        this.f18782b = textView;
        this.f18783c = textView2;
    }
    ...
    public static c5 a(@NonNull View view) {
        ...
        if (textView != null) {
            ...
            if (textView2 != null) {
                return new c5((LinearLayout) view, textView, textView2);
            }
        }
    ...
    @NonNull
    public static c5 d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
