...
/* compiled from: GamelistListitembigGameiconLayoutBinding.java */
/* loaded from: classes3.dex */
public final class ym implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f26997a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final SimpleDraweeView f26998b;

    private ym(@NonNull LinearLayout linearLayout, @NonNull SimpleDraweeView simpleDraweeView) {
        this.f26997a = linearLayout;
        this.f26998b = simpleDraweeView;
    }
    ...
    public static ym a(@NonNull View view) {
        ...
        if (simpleDraweeView != null) {
            return new ym((LinearLayout) view, simpleDraweeView);
        }
