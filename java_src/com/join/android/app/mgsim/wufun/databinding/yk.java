...
/* compiled from: GamedetailItemTipitemLittleBinding.java */
/* loaded from: classes3.dex */
public final class yk implements ViewBinding {
    @NonNull

    /* renamed from: a  reason: collision with root package name */
    private final LinearLayout f26956a;
    @NonNull

    /* renamed from: b  reason: collision with root package name */
    public final TextView f26957b;

    private yk(@NonNull LinearLayout linearLayout, @NonNull TextView textView) {
        this.f26956a = linearLayout;
    ...
    public static yk a(@NonNull View view) {
        ...
        if (textView != null) {
            return new yk((LinearLayout) view, textView);
        }
    ...
    @NonNull
    public static yk d(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z3) {
