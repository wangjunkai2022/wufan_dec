...
public class XRecyclerView extends RecyclerView {
    ...
    protected static final int f17786a2 = 0;

    /* renamed from: b2  reason: collision with root package name */
    protected static final int f17787b2 = 1;

    /* renamed from: c2  reason: collision with root package name */
    protected static final int f17788c2 = 400;

    /* renamed from: d2  reason: collision with root package name */
    protected static final int f17789d2 = 50;

    /* renamed from: e2  reason: collision with root package name */
    protected static final float f17790e2 = 2.0f;
    private boolean A1;
    private boolean B1;
    ...
    class a extends com.join.mgps.ptr.a {
        ...
        private void e() {
            ...
            xRecyclerView.setLoadingMoreEnabled(xRecyclerView.H1);
        }

        @Override // com.join.mgps.ptr.a, com.join.mgps.ptr.b
        public boolean a(PtrFrameLayout ptrFrameLayout, View view, View view2) {
            return XRecyclerView.this.N1 == AppBarStateChangeListener.State.EXPANDED && com.join.mgps.ptr.a.d(ptrFrameLayout, view, view2);
        }

        @Override // com.join.mgps.ptr.b
        public void b(PtrFrameLayout ptrFrameLayout) {
            e();
            if (XRecyclerView.this.F1 != null) {
                XRecyclerView.this.F1.onRefresh();
            }
        }
    }
    ...
    public class c implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            XRecyclerView xRecyclerView = XRecyclerView.this;
            xRecyclerView.L1 = true;
            xRecyclerView.K1.setState(2);
            if (XRecyclerView.this.F1 != null) {
                XRecyclerView.this.F1.onLoadMore();
            }
        }
    }
    ...
    private class e extends RecyclerView.AdapterDataObserver {
        ...
        public void onChanged() {
            ...
            if (adapter != null && XRecyclerView.this.J1 != null) {
                ?? r12 = XRecyclerView.this.G1;
                int i2 = r12;
                if (XRecyclerView.this.H1) {
                    i2 = r12 + 1;
                }
                if (adapter.getItemCount() == i2) {
                    XRecyclerView.this.J1.setVisibility(0);
                    XRecyclerView.this.setVisibility(8);
                } else {
                    XRecyclerView.this.J1.setVisibility(8);
                    XRecyclerView.this.setVisibility(0);
                }
            }
            if (XRecyclerView.this.D1 != null) {
                XRecyclerView.this.D1.notifyDataSetChanged();
            }
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeChanged(int i2, int i4) {
            XRecyclerView.this.D1.notifyItemRangeChanged(i2, i4);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeInserted(int i2, int i4) {
            XRecyclerView.this.D1.notifyItemRangeInserted(i2, i4);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeMoved(int i2, int i4, int i5) {
            XRecyclerView.this.D1.notifyItemMoved(i2, i4);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.AdapterDataObserver
        public void onItemRangeRemoved(int i2, int i4) {
            XRecyclerView.this.D1.notifyItemRangeRemoved(i2, i4);
        }
        ...
        public void onItemRangeChanged(int i2, int i4, Object obj) {
            XRecyclerView.this.D1.notifyItemRangeChanged(i2, i4, obj);
        }
    }
    ...
    public class g extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        private RecyclerView.Adapter f17797b;

        /* loaded from: classes2.dex */
        class a extends GridLayoutManager.SpanSizeLookup {

            /* renamed from: a  reason: collision with root package name */
            final /* synthetic */ GridLayoutManager f17799a;

            a(GridLayoutManager gridLayoutManager) {
                this.f17799a = gridLayoutManager;
            }

            @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
            public int getSpanSize(int i2) {
                if (g.this.d(i2) || g.this.c(i2) || g.this.e(i2)) {
                    return this.f17799a.getSpanCount();
                }
                return 1;
            }
        }
        ...
        public g(RecyclerView.Adapter adapter) {
            this.f17797b = adapter;
        }

        private void f() {
            XRecyclerView xRecyclerView = XRecyclerView.this;
            if (xRecyclerView.K1 != null) {
                if (xRecyclerView.B1) {
                    XRecyclerView.this.K1.setState(3);
                    return;
                }
                XRecyclerView xRecyclerView2 = XRecyclerView.this;
                if (xRecyclerView2.L1) {
                    xRecyclerView2.K1.setState(2);
                } else {
                    xRecyclerView2.K1.setState(0);
                }
            }
        }
        ...
        public boolean c(int i2) {
            return XRecyclerView.this.H1 && i2 == getItemCount() - 1;
        }

        public boolean d(int i2) {
            return this.f17796a && i2 >= 1 && i2 < XRecyclerView.this.C1.size() + 1;
        }
        ...
        public int getItemCount() {
            ...
            int i4;
            if (XRecyclerView.this.H1) {
                int i5 = this.f17796a ? 2 : 1;
                if (this.f17797b != null) {
                    b5 = b();
                    itemCount = this.f17797b.getItemCount();
                    i4 = i5;
                    b4 = b5 + itemCount;
                    i2 = i4;
                } else {
        ...
        public long getItemId(int i2) {
            int b4;
            boolean z3 = this.f17796a;
            if (this.f17797b == null || i2 < b() + (z3 ? 1 : 0) || (b4 = i2 - (b() + (z3 ? 1 : 0))) >= this.f17797b.getItemCount()) {
                return -1L;
            }
            return this.f17797b.getItemId(b4);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public int getItemViewType(int i2) {
            RecyclerView.Adapter adapter = this.f17797b;
            int itemCount = adapter != null ? adapter.getItemCount() : 0;
            int b4 = i2 - (b() + (this.f17796a ? 1 : 0));
            if (b4 < itemCount && XRecyclerView.this.p1(this.f17797b.getItemViewType(b4))) {
                throw new IllegalStateException("XRecyclerView require itemViewType in adapter should be less than 10000 ");
            }
            if (e(i2) && this.f17796a) {
                return 10000;
            }
            if (d(i2)) {
                if (this.f17796a) {
                ...
                return ((Integer) XRecyclerView.Z1.get(i2)).intValue();
            } else if (c(i2)) {
                return 10001;
            } else {
                if (b4 < itemCount) {
                    return this.f17797b.getItemViewType(b4);
                }
                return 0;
            }
        }
        ...
        public void onAttachedToRecyclerView(RecyclerView recyclerView) {
            ...
            this.f17797b.onAttachedToRecyclerView(recyclerView);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i2) {
            if (d(i2) || (e(i2) && this.f17796a)) {
                return;
            }
            if (c(i2)) {
                f();
            ...
            this.f17797b.onBindViewHolder(viewHolder, b4);
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i2) {
            ...
            if (XRecyclerView.this.m1(i2)) {
                return new b(XRecyclerView.this.j1(i2));
            }
            if (i2 == 10001) {
                return new b(XRecyclerView.this.K1);
            }
            return this.f17797b.onCreateViewHolder(viewGroup, i2);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void onDetachedFromRecyclerView(RecyclerView recyclerView) {
            this.f17797b.onDetachedFromRecyclerView(recyclerView);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public boolean onFailedToRecycleView(RecyclerView.ViewHolder viewHolder) {
            return this.f17797b.onFailedToRecycleView(viewHolder);
        }
        ...
        public void onViewAttachedToWindow(RecyclerView.ViewHolder viewHolder) {
            ...
            this.f17797b.onViewAttachedToWindow(viewHolder);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void onViewDetachedFromWindow(RecyclerView.ViewHolder viewHolder) {
            this.f17797b.onViewDetachedFromWindow(viewHolder);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void onViewRecycled(RecyclerView.ViewHolder viewHolder) {
            this.f17797b.onViewRecycled(viewHolder);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void registerAdapterDataObserver(RecyclerView.AdapterDataObserver adapterDataObserver) {
            this.f17797b.registerAdapterDataObserver(adapterDataObserver);
        }

        @Override // androidx.recyclerview.widget.RecyclerView.Adapter
        public void unregisterAdapterDataObserver(RecyclerView.AdapterDataObserver adapterDataObserver) {
            this.f17797b.unregisterAdapterDataObserver(adapterDataObserver);
        }
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i2, @NonNull List<Object> list) {
            if (list == null) {
            ...
            } else if (d(i2) || (e(i2) && this.f17796a)) {
            } else {
                if (c(i2)) {
                    f();
                    return;
                ...
                this.f17797b.onBindViewHolder(viewHolder, b4, list);
            }
        }
    }
}
