...
public class DownloadService extends Service {
        ...
        if (this.f56405a == null) {
            try {
                if (b.b().d()) {
                    ...
                    this.f56405a = aPKDownloadServiceDelegate;
    ...
    public IBinder onBind(Intent intent) {
        ...
        return this.f56405a.onBind(intent);
    }
    ...
    public int onStartCommand(Intent intent, int i2, int i4) {
        if (intent == null) {
            ...
            return this.f56405a.onStartCommand(intent, i2, i4);
        }
    }
