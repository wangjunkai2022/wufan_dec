...
public class d {
    ...
    private static final ThreadLocal<Matrix> f15143a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f15144b = new ThreadLocal<>();
    ...
    public static void c(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull Rect rect) {
        ThreadLocal<Matrix> threadLocal = f15143a;
        ...
        ThreadLocal<RectF> threadLocal2 = f15144b;
