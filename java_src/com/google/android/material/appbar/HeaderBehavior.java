...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    final boolean fling(CoordinatorLayout coordinatorLayout, @NonNull V v3, int i2, int i4, float f4) {
        ...
        this.scroller.fling(0, getTopAndBottomOffset(), 0, Math.round(f4), 0, 0, i2, i4);
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final int scroll(CoordinatorLayout coordinatorLayout, V v3, int i2, int i4, int i5) {
        return setHeaderTopBottomOffset(coordinatorLayout, v3, getTopBottomOffsetForScrollingSibling() - i2, i4, i5);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v3, int i2) {
        return setHeaderTopBottomOffset(coordinatorLayout, v3, i2, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v3, int i2, int i4, int i5) {
        int clamp;
        int topAndBottomOffset = getTopAndBottomOffset();
        if (i4 == 0 || topAndBottomOffset < i4 || topAndBottomOffset > i5 || topAndBottomOffset == (clamp = MathUtils.clamp(i2, i4, i5))) {
            return 0;
        }
