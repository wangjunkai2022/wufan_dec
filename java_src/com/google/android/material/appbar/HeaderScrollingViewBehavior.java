...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i2, int i4, int i5, int i6) {
        ...
        if ((i7 == -1 || i7 == -2) && (findFirstDependency = findFirstDependency(coordinatorLayout.getDependencies(view))) != null) {
            ...
            coordinatorLayout.onMeasureChild(view, i2, i4, View.MeasureSpec.makeMeasureSpec(scrollRange, i7 == -1 ? 1073741824 : Integer.MIN_VALUE), i6);
            return true;
        }
        return false;
    }
