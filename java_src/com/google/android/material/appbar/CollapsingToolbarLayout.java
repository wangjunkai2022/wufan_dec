...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    @NonNull
    final a elevationOverlayProvider;
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i2) {
            ...
            float f4 = height2;
            CollapsingToolbarLayout.this.collapsingTextHelper.B0(Math.min(1.0f, (height - CollapsingToolbarLayout.this.getScrimVisibleHeightTrigger()) / f4));
            CollapsingToolbarLayout collapsingToolbarLayout3 = CollapsingToolbarLayout.this;
            collapsingToolbarLayout3.collapsingTextHelper.o0(collapsingToolbarLayout3.currentOffset + height2);
            CollapsingToolbarLayout.this.collapsingTextHelper.z0(Math.abs(i2) / f4);
        }
    }
    ...
    private void animateScrim(int i2) {
        ...
        if (valueAnimator == null) {
            ...
            if (i2 > this.scrimAlpha) {
                ...
                timeInterpolator = com.google.android.material.animation.a.f14007d;
            }
    ...
    private void updateCollapsedBounds(boolean z3) {
        ...
        d.a(this, this.dummyView, this.tmpRect);
        ...
        b bVar = this.collapsingTextHelper;
        Rect rect = this.tmpRect;
        int i7 = rect.left + (z3 ? i4 : i6);
        int i8 = rect.top + maxOffsetForPinChild + i5;
        int i9 = rect.right;
        if (!z3) {
            i6 = i4;
        }
        bVar.f0(i7, i8, i9 - i6, (rect.bottom + maxOffsetForPinChild) - i2);
    }
    ...
    private void updateContentScrimBounds(@NonNull Drawable drawable, int i2, int i4) {
        updateContentScrimBounds(drawable, this.toolbar, i2, i4);
    }
    ...
    private void updateTextBounds(int i2, int i4, int i5, int i6, boolean z3) {
        View view;
        if (!this.collapsingTitleEnabled || (view = this.dummyView) == null) {
            return;
        }
        ...
        if (z4 || z3) {
            ...
            this.collapsingTextHelper.p0(z5 ? this.expandedMarginEnd : this.expandedMarginStart, this.tmpRect.top + this.expandedMarginTop, (i5 - i2) - (z5 ? this.expandedMarginStart : this.expandedMarginEnd), (i6 - i4) - this.expandedMarginBottom);
            this.collapsingTextHelper.d0(z3);
        }
    }

    private void updateTitleFromToolbarIfNeeded() {
        if (this.toolbar != null && this.collapsingTitleEnabled && TextUtils.isEmpty(this.collapsingTextHelper.P())) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (this.collapsingTitleEnabled && this.drawCollapsingTitle) {
            if (this.toolbar != null && this.contentScrim != null && this.scrimAlpha > 0 && isTitleCollapseFadeMode() && this.collapsingTextHelper.G() < this.collapsingTextHelper.H()) {
    ...
    protected void onLayout(boolean z3, int i2, int i4, int i5, int i6) {
        ...
        updateTextBounds(i2, i4, i5, i6, false);
    ...
    protected void onMeasure(int i2, int i4) {
        ...
        if (this.extraMultilineHeightEnabled && this.collapsingTextHelper.M() > 1) {
            updateTitleFromToolbarIfNeeded();
            updateTextBounds(0, 0, getMeasuredWidth(), getMeasuredHeight(), true);
            int z3 = this.collapsingTextHelper.z();
            if (z3 > 1) {
                this.extraMultilineHeight = Math.round(this.collapsingTextHelper.B()) * (z3 - 1);
    ...
    protected void onSizeChanged(int i2, int i4, int i5, int i6) {
        ...
        if (drawable != null) {
            updateContentScrimBounds(drawable, i2, i4);
        }
    }
    ...
    public void setCollapsedTitleGravity(int i2) {
        this.collapsingTextHelper.k0(i2);
    }
    ...
    public void setExpandedTitleGravity(int i2) {
        this.collapsingTextHelper.v0(i2);
    }

    public void setExpandedTitleMargin(int i2, int i4, int i5, int i6) {
    ...
    public void setExpandedTitleTextAppearance(@StyleRes int i2) {
        this.collapsingTextHelper.s0(i2);
    }
    ...
    public void setHyphenationFrequency(int i2) {
        this.collapsingTextHelper.C0(i2);
    }

    @RequiresApi(23)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setLineSpacingAdd(float f4) {
        this.collapsingTextHelper.E0(f4);
    }

    @RequiresApi(23)
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setLineSpacingMultiplier(@FloatRange(from = 0.0d) float f4) {
        this.collapsingTextHelper.F0(f4);
    }
    ...
    public void setRtlTextDirectionHeuristicsEnabled(boolean z3) {
        this.collapsingTextHelper.I0(z3);
    }
    ...
    public void setTitleCollapseMode(int i2) {
        ...
        this.collapsingTextHelper.A0(isTitleCollapseFadeMode);
        ViewParent parent = getParent();
        if (parent instanceof AppBarLayout) {
            disableLiftOnScrollIfNeeded((AppBarLayout) parent);
        }
        if (isTitleCollapseFadeMode && this.contentScrim == null) {
            setContentScrimColor(this.elevationOverlayProvider.g(getResources().getDimension(R.dimen.design_appbar_elevation)));
        }
    }
    ...
    private void updateContentScrimBounds(@NonNull Drawable drawable, @Nullable View view, int i2, int i4) {
