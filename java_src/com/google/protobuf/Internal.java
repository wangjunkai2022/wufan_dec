...
public final class Internal {
    ...
    public interface DoubleList extends ProtobufList<Double> {
        ...
        double setDouble(int i2, double d4);
    }
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        public V put(K k4, V v3) {
            RealValue put = this.realMap.put(k4, this.valueConverter.doBackward(v3));
            if (put == null) {
                return null;
            }
    ...
    public static int partialHash(int i2, byte[] bArr, int i4, int i5) {
    ...
    static int hashCode(byte[] bArr, int i2, int i4) {
        int partialHash = partialHash(i4, bArr, i2, i4);
        if (partialHash == 0) {
            return 1;
        }
        return partialHash;
