...
public interface MessageLite extends MessageLiteOrBuilder {
    ...
    public interface Builder extends MessageLiteOrBuilder, Cloneable {
        ...
        Builder mergeFrom(byte[] bArr, int i2, int i4) throws InvalidProtocolBufferException;

        Builder mergeFrom(byte[] bArr, int i2, int i4, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException;
