...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        /* synthetic */ FieldType(String str, int i2, JavaType javaType, int i4, AnonymousClass1 anonymousClass1) {
            this(str, i2, javaType, i4);
        }
        ...
        private FieldType(String str, int i2, JavaType javaType, int i4) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int makeTag(int i2, int i4) {
        return (i2 << 3) | i4;
    }
