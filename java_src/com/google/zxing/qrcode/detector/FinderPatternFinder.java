...
public class FinderPatternFinder {
    ...
    */
    ...
    public static boolean foundPatternCross(int[] iArr) {
        ...
        return i5 >= 7 && Math.abs(i2 - (iArr[0] << 8)) < (i4 = (i2 = (i5 << 8) / 7) / 2) && Math.abs(i2 - (iArr[1] << 8)) < i4 && Math.abs((i2 * 3) - (iArr[2] << 8)) < i4 * 3 && Math.abs(i2 - (iArr[3] << 8)) < i4 && Math.abs(i2 - (iArr[4] << 8)) < i4;
    }
        ...
        if (size >= 3) {
            ...
            if (size > 3) {
                ...
                while (i2 < this.possibleCenters.size() && this.possibleCenters.size() > 3) {
                    if (Math.abs(this.possibleCenters.get(i2).getEstimatedModuleSize() - f8) > max) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public boolean handlePossibleCenter(int[] iArr, int i2, int i4) {
        boolean z3 = false;
        ...
        if (!Float.isNaN(crossCheckVertical)) {
            float crossCheckHorizontal = crossCheckHorizontal(centerFromEnd, (int) crossCheckVertical, iArr[2], i5);
            if (!Float.isNaN(crossCheckHorizontal)) {
                ...
                while (true) {
                    ...
                    if (finderPattern.aboutEquals(f4, crossCheckVertical, crossCheckHorizontal)) {
                        this.possibleCenters.set(i6, finderPattern.combineEstimate(crossCheckVertical, crossCheckHorizontal, f4));
                        z3 = true;
                        break;
                    }
                    i6++;
