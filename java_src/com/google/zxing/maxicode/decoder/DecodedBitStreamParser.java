...
final class DecodedBitStreamParser {
    ...
    private static int getInt(byte[] bArr, byte[] bArr2) {
        ...
        for (int i4 = 0; i4 < bArr2.length; i4++) {
            i2 += getBit(bArr2[i4], bArr) << ((bArr2.length - i4) - 1);
        }
        return i2;
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    private static String getMessage(byte[] bArr, int i2, int i4) {
        int i5;
        int i6;
        int i7;
        int i8;
        ...
        int i12 = 0;
        while (i9 < i2 + i4) {
            char charAt = SETS[i10].charAt(bArr[i9]);
            switch (charAt) {
                case 65520:
                case 65521:
                case 65522:
                ...
                case 65531:
                    i9 = i9 + 1 + 1 + 1 + 1 + 1;
                    sb.append(NINE_DIGITS.format((bArr[i5] << BinaryMemcacheOpcodes.FLUSHQ) + (bArr[i6] << BinaryMemcacheOpcodes.ADDQ) + (bArr[i7] << 12) + (bArr[i8] << 6) + bArr[i9]));
                    break;
            }
            int i13 = i11 - 1;
            if (i11 == 0) {
