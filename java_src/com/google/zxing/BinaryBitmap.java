...
public final class BinaryBitmap {
    ...
    public BinaryBitmap crop(int i2, int i4, int i5, int i6) {
        return new BinaryBitmap(this.binarizer.createBinarizer(this.binarizer.getLuminanceSource().crop(i2, i4, i5, i6)));
    }
