...
public final class Version {
    ...
    public static final class ECB {
        ...
        private ECB(int i2, int i4) {
            this.count = i2;
            this.dataCodewords = i4;
        }
    }

    private Version(int i2, int i4, int i5, int i6, int i7, ECBlocks eCBlocks) {
        ECB[] eCBlocks2;
    ...
    public static Version getVersionForDimensions(int i2, int i4) throws FormatException {
        if ((i2 & 1) == 0 && (i4 & 1) == 0) {
            int length = VERSIONS.length;
            for (int i5 = 0; i5 < length; i5++) {
                Version version = VERSIONS[i5];
                if (version.symbolSizeRows == i2 && version.symbolSizeColumns == i4) {
                    return version;
                }
            }
