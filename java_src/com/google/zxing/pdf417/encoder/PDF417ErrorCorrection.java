...
final class PDF417ErrorCorrection {
    ...
    public static String generateErrorCorrection(CharSequence charSequence, int i2) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            ...
            int charAt = (charSequence.charAt(i4) + cArr[i5]) % 929;
            while (i5 >= 1) {
                cArr[i5] = (char) ((cArr[i5 - 1] + (929 - ((EC_COEFFICIENTS[i2][i5] * charAt) % 929))) % 929);
                i5--;
            }
            cArr[0] = (char) ((929 - ((charAt * EC_COEFFICIENTS[i2][0]) % 929)) % 929);
        }
        StringBuilder sb = new StringBuilder(errorCorrectionCodewordCount);
        for (int i6 = errorCorrectionCodewordCount - 1; i6 >= 0; i6--) {
            if (cArr[i6] != 0) {
                cArr[i6] = (char) (929 - cArr[i6]);
            }
            sb.append(cArr[i6]);
        }
        return sb.toString();
