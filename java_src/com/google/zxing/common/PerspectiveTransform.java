...
public final class PerspectiveTransform {
    ...
    public static PerspectiveTransform squareToQuadrilateral(float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11) {
        ...
        float f14 = f6 - f8;
        float f15 = f10 - f8;
        float f16 = ((f4 - f6) + f8) - f10;
        float f17 = f7 - f9;
        float f18 = (f14 * f12) - (f15 * f17);
        float f19 = ((f12 * f16) - (f15 * f13)) / f18;
        float f20 = ((f14 * f13) - (f16 * f17)) / f18;
    ...
    public void transformPoints(float[] fArr) {
        ...
        for (int i2 = 0; i2 < length; i2 += 2) {
            ...
            fArr[i2] = (((f4 * f13) + (f7 * f14)) + f10) / f15;
            fArr[i4] = (((f13 * f5) + (f14 * f8)) + f11) / f15;
        }
    }
    ...
    public void transformPoints(float[] fArr, float[] fArr2) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            fArr[i2] = (((this.a11 * f4) + (this.a21 * f5)) + this.a31) / f6;
            fArr2[i2] = (((this.a12 * f4) + (this.a22 * f5)) + this.a32) / f6;
        }
    }
}
