...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i2, int i4, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !"".equals(str.trim())) {
            ...
            DefaultDateTypeAdapter defaultDateTypeAdapter4 = new DefaultDateTypeAdapter(Date.class, i2, i4);
            DefaultDateTypeAdapter defaultDateTypeAdapter5 = new DefaultDateTypeAdapter(Timestamp.class, i2, i4);
            DefaultDateTypeAdapter defaultDateTypeAdapter6 = new DefaultDateTypeAdapter(java.sql.Date.class, i2, i4);
