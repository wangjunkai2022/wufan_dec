...
public class JsonWriter implements Closeable, Flushable {
    ...
    private JsonWriter close(int i2, int i4, char c4) throws IOException {
        int peek = peek();
        if (peek != i4 && peek != i2) {
            throw new IllegalStateException("Nesting problem.");
        }
    ...
    private JsonWriter open(int i2, char c4) throws IOException {
        beforeValue();
        push(i2);
        this.out.write(c4);
        return this;
    ...
    */
    ...
    public JsonWriter value(boolean z3) throws IOException {
        writeDeferredName();
        beforeValue();
        this.out.write(z3 ? "true" : Bugly.SDK_IS_DEV);
        return this;
    }
