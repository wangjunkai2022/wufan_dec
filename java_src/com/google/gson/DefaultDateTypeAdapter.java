...
final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public DefaultDateTypeAdapter(int i2, int i4) {
        this(Date.class, i2, i4);
    }

    public DefaultDateTypeAdapter(Class<? extends Date> cls, int i2, int i4) {
        ArrayList arrayList = new ArrayList();
        this.dateFormats = arrayList;
        this.dateType = verifyDateType(cls);
        Locale locale = Locale.US;
        ...
        if (JavaVersion.isJava9OrLater()) {
            arrayList.add(PreJava9DateFormatProvider.getUSDateTimeFormat(i2, i4));
        }
    }
}
