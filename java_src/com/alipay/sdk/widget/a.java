...
public final class a {
    ...
    /* loaded from: classes2.dex */
    public class AlertDialogC0026a extends AlertDialog {
        /* JADX INFO: Access modifiers changed from: protected */
        public AlertDialogC0026a(Context context) {
            super(context);
        }

        private static int a(Context context, float f4) {
            return (int) (f4 * (context == null ? Resources.getSystem() : context.getResources()).getDisplayMetrics().density);
        }
        ...
        private View c(Context context) {
            ...
            layoutParams2.setMargins(a(a.this.f9862b, 17.0f), a(a.this.f9862b, 10.0f), a(a.this.f9862b, 8.0f), a(a.this.f9862b, 10.0f));
            imageView.setLayoutParams(layoutParams2);
            imageView.setScaleType(ImageView.ScaleType.FIT_CENTER);
            imageView.setImageDrawable(b(context, a.f9860g));
            ...
            textView.setText(TextUtils.isEmpty(a.this.f9863c) ? a.f9857d : a.this.f9863c);
