...
public class JavaxPersistence {
    public static DatabaseFieldConfig createFieldConfig(DatabaseType databaseType, Field field) throws SQLException {
        ...
        if (annotation3 != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Problem accessing fields from the @Column annotation for field " + field, e4);
            }
        } else {
            annotation2 = annotation8;
            annotation = annotation9;
        ...
        if (annotation4 != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Problem accessing fields from the @Basic annotation for field " + field, e5);
            }
        }
        if (annotation5 != null) {
            ...
            if (!Collection.class.isAssignableFrom(field.getType()) && !ForeignCollection.class.isAssignableFrom(field.getType())) {
                ...
                if (annotation11 != null) {
                    try {
                        ...
                        throw SqlExceptionUtil.create("Problem accessing fields from the @JoinColumn annotation for field " + field, e6);
                    }
                }
            } else {
        ...
        if (annotation2 != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Problem accessing fields from the @Enumerated annotation for field " + field, e8);
            }
        }
        if (annotation != null) {
    ...
    public static String getEntityName(Class<?> cls) {
        ...
        try {
            ...
            throw new IllegalStateException("Could not get entity name from class " + cls, e4);
        }
    }
}
