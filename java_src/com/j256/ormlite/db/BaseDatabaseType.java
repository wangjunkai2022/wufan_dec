...
public abstract class BaseDatabaseType implements DatabaseType {
    ...
    protected void appendBigDecimalNumericType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("NUMERIC");
    }

    protected void appendBooleanType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("BOOLEAN");
    }

    protected void appendByteArrayType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("BLOB");
    }

    protected void appendByteType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("TINYINT");
    }

    protected void appendCharType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("CHAR");
    }
    ...
    protected void appendDateType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("TIMESTAMP");
    }
    ...
    protected void appendLongStringType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("TEXT");
    }

    protected void appendLongType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("BIGINT");
    }
    ...
    protected void appendSerializableType(StringBuilder sb, FieldType fieldType, int i2) {
        sb.append("BLOB");
    }
    ...
    public void loadDriver() throws SQLException {
        ...
        if (driverClassName != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Driver class was not found for " + getDatabaseName() + " database.  Missing jar with class " + driverClassName + g0.f27568a, e4);
            }
        }
    }
