...
public class EagerForeignCollection<T, ID> extends BaseForeignCollection<T, ID> implements ForeignCollection<T>, CloseableWrappedIterable<T>, Serializable {
    ...
    public EagerForeignCollection(Dao<T, ID> dao, Object obj, Object obj2, FieldType fieldType, String str, boolean z3) throws SQLException {
        super(dao, obj, obj2, fieldType, str, z3);
        if (obj2 == null) {
    ...
    public int refreshAll() throws SQLException {
        int i2 = 0;
        for (T t3 : this.results) {
            i2 += this.dao.refresh(t3);
        }
        return i2;
    }
    ...
    public boolean remove(Object obj) {
        ...
        try {
            ...
            throw new IllegalStateException("Could not delete data element from dao", e4);
        }
    }
    ...
    public int updateAll() throws SQLException {
        int i2 = 0;
        for (T t3 : this.results) {
            i2 += this.dao.update((Dao<T, ID>) t3);
        }
        return i2;
    }
    ...
    public CloseableIterator<T> iteratorThrow(int i2) {
        return new CloseableIterator<T>() { // from class: com.j256.ormlite.dao.EagerForeignCollection.1
            ...
            public T nextThrow() {
                ...
                this.offset = i4;
                if (i4 >= EagerForeignCollection.this.results.size()) {
                    return null;
                }
                return (T) EagerForeignCollection.this.results.get(this.offset);
            }
