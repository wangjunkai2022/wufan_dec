...
public class FieldType {
                    ...
                    try {
                        ...
                        if (invoke != null) {
                            try {
                                ...
                                throw SqlExceptionUtil.create("Could not cast result of static getSingleton method to DataPersister from class " + persisterClass, e4);
                            }
                        } else {
                            throw new SQLException("Static getSingleton method should not return null on class " + persisterClass);
                        }
                    } catch (InvocationTargetException e5) {
                        throw SqlExceptionUtil.create("Could not run getSingleton method on class " + persisterClass, e5.getTargetException());
                    } catch (Exception e6) {
                        throw SqlExceptionUtil.create("Could not run getSingleton method on class " + persisterClass, e6);
                    }
                } catch (Exception e7) {
                    throw SqlExceptionUtil.create("Could not find getSingleton static method on class " + persisterClass, e7);
                }
            } else {
    ...
    public void assignField(Object obj, Object obj2, boolean z3, ObjectCache objectCache) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Could not call " + this.fieldSetMethod + " on object with '" + obj2 + "' for " + this, e6);
        }
    }
    ...
    public <T> int createWithForeignDao(T t3) throws SQLException {
        return this.foreignDao.create(t3);
    }
    ...
    public <FV> FV extractRawJavaFieldValue(Object obj) throws SQLException {
        ...
        if (method == null) {
            try {
                ...
                throw SqlExceptionUtil.create("Could not get field value for " + this, e4);
            }
        }
        try {
            return (FV) method.invoke(obj, new Object[0]);
        } catch (Exception e5) {
            throw SqlExceptionUtil.create("Could not call " + this.fieldGetMethod + " for " + this, e5);
        }
    }
    ...
    public <T> T resultToJava(DatabaseResults databaseResults, Map<String, Integer> map) throws SQLException {
        ...
        T t3 = (T) this.fieldConverter.resultToJava(this, databaseResults, num.intValue());
        if (this.fieldConfig.isForeign()) {
