...
public class UuidType extends BaseDataType {
    ...
    public Object parseDefaultString(FieldType fieldType, String str) throws SQLException {
        try {
            ...
            throw SqlExceptionUtil.create("Problems with field " + fieldType + " parsing default UUID-string '" + str + "'", e4);
        }
    }
    ...
    public Object sqlArgToJava(FieldType fieldType, Object obj, int i2) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Problems with column " + i2 + " parsing UUID-string '" + str + "'", e4);
        }
    }
