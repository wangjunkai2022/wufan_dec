...
public class DateStringType extends BaseDateType {
    ...
    public Object parseDefaultString(FieldType fieldType, String str) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Problems with field " + fieldType + " parsing default date-string '" + str + "' using '" + convertDateStringConfig + "'", e4);
        }
    }
    ...
    public Object sqlArgToJava(FieldType fieldType, Object obj, int i2) throws SQLException {
        ...
        try {
            ...
            throw SqlExceptionUtil.create("Problems with column " + i2 + " parsing date-string '" + str + "' using '" + convertDateStringConfig + "'", e4);
        }
    }
