...
public class AndroidCompiledStatement implements CompiledStatement {
    ...
    public AndroidCompiledStatement(String str, SQLiteDatabase sQLiteDatabase, StatementBuilder.StatementType statementType, boolean z3) {
        this.sql = str;
    ...
    public void close() throws SQLException {
        ...
        if (cursor != null) {
            try {
                ...
                throw SqlExceptionUtil.create("Problems closing Android cursor", e4);
            }
        }
    ...
    public Cursor getCursor() throws SQLException {
        if (this.cursor == null) {
            ...
            try {
                ...
                throw SqlExceptionUtil.create("Problems executing Android query: " + str, e4);
            }
        }
        return this.cursor;
    }
