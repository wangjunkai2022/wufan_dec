    ...
    private static OrmLiteSqliteOpenHelper constructHelper(Context context, Class<? extends OrmLiteSqliteOpenHelper> cls) {
        try {
            try {
                ...
                throw new IllegalStateException("Could not construct instance of helper class " + cls, e4);
            }
        } catch (Exception e5) {
            throw new IllegalStateException("Could not find public constructor that has a single (Context) argument for helper class " + cls, e5);
        }
    }
    ...
    private static Class<? extends OrmLiteSqliteOpenHelper> lookupHelperClass(Context context, Class<?> cls) {
        ...
        if (identifier != 0) {
            ...
            try {
                ...
                throw new IllegalStateException("Could not create helper instance for class " + string, e4);
            }
        }
