...
public class LocalLog implements Log {
        ...
        if (level == null) {
            ...
            if (property == null) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException("Level '" + property + "' was not found", e4);
                }
            }
        }
        this.level = level;
    ...
    public static void openLogFile(String str) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Log file " + str + " was not found", e4);
        }
    }
        ...
        try {
            if (inputStream != null) {
                try {
                    ...
                    PrintStream printStream2 = System.err;
                    printStream2.println("IO exception reading the log properties file '/ormliteLocalLog.properties': " + e4);
                    try {
                        inputStream.close();
