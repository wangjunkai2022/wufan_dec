...
public class SelectIterator<T, ID> implements CloseableIterator<T> {
    ...
    public boolean hasNext() {
        try {
            ...
            this.last = null;
            closeQuietly();
            throw new IllegalStateException("Errors getting more results of " + this.dataClass, e4);
        }
    }
    ...
    public void remove() {
        try {
            ...
            closeQuietly();
            throw new IllegalStateException("Could not delete " + this.dataClass + " object " + this.last, e4);
        }
    }
