...
public class Where<T, ID> {
    ...
    private Clause pop(String str) {
        ...
        if (i2 != 0) {
            ...
            int i4 = i2 - 1;
            this.clauseStackLevel = i4;
            Clause clause = clauseArr[i4];
            clauseArr[i4] = null;
            return clause;
        }
    ...
    private void push(Clause clause) {
        ...
        if (i2 == this.clauseStack.length) {
            ...
            for (int i4 = 0; i4 < this.clauseStackLevel; i4++) {
                ...
                clauseArr[i4] = clauseArr2[i4];
                clauseArr2[i4] = null;
            }
            this.clauseStack = clauseArr;
        }
        Clause[] clauseArr3 = this.clauseStack;
        int i5 = this.clauseStackLevel;
        this.clauseStackLevel = i5 + 1;
        clauseArr3[i5] = clause;
    }
    ...
    private Where<T, ID> in(boolean z3, String str, Object... objArr) throws SQLException {
        if (objArr.length == 1) {
            if (objArr[0].getClass().isArray()) {
                StringBuilder sb = new StringBuilder();
                sb.append("Object argument to ");
                sb.append(z3 ? "IN" : "notId");
    ...
    private Where<T, ID> in(boolean z3, String str, QueryBuilder<?, ?> queryBuilder) throws SQLException {
        ...
        queryBuilder.enableInnerQuery();
        addClause(new InSubQuery(str, findColumnFieldType(str), new QueryBuilder.InternalQueryBuilderWrapper(queryBuilder), z3));
        return this;
    }
}
