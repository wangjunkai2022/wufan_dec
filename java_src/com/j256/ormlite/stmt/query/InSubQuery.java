...
public class InSubQuery extends BaseComparison {
    ...
    private final boolean f16860in;
    private final QueryBuilder.InternalQueryBuilderWrapper subQueryBuilder;

    public InSubQuery(String str, FieldType fieldType, QueryBuilder.InternalQueryBuilderWrapper internalQueryBuilderWrapper, boolean z3) throws SQLException {
