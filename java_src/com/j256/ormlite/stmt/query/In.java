...
public class In extends BaseComparison {
    ...
    private final boolean f16859in;
    private Iterable<?> objects;

    public In(String str, FieldType fieldType, Iterable<?> iterable, boolean z3) throws SQLException {
    ...
    public In(String str, FieldType fieldType, Object[] objArr, boolean z3) throws SQLException {
        super(str, fieldType, null, true);
