...
public class AppInfo {
    ...
    private static ActivityManager f59357a;
    ...
    public static boolean e(Context context) {
        ...
        if (f59357a == null) {
            f59357a = (ActivityManager) context.getSystemService(TTDownloadField.TT_ACTIVITY);
        }
        try {
            ActivityManager.MemoryInfo memoryInfo = new ActivityManager.MemoryInfo();
            f59357a.getMemoryInfo(memoryInfo);
    ...
    public static String a(int i2) {
        ...
        try {
            ...
            try {
                ...
                int i4 = 0;
                while (i4 < 512 && cArr[i4] != 0) {
                    i4++;
                }
                String substring = new String(cArr).substring(0, i4);
                try {
                    fileReader.close();
