...
public final class q extends SQLiteOpenHelper {
    ...
    public static String f59793a = "bugly_db";

    /* renamed from: b  reason: collision with root package name */
    private static int f59794b = 15;

    /* renamed from: c  reason: collision with root package name */
    private Context f59795c;

    /* renamed from: d  reason: collision with root package name */
    private List<com.tencent.bugly.a> f59796d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public q(Context context, List<com.tencent.bugly.a> list) {
        super(context, f59793a + "_", (SQLiteDatabase.CursorFactory) null, f59794b);
    ...
    public final synchronized void onCreate(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            x.c(sb.toString(), new Object[0]);
            sQLiteDatabase.execSQL(sb.toString(), new String[0]);
            List<com.tencent.bugly.a> list = this.f59796d;
            if (list == null) {
                return;
            }
    ...
    @Override // android.database.sqlite.SQLiteOpenHelper
    @TargetApi(11)
    public final synchronized void onDowngrade(SQLiteDatabase sQLiteDatabase, int i2, int i4) {
        if (com.tencent.bugly.crashreport.common.info.b.c() >= 11) {
            x.d("[Database] Downgrade %d to %d drop tables.", Integer.valueOf(i2), Integer.valueOf(i4));
            List<com.tencent.bugly.a> list = this.f59796d;
            if (list != null) {
                for (com.tencent.bugly.a aVar : list) {
                    aVar.onDbDowngrade(sQLiteDatabase, i2, i4);
                }
            }
            if (a(sQLiteDatabase)) {
            ...
            File databasePath = this.f59795c.getDatabasePath(f59793a);
    ...
    @Override // android.database.sqlite.SQLiteOpenHelper
    public final synchronized void onUpgrade(SQLiteDatabase sQLiteDatabase, int i2, int i4) {
        x.d("[Database] Upgrade %d to %d , drop tables!", Integer.valueOf(i2), Integer.valueOf(i4));
        List<com.tencent.bugly.a> list = this.f59796d;
        if (list != null) {
            for (com.tencent.bugly.a aVar : list) {
                aVar.onDbUpgrade(sQLiteDatabase, i2, i4);
            }
        }
        if (a(sQLiteDatabase)) {
            onCreate(sQLiteDatabase);
