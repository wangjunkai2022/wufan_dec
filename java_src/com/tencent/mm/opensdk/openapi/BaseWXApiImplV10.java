...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z3, int i2) {
        this.checkSignature = false;
        this.launchMode = 2;
        Log.d(TAG, "<init>, appId = " + str + ", checkSignature = " + z3 + ", launchMode = " + i2);
        this.context = context;
        this.appId = str;
        this.checkSignature = z3;
        this.launchMode = i2;
        b.f59911a = context.getApplicationContext();
    }
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        try {
            ...
            Log.e(TAG, "handleWxInternalRespType fail, ex = " + e4.getMessage());
        }
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            Log.e(TAG, "launchWXUsingPendingIntent pendingIntent send failed: " + e4.getMessage());
            openWXApp();
        }
    }
        ...
        if (wxappPayEntryClassname == null) {
            ...
            if (wxappPayEntryClassname == null) {
                try {
                    ...
                    Log.e(TAG, "get from metaData failed : " + e4.getMessage());
                }
            }
            if (wxappPayEntryClassname == null) {
    ...
    public int getWXAppSupportAPI() {
        ...
        b.f59915e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
            ...
            public void run() {
                try {
                    ...
                    Log.w(BaseWXApiImplV10.TAG, e4.getMessage());
                }
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            ...
            Log.e(TAG, "handleIntent fail, ex = " + e4.getMessage());
        }
                    ...
                    case 4:
                        ...
                        if (str != null && str.contains("openbusinesswebview")) {
                            try {
                                ...
                                Log.e(TAG, "parse fail, ex = " + e5.getMessage());
                            }
                        }
    ...
    public boolean registerApp(String str, long j4) {
        ...
        c0344a.f59872a = "com.tencent.mm";
        c0344a.f59873b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0344a.f59874c = "weixin://registerapp?appid=" + this.appId;
        c0344a.f59875d = j4;
        return a.a(this.context, c0344a);
    }
        ...
        if (WXApiImplComm.validateAppSignatureForPackage(this.context, "com.tencent.mm", this.checkSignature)) {
            ...
            if (baseReq.checkArgs()) {
                ...
                try {
                    ...
                    Log.e(TAG, "getTokenFromWX fail, exception = " + e4);
                }
    ...
    public void unregisterApp() {
        ...
        a.C0344a c0344a = new a.C0344a();
        c0344a.f59872a = "com.tencent.mm";
        c0344a.f59873b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0344a.f59874c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0344a);
    }
}
