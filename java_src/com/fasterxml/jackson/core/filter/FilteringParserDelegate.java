...
public class FilteringParserDelegate extends JsonParserDelegate {
    ...
    @Deprecated
    public FilteringParserDelegate(JsonParser jsonParser, TokenFilter tokenFilter, boolean z3, boolean z4) {
        this(jsonParser, tokenFilter, z3 ? TokenFilter.Inclusion.INCLUDE_ALL_AND_PATH : TokenFilter.Inclusion.ONLY_INCLUDE_ALL, z4);
    }
    ...
    public FilteringParserDelegate(JsonParser jsonParser, TokenFilter tokenFilter, TokenFilter.Inclusion inclusion, boolean z3) {
        super(jsonParser);
    ...
    public boolean getValueAsBoolean(boolean z3) throws IOException {
        return this.delegate.getValueAsBoolean(z3);
    }

    @Override // com.fasterxml.jackson.core.util.JsonParserDelegate, com.fasterxml.jackson.core.JsonParser
    public double getValueAsDouble(double d4) throws IOException {
        return this.delegate.getValueAsDouble(d4);
    }
