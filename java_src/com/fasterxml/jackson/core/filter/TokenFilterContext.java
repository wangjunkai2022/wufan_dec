...
public class TokenFilterContext extends JsonStreamContext {
    ...
    protected TokenFilterContext(int i2, TokenFilterContext tokenFilterContext, TokenFilter tokenFilter, boolean z3) {
        this._type = i2;
        this._parent = tokenFilterContext;
        this._filter = tokenFilter;
        this._index = -1;
        this._startHandled = z3;
    ...
    public TokenFilter checkValue(TokenFilter tokenFilter) {
        ...
        this._index = i4;
        if (i2 == 1) {
            return tokenFilter.includeElement(i4);
        }
        return tokenFilter.includeRootValue(i4);
    }
    ...
    public TokenFilterContext createChildArrayContext(TokenFilter tokenFilter, boolean z3) {
        ...
        return tokenFilterContext.reset(1, tokenFilter, z3);
    }

    public TokenFilterContext createChildObjectContext(TokenFilter tokenFilter, boolean z3) {
        TokenFilterContext tokenFilterContext = this._child;
        if (tokenFilterContext == null) {
        ...
        return tokenFilterContext.reset(2, tokenFilter, z3);
    }
    ...
    protected TokenFilterContext reset(int i2, TokenFilter tokenFilter, boolean z3) {
        this._type = i2;
        this._filter = tokenFilter;
        this._index = -1;
