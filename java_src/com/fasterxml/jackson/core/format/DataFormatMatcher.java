...
public class DataFormatMatcher {
    ...
    public DataFormatMatcher(InputStream inputStream, byte[] bArr, int i2, int i4, JsonFactory jsonFactory, MatchStrength matchStrength) {
        ...
        if ((i2 | i4) < 0 || i2 + i4 > bArr.length) {
            throw new IllegalArgumentException(String.format("Illegal start/length (%d/%d) wrt input array of %d bytes", Integer.valueOf(i2), Integer.valueOf(i4), Integer.valueOf(bArr.length)));
        }
    }
