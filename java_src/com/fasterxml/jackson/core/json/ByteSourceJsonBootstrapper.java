...
public final class ByteSourceJsonBootstrapper {
    ...
    public JsonParser constructParser(int i2, ObjectCodec objectCodec, ByteQuadsCanonicalizer byteQuadsCanonicalizer, CharsToNameCanonicalizer charsToNameCanonicalizer, int i4) throws IOException {
        int i5 = this._inputPtr;
        JsonEncoding detectEncoding = detectEncoding();
        int i6 = this._inputPtr - i5;
        if (detectEncoding == JsonEncoding.UTF8 && JsonFactory.Feature.CANONICALIZE_FIELD_NAMES.enabledIn(i4)) {
            return new UTF8StreamJsonParser(this._context, i2, this._in, objectCodec, byteQuadsCanonicalizer.makeChild(i4), this._inputBuffer, this._inputPtr, this._inputEnd, i6, this._bufferRecyclable);
        }
        return new ReaderBasedJsonParser(this._context, i2, constructReader(), objectCodec, charsToNameCanonicalizer.makeChild(i4));
    }
    ...
    */
    ...
    private static int skipSpace(InputAccessor inputAccessor, byte b4) throws IOException {
        while (true) {
            int i2 = b4 & 255;
    ...
    public ByteSourceJsonBootstrapper(IOContext iOContext, byte[] bArr, int i2, int i4) {
        this._bigEndian = true;
        this._context = iOContext;
        this._in = null;
        this._inputBuffer = bArr;
        this._inputPtr = i2;
        this._inputEnd = i2 + i4;
