...
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    protected final void _verifyOffsets(int i2, int i4, int i5) {
        if (i4 < 0 || i4 + i5 > i2) {
            throw new IllegalArgumentException(String.format("invalid argument(s) (offset=%d, length=%d) for input array of %d element", Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i2)));
        }
    }
    ...
    public JsonGenerator overrideStdFeatures(int i2, int i4) {
        return setFeatureMask((i2 & i4) | (getFeatureMask() & (i4 ^ (-1))));
    }
    ...
    public void writeArray(int[] iArr, int i2, int i4) throws IOException {
        if (iArr != null) {
            _verifyOffsets(iArr.length, i2, i4);
    ...
    public abstract void writeBinary(Base64Variant base64Variant, byte[] bArr, int i2, int i4) throws IOException;

    public void writeBinary(byte[] bArr, int i2, int i4) throws IOException {
        writeBinary(Base64Variants.getDefaultVariant(), bArr, i2, i4);
    }
    ...
    public abstract void writeRaw(String str, int i2, int i4) throws IOException;

    public abstract void writeRaw(char[] cArr, int i2, int i4) throws IOException;

    public abstract void writeRawUTF8String(byte[] bArr, int i2, int i4) throws IOException;
    ...
    public abstract void writeRawValue(String str, int i2, int i4) throws IOException;

    public abstract void writeRawValue(char[] cArr, int i2, int i4) throws IOException;
    ...
    public abstract void writeString(char[] cArr, int i2, int i4) throws IOException;
    ...
    public abstract void writeUTF8String(byte[] bArr, int i2, int i4) throws IOException;
    ...
    public void writeNumber(char[] cArr, int i2, int i4) throws IOException {
        writeNumber(new String(cArr, i2, i4));
    }
    ...
    public void writeArray(long[] jArr, int i2, int i4) throws IOException {
        if (jArr != null) {
            _verifyOffsets(jArr.length, i2, i4);
    ...
    public void writeArray(double[] dArr, int i2, int i4) throws IOException {
        if (dArr != null) {
            _verifyOffsets(dArr.length, i2, i4);
    ...
    public void writeArray(String[] strArr, int i2, int i4) throws IOException {
        if (strArr != null) {
            _verifyOffsets(strArr.length, i2, i4);
