...
public final class SegmentedStringWriter extends Writer {
    ...
    public void write(char[] cArr, int i2, int i4) {
        this._buffer.append(cArr, i2, i4);
    }
    ...
    @Override // java.io.Writer
    public void write(String str, int i2, int i4) {
        this._buffer.append(str, i2, i4);
    }

    @Override // java.io.Writer, java.lang.Appendable
    public Writer append(CharSequence charSequence, int i2, int i4) {
