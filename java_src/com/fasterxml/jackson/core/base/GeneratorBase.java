...
public abstract class GeneratorBase extends JsonGenerator {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void _checkStdFeatureChanges(int i2, int i4) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final int _decodeSurrogate(int i2, int i4) throws IOException {
        if (i4 < 56320 || i4 > 57343) {
            _reportError("Incomplete surrogate pair: first char 0x" + Integer.toHexString(i2) + ", second 0x" + Integer.toHexString(i4));
        }
        return ((i2 - SURR1_FIRST) << 10) + 65536 + (i4 - 56320);
    }
    ...
    protected GeneratorBase(int i2, ObjectCodec objectCodec, JsonWriteContext jsonWriteContext) {
        this._features = i2;
        this._objectCodec = objectCodec;
