...
public class ObjectWriter implements Versioned, Serializable {
    ...
    private final void _writeCloseable(JsonGenerator jsonGenerator, Object obj) throws IOException {
        ...
        try {
            ...
            e4 = e6;
            ClassUtil.closeOnFailAndThrowAsIOE(jsonGenerator, closeable, e4);
        }
    }
    ...
    protected SequenceWriter _newSequenceWriter(boolean z3, JsonGenerator jsonGenerator, boolean z4) throws IOException {
        return new SequenceWriter(_serializerProvider(), _configureGenerator(jsonGenerator), z4, this._prefetch).init(z3);
    }
