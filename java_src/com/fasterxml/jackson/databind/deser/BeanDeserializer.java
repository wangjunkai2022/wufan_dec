...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable {
    ...
    public BeanDeserializer(BeanDeserializerBuilder beanDeserializerBuilder, BeanDescription beanDescription, BeanPropertyMap beanPropertyMap, Map<String, SettableBeanProperty> map, HashSet<String> hashSet, boolean z3, boolean z4) {
        super(beanDeserializerBuilder, beanDescription, beanPropertyMap, map, hashSet, z3, null, z4);
    }
                ...
                if (findCreatorProperty != null) {
                    ...
                    if (find != null) {
                        try {
                            ...
                            BeanReferring handleUnresolvedReference = handleUnresolvedReference(deserializationContext, find, startBuilding, e5);
                            if (arrayList == null) {
