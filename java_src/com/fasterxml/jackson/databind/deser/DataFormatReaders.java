...
public class DataFormatReaders {
    ...
    public static class AccessorForReader extends InputAccessor.Std {
        ...
        public AccessorForReader(byte[] bArr, int i2, int i4) {
            super(bArr, i2, i4);
        }
    }
    ...
    public static class Match {
        ...
        protected Match(InputStream inputStream, byte[] bArr, int i2, int i4, ObjectReader objectReader, MatchStrength matchStrength) {
    ...
    public Match findFormat(byte[] bArr, int i2, int i4) throws IOException {
        return _findFormat(new AccessorForReader(bArr, i2, i4));
    }
}
