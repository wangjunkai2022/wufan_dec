...
public abstract class ValueInstantiator {
    ...
    public static class Delegating extends ValueInstantiator implements Serializable {
        ...
        public Object createFromDouble(DeserializationContext deserializationContext, double d4) throws IOException {
            return delegate().createFromDouble(deserializationContext, d4);
        }
    ...
    public Object createFromBoolean(DeserializationContext deserializationContext, boolean z3) throws IOException {
        return deserializationContext.handleMissingInstantiator(getValueClass(), this, null, "no boolean/Boolean-argument constructor/factory method to deserialize from boolean value (%s)", Boolean.valueOf(z3));
    }
    ...
    public Object createFromInt(DeserializationContext deserializationContext, int i2) throws IOException {
        return deserializationContext.handleMissingInstantiator(getValueClass(), this, null, "no int/Int-argument constructor/factory method to deserialize from Number value (%s)", Integer.valueOf(i2));
    }
