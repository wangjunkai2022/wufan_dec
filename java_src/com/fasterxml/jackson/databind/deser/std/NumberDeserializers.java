...
public class NumberDeserializers {
    ...
    public static class FloatDeserializer extends PrimitiveOrWrapperDeserializer<Float> {
        ...
        public FloatDeserializer(Class<Float> cls, Float f4) {
    ...
    public static abstract class PrimitiveOrWrapperDeserializer<T> extends StdScalarDeserializer<T> {
        ...
        protected PrimitiveOrWrapperDeserializer(Class<T> cls, LogicalType logicalType, T t3, T t4) {
            super((Class<?>) cls);
        ...
        @Deprecated
        protected PrimitiveOrWrapperDeserializer(Class<T> cls, T t3, T t4) {
            this(cls, LogicalType.OtherScalar, t3, t4);
        }
    }
}
