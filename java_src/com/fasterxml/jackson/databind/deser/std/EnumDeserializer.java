...
public class EnumDeserializer extends StdScalarDeserializer<Object> implements ContextualDeserializer {
    ...
    private final Object _deserializeAltString(JsonParser jsonParser, DeserializationContext deserializationContext, CompactStringObjectMap compactStringObjectMap, String str) throws IOException {
        ...
        if (trim.isEmpty()) {
            ...
            int i2 = AnonymousClass1.$SwitchMap$com$fasterxml$jackson$databind$cfg$CoercionAction[_checkCoercionFail.ordinal()];
            if (i2 == 2 || i2 == 3) {
    ...
    protected Object _fromInteger(JsonParser jsonParser, DeserializationContext deserializationContext, int i2) throws IOException {
        ...
        if (findCoercionAction == CoercionAction.Fail) {
            ...
            _checkCoercionFail(deserializationContext, findCoercionAction, handledType, valueOf, "Integer value (" + i2 + ")");
        }
        ...
        if (i4 != 1) {
            if (i4 != 2) {
                ...
                return deserializationContext.handleWeirdNumberValue(_enumClass(), Integer.valueOf(i2), "index value outside legal index range [0..%s]", Integer.valueOf(this._enumsByIndex.length - 1));
            }
            return getEmptyValue(deserializationContext);
        }
        return null;
