...
public abstract class PrimitiveArrayDeserializers<T> extends StdDeserializer<T> implements ContextualDeserializer {
                ...
                try {
                    ...
                    if (nextToken != JsonToken.END_ARRAY) {
                        try {
                            ...
                            e = e4;
                            i4 = i2;
                            throw JsonMappingException.wrapWithPath(e, resetAndStart, booleanBuilder.bufferedSize() + i4);
                        }
                        if (i4 >= resetAndStart.length) {
                            resetAndStart = booleanBuilder.appendCompletedChunk(resetAndStart, i4);
                            i4 = 0;
                        }
                        i2 = i4 + 1;
                    } else {
                        return booleanBuilder.completeAndClearBuffer(resetAndStart, i4);
                    }
                } catch (Exception e5) {
                    e = e5;
                }
                ...
                try {
                    ...
                    if (nextToken != JsonToken.END_ARRAY) {
                        try {
                            ...
                            resetAndStart[i4] = byteValue;
                            i4 = i2;
                        } catch (Exception e5) {
                            e = e5;
                            i4 = i2;
                            throw JsonMappingException.wrapWithPath(e, resetAndStart, byteBuilder.bufferedSize() + i4);
                        }
                        if (i4 >= resetAndStart.length) {
                            resetAndStart = byteBuilder.appendCompletedChunk(resetAndStart, i4);
                            i4 = 0;
                        }
                        i2 = i4 + 1;
                    } else {
                        return byteBuilder.completeAndClearBuffer(resetAndStart, i4);
                    }
                } catch (Exception e6) {
                    e = e6;
                }
                    ...
                    if (nextToken != JsonToken.END_ARRAY) {
                        if (nextToken == JsonToken.VALUE_NULL && (nullValueProvider = this._nuller) != null) {
                            ...
                            try {
                                ...
                                e = e4;
                                i2 = i4;
                                throw JsonMappingException.wrapWithPath(e, resetAndStart, doubleBuilder.bufferedSize() + i2);
                            }
                        }
                    } else {
                ...
                try {
                    ...
                    if (nextToken != JsonToken.END_ARRAY) {
                        try {
                            ...
                            resetAndStart[i4] = intValue;
                            i4 = i2;
                        } catch (Exception e4) {
                            e = e4;
                            i4 = i2;
                            throw JsonMappingException.wrapWithPath(e, resetAndStart, intBuilder.bufferedSize() + i4);
                        }
                        if (i4 >= resetAndStart.length) {
                            resetAndStart = intBuilder.appendCompletedChunk(resetAndStart, i4);
                            i4 = 0;
                        }
                        i2 = i4 + 1;
                    } else {
                        return intBuilder.completeAndClearBuffer(resetAndStart, i4);
                    }
                } catch (Exception e5) {
                    e = e5;
                }
                ...
                try {
                    ...
                    if (nextToken != JsonToken.END_ARRAY) {
                        try {
                            ...
                            resetAndStart[i4] = longValue;
                            i4 = i2;
                        } catch (Exception e4) {
                            e = e4;
                            i4 = i2;
                            throw JsonMappingException.wrapWithPath(e, resetAndStart, longBuilder.bufferedSize() + i4);
                        }
                        if (i4 >= resetAndStart.length) {
                            resetAndStart = longBuilder.appendCompletedChunk(resetAndStart, i4);
                            i4 = 0;
                        }
                        i2 = i4 + 1;
                    } else {
                        return longBuilder.completeAndClearBuffer(resetAndStart, i4);
                    }
                } catch (Exception e5) {
                    e = e5;
                }
                ...
                try {
                    ...
                    if (nextToken != JsonToken.END_ARRAY) {
                        try {
                            ...
                            resetAndStart[i4] = _parseShortPrimitive;
                            i4 = i2;
                        } catch (Exception e4) {
                            e = e4;
                            i4 = i2;
                            throw JsonMappingException.wrapWithPath(e, resetAndStart, shortBuilder.bufferedSize() + i4);
                        }
                        if (i4 >= resetAndStart.length) {
                            resetAndStart = shortBuilder.appendCompletedChunk(resetAndStart, i4);
                            i4 = 0;
                        }
                        i2 = i4 + 1;
                    } else {
                        return shortBuilder.completeAndClearBuffer(resetAndStart, i4);
                    }
                } catch (Exception e5) {
                    e = e5;
                }
    ...
    protected abstract T _concat(T t3, T t4);
