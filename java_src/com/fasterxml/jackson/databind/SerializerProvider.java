...
public abstract class SerializerProvider extends DatabindContext {
    ...
    protected JsonSerializer<Object> _createAndCacheUntypedSerializer(Class<?> cls) throws JsonMappingException {
        ...
        try {
            ...
            reportMappingProblem(e4, ClassUtil.exceptionMessage(e4), new Object[0]);
            jsonSerializer = null;
        }
    ...
    public JsonSerializer<Object> findTypedValueSerializer(Class<?> cls, boolean z3, BeanProperty beanProperty) throws JsonMappingException {
    ...
    public JsonSerializer<Object> findTypedValueSerializer(JavaType javaType, boolean z3, BeanProperty beanProperty) throws JsonMappingException {
