...
public abstract class MapperBuilder<M extends ObjectMapper, B extends MapperBuilder<M, B>> {
    ...
    public B configure(MapperFeature mapperFeature, boolean z3) {
        this._mapper.configure(mapperFeature, z3);
        return _this();
    }
    ...
    public B configure(SerializationFeature serializationFeature, boolean z3) {
        this._mapper.configure(serializationFeature, z3);
        return _this();
    }
    ...
    public B configure(DeserializationFeature deserializationFeature, boolean z3) {
        this._mapper.configure(deserializationFeature, z3);
        return _this();
    }
    ...
    public B configure(JsonParser.Feature feature, boolean z3) {
        this._mapper.configure(feature, z3);
        return _this();
    }

    public B configure(JsonGenerator.Feature feature, boolean z3) {
        this._mapper.configure(feature, z3);
        return _this();
    }
    ...
    public B configure(StreamReadFeature streamReadFeature, boolean z3) {
        this._mapper.configure(streamReadFeature.mappedFeature(), z3);
        return _this();
    }
    ...
    public B configure(StreamWriteFeature streamWriteFeature, boolean z3) {
        this._mapper.configure(streamWriteFeature.mappedFeature(), z3);
        return _this();
    }
