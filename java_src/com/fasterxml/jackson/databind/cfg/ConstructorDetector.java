...
public final class ConstructorDetector implements Serializable {
    ...
    protected ConstructorDetector(SingleArgConstructor singleArgConstructor, boolean z3, boolean z4) {
        ...
        this._requireCtorAnnotation = z3;
        this._allowJDKTypeCtors = z4;
    }
    ...
    public ConstructorDetector withAllowJDKTypeConstructors(boolean z3) {
        return new ConstructorDetector(this._singleArgMode, this._requireCtorAnnotation, z3);
    }

    public ConstructorDetector withRequireAnnotation(boolean z3) {
        return new ConstructorDetector(this._singleArgMode, z3, this._allowJDKTypeCtors);
    }
