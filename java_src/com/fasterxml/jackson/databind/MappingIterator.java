...
public class MappingIterator<T> implements Iterator<T>, Closeable {
    ...
    public MappingIterator(JavaType javaType, JsonParser jsonParser, DeserializationContext deserializationContext, JsonDeserializer<?> jsonDeserializer, boolean z3, Object obj) {
        ...
        if (z3 && jsonParser.isExpectedStartArrayToken()) {
    ...
    public boolean hasNext() {
        try {
            ...
            return ((Boolean) _handleMappingException(e4)).booleanValue();
        } catch (IOException e5) {
            return ((Boolean) _handleIOException(e5)).booleanValue();
        }
    }
    ...
    public T next() {
        try {
            ...
            return (T) _handleMappingException(e4);
        } catch (IOException e5) {
            return (T) _handleIOException(e5);
        }
    }
    ...
    public T nextValue() throws IOException {
        ...
        if (i2 != 0) {
            ...
            try {
                T t4 = this._updatedValue;
                if (t4 == null) {
                    t3 = this._deserializer.deserialize(this._parser, this._context);
                } else {
                    this._deserializer.deserialize(this._parser, this._context, t4);
                    t3 = this._updatedValue;
                }
                this._state = 2;
