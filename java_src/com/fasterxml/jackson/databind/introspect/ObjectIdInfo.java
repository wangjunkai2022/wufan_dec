...
public class ObjectIdInfo {
    ...
    public ObjectIdInfo withAlwaysAsId(boolean z3) {
        return this._alwaysAsId == z3 ? this : new ObjectIdInfo(this._propertyName, this._scope, this._generator, z3, this._resolver);
    }

    protected ObjectIdInfo(PropertyName propertyName, Class<?> cls, Class<? extends ObjectIdGenerator<?>> cls2, boolean z3) {
        this(propertyName, cls, cls2, z3, SimpleObjectIdResolver.class);
    }
