...
public class AnnotatedClassResolver {
    ...
    private static void _addSuperInterfaces(JavaType javaType, List<JavaType> list, boolean z3) {
        Class<?> rawClass = javaType.getRawClass();
        if (z3) {
    ...
    private static void _addSuperTypes(JavaType javaType, List<JavaType> list, boolean z3) {
        Class<?> rawClass = javaType.getRawClass();
    ...
    private Annotations resolveClassAnnotations(List<JavaType> list) {
        ...
        boolean z3 = mixInResolver != null && (!(mixInResolver instanceof SimpleMixInResolver) || ((SimpleMixInResolver) mixInResolver).hasMixIns());
        if (!z3 && !this._collectAnnotations) {
            return NO_ANNOTATIONS;
        }
