...
public class AnnotatedMethodCollector extends CollectorBase {
    ...
    AnnotatedMethodCollector(AnnotationIntrospector annotationIntrospector, ClassIntrospector.MixInResolver mixInResolver, boolean z3) {
    ...
    public static AnnotatedMethodMap collectMethods(AnnotationIntrospector annotationIntrospector, TypeResolutionContext typeResolutionContext, ClassIntrospector.MixInResolver mixInResolver, TypeFactory typeFactory, JavaType javaType, List<JavaType> list, Class<?> cls, boolean z3) {
        return new AnnotatedMethodCollector(annotationIntrospector, mixInResolver, z3).collect(typeFactory, typeResolutionContext, javaType, list, cls);
    }
    ...
    AnnotatedMethodMap collect(TypeFactory typeFactory, TypeResolutionContext typeResolutionContext, JavaType javaType, List<JavaType> list, Class<?> cls) {
        ...
        if (z3 && this._intr != null && !linkedHashMap.isEmpty()) {
