...
public class TypeFactory implements Serializable {
    ...
    private TypeBindings _bindingsForSubtype(JavaType javaType, int i2, Class<?> cls, boolean z3) {
        ...
        if (findSuperType != null) {
            ...
            if (_resolveTypePlaceholders != null && !z3) {
    ...
    protected Class<?> classForName(String str, boolean z3, ClassLoader classLoader) throws ClassNotFoundException {
    ...
    public JavaType constructSpecializedType(JavaType javaType, Class<?> cls, boolean z3) throws IllegalArgumentException {
        JavaType _fromClass;
        Class<?> rawClass = javaType.getRawClass();
        if (rawClass == cls) {
            return javaType;
        ...
        if (rawClass == Object.class) {
            ...
            if (javaType.getBindings().isEmpty()) {
                ...
                if (length == 0) {
                    ...
                    _fromClass = _fromClass(null, cls, _bindingsForSubtype(javaType, length, cls, z3));
                }
            }
        } else {
