...
public class SequenceWriter implements Versioned, Closeable, Flushable {
    ...
    public SequenceWriter(DefaultSerializerProvider defaultSerializerProvider, JsonGenerator jsonGenerator, boolean z3, ObjectWriter.Prefetch prefetch) throws IOException {
        this._provider = defaultSerializerProvider;
        this._generator = jsonGenerator;
        this._closeGenerator = z3;
    ...
    public SequenceWriter init(boolean z3) throws IOException {
        if (z3) {
    ...
    public <C extends Collection<?>> SequenceWriter writeAll(C c4) throws IOException {
        for (Object obj : c4) {
            write(obj);
        }
        return this;
