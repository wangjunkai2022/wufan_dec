...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
    ...
    public AsPropertyTypeDeserializer(JavaType javaType, TypeIdResolver typeIdResolver, String str, boolean z3, JavaType javaType2) {
        this(javaType, typeIdResolver, str, z3, javaType2, JsonTypeInfo.As.PROPERTY);
    }
