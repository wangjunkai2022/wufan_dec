...
public class StdTypeResolverBuilder implements TypeResolverBuilder<StdTypeResolverBuilder> {
    ...
    protected TypeIdResolver idResolver(MapperConfig<?> mapperConfig, JavaType javaType, PolymorphicTypeValidator polymorphicTypeValidator, Collection<NamedType> collection, boolean z3, boolean z4) {
        ...
        if (id != null) {
            ...
            if (i2 != 3) {
                ...
                return TypeNameIdResolver.construct(mapperConfig, javaType, collection, z3, z4);
            }
    ...
    @Override // com.fasterxml.jackson.databind.jsontype.TypeResolverBuilder
    public StdTypeResolverBuilder typeIdVisibility(boolean z3) {
        this._typeIdVisible = z3;
        return this;
    }
