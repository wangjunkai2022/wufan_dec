...
public class IteratorSerializer extends AsArraySerializerBase<Iterator<?>> {
    public IteratorSerializer(JavaType javaType, boolean z3, TypeSerializer typeSerializer) {
        super(Iterator.class, javaType, z3, typeSerializer, (JsonSerializer<Object>) null);
    }
