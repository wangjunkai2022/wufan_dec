...
public class MapSerializer extends ContainerSerializer<Map<?, ?>> implements ContextualSerializer {
    ...
    protected MapSerializer(Set<String> set, Set<String> set2, JavaType javaType, JavaType javaType2, boolean z3, TypeSerializer typeSerializer, JsonSerializer<?> jsonSerializer, JsonSerializer<?> jsonSerializer2) {
    ...
    public static MapSerializer construct(Set<String> set, Set<String> set2, JavaType javaType, boolean z3, TypeSerializer typeSerializer, JsonSerializer<Object> jsonSerializer, JsonSerializer<Object> jsonSerializer2, Object obj) {
        ...
        if (!z3) {
            ...
            z4 = javaType2.getRawClass() == Object.class ? false : z3;
        }
        MapSerializer mapSerializer = new MapSerializer(set, set2, javaType3, javaType2, z4, typeSerializer, jsonSerializer, jsonSerializer2);
    ...
    protected void _writeNullKeyedEntry(JsonGenerator jsonGenerator, SerializerProvider serializerProvider, Object obj) throws IOException {
        ...
        try {
            ...
            wrapAndThrow(serializerProvider, e4, obj, "");
        }
    }
    ...
    */
            ...
            if (checker == null || !checker.shouldIgnore(key)) {
                ...
                if (value == null) {
                    ...
                    try {
                        ...
                        wrapAndThrow(serializerProvider, e4, map, String.valueOf(key));
                    }
                } else {
    ...
    public void serializeFilteredAnyProperties(SerializerProvider serializerProvider, JsonGenerator jsonGenerator, Object obj, Map<?, ?> map, PropertyFilter propertyFilter, Object obj2) throws IOException {
        ...
        boolean z3 = MARKER_FOR_EMPTY == obj2;
        for (Map.Entry<?, ?> entry : map.entrySet()) {
            Object key = entry.getKey();
            IgnorePropertiesUtil.Checker checker = this._inclusionChecker;
            if (checker == null || !checker.shouldIgnore(key)) {
    ...
    */
    ...
    public MapSerializer withResolved(BeanProperty beanProperty, JsonSerializer<?> jsonSerializer, JsonSerializer<?> jsonSerializer2, Set<String> set, Set<String> set2, boolean z3) {
    ...
    public MapSerializer withResolved(BeanProperty beanProperty, JsonSerializer<?> jsonSerializer, JsonSerializer<?> jsonSerializer2, Set<String> set, boolean z3) {
        return withResolved(beanProperty, jsonSerializer, jsonSerializer2, set, null, z3);
    }

    public static MapSerializer construct(Set<String> set, JavaType javaType, boolean z3, TypeSerializer typeSerializer, JsonSerializer<Object> jsonSerializer, JsonSerializer<Object> jsonSerializer2, Object obj) {
        return construct(set, null, javaType, z3, typeSerializer, jsonSerializer, jsonSerializer2, obj);
    }

    @Deprecated
    public static MapSerializer construct(String[] strArr, JavaType javaType, boolean z3, TypeSerializer typeSerializer, JsonSerializer<Object> jsonSerializer, JsonSerializer<Object> jsonSerializer2, Object obj) {
        return construct(ArrayBuilders.arrayToSet(strArr), javaType, z3, typeSerializer, jsonSerializer, jsonSerializer2, obj);
    }

    @Deprecated
    protected MapSerializer(Set<String> set, JavaType javaType, JavaType javaType2, boolean z3, TypeSerializer typeSerializer, JsonSerializer<?> jsonSerializer, JsonSerializer<?> jsonSerializer2) {
        this(set, null, javaType, javaType2, z3, typeSerializer, jsonSerializer, jsonSerializer2);
    }
    ...
    protected MapSerializer(MapSerializer mapSerializer, TypeSerializer typeSerializer, Object obj, boolean z3) {
        super(Map.class, false);
    ...
    protected MapSerializer(MapSerializer mapSerializer, Object obj, boolean z3) {
        super(Map.class, false);
        this._ignoredEntries = mapSerializer._ignoredEntries;
        this._includedEntries = mapSerializer._includedEntries;
        this._keyType = mapSerializer._keyType;
