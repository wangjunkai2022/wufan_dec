...
public abstract class ArraySerializerBase<T> extends ContainerSerializer<T> implements ContextualSerializer {
    ...
    public void serialize(T t3, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        if (_shouldUnwrapSingle(serializerProvider) && hasSingleElement(t3)) {
    ...
    public final void serializeWithType(T t3, JsonGenerator jsonGenerator, SerializerProvider serializerProvider, TypeSerializer typeSerializer) throws IOException {
