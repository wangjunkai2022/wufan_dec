...
public class IterableSerializer extends AsArraySerializerBase<Iterable<?>> {
    public IterableSerializer(JavaType javaType, boolean z3, TypeSerializer typeSerializer) {
        super(Iterable.class, javaType, z3, typeSerializer, (JsonSerializer<Object>) null);
    }
