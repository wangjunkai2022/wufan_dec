...
public abstract class ReferenceTypeSerializer<T> extends StdSerializer<T> implements ContextualSerializer {
    ...
    protected abstract Object _getReferenced(T t3);

    protected abstract Object _getReferencedIfPresent(T t3);

    protected abstract boolean _isValuePresent(T t3);
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        return (this._suppressableValue == obj && this._suppressNulls == z3) ? withResolved : withResolved.withContentInclusion(obj, z3);
    }
