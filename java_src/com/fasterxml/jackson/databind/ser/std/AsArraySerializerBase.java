...
public abstract class AsArraySerializerBase<T> extends ContainerSerializer<T> implements ContextualSerializer {
    ...
    public AsArraySerializerBase(Class<?> cls, JavaType javaType, boolean z3, TypeSerializer typeSerializer, JsonSerializer<Object> jsonSerializer) {
        this(cls, javaType, z3, typeSerializer, null, jsonSerializer, null);
    }
    ...
    */
    ...
    public void serialize(T t3, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
        if (serializerProvider.isEnabled(SerializationFeature.WRITE_SINGLE_ELEM_ARRAYS_UNWRAPPED) && hasSingleElement(t3)) {
            serializeContents(t3, jsonGenerator, serializerProvider);
            return;
        }
        jsonGenerator.writeStartArray(t3);
        serializeContents(t3, jsonGenerator, serializerProvider);
        jsonGenerator.writeEndArray();
    }

    protected abstract void serializeContents(T t3, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException;
    ...
    public void serializeWithType(T t3, JsonGenerator jsonGenerator, SerializerProvider serializerProvider, TypeSerializer typeSerializer) throws IOException {
        WritableTypeId writeTypePrefix = typeSerializer.writeTypePrefix(jsonGenerator, typeSerializer.typeId(t3, JsonToken.START_ARRAY));
        jsonGenerator.setCurrentValue(t3);
        serializeContents(t3, jsonGenerator, serializerProvider);
    ...
    @Deprecated
    protected AsArraySerializerBase(Class<?> cls, JavaType javaType, boolean z3, TypeSerializer typeSerializer, BeanProperty beanProperty, JsonSerializer<Object> jsonSerializer) {
        this(cls, javaType, z3, typeSerializer, beanProperty, jsonSerializer, null);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    protected AsArraySerializerBase(Class<?> cls, JavaType javaType, boolean z3, TypeSerializer typeSerializer, BeanProperty beanProperty, JsonSerializer<?> jsonSerializer, Boolean bool) {
        super(cls, false);
        boolean z4 = false;
        this._elementType = javaType;
        if (z3 || (javaType != null && javaType.isFinal())) {
            z4 = true;
        }
