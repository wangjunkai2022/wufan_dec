...
public class CollectionSerializer extends AsArraySerializerBase<Collection<?>> {
    ...
    public CollectionSerializer(JavaType javaType, boolean z3, TypeSerializer typeSerializer, JsonSerializer<Object> jsonSerializer) {
        super(Collection.class, javaType, z3, typeSerializer, jsonSerializer);
    }
            ...
            do {
                ...
                if (next == null) {
                    try {
                        ...
                        wrapAndThrow(serializerProvider, e4, collection, i2);
                    }
    ...
    @Deprecated
    public CollectionSerializer(JavaType javaType, boolean z3, TypeSerializer typeSerializer, BeanProperty beanProperty, JsonSerializer<Object> jsonSerializer) {
        this(javaType, z3, typeSerializer, jsonSerializer);
    }
