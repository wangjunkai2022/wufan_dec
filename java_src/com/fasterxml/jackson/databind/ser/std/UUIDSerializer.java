...
public class UUIDSerializer extends StdScalarSerializer<UUID> implements ContextualSerializer {
    ...
    private static void _appendInt(int i2, char[] cArr, int i4) {
        _appendShort(i2 >> 16, cArr, i4);
        _appendShort(i2, cArr, i4 + 4);
    }

    private static void _appendShort(int i2, char[] cArr, int i4) {
        char[] cArr2 = HEX_CHARS;
        cArr[i4] = cArr2[(i2 >> 12) & 15];
        int i5 = i4 + 1;
        cArr[i5] = cArr2[(i2 >> 8) & 15];
        int i6 = i5 + 1;
        cArr[i6] = cArr2[(i2 >> 4) & 15];
        cArr[i6 + 1] = cArr2[i2 & 15];
    }
    ...
    */
    ...
    private static final void _appendInt(int i2, byte[] bArr, int i4) {
        bArr[i4] = (byte) (i2 >> 24);
        int i5 = i4 + 1;
        bArr[i5] = (byte) (i2 >> 16);
        int i6 = i5 + 1;
