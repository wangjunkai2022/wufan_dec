...
public @interface JsonIgnoreProperties {
    ...
    public static class Value implements JacksonAnnotationValue<JsonIgnoreProperties>, Serializable {
        ...
        protected Value(Set<String> set, boolean z3, boolean z4, boolean z5, boolean z6) {
            ...
            this._allowGetters = z4;
            this._allowSetters = z5;
            this._merge = z6;
        }
        ...
        private static boolean _empty(Set<String> set, boolean z3, boolean z4, boolean z5, boolean z6) {
            Value value = EMPTY;
            if (z3 == value._ignoreUnknown && z4 == value._allowGetters && z5 == value._allowSetters && z6 == value._merge) {
        ...
        public static Value construct(Set<String> set, boolean z3, boolean z4, boolean z5, boolean z6) {
            if (_empty(set, z3, z4, z5, z6)) {
                return EMPTY;
            }
            return new Value(set, z3, z4, z5, z6);
        }
        ...
        public static Value forIgnoreUnknown(boolean z3) {
            if (z3) {
