...
public @interface JsonFormat {
    ...
    public static class Features {
        ...
        private Features(int i2, int i4) {
            this._enabled = i2;
            this._disabled = i4;
        }
    ...
    public static class Value implements JacksonAnnotationValue<JsonFormat>, Serializable {
        ...
        private static <T> boolean _equal(T t3, T t4) {
            if (t3 == null) {
                return t4 == null;
            } else if (t4 == null) {
                return false;
        ...
        public static Value forLeniency(boolean z3) {
            return new Value("", null, null, null, null, Features.empty(), Boolean.valueOf(z3));
        }
