...
public class TTAdConstant {
    ...
    public static final int BUILD_IN_MODULE_VERSION_CODE = 4602;
    public static final String BUILD_IN_MODULE_VERSION_NAME = "4.6.0.2";
    ...
    public static final String C_H = "9583d45";
    ...
    public static final int SDK_VERSION_CODE = 4602;
    public static final String SDK_VERSION_NAME = "4.6.0.2";
