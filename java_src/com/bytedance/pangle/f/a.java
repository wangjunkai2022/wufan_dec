...
public final class a {
    ...
    private static final AtomicReference<byte[]> f10213a = new AtomicReference<>();
    ...
    public static o a(String str) {
        ...
        try {
            ...
            if (jarEntry != null) {
                Certificate[][] a4 = a(jarFile, jarEntry);
                if (!com.bytedance.pangle.util.c.a(a4)) {
                    ...
                    for (JarEntry jarEntry2 : arrayList) {
                        Certificate[][] a6 = a(jarFile, jarEntry2);
                        if (!com.bytedance.pangle.util.c.a(a6)) {
                            if (!o.a(a5, d.a(a6))) {
    ...
    */
    private static java.security.cert.Certificate[][] a(java.util.jar.JarFile r7, java.util.jar.JarEntry r8) {
        /*
            ...
            java.util.concurrent.atomic.AtomicReference<byte[]> r2 = com.bytedance.pangle.f.a.f10213a     // Catch: java.lang.Throwable -> L30 java.lang.RuntimeException -> L33 java.io.IOException -> L35
