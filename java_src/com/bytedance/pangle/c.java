...
public interface c extends IInterface {
    ...
    public static abstract class a extends Binder implements c {
        ...
        public static class C0033a implements c {
            ...
            public static c f10114a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f10115b;

            C0033a(IBinder iBinder) {
                this.f10115b = iBinder;
            }
            ...
            public final boolean a(String str) {
                ...
                try {
                    ...
                    if (!this.f10115b.transact(1, obtain, obtain2, 0) && a.a() != null) {
                        return a.a().a(str);
                    }
            ...
            public final int b(String str) {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.pangle.IPackageManager");
                    obtain.writeString(str);
                    if (!this.f10115b.transact(2, obtain, obtain2, 0) && a.a() != null) {
                        return a.a().b(str);
                    }
                    obtain2.readException();
            ...
            public final boolean a(String str, String str2) {
                ...
                try {
                    ...
                    if (!this.f10115b.transact(3, obtain, obtain2, 0) && a.a() != null) {
