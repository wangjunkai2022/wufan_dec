...
public final class b {
    ...
    private static final Object f10343a = new Object();

    /* renamed from: b  reason: collision with root package name */
    private static final Object f10344b = new Object();

    /* renamed from: c  reason: collision with root package name */
    private static final Object f10345c = new Object();

    /* renamed from: d  reason: collision with root package name */
    private static final Map<String, Boolean> f10346d = new ConcurrentHashMap();

    /* renamed from: e  reason: collision with root package name */
    private static final Map<String, d> f10347e = new ConcurrentHashMap();

    /* renamed from: f  reason: collision with root package name */
    private static c f10348f;

    public static d a(String str) {
        Boolean bool = f10346d.get(str);
        if (bool == null || !bool.booleanValue()) {
            f10347e.remove(str);
        }
        Map<String, d> map = f10347e;
        if (map.get(str) == null) {
    ...
    */
    private static android.os.IInterface a(java.lang.String r6, final java.lang.String r7) {
        /*
            ...
            if (r0 == 0) goto L4d
            android.os.IBinder r0 = r0.f10342a
            goto L4e
        L4d:
            r0 = r3
        L4e:
            ...
            java.util.Map<java.lang.String, java.lang.Boolean> r1 = com.bytedance.pangle.servermanager.b.f10346d     // Catch: android.os.RemoteException -> L9a
