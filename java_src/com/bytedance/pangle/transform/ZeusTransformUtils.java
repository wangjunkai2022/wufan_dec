...
public class ZeusTransformUtils {
        ...
        if (Build.VERSION.SDK_INT <= 23) {
            try {
                ...
                for (String str : new HashSet(sConstructorMap.keySet())) {
                    if (!str.startsWith("android.view.") && !str.startsWith("android.widget.") && !str.startsWith("android.webkit.") && str.contains(g0.f27568a)) {
    ...
    public static int getIdentifier(Object obj, String str, String str2, String str3, String str4) {
        if (obj instanceof Resources) {
            ...
            if (!TextUtils.equals(a.f73954a, str3)) {
                str3 = str4;
            }
    ...
    public static View inflate(LayoutInflater layoutInflater, int i2, ViewGroup viewGroup, boolean z3, String str) {
    ...
    public static int mapRes(int i2, String str, String str2) {
        ...
        if (identifier == 0) {
            identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.replace("_", g0.f27568a), str, Zeus.getAppApplication().getPackageName());
        }
        if (identifier == 0) {
