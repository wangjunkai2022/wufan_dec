...
public abstract class GeneratePluginAppCompatActivity extends AppCompatActivity implements IPluginActivity {
    ...
    public PendingIntent createPendingResult(int i2, Intent intent, int i4) {
        return this.mProxyActivity.zeusSuperCreatePendingResult(i2, intent, i4);
    }
    ...
    public void onActivityResult(int i2, int i4, Intent intent) {
        this.mProxyActivity.zeusSuperOnActivityResult(i2, i4, intent);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // android.app.Activity, android.view.ContextThemeWrapper
    public void onApplyThemeResource(Resources.Theme theme, int i2, boolean z3) {
        this.mProxyActivity.zeusSuperOnApplyThemeResource(theme, i2, z3);
    }
    ...
    public boolean onKeyMultiple(int i2, int i4, KeyEvent keyEvent) {
        return this.mProxyActivity.zeusSuperOnKeyMultiple(i2, i4, keyEvent);
    }
    ...
    public void overridePendingTransition(int i2, int i4) {
        this.mProxyActivity.zeusSuperOverridePendingTransition(i2, i4);
    }
    ...
    public void startIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5) {
        this.mProxyActivity.zeusSuperStartIntentSender(intentSender, intent, i2, i4, i5);
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        this.mProxyActivity.zeusSuperStartIntentSenderForResult(intentSender, i2, intent, i4, i5, i6);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        this.mProxyActivity.zeusSuperStartIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6);
    }
    ...
    public void startIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartIntentSender(intentSender, intent, i2, i4, i5, bundle);
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartIntentSenderForResult(intentSender, i2, intent, i4, i5, i6, bundle);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        this.mProxyActivity.zeusSuperStartIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6, bundle);
    }
