...
public abstract class GenerateProxyActivity extends Activity implements b {
    ...
    public PendingIntent createPendingResult(int i2, Intent intent, int i4) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            return generatePluginActivity.createPendingResult(i2, intent, i4);
        }
    ...
    protected void onActivityResult(int i2, int i4, Intent intent) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onActivityResult(i2, i4, intent);
        } else {
    ...
    protected void onApplyThemeResource(Resources.Theme theme, int i2, boolean z3) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.onApplyThemeResource(theme, i2, z3);
        } else {
    ...
    public boolean onKeyMultiple(int i2, int i4, KeyEvent keyEvent) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            return generatePluginActivity.onKeyMultiple(i2, i4, keyEvent);
        }
    ...
    public void overridePendingTransition(int i2, int i4) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.overridePendingTransition(i2, i4);
        } else {
    ...
    public void startIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.startIntentSender(intentSender, intent, i2, i4, i5);
        } else {
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6);
        } else {
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6);
        } else {
    ...
    public void startIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5, Bundle bundle) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.startIntentSender(intentSender, intent, i2, i4, i5, bundle);
        } else {
            super.startIntentSender(intentSender, intent, i2, i4, i5, bundle);
        }
    }
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6, bundle);
        } else {
            super.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6, bundle);
        }
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        GeneratePluginActivity generatePluginActivity = this.mTargetActivity;
        if (generatePluginActivity != null) {
            generatePluginActivity.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6, bundle);
        } else {
            super.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6, bundle);
        }
    }
