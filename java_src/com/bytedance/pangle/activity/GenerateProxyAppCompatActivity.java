...
public abstract class GenerateProxyAppCompatActivity extends AppCompatActivity implements b {
    ...
    @Override // android.app.Activity
    public PendingIntent createPendingResult(int i2, Intent intent, int i4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.createPendingResult(i2, intent, i4);
        }
        return super.createPendingResult(i2, intent, i4);
    }
    ...
    public void onActivityResult(int i2, int i4, Intent intent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onActivityResult(i2, i4, intent);
        } else {
    ...
    protected void onApplyThemeResource(Resources.Theme theme, int i2, boolean z3) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.onApplyThemeResource(theme, i2, z3);
        } else {
            super.onApplyThemeResource(theme, i2, z3);
        }
    }
    ...
    public boolean onKeyMultiple(int i2, int i4, KeyEvent keyEvent) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            return generatePluginAppCompatActivity.onKeyMultiple(i2, i4, keyEvent);
        }
        return super.onKeyMultiple(i2, i4, keyEvent);
    }
    ...
    @Override // android.app.Activity
    public void overridePendingTransition(int i2, int i4) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.overridePendingTransition(i2, i4);
        } else {
            super.overridePendingTransition(i2, i4);
        }
    }
    ...
    public void startIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSender(intentSender, intent, i2, i4, i5);
        } else {
            super.startIntentSender(intentSender, intent, i2, i4, i5);
        }
    }
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6);
        } else {
    ...
    @Override // android.app.Activity
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6);
        } else {
            super.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6);
        }
    }
    ...
    public PendingIntent zeusSuperCreatePendingResult(int i2, Intent intent, int i4) {
        return super.createPendingResult(i2, intent, i4);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void zeusSuperOnActivityResult(int i2, int i4, Intent intent) {
        super.onActivityResult(i2, i4, intent);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void zeusSuperOnApplyThemeResource(Resources.Theme theme, int i2, boolean z3) {
        super.onApplyThemeResource(theme, i2, z3);
    }
    ...
    public boolean zeusSuperOnKeyMultiple(int i2, int i4, KeyEvent keyEvent) {
        return super.onKeyMultiple(i2, i4, keyEvent);
    }
    ...
    public void zeusSuperOverridePendingTransition(int i2, int i4) {
        super.overridePendingTransition(i2, i4);
    }
    ...
    public void zeusSuperStartIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5) {
        super.startIntentSender(intentSender, intent, i2, i4, i5);
    }

    public void zeusSuperStartIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        super.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6);
    }

    public void zeusSuperStartIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        super.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6);
    }
    ...
    public void zeusSuperStartIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5, Bundle bundle) {
        super.startIntentSender(intentSender, intent, i2, i4, i5, bundle);
    }

    public void zeusSuperStartIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        super.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6, bundle);
    }

    public void zeusSuperStartIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        super.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6, bundle);
    }
    ...
    public void startIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSender(intentSender, intent, i2, i4, i5, bundle);
        } else {
            super.startIntentSender(intentSender, intent, i2, i4, i5, bundle);
        }
    }
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6, bundle);
        } else {
            super.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6, bundle);
        }
    }
    ...
    @Override // android.app.Activity
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
            generatePluginAppCompatActivity.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6, bundle);
        } else {
            super.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6, bundle);
        }
    }
