...
public abstract class GenerateFragmentActivityWrapper extends FragmentActivity implements a {
    ...
    public PendingIntent createPendingResult(int i2, Intent intent, int i4) {
        return this.mOriginActivity.createPendingResult(i2, intent, i4);
    }
    ...
    public boolean onKeyMultiple(int i2, int i4, KeyEvent keyEvent) {
        return this.mOriginActivity.onKeyMultiple(i2, i4, keyEvent);
    }
    ...
    public void overridePendingTransition(int i2, int i4) {
        this.mOriginActivity.overridePendingTransition(i2, i4);
    }
    ...
    public void startIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5) {
        this.mOriginActivity.startIntentSender(intentSender, intent, i2, i4, i5);
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        this.mOriginActivity.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6) {
        this.mOriginActivity.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6);
    }

    @Override // androidx.fragment.app.FragmentActivity
    public void startIntentSenderFromFragment(androidx.fragment.app.Fragment fragment, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        this.mOriginActivity.startIntentSenderFromFragment(fragment, intentSender, i2, intent, i4, i5, i6, bundle);
    }
    ...
    public void startIntentSender(IntentSender intentSender, Intent intent, int i2, int i4, int i5, Bundle bundle) {
        this.mOriginActivity.startIntentSender(intentSender, intent, i2, i4, i5, bundle);
    }

    @Override // androidx.activity.ComponentActivity, android.app.Activity
    public void startIntentSenderForResult(IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        this.mOriginActivity.startIntentSenderForResult(intentSender, i2, intent, i4, i5, i6, bundle);
    }
    ...
    public void startIntentSenderFromChild(Activity activity, IntentSender intentSender, int i2, Intent intent, int i4, int i5, int i6, Bundle bundle) {
        this.mOriginActivity.startIntentSenderFromChild(activity, intentSender, i2, intent, i4, i5, i6, bundle);
    }
