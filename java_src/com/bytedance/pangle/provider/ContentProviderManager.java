...
public class ContentProviderManager {
    ...
    public static final class a {
        ...
        public final ProviderInfo f10288b;

        /* renamed from: c  reason: collision with root package name */
        public final PluginContentProvider f10289c;

        public a(b bVar, ProviderInfo providerInfo, PluginContentProvider pluginContentProvider) {
            this.f10288b = providerInfo;
            this.f10287a = bVar;
            this.f10289c = pluginContentProvider;
        }
    }
    ...
    public static class b {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof b) {
                b bVar = (b) obj;
                if (TextUtils.equals(this.f10292c, bVar.f10292c) && TextUtils.equals(this.f10291b, bVar.f10291b) && TextUtils.equals(this.f10290a, bVar.f10290a)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            if (Build.VERSION.SDK_INT >= 19) {
                return Objects.hash(this.f10290a, this.f10291b, this.f10292c);
            }
            return (this.f10290a + this.f10291b + this.f10290a).hashCode();
        }
    }
    ...
    private void installProvider(ProviderInfo providerInfo, Plugin plugin) {
        ...
        try {
            ...
            ZeusLogger.w(ZeusLogger.TAG_PROVIDER, "Instantiating Exception : ", e4);
        }
    }
        ...
        try {
            ...
            for (ProviderInfo providerInfo : providerInfoArr) {
                if (providerInfo != null && (str = providerInfo.authority) != null) {
                    String str2 = ZeusConstants.f10060f;
                    if (str.contains(str2)) {
                        try {
                            ...
                            ZeusLogger.errReport(ZeusLogger.TAG_PROVIDER, "Init system contentProviderInfo [authority:" + providerInfo.authority + "],exception：", e4);
                        }
                    }
                }
            }
