...
public final class b {
    ...
    private static final int[] f60172a = {126, 147, 115, 241, 101, 198, 215, 134};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f60173b = {125, 185, 233, Opcodes.USHR_INT_LIT8, 129, 142, 151, 176};

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f60174c = {238, 185, 233, 179, 129, 142, 151, 167};
    ...
    public static String a(String str) {
        ...
        if (file.exists()) {
            ...
            try {
                ...
                byte[] a4 = a(bArr, f60172a);
                if (a4 != null && a4.length > 0) {
                    int length = a4.length - 1;
                    String str2 = a4[length] == 10 ? new String(a4, 0, length) : new String(a4);
                    g.a((Closeable) null);
                    return str2;
                }
                g.a((Closeable) null);
        ...
        if (bArr != null && iArr != null && iArr.length == 8) {
            ...
            try {
                ...
                for (int i2 = 0; i2 < length; i2++) {
                    byte b5 = bArr[i2];
                    bArr2[i2] = (byte) (iArr[i2 % 8] ^ b5);
                    b4 = (byte) (b4 ^ b5);
                }
                bArr2[length] = (byte) (iArr[0] ^ b4);
                bArr2[length + 1] = (byte) (iArr[1] ^ b4);
                return bArr2;
            } catch (Exception e4) {
                g.a(e4);
            }
    ...
    */
    ...
    private static byte[] a(byte[] bArr, int[] iArr) {
        if (bArr.length - 0 >= 2 && iArr != null && iArr.length == 8) {
            ...
            try {
                ...
                byte b4 = 0;
                for (int i2 = 0; i2 < length; i2++) {
                    byte b5 = (byte) (bArr[i2 + 0] ^ iArr[i2 % 8]);
                    bArr2[i2] = b5;
                    b4 = (byte) (b4 ^ b5);
                }
                if (bArr[length + 0] == ((byte) ((iArr[0] ^ b4) & 255)) && bArr[length + 1 + 0] == ((byte) ((iArr[1] ^ b4) & 255))) {
                    return bArr2;
                }
                return null;
            } catch (Exception e4) {
    ...
    public static boolean a(String str, String str2) {
        ...
        byte[] b4 = b(str2.getBytes(), f60172a);
        if (b4 == null) {
            return false;
        }
        try {
