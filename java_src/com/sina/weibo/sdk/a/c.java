...
public abstract class c<Params, Progress, Result> {
    ...
    Handler f56721x = new Handler(Looper.getMainLooper()) { // from class: com.sina.weibo.sdk.a.c.1
    ...
    /* loaded from: classes4.dex */
    abstract class AbstractC0285c extends FutureTask<Result> implements Comparable<Object> {
        int priority;

        public AbstractC0285c(d dVar) {
            super(dVar);
    ...
    public c() {
        ...
        this.M = dVar;
        this.N = new c<Params, Progress, Result>.AbstractC0285c(dVar) { // from class: com.sina.weibo.sdk.a.c.3
            ...
            protected final void done() {
                try {
                    Result result = get();
                    c cVar = c.this;
                    cVar.f56721x.obtainMessage(1, new a(cVar, result)).sendToTarget();
                } catch (InterruptedException unused) {
                    throw new RuntimeException("An error occur while execute doInBackground().");
                } catch (CancellationException unused2) {
                    c.this.f56721x.obtainMessage(3, new a(c.this, null)).sendToTarget();
