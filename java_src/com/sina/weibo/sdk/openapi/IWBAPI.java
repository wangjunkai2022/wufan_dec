...
public interface IWBAPI {
    ...
    void authorizeCallback(Activity activity, int i2, int i4, Intent intent);
    ...
    void shareMessage(Activity activity, WeiboMultiMessage weiboMultiMessage, boolean z3);
}
