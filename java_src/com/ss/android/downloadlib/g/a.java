...
public class a {
    ...
    /* loaded from: classes4.dex */
    public static class C0300a implements InvocationHandler {

        /* renamed from: a  reason: collision with root package name */
        private Object f57505a;
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            return method.invoke(this.f57505a, objArr);
        }

        private C0300a(Object obj) {
            this.f57505a = obj;
        }
    }
    ...
    public static void c() {
        ...
        try {
            ...
            declaredField2.set(obj, Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), new Class[]{cls}, new C0300a(obj2)));
        } catch (Throwable unused) {
        }
    }
    ...
    public static void a(Object[] objArr) {
        if (com.ss.android.downloadlib.addownload.j.i().optInt("hook", 0) == 1 && (objArr[1] instanceof String) && (objArr[2] instanceof Intent)) {
            ...
            if ("android.intent.action.VIEW".equals(intent.getAction()) && com.ss.android.socialbase.downloader.constants.e.f57871a.equals(intent.getType())) {
                if (com.ss.android.socialbase.appdownloader.f.d.c()) {
                    ...
                    String optString2 = i2.optString("hook_kllk_arg1", "com." + com.ss.android.socialbase.downloader.constants.e.f57873c + ".market");
                    ...
                    String optString4 = i4.optString("hook_kllk_arg3", "m.store." + com.ss.android.socialbase.downloader.constants.e.f57873c + "mobile.com");
                    StringBuilder sb = new StringBuilder();
                    sb.append(com.ss.android.socialbase.downloader.constants.e.f57873c);
                    ...
                    if (com.ss.android.downloadlib.addownload.j.i().optInt("hook_kllk_arg4", 0) == 1) {
                        ...
                        intent2.putExtra(com.ss.android.socialbase.downloader.constants.e.f57873c + "_extra_pkg_name", optString3);
