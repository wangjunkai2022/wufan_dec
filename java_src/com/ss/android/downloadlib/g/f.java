...
public class f {
    ...
    public static void b(DownloadInfo downloadInfo, JSONObject jSONObject) {
        ...
        double d4;
        if (jSONObject == null || (a4 = com.ss.android.downloadlib.addownload.b.f.a().a(downloadInfo)) == null) {
            return;
        }
        try {
            c(downloadInfo, jSONObject);
            jSONObject.putOpt("time_after_click", Long.valueOf(System.currentTimeMillis() - a4.T()));
            jSONObject.putOpt("click_download_size", Long.valueOf(a4.U()));
            jSONObject.putOpt("download_length", Long.valueOf(downloadInfo.getCurBytes()));
            jSONObject.putOpt("download_apk_size", Long.valueOf(downloadInfo.getTotalBytes()));
            a4.A();
            com.ss.android.downloadlib.addownload.b.i.a().a(a4);
            jSONObject.put("click_pause_times", a4.z());
    ...
    public static void c(DownloadInfo downloadInfo, JSONObject jSONObject) {
        if (downloadInfo != null) {
            try {
                ...
                com.ss.android.downloadad.api.a.b a4 = com.ss.android.downloadlib.addownload.b.f.a().a(downloadInfo.getId());
                if (a4 != null) {
                    jSONObject.putOpt("click_download_time", Long.valueOf(a4.T()));
                    jSONObject.putOpt("click_download_size", Long.valueOf(a4.U()));
                }
            } catch (Exception e4) {
                e4.printStackTrace();
    ...
    public static void a(JSONObject jSONObject, int i2) {
        ...
        JSONArray e4 = com.ss.android.socialbase.downloader.g.a.a(i2).e("ah_report_config");
        if (e4 != null) {
            for (int i4 = 0; i4 < e4.length(); i4++) {
                try {
                    String string = e4.getString(i4);
                    g.a a4 = com.ss.android.socialbase.appdownloader.f.a.a(string);
                    if (a4 != null) {
                        String replaceAll = string.replaceAll("\\.", "_");
                        jSONObject.put(replaceAll, a4.f() + "_" + a4.g());
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
                }
