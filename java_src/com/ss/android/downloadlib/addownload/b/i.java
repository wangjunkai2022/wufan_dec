...
public class i {
    ...
    public static class a {
        ...
        private static i f57158a = new i();
    }
        ...
        for (Map.Entry<String, ?> entry : all.entrySet()) {
            if (entry.getValue() != null) {
                try {
                    ...
                    com.ss.android.downloadad.api.a.b b4 = com.ss.android.downloadad.api.a.b.b(new JSONObject(String.valueOf(entry.getValue())));
                    if (longValue > 0 && b4 != null) {
                        concurrentHashMap.put(Long.valueOf(longValue), b4);
                    }
                } catch (Exception e4) {
                    e4.printStackTrace();
                }
