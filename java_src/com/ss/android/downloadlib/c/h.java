...
public class h {
    ...
    public static class a {
        ...
        private static h f57415a = new h();
    }
    ...
    private void b(@NonNull final com.ss.android.downloadad.api.a.b bVar, long j4) {
        final int s3 = bVar.s();
        if (com.ss.android.socialbase.downloader.g.a.a(s3).b("notification_opt_2") != 1) {
            return;
        }
        a(s3);
    ...
    private void c(@NonNull final com.ss.android.downloadad.api.a.b bVar, long j4) {
        final int s3 = bVar.s();
        if (com.ss.android.socialbase.downloader.g.a.a(s3).b("notification_opt_2") != 1) {
            return;
        }
    ...
    public void a(@NonNull final com.ss.android.downloadad.api.a.b bVar, long j4) {
        final int s3 = bVar.s();
        if (com.ss.android.socialbase.downloader.g.a.a(s3).b("notification_opt_2") != 1) {
            return;
        }
