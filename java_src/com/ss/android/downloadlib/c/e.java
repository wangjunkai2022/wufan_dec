...
public class e implements com.ss.android.socialbase.downloader.d.c {
    ...
    public void a(int i2, String str, JSONObject jSONObject) {
        ...
        if (downloadInfo == null || (a4 = com.ss.android.downloadlib.addownload.b.f.a().a(downloadInfo)) == null) {
            return;
        }
        if ("install_view_result".equals(str)) {
            jSONObject = l.a(jSONObject);
            com.ss.android.downloadlib.a.a(jSONObject, downloadInfo);
            l.a(jSONObject, "model_id", Long.valueOf(a4.b()));
        }
        com.ss.android.downloadlib.d.a.a().b(str, jSONObject, a4);
    }
    ...
    public void b(int i2, String str, JSONObject jSONObject) {
        ...
        com.ss.android.downloadlib.d.a.a().a(str, jSONObject, a4);
    }
}
