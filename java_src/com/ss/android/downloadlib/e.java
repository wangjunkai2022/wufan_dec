            ...
            downloaderBuilder.notificationClickCallback(new af() { // from class: com.ss.android.downloadlib.e.2
                private boolean d(DownloadInfo downloadInfo) {
                    ...
                    if (r3 != null) {
                        ...
                        if (a5 != null && a5.c()) {
                            a4 = com.ss.android.socialbase.downloader.g.a.a(downloadInfo.getId()).a("ad_notification_jump_url", (String) null);
                        } else {
                            a4 = com.ss.android.downloadlib.addownload.h.a(downloadInfo);
                        }
                        if (TextUtils.isEmpty(a4)) {
                            return false;
                        }
                        return r3.a(j.getContext(), a4);
                    }
                    return false;
                }
                ...
                public boolean a(DownloadInfo downloadInfo) {
                    ...
                    if (a4.a("disable_delete_dialog", 0) == 1) {
                        return true;
                    }
                    return d4;
                }
                ...
                public boolean c(DownloadInfo downloadInfo) {
                    ...
                    if (a4 != null) {
                        com.ss.android.downloadlib.b.a.a(a4);
                    } else {
