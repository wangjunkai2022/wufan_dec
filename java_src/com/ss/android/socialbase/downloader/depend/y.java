...
/* compiled from: IDownloadNotificationEventAidlListener.java */
...
public interface y extends IInterface {
    ...
    boolean a(boolean z3) throws RemoteException;
    ...
    public static abstract class a extends Binder implements y {
        ...
        public static y a(IBinder iBinder) {
            ...
            return new C0326a(iBinder);
        }

        public static y b() {
            return C0326a.f57929a;
        }
        ...
        public static class C0326a implements y {
            ...
            public static y f57929a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f57930b;

            C0326a(IBinder iBinder) {
                this.f57930b = iBinder;
            }
            ...
            public void a(int i2, DownloadInfo downloadInfo, String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f57930b.transact(1, obtain, obtain2, 0) && a.b() != null) {
            ...
            public boolean a(boolean z3) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f57930b.transact(2, obtain, obtain2, 0) && a.b() != null) {
                        return a.b().a(z3);
                    }
                    obtain2.readException();
            ...
            public String a() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.ss.android.socialbase.downloader.depend.IDownloadNotificationEventAidlListener");
                    if (!this.f57930b.transact(3, obtain, obtain2, 0) && a.b() != null) {
                        return a.b().a();
                    }
                    obtain2.readException();
