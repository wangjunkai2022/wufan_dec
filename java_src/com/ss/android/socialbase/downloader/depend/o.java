...
/* compiled from: IDownloadDiskSpaceAidlCallback.java */
...
public interface o extends IInterface {
    ...
    public static abstract class a extends Binder implements o {
        ...
        /* loaded from: classes4.dex */
        public static class C0322a implements o {

            /* renamed from: a  reason: collision with root package name */
            public static o f57921a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f57922b;

            C0322a(IBinder iBinder) {
                this.f57922b = iBinder;
            }
            ...
            public void a() throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f57922b.transact(1, obtain, obtain2, 0) && a.b() != null) {
                        a.b().a();
                    } else {
        ...
        public static o a(IBinder iBinder) {
            ...
            return new C0322a(iBinder);
        }

        public static o b() {
            return C0322a.f57921a;
        }
