...
/* compiled from: IDownloadAidlMonitorDepend.java */
...
public interface j extends IInterface {
    ...
    public static abstract class a extends Binder implements j {
        ...
        public static j a(IBinder iBinder) {
            ...
            return new C0320a(iBinder);
        }

        public static j c() {
            return C0320a.f57917a;
        }
        ...
        public static class C0320a implements j {
            ...
            public static j f57917a;

            /* renamed from: b  reason: collision with root package name */
            private IBinder f57918b;

            C0320a(IBinder iBinder) {
                this.f57918b = iBinder;
            }
            ...
            public void a(String str) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f57918b.transact(1, obtain, obtain2, 0) && a.c() != null) {
                        a.c().a(str);
                    } else {
            ...
            public int[] b() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.ss.android.socialbase.downloader.depend.IDownloadAidlMonitorDepend");
                    if (!this.f57918b.transact(3, obtain, obtain2, 0) && a.c() != null) {
                        return a.c().b();
                    }
                    obtain2.readException();
            ...
            public String a() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.ss.android.socialbase.downloader.depend.IDownloadAidlMonitorDepend");
                    if (!this.f57918b.transact(2, obtain, obtain2, 0) && a.c() != null) {
                        return a.c().a();
                    }
                    obtain2.readException();
