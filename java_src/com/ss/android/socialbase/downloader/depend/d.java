...
public abstract class d extends AbsDownloadListener implements s {
    private void a(int i2, DownloadInfo downloadInfo, BaseException baseException, boolean z3) {
        ...
        if (i2 == -3) {
            e4.a(downloadInfo.getTotalBytes());
        } else {
            e4.a(downloadInfo.getCurBytes());
        }
        e4.a(i2, baseException, z3);
    }
    ...
    private void c(DownloadInfo downloadInfo) {
        if (downloadInfo != null && downloadInfo.canShowNotification() && downloadInfo.getStatus() == 4) {
            ...
            e4.a(downloadInfo.getCurBytes(), downloadInfo.getTotalBytes());
        }
    }
