...
public class b {
    ...
    public void setThrottleNetSpeed(int i2, long j4) {
        d.a().a(i2, j4);
    }
    ...
    public void cancel(int i2, boolean z3) {
        d.a().c(i2, z3);
    }

    public void clearDownloadData(int i2, boolean z3) {
        d.a().d(i2, z3);
    }
    ...
    @Deprecated
    public void setMainThreadListener(int i2, IDownloadListener iDownloadListener, boolean z3) {
        if (iDownloadListener == null) {
            return;
        }
        d.a().a(i2, iDownloadListener, com.ss.android.socialbase.downloader.constants.f.MAIN, true, z3);
    }
}
