...
public class g implements IDownloadHttpService {
    ...
    private final com.ss.android.socialbase.downloader.i.h<String, OkHttpClient> f58371a = new com.ss.android.socialbase.downloader.i.h<>(4, 8);
    ...
    private OkHttpClient a(String str, final String str2) {
        try {
            ...
            if (!TextUtils.isEmpty(host) && !TextUtils.isEmpty(str2)) {
                ...
                synchronized (this.f58371a) {
                    OkHttpClient okHttpClient = this.f58371a.get(str3);
                    if (okHttpClient != null) {
                        return okHttpClient;
                    }
                    OkHttpClient.Builder t3 = com.ss.android.socialbase.downloader.downloader.c.t();
                    t3.dns(new Dns() { // from class: com.ss.android.socialbase.downloader.impls.g.2
                    ...
                    OkHttpClient build = t3.build();
                    synchronized (this.f58371a) {
                        this.f58371a.put(str3, build);
                    }
                    return build;
                }
            }
    ...
    public com.ss.android.socialbase.downloader.network.i downloadWithConnection(int i2, String str, List<com.ss.android.socialbase.downloader.model.c> list) throws IOException {
        ...
        if (list == null || list.size() <= 0) {
            ...
            for (com.ss.android.socialbase.downloader.model.c cVar : list) {
                ...
                if (str2 == null && "ss_d_request_host_ip_114".equals(a4)) {
                    ...
                    url.addHeader(a4, com.ss.android.socialbase.downloader.i.f.g(cVar.b()));
                }
            }
        }
        if (!TextUtils.isEmpty(str2)) {
            ...
            s3 = com.ss.android.socialbase.downloader.downloader.c.s();
        }
        if (s3 != null) {
            final Call newCall = s3.newCall(url.build());
