...
public class h extends com.ss.android.socialbase.downloader.downloader.a {
    ...
    private static final String f58380e = "h";
    ...
    public void a(Intent intent, int i2, int i4) {
        if (com.ss.android.socialbase.downloader.c.a.a()) {
            com.ss.android.socialbase.downloader.c.a.b(f58380e, "onStartCommand");
        }
    ...
    public void c() {
        if (com.ss.android.socialbase.downloader.i.a.a(262144)) {
            ...
            this.f57946d = false;
            if (com.ss.android.socialbase.downloader.c.a.a()) {
                com.ss.android.socialbase.downloader.c.a.b(f58380e, "onStartCommandOnMainThread");
            }
        }
    }
