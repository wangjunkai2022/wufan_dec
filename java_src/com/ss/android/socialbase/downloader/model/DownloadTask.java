...
public class DownloadTask {
    ...
    public void addDownloadListener(int i2, IDownloadListener iDownloadListener, f fVar, boolean z3) {
    ...
    public int download() {
        ...
        DownloadInfo b4 = com.ss.android.socialbase.downloader.downloader.c.x().b(this.downloadInfo.getId());
        if (b4 == null) {
            this.downloadInfo.generateTaskId();
            com.ss.android.socialbase.downloader.d.a.a(this, (BaseException) null, 0);
        } else {
            this.downloadInfo.copyTaskIdFromCacheData(b4);
        }
        setChunkCalculator();
    ...
    public void removeDownloadListener(int i2, IDownloadListener iDownloadListener, f fVar, boolean z3) {
        int indexOfValue;
        SparseArray<IDownloadListener> downloadListeners = getDownloadListeners(fVar);
        if (downloadListeners == null) {
            if (z3 && this.singleListenerMap.containsKey(fVar)) {
