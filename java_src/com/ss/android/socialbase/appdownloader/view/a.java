...
public class a extends Fragment {
    ...
    private Intent f() {
        ...
        int i2 = e4.getApplicationInfo().uid;
    ...
    public Intent b() {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (lowerCase.contains(e.f57873c)) {
        ...
        return new Intent("android.settings.APPLICATION_DETAILS_SETTINGS", Uri.parse("package:" + e4.getPackageName()));
    }
