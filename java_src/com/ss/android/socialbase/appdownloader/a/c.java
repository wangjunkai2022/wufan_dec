...
public class c extends a {
    ...
    public Intent b() {
        String optString = this.f57563d.optString("action");
        String optString2 = this.f57563d.optString("category");
        int optInt = this.f57563d.optInt("flags", 1342210048);
        String optString3 = this.f57563d.optString("path_extra_key");
        String optString4 = this.f57563d.optString("path_data_key");
        JSONObject optJSONObject = this.f57563d.optJSONObject(BaseConstants.EVENT_LABEL_EXTRA);
        JSONObject optJSONObject2 = this.f57563d.optJSONObject("extra_type");
        ...
        if (!TextUtils.isEmpty(optString4)) {
            try {
                intent.setData(Uri.parse(String.format(optString4, this.f57562c)));
            } catch (Throwable unused) {
            }
        }
        intent.setFlags(optInt);
        if (!TextUtils.isEmpty(optString3)) {
            intent.putExtra(optString3, this.f57562c);
        }
