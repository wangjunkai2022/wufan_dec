...
public class ActivityTracker implements PublicMemberKeeper {
    ...
    private static ActivityTracker f53905a;

    /* renamed from: b  reason: collision with root package name */
    private HashSet<Tracker> f53906b = new HashSet<>();
    ...
    public static synchronized ActivityTracker getInstance(Context context) {
        ...
        synchronized (ActivityTracker.class) {
            if (f53905a == null) {
                f53905a = new ActivityTracker(context);
            }
            activityTracker = f53905a;
        }
    ...
    public void addTracker(Tracker tracker) {
        synchronized (this.f53906b) {
            this.f53906b.add(tracker);
        }
    }

    public void removeTracker(Tracker tracker) {
        synchronized (this.f53906b) {
            this.f53906b.remove(tracker);
        }
    }
    ...
    private void a(EachTracker eachTracker) {
        ...
        try {
            synchronized (this.f53906b) {
                HashSet<Tracker> hashSet = this.f53906b;
