...
public class FakeActivity implements EverythingKeeper {
    ...
    public static void registerExecutor(String str, Object obj) {
        ...
        if (cls != null) {
            try {
                Method method = cls.getMethod(i.a("016AfjYk$hhfghi3fk_fjiffn$k3fife^f:gefj"), String.class, Object.class);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public int onSetTheme(int i2, boolean z3) {
        return i2;
    }
    ...
    public void requestFullScreen(boolean z3) {
        Activity activity = this.activity;
        if (activity == null) {
            return;
        }
    ...
    public void requestPermissions(String[] strArr, int i2) {
        ...
        if (activity != null && Build.VERSION.SDK_INT >= 23) {
            try {
                ReflectHelper.invokeInstanceMethod(activity, i.a("018SfjSkm<feRkJhi>fMij2kUfj1nPfghihifggefmhi"), new Object[]{strArr, Integer.valueOf(i2)}, new Class[]{String.class, Integer.TYPE});
            } catch (Throwable th) {
    ...
    public void showForResult(final Context context, Intent intent, FakeActivity fakeActivity) {
        ...
        if (shellClass != null) {
            ...
            try {
                Method method = shellClass.getMethod(i.a("016%fjWkGhhfghi!fk6fjiffn4kPfifeJfMgefj"), Object.class);
                method.setAccessible(true);
        ...
        intent2.putExtra(i.a("011]gffhfefmfi>e>ff-fRfgBnk"), str);
        intent2.putExtra(i.a("013k,fn>k<fife5fKgefjfffmfhGnk"), getClass().getName());
        if (intent != null) {
    ...
    public void runOnUIThread(final Runnable runnable, long j4) {
        UIHandler.sendEmptyMessageDelayed(0, j4, new Handler.Callback() { // from class: com.mob.tools.FakeActivity.3
            @Override // android.os.Handler.Callback
            public boolean handleMessage(Message message) {
                runnable.run();
                return false;
