...
public class AsyncImageView extends ImageView implements Handler.Callback, BitmapProcessor.BitmapCallback {
    ...
    private Bitmap goCrop(Bitmap bitmap) {
        ...
        float f4 = (size[1] * width) / size[0];
        if (f4 == height) {
            return bitmap;
        }
        int[] iArr = new int[4];
        if (f4 < height) {
            iArr[1] = (int) ((height - f4) / 2.0f);
            iArr[3] = iArr[1];
        } else {
    ...
    public void setCompressOptions(int i2, int i4, int i5, long j4) {
    ...
    public void setScaleToCropCenter(boolean z3) {
        this.scaleToCrop = z3;
    }

    public void setUseCacheOption(boolean z3, boolean z4) {
        setUseCacheOption(z3, z4, 0L);
    }

    public void execute(String str, int i2, int i4) {
    ...
    public void setUseCacheOption(boolean z3, boolean z4, long j4) {
        this.useRamCache = z3;
