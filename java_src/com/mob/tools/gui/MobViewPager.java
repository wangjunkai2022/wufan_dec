...
public class MobViewPager extends ViewGroup {
    ...
    private void handleInterceptMove(MotionEvent motionEvent) {
        ...
        int abs = (int) Math.abs(x3 - this.lastMotionX);
        if (((int) Math.abs(y3 - this.lastMotionY)) >= abs || abs <= this.touchSlop) {
            return;
        }
        this.touchState = 1;
        this.lastMotionX = x3;
    ...
    private void handleScrollMove(MotionEvent motionEvent) {
        ...
        float x3 = motionEvent.getX();
        int i2 = (int) (this.lastMotionX - x3);
        this.lastMotionX = x3;
        if (i2 < 0) {
            if (getScrollX() > 0) {
    ...
    private void onScreenChange(int i2) {
        if (this.adapter != null) {
            if (this.skipScreen && Math.abs(i2 - this.currentScreen) > 2) {
                ...
                if (i4 > 0) {
                    View view = this.adapter.getView(i4 - 1, this.previousPage, this);
                ...
                if (i5 < this.screenCount - 1) {
                    View view3 = this.adapter.getView(i5 + 1, this.nextPage, this);
                    this.nextPage = view3;
                    addView(view3);
                }
            } else if (this.currentScreen > i2) {
                for (int i6 = 0; i6 < this.currentScreen - i2; i6++) {
                    int i7 = i2 + i6 + 1;
                    ...
                    if (i7 < this.screenCount - 1) {
                        View view5 = this.adapter.getView(i7 + 1, view4, this);
                        this.nextPage = view5;
                        addView(view5);
                    } else {
                        this.nextPage = view4;
                ...
                for (int i8 = 0; i8 < i2 - this.currentScreen; i8++) {
                    int i9 = (i2 - i8) - 1;
                    ...
                    if (i9 > 0) {
                        View view7 = this.adapter.getView(i9 - 1, view6, this);
    ...
    public void scrollToScreenOnUIThread(int i2, boolean z3) {
        int i4;
        int abs;
        this.skipScreen = z3;
        if (this.currentPage != null) {
        ...
        if (width != 0) {
            ...
            if (z3) {
                ...
                int i6 = this.flingVelocity;
                if (i6 != 0) {
                    double abs3 = Math.abs(i6);
                    double sqrt = Math.sqrt((abs * abs) - (Math.abs(width) * 20));
                    Double.isNaN(abs3);
                    i5 = (int) (((abs3 - sqrt) * 1000.0d) / 10.0d);
                }
                i4 = (i5 == 0 || i5 > abs2) ? abs2 : i5;
            }
            this.scroller.startScroll(getScrollX(), 0, width, 0, i4);
        }
        invalidate();
    }
    ...
    public void computeScroll() {
        ...
        if (this.scroller.computeScrollOffset()) {
            ...
            int max = Math.max(0, Math.min(i4, this.screenCount - 1));
    ...
    public boolean dispatchUnhandledMove(View view, int i2) {
        ...
        } else if (i2 == 66 && (i4 = this.currentScreen) < this.screenCount - 1) {
    ...
    */
    ...
    protected void onLayout(boolean z3, int i2, int i4, int i5, int i6) {
        ...
        int i10 = i9 * i7;
        if (i9 > 0) {
            this.previousPage.layout(i10 - i7, 0, i10, i8);
        }
        int i11 = i10 + i7;
        this.currentPage.layout(i10, 0, i11, i8);
        if (this.currentScreen < this.screenCount - 1) {
            this.nextPage.layout(i11, 0, i7 + i11, i8);
        }
    ...
    public void scrollToScreen(final int i2, final boolean z3) {
        post(new Runnable() { // from class: com.mob.tools.gui.MobViewPager.2
            @Override // java.lang.Runnable
            public void run() {
                MobViewPager.this.scrollToScreenOnUIThread(i2, z3);
            }
        });
    }
    ...
    public void setAdapter(ViewPagerAdapter viewPagerAdapter) {
        ...
        if (count <= 0) {
            ...
            if (i4 < this.screenCount - 1) {
                View view3 = viewPagerAdapter.getView(i4 + 1, this.nextPage, this);
                this.nextPage = view3;
                addView(view3);
            }
        }
    ...
    @Deprecated
    public void scrollToScreen(int i2, boolean z3, boolean z4) {
        scrollToScreen(i2, z3);
    }
