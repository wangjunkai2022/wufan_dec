    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        try {
            ...
            if (action == 0) {
                ...
                float x3 = motionEvent.getX(0) - this.downPoint[0];
                float y3 = motionEvent.getY(0) - this.downPoint[1];
                if (this.mode == 1 && (x3 * x3) + (y3 * y3) <= this.dragScrollMinDistSquare) {
                    performClick();
                }
                this.mode = 0;
            } else if (action == 2) {
                ...
                if (i2 == 1) {
                    ...
                    matrix3.postTranslate(f4 - fArr2[0], fArr[1] - fArr2[1]);
                } else if (i2 == 2) {
                    ...
                    matrix4.postTranslate(f5 - fArr4[0], fArr3[1] - fArr4[1]);
                } else if (i2 == 3) {
                    ...
                    this.matrix.set(this.savedMatrix);
                    float sqrt = (float) Math.sqrt(((f6 * f6) + (f7 * f7)) / this.distSquare);
                ...
                float f8 = fArr8[0] - fArr9[0];
                float f9 = fArr8[1] - fArr9[1];
                ...
                float f10 = fArr10[0] - fArr11[0];
                float f11 = fArr10[1] - fArr11[1];
                this.distSquare = (f10 * f10) + (f11 * f11);
                this.mode = 3;
            } else if (action != 262) {
                return false;
            } else {
