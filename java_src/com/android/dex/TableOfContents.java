...
public final class TableOfContents {
    ...
    public TableOfContents() {
        ...
        Section section17 = new Section(n.a.f60854r);
        this.debugInfos = section17;
        Section section18 = new Section(n.a.f60855s);
        this.annotations = section18;
        Section section19 = new Section(n.a.f60856t);
    ...
    private void readMap(Dex.Section section) throws IOException {
        ...
        while (i4 < readInt) {
            ...
            int i5 = section3.size;
            if ((i5 != 0 && i5 != readInt2) || ((i2 = section3.off) != -1 && i2 != readInt3)) {
    ...
    public void writeHeader(Dex.Section section, int i2) throws IOException {
        section.write(DexFormat.apiToMagic(i2).getBytes("UTF-8"));
