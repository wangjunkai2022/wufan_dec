...
public final class Code {
    ...
    public static class CatchHandler {
        ...
        public CatchHandler(int[] iArr, int[] iArr2, int i2, int i4) {
    ...
    public static class Try {
        ...
        public Try(int i2, int i4, int i5) {
    ...
    public Code(int i2, int i4, int i5, int i6, short[] sArr, Try[] tryArr, CatchHandler[] catchHandlerArr) {
