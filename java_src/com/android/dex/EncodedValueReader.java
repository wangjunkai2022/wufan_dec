...
public final class EncodedValueReader {
    ...
    protected final ByteInput f9947in;
    private int type;

    public EncodedValueReader(ByteInput byteInput) {
        this.type = -1;
        this.f9947in = byteInput;
    }
    ...
    public int peek() {
        if (this.type == -1) {
            int readByte = this.f9947in.readByte() & 255;
    ...
    public int readAnnotation() {
        checkType(29);
        this.type = -1;
        this.annotationType = Leb128.readUnsignedLeb128(this.f9947in);
        return Leb128.readUnsignedLeb128(this.f9947in);
    }
    ...
    public byte readByte() {
        checkType(0);
        this.type = -1;
        return (byte) EncodedValueCodec.readSignedInt(this.f9947in, this.arg);
    }

    public char readChar() {
        checkType(3);
        this.type = -1;
        return (char) EncodedValueCodec.readUnsignedInt(this.f9947in, this.arg, false);
    }

    public double readDouble() {
        checkType(17);
        this.type = -1;
        return Double.longBitsToDouble(EncodedValueCodec.readUnsignedLong(this.f9947in, this.arg, true));
    }

    public int readEnum() {
        checkType(27);
        this.type = -1;
        return EncodedValueCodec.readUnsignedInt(this.f9947in, this.arg, false);
    }
    ...
    public float readFloat() {
        checkType(16);
        this.type = -1;
        return Float.intBitsToFloat(EncodedValueCodec.readUnsignedInt(this.f9947in, this.arg, true));
    }

    public int readInt() {
        checkType(4);
        this.type = -1;
        return EncodedValueCodec.readSignedInt(this.f9947in, this.arg);
    }

    public long readLong() {
        checkType(6);
        this.type = -1;
        return EncodedValueCodec.readSignedLong(this.f9947in, this.arg);
    }
    ...
    public short readShort() {
        checkType(2);
        this.type = -1;
        return (short) EncodedValueCodec.readSignedInt(this.f9947in, this.arg);
    }
    ...
    public EncodedValueReader(EncodedValue encodedValue, int i2) {
        this(encodedValue.asByteInput(), i2);
    }
}
