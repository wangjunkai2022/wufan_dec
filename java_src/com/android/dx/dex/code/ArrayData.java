...
public final class ArrayData extends VariableSizeInsn {
    ...
    protected String argString() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            sb.append(i2);
            sb.append(": ");
            sb.append(this.values.get(i2).toHuman());
        }
        return sb.toString();
    }
    ...
    public void writeTo(AnnotatedOutput annotatedOutput) {
        ...
        if (i2 == 1) {
            for (int i4 = 0; i4 < size; i4++) {
                annotatedOutput.writeByte((byte) ((CstLiteral32) this.values.get(i4)).getIntBits());
            }
        } else if (i2 == 2) {
            for (int i5 = 0; i5 < size; i5++) {
                annotatedOutput.writeShort((short) ((CstLiteral32) this.values.get(i5)).getIntBits());
            }
        } else if (i2 == 4) {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                annotatedOutput.writeLong(((CstLiteral64) this.values.get(i7)).getLongBits());
            }
        }
