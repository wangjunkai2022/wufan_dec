...
public final class DexFile {
    ...
    public static final class Storage {
        ...
        public byte[] getStorage(int i2) {
            if (this.storage.length < i2) {
                Logger anonymousLogger = Logger.getAnonymousLogger();
                Level level = Level.FINER;
                anonymousLogger.log(level, "DexFile storage too small  " + this.storage.length + " vs " + i2);
                this.storage = new byte[i2];
            }
            return this.storage;
        }
    }
    ...
    private static void calcChecksum(byte[] bArr, int i2) {
    ...
    private static void calcSignature(byte[] bArr, int i2) {
        try {
    ...
    private ByteArrayAnnotatedOutput toDex0(boolean z3, boolean z4, Storage storage) {
            ...
            if ((section != this.callSiteIds && section != this.methodHandles) || !section.items().isEmpty()) {
                ...
                if (fileOffset >= i2) {
                    try {
                        ...
                        throw ExceptionWithContext.withContext(e4, "...while writing section " + i4);
                    }
                } else {
        ...
        this.fileSize = i2;
        byte[] storage2 = storage == null ? new byte[i2] : storage.getStorage(i2);
        ...
        for (int i5 = 0; i5 < length; i5++) {
            try {
                Section section2 = this.sections[i5];
    ...
    public void setDumpWidth(int i2) {
        if (i2 >= 40) {
            this.dumpWidth = i2;
            return;
        }
    ...
    public byte[] toDex(Writer writer, boolean z3) throws IOException {
        ...
        ByteArrayAnnotatedOutput dex0 = toDex0(z4, z3, null);
        if (z4) {
    ...
    public void writeTo(OutputStream outputStream, Storage storage, Writer writer, boolean z3) throws IOException {
        boolean z4 = writer != null;
        ByteArrayAnnotatedOutput dex0 = toDex0(z4, z3, storage);
