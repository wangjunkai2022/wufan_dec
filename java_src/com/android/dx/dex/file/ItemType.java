...
public enum ItemType implements ToHuman {
    ...
    TYPE_DEBUG_INFO_ITEM(n.a.f60854r, "debug_info_item"),
    TYPE_ANNOTATION_ITEM(n.a.f60855s, "annotation_item"),
    TYPE_ENCODED_ARRAY_ITEM(n.a.f60856t, "encoded_array_item"),
