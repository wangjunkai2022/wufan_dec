...
public final class CodeStatistics {
    ...
    public void dumpStatistics(PrintStream printStream) {
        int i2;
        int i4;
        double abs = this.runningDeltaInsns / (this.runningTotalInsns + Math.abs(i2));
        Double.isNaN(abs);
        ...
        double abs2 = this.dexRunningDeltaInsns / (this.dexRunningTotalInsns + Math.abs(i4));
        Double.isNaN(abs2);
    ...
    public void updateOriginalByteCount(int i2) {
        this.runningOriginalBytes += i2;
    }
