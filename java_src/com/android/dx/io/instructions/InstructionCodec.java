...
public enum InstructionCodec {
    FORMAT_00X { // from class: com.android.dx.io.instructions.InstructionCodec.1
        ...
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new ZeroRegisterDecodedInstruction(this, i2, 0, null, 0, 0L);
        }
    ...
    FORMAT_10X { // from class: com.android.dx.io.instructions.InstructionCodec.2
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new ZeroRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_12X { // from class: com.android.dx.io.instructions.InstructionCodec.3
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new TwoRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, 0L, InstructionCodec.nibble2(i2), InstructionCodec.nibble3(i2));
        }
    ...
    FORMAT_11N { // from class: com.android.dx.io.instructions.InstructionCodec.4
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new OneRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, (InstructionCodec.nibble3(i2) << 28) >> 28, InstructionCodec.nibble2(i2));
        }
    ...
    FORMAT_11X { // from class: com.android.dx.io.instructions.InstructionCodec.5
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new OneRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, 0L, InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_10T { // from class: com.android.dx.io.instructions.InstructionCodec.6
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new ZeroRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, (codeInput.cursor() - 1) + ((byte) InstructionCodec.byte1(i2)), 0L);
        }
    ...
    FORMAT_20T { // from class: com.android.dx.io.instructions.InstructionCodec.7
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new ZeroRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, (codeInput.cursor() - 1) + ((short) codeInput.read()), InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_20BC { // from class: com.android.dx.io.instructions.InstructionCodec.8
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new ZeroRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), codeInput.read(), IndexType.VARIES, 0, InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_22X { // from class: com.android.dx.io.instructions.InstructionCodec.9
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new TwoRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, 0L, InstructionCodec.byte1(i2), codeInput.read());
        }
    ...
    FORMAT_21T { // from class: com.android.dx.io.instructions.InstructionCodec.10
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new OneRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, (codeInput.cursor() - 1) + ((short) codeInput.read()), 0L, InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_21S { // from class: com.android.dx.io.instructions.InstructionCodec.11
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new OneRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, (short) codeInput.read(), InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_21H { // from class: com.android.dx.io.instructions.InstructionCodec.12
        ...
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            ...
            return new OneRegisterDecodedInstruction(this, byte0, 0, null, 0, ((short) codeInput.read()) << (byte0 == 21 ? (char) 16 : '0'), InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_21C { // from class: com.android.dx.io.instructions.InstructionCodec.13
        ...
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            int byte0 = InstructionCodec.byte0(i2);
            return new OneRegisterDecodedInstruction(this, byte0, codeInput.read(), OpcodeInfo.getIndexType(byte0), 0, 0L, InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_22T { // from class: com.android.dx.io.instructions.InstructionCodec.16
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new TwoRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, (codeInput.cursor() - 1) + ((short) codeInput.read()), 0L, InstructionCodec.nibble2(i2), InstructionCodec.nibble3(i2));
        }
    ...
    FORMAT_22S { // from class: com.android.dx.io.instructions.InstructionCodec.17
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new TwoRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, (short) codeInput.read(), InstructionCodec.nibble2(i2), InstructionCodec.nibble3(i2));
        }
    ...
    FORMAT_22C { // from class: com.android.dx.io.instructions.InstructionCodec.18
        ...
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            int byte0 = InstructionCodec.byte0(i2);
            return new TwoRegisterDecodedInstruction(this, byte0, codeInput.read(), OpcodeInfo.getIndexType(byte0), 0, 0L, InstructionCodec.nibble2(i2), InstructionCodec.nibble3(i2));
        }
    ...
    FORMAT_22CS { // from class: com.android.dx.io.instructions.InstructionCodec.19
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new TwoRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), codeInput.read(), IndexType.FIELD_OFFSET, 0, 0L, InstructionCodec.nibble2(i2), InstructionCodec.nibble3(i2));
        }
    ...
    FORMAT_30T { // from class: com.android.dx.io.instructions.InstructionCodec.20
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new ZeroRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, (codeInput.cursor() - 1) + codeInput.readInt(), InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_32X { // from class: com.android.dx.io.instructions.InstructionCodec.21
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new TwoRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, InstructionCodec.byte1(i2), codeInput.read(), codeInput.read());
        }
    ...
    FORMAT_31I { // from class: com.android.dx.io.instructions.InstructionCodec.22
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new OneRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, codeInput.readInt(), InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_31C { // from class: com.android.dx.io.instructions.InstructionCodec.24
        ...
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            int byte0 = InstructionCodec.byte0(i2);
            return new OneRegisterDecodedInstruction(this, byte0, codeInput.readInt(), OpcodeInfo.getIndexType(byte0), 0, 0L, InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_35C { // from class: com.android.dx.io.instructions.InstructionCodec.25
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return InstructionCodec.decodeRegisterList(this, i2, codeInput);
        }
    ...
    FORMAT_3RC { // from class: com.android.dx.io.instructions.InstructionCodec.28
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return InstructionCodec.decodeRegisterRange(this, i2, codeInput);
        }
    ...
    FORMAT_51L { // from class: com.android.dx.io.instructions.InstructionCodec.31
        @Override // com.android.dx.io.instructions.InstructionCodec
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            return new OneRegisterDecodedInstruction(this, InstructionCodec.byte0(i2), 0, null, 0, codeInput.readLong(), InstructionCodec.byte1(i2));
        }
    ...
    FORMAT_PACKED_SWITCH_PAYLOAD { // from class: com.android.dx.io.instructions.InstructionCodec.34
        ...
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            ...
            for (int i4 = 0; i4 < read; i4++) {
                iArr[i4] = codeInput.readInt() + baseAddressForCursor;
            }
            return new PackedSwitchPayloadDecodedInstruction(this, i2, readInt, iArr);
        }
    ...
    FORMAT_SPARSE_SWITCH_PAYLOAD { // from class: com.android.dx.io.instructions.InstructionCodec.35
        ...
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            ...
            for (int i5 = 0; i5 < read; i5++) {
                iArr2[i5] = codeInput.readInt() + baseAddressForCursor;
            }
            return new SparseSwitchPayloadDecodedInstruction(this, i2, iArr, iArr2);
        }
    ...
    FORMAT_FILL_ARRAY_DATA_PAYLOAD { // from class: com.android.dx.io.instructions.InstructionCodec.36
        ...
        public DecodedInstruction decode(int i2, CodeInput codeInput) throws EOFException {
            ...
            if (read == 1) {
                ...
                return new FillArrayDataPayloadDecodedInstruction((InstructionCodec) this, i2, bArr);
            } else if (read == 2) {
                ...
                return new FillArrayDataPayloadDecodedInstruction((InstructionCodec) this, i2, sArr);
            } else if (read == 4) {
                ...
                return new FillArrayDataPayloadDecodedInstruction((InstructionCodec) this, i2, iArr);
            } else if (read == 8) {
                ...
                return new FillArrayDataPayloadDecodedInstruction(this, i2, jArr);
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static DecodedInstruction decodeRegisterList(InstructionCodec instructionCodec, int i2, CodeInput codeInput) throws EOFException {
        int byte0 = byte0(i2);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static DecodedInstruction decodeRegisterRange(InstructionCodec instructionCodec, int i2, CodeInput codeInput) throws EOFException {
        int byte0 = byte0(i2);
        int byte1 = byte1(i2);
