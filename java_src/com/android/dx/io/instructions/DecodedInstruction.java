...
public abstract class DecodedInstruction {
    ...
    public DecodedInstruction(InstructionCodec instructionCodec, int i2, int i4, IndexType indexType, int i5, long j4) {
    ...
    public final int getTargetByte(int i2) {
    ...
    public final short getTargetUnit(int i2) {
        int target = getTarget(i2);
    ...
    public abstract DecodedInstruction withIndex(int i2);

    public DecodedInstruction withProtoIndex(int i2, int i4) {
        throw new IllegalStateException(getClass().toString());
    }

    public final int getTarget(int i2) {
        return this.target - i2;
    }
}
