...
public final class OpcodeInfo {
    ...
    public static class Info {
        ...
        public Info(int i2, String str, InstructionCodec instructionCodec, IndexType indexType) {
            this.opcode = i2;
            this.name = str;
    ...
    public static Info get(int i2) {
        ...
        throw new IllegalArgumentException("bogus opcode: " + Hex.u2or4(i2));
    }

    public static InstructionCodec getFormat(int i2) {
        return get(i2).getFormat();
    }

    public static IndexType getIndexType(int i2) {
        return get(i2).getIndexType();
    }
