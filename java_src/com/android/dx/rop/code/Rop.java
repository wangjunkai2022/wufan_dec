...
public final class Rop {
    ...
    public Rop(int i2, Type type, TypeList typeList, TypeList typeList2, int i4, boolean z3, String str) {
    ...
    public String toString() {
        ...
        if (size == 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                sb.append(' ');
                sb.append(this.sources.getType(i2));
            }
        }
        if (this.isCallLike) {
            sb.append(" call");
        ...
        if (size2 != 0) {
            ...
            for (int i4 = 0; i4 < size2; i4++) {
                sb.append(' ');
                if (this.exceptions.getType(i4) == Type.THROWABLE) {
                    sb.append("<any>");
                } else {
                    sb.append(this.exceptions.getType(i4));
                }
            }
        } else {
            int i5 = this.branchingness;
            if (i5 == 1) {
                sb.append(" flows");
            } else if (i5 == 2) {
                sb.append(" returns");
    ...
    public Rop(int i2, Type type, TypeList typeList, TypeList typeList2, int i4, String str) {
        this(i2, type, typeList, typeList2, i4, false, str);
    }

    public Rop(int i2, Type type, TypeList typeList, int i4, String str) {
        this(i2, type, typeList, StdTypeList.EMPTY, i4, false, str);
    }

    public Rop(int i2, Type type, TypeList typeList, String str) {
        this(i2, type, typeList, StdTypeList.EMPTY, 1, false, str);
    }
    ...
    public Rop(int i2, TypeList typeList, TypeList typeList2) {
        this(i2, Type.VOID, typeList, typeList2, 6, true, null);
    }
}
