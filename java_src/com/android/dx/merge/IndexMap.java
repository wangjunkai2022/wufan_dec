...
public final class IndexMap {
    ...
    private final class EncodedValueTransformer {
        ...
        private void writeTypeAndArg(int i2, int i4) {
            this.out.writeByte(i2 | (i4 << 5));
        }
    ...
    public int adjustField(int i2) {
        return this.fieldIds[i2] & UShort.MAX_VALUE;
    }

    public int adjustMethod(int i2) {
        return this.methodIds[i2] & UShort.MAX_VALUE;
    }
    ...
    public int adjustProto(int i2) {
        return this.protoIds[i2] & UShort.MAX_VALUE;
    }
    ...
    public void putAnnotationDirectoryOffset(int i2, int i4) {
        if (i2 > 0 && i4 > 0) {
            this.annotationDirectoryOffsets.put(Integer.valueOf(i2), Integer.valueOf(i4));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putAnnotationOffset(int i2, int i4) {
        if (i2 > 0 && i4 > 0) {
            this.annotationOffsets.put(Integer.valueOf(i2), Integer.valueOf(i4));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putAnnotationSetOffset(int i2, int i4) {
        if (i2 > 0 && i4 > 0) {
            this.annotationSetOffsets.put(Integer.valueOf(i2), Integer.valueOf(i4));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putAnnotationSetRefListOffset(int i2, int i4) {
        if (i2 > 0 && i4 > 0) {
            this.annotationSetRefListOffsets.put(Integer.valueOf(i2), Integer.valueOf(i4));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putEncodedArrayValueOffset(int i2, int i4) {
        if (i2 > 0 && i4 > 0) {
            this.encodedArrayValueOffset.put(Integer.valueOf(i2), Integer.valueOf(i4));
            return;
        }
        throw new IllegalArgumentException();
    }

    public void putTypeListOffset(int i2, int i4) {
        if (i2 > 0 && i4 > 0) {
            this.typeListOffsets.put(Integer.valueOf(i2), Integer.valueOf(i4));
            return;
        }
        throw new IllegalArgumentException();
    }
