...
public class ConstCollector {
            ...
            if (definitionForRegister != null && definitionForRegister.getOpcode() != null) {
                ...
                if (typeBearer.isConstant()) {
                    ...
                    if (definitionForRegister.canThrow()) {
                        boolean z3 = typedConstant instanceof CstString;
    ...
    private void run() {
        ...
        int i4 = 0;
        while (i4 < min) {
            TypedConstant typedConstant = constsSortedByCountUse.get(i4);
    ...
    private void updateConstUses(HashMap<TypedConstant, RegisterSpec> hashMap, int i2) {
