...
public class SCCP {
    ...
    private void addUsersToWorklist(int i2, int i4) {
        if (i4 == 2) {
        ...
        for (SsaInsn ssaInsn2 : this.ssaMeth.getUseListForRegister(i2)) {
            this.ssaWorklist.add(ssaInsn2);
        }
    }

    private static String latticeValName(int i2) {
        return i2 != 0 ? i2 != 1 ? i2 != 2 ? "UNKNOWN" : "VARYING" : "CONSTANT" : "TOP";
    }
    ...
    private void replaceBranches() {
        ...
        while (it2.hasNext()) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                int i5 = block.getSuccessorList().get(i4);
                if (!this.executableBlocks.get(i5)) {
                    i2 = i5;
                }
            }
            if (size == 2 && i2 != -1) {
    ...
    private boolean setLatticeValueTo(int i2, int i4, Constant constant) {
        if (i4 != 1) {
            ...
            return false;
        } else if (this.latticeValues[i2] == i4 && this.latticeConstants[i2].equals(constant)) {
            return false;
        } else {
            this.latticeValues[i2] = i4;
    ...
    */
    ...
    private Constant simulateMath(SsaInsn ssaInsn, int i2) {
        Constant constant;
        int i4;
        int i5;
        ...
        if (constant2 == null || constant == null || i2 != 6) {
            return null;
        }
    ...
    private void simulatePhi(PhiInsn phiInsn) {
        ...
        while (true) {
            ...
            int predBlockIndexForSourcesIndex = phiInsn.predBlockIndexForSourcesIndex(i4);
            int reg2 = sources.get(i4).getReg();
            int i6 = this.latticeValues[reg2];
