...
public final class TwoColumnOutput {
    ...
    public TwoColumnOutput(Writer writer, int i2, int i4, String str) {
        ...
        if (i4 >= 1) {
            ...
            this.leftColumn = new IndentingWriter(stringWriter, i2);
            this.rightColumn = new IndentingWriter(stringWriter2, i4, str);
            return;
        }
    ...
    public static String toString(String str, int i2, String str2, String str3, int i4) {
        StringWriter stringWriter = new StringWriter((str.length() + str3.length()) * 3);
        TwoColumnOutput twoColumnOutput = new TwoColumnOutput(stringWriter, i2, i4, str2);
        try {
    ...
    private static void writeSpaces(Writer writer, int i2) throws IOException {
        while (i2 > 0) {
            writer.write(32);
            i2--;
        }
    ...
    public TwoColumnOutput(OutputStream outputStream, int i2, int i4, String str) {
        this(new OutputStreamWriter(outputStream), i2, i4, str);
    }
}
