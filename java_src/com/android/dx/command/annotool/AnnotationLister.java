...
public class AnnotationLister {
    ...
    public void printMatch(DirectClassFile directClassFile) {
        ...
        while (it2.hasNext()) {
            int i2 = AnonymousClass2.$SwitchMap$com$android$dx$command$annotool$Main$PrintType[((Main.PrintType) it2.next()).ordinal()];
            if (i2 == 1) {
                System.out.println(directClassFile.getThisClass().getClassType().getClassName().replace('/', d.f65364a));
            } else if (i2 == 2) {
    ...
    private void printMatchPackage(String str) {
        ...
        while (it2.hasNext()) {
            ...
            if (i2 == 1 || i2 == 2 || i2 == 3) {
                ...
                System.out.println(str.replace('/', d.f65364a));
            }
        }
    }
