...
public class ByteOps {
    ...
    static {
        ...
        while (i2 < 2498) {
            int i4 = 16;
            int digit = (Character.digit(OPCODE_DETAILS.charAt(i2), 16) << 4) | Character.digit(OPCODE_DETAILS.charAt(i2 + 1), 16);
            char charAt = OPCODE_DETAILS.charAt(i2 + 3);
            if (charAt == '-') {
                i4 = 1;
            } else if (charAt == 'I') {
                i4 = 13;
            ...
            int i5 = i2 + 5;
            if (OPCODE_DETAILS.charAt(i5 - 1) == ':') {
                while (true) {
                    char charAt2 = OPCODE_DETAILS.charAt(i5);
                    if (charAt2 == 'D') {
                        i4 |= 256;
                    } else if (charAt2 == 'F') {
                        i4 |= 64;
            ...
            int indexOf = OPCODE_DETAILS.indexOf(59, i5);
            OPCODE_INFO[digit] = i4;
            OPCODE_NAMES[digit] = OPCODE_DETAILS.substring(i5, indexOf);
            i2 = indexOf + 1;
        }
    }
    ...
    public static int opInfo(int i2) {
        return OPCODE_INFO[i2];
    }

    public static String opName(int i2) {
        String[] strArr = OPCODE_NAMES;
        String str = strArr[i2];
        if (str == null) {
            String str2 = "unused_" + Hex.u1(i2);
            strArr[i2] = str2;
            return str2;
        }
        return str;
