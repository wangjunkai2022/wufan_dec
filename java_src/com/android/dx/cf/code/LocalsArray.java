...
public abstract class LocalsArray extends MutabilityControl implements ToHuman {
    ...
    public abstract TypeBearer get(int i2);

    public abstract TypeBearer getCategory1(int i2);

    public abstract TypeBearer getCategory2(int i2);

    public abstract int getMaxLocals();

    public abstract TypeBearer getOrNull(int i2);

    /* JADX INFO: Access modifiers changed from: protected */
    public abstract OneLocalsArray getPrimary();

    public abstract void invalidate(int i2);

    public abstract void makeInitialized(Type type);

    public abstract LocalsArray merge(LocalsArray localsArray);

    public abstract LocalsArraySet mergeWithSubroutineCaller(LocalsArray localsArray, int i2);

    public abstract void set(int i2, TypeBearer typeBearer);
