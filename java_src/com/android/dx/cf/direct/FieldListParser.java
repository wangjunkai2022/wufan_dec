...
public final class FieldListParser extends MemberListParser {
    ...
    public FieldListParser(DirectClassFile directClassFile, CstType cstType, int i2, AttributeFactory attributeFactory) {
    ...
    protected Member set(int i2, int i4, CstNat cstNat, AttributeList attributeList) {
        StdField stdField = new StdField(getDefiner(), i4, cstNat, attributeList);
        this.fields.set(i2, stdField);
        return stdField;
    }
}
