...
public abstract class MemberListParser {
    ...
    private void parse() {
        ...
        if (parseObserver != null) {
            int i5 = this.offset;
            parseObserver.parsed(bytes, i5, 2, humanName() + "s_count: " + Hex.u2(count));
        }
        int i6 = 0;
        while (i6 < count) {
            try {
                ...
                i4 = attributeListParser.getEndOffset();
                ...
                if (parseObserver7 != null) {
                    ...
                    parseObserver8.parsed(bytes, i4, 0, "end " + humanName() + "s[" + i6 + "]\n");
                    i2 = i6;
                    try {
    ...
    protected abstract String humanAccessFlags(int i2);
    ...
    protected abstract Member set(int i2, int i4, CstNat cstNat, AttributeList attributeList);
