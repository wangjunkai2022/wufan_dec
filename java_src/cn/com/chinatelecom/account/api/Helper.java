...
public final class Helper {
    ...
    public static native String cepahsul(boolean z3);

    public static native String dnepah(Context context, String str, String str2, String str3, long j4, boolean z3, boolean z4, String str4);
