...
public abstract class InnerShareParams {
    ...
    public void setDouyinShareToPublish(boolean z3) {
        set(SHARE_TO_PUBLISH, Boolean.valueOf(z3));
    }
    ...
    public void setFamily(boolean z3) {
        set(IS_FAMILY, Boolean.valueOf(z3));
    }
    ...
    public void setFriend(boolean z3) {
        set(IS_FRIEND, Boolean.valueOf(z3));
    }
    ...
    public void setLongitude(float f4) {
        set(LONGITUDE, Float.valueOf(f4));
    }
    ...
    public void setOpenCustomEven(boolean z3) {
        set(IS_LOG_EVEN, Boolean.valueOf(z3));
    }

    public void setPublic(boolean z3) {
        set(IS_PUBLIC, Boolean.valueOf(z3));
    }
    ...
    public void setScence(int i2) {
        set(SCENCE, Integer.valueOf(i2));
    }

    public void setShareTencentWeibo(boolean z3) {
        set(IS_SHARE_TENCENT_WEIBO, Boolean.valueOf(z3));
    }
    ...
    public void setTagPosition(int i2) {
        set(TAG_POSITION, Integer.valueOf(i2));
    }
    ...
    public void setWxWithShareTicket(boolean z3) {
        set(WX_MINIPROGRAM_WITH_SHARETICKET, Boolean.valueOf(z3));
    }
