...
public class PRTHeader extends LinearLayout {
    ...
    public PRTHeader(Context context) {
        ...
        float f4 = (screenSize[0] < screenSize[1] ? screenSize[0] : screenSize[1]) / 720.0f;
        setOrientation(1);
        ...
        this.tvHeader.setPadding(i4, 0, i4, 0);
    ...
    public void onPullDown(int i2) {
        if (i2 > 100) {
            int i4 = ((i2 - 100) * 180) / 20;
            int i5 = i4 <= 180 ? i4 : 180;
            if (i5 < 0) {
                i5 = 0;
            }
            this.ivArrow.setRotation(i5);
        } else {
