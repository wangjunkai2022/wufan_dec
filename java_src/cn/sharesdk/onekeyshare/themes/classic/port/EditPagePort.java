...
public class EditPagePort extends EditPage {
    ...
    private void initBody(RelativeLayout relativeLayout, float f4) {
        ...
        this.rlThumb.addView(this.aivThumb, new RelativeLayout.LayoutParams(i4, i4));
    ...
    private void initBottom(LinearLayout linearLayout, float f4) {
        LinearLayout linearLayout2 = new LinearLayout(this.activity);
        linearLayout2.setPadding(0, 0, 0, 5);
        linearLayout2.setBackgroundColor(-1);
        linearLayout.addView(linearLayout2, new LinearLayout.LayoutParams(-1, (int) (75.0f * f4)));
        ...
        linearLayout.addView(view, new LinearLayout.LayoutParams(-1, f4 > 1.0f ? (int) f4 : 1));
    }

    private void initShadow(LinearLayout linearLayout, float f4) {
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, f4 > 1.0f ? (int) f4 : 1);
        View view = new View(this.activity);
