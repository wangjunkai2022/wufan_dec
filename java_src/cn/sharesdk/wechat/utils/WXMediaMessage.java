...
public final class WXMediaMessage {
    ...
    public static class a {
        ...
        public static WXMediaMessage a(Bundle bundle) {
            ...
            String a4 = a(bundle.getString(WXMediaMessage.Builder.KEY_IDENTIFIER));
            if (a4 != null && a4.length() > 0) {
                if (!TextUtils.isEmpty(wXMediaMessage.wxminiprogram_ext_msg)) {
                    try {
                        ...
                        b4.a(" WechatResp get _launch_wxminiprogram_ext_msg error " + th, new Object[0]);
                    }
                }
                try {
                    IMediaObject iMediaObject = (IMediaObject) Class.forName(a4).newInstance();
                    wXMediaMessage.mediaObject = iMediaObject;
                    iMediaObject.unserialize(bundle);
                    return wXMediaMessage;
                } catch (Exception e4) {
                    SSDKLog b5 = SSDKLog.b();
                    b5.a("get media object from bundle failed: unknown ident " + a4 + ", ex = " + e4.getMessage(), new Object[0]);
                }
            }
            return wXMediaMessage;
        }
        ...
        private static String a(String str) {
            if (str != null && str.length() != 0) {
                ...
                SSDKLog b4 = SSDKLog.b();
                b4.a("pathOldToNew fail, invalid pos, oldPath = " + str, new Object[0]);
                return str;
            }
