...
public class a extends cn.sharesdk.framework.authorize.b {
    ...
    private void a(HashMap<String, String> hashMap) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                HashMap<String, Object> c4 = cn.sharesdk.tencent.qq.utils.a.a(this.activity.getHelper().getPlatform()).c(str);
                if (c4 != null && c4.size() > 0) {
                    if (!c4.containsKey("openid")) {
                    ...
                    bundle.putString("open_id", String.valueOf(c4.get("openid")));
