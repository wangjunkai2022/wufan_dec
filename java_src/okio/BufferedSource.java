...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    boolean rangeEquals(long j4, @NotNull ByteString byteString, int i2, int i4) throws IOException;

    int read(@NotNull byte[] bArr) throws IOException;

    int read(@NotNull byte[] bArr, int i2, int i4) throws IOException;
