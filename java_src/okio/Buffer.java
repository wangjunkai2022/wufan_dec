...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    /* compiled from: Buffer.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\t\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u001d\u0010\u001eJ\u0006\u0010\u0003\u001a\u00020\u0002J\u000e\u0010\u0006\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004J\u000e\u0010\b\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0004J\u000e\u0010\n\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\u0002J\b\u0010\f\u001a\u00020\u000bH\u0016R\u0016\u0010\u000e\u001a\u00020\r8\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u000e\u0010\u000fR\u0018\u0010\u0011\u001a\u0004\u0018\u00010\u00108\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012R\u0018\u0010\u0014\u001a\u0004\u0018\u00010\u00138\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u0014\u0010\u0015R\u0018\u0010\u0017\u001a\u0004\u0018\u00010\u00168\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u0017\u0010\u0018R\u0016\u0010\u0019\u001a\u00020\u00028\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u0019\u0010\u001aR\u0016\u0010\u001b\u001a\u00020\u00028\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u001b\u0010\u001aR\u0016\u0010\u0005\u001a\u00020\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0006\n\u0004\b\u0005\u0010\u001c¨\u0006\u001f"}, d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "", "next", "", "offset", "seek", "newSize", "resizeBuffer", "minByteCount", "expandBuffer", "", "close", "", "readWrite", "Z", "Lokio/Segment;", "segment", "Lokio/Segment;", "", "data", "[B", "Lokio/Buffer;", "buffer", "Lokio/Buffer;", "start", "I", "end", "J", "<init>", "()V", "okio"}, k = 1, mv = {1, 4, 0})
                    ...
                    if (j4 <= size) {
                        if (j4 >= 0) {
                            ...
                            while (true) {
                                ...
                                long j6 = i4 - segment2.pos;
                                if (j6 <= j5) {
                                    buffer.head = segment2.pop();
                                    SegmentPool.recycle(segment2);
                                    j5 -= j6;
                                } else {
                                    segment2.limit = i4 - ((int) j5);
                                    break;
                                }
                            }
                            this.segment = null;
    ...
    public static /* synthetic */ Buffer copyTo$default(Buffer buffer, OutputStream outputStream, long j4, long j5, int i2, Object obj) throws IOException {
        if ((i2 & 2) != 0) {
            j4 = 0;
        }
        long j6 = j4;
    ...
    public static /* synthetic */ Buffer copyTo$default(Buffer buffer, Buffer buffer2, long j4, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j4 = 0;
        }
    ...
    public static /* synthetic */ Buffer copyTo$default(Buffer buffer, Buffer buffer2, long j4, long j5, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j4 = 0;
        }
    ...
    public static /* synthetic */ Buffer writeTo$default(Buffer buffer, OutputStream outputStream, long j4, int i2, Object obj) throws IOException {
        if ((i2 & 2) != 0) {
            j4 = buffer.size;
        }
    ...
    public final byte m1411deprecated_getByte(long j4) {
        return getByte(j4);
    }
    ...
    public final long m1412deprecated_size() {
        return this.size;
    }
    ...
    public final Buffer copyTo(@NotNull OutputStream out, long j4, long j5) throws IOException {
        ...
        while (j5 > 0) {
            Intrinsics.checkNotNull(segment);
            int min = (int) Math.min(segment.limit - i2, j5);
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: okio.Buffer$inputStream$1
            ...
            @Override // java.io.InputStream
            public int read(@NotNull byte[] sink, int i2, int i4) {
                Intrinsics.checkNotNullParameter(sink, "sink");
                return Buffer.this.read(sink, i2, i4);
            }
        };
    }
    ...
    public OutputStream outputStream() {
        return new OutputStream() { // from class: okio.Buffer$outputStream$1
            ...
            @Override // java.io.OutputStream
            public void write(@NotNull byte[] data, int i2, int i4) {
                Intrinsics.checkNotNullParameter(data, "data");
                Buffer.this.write(data, i2, i4);
            }
        };
    }
    ...
    */
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (size() != 0) {
            ...
            throw new EOFException("size < " + i4 + ": " + size() + " (to read code point prefixed 0x" + Util.toHexString(b4) + ')');
        }
        throw new EOFException();
    }
    ...
    @Override // okio.BufferedSource
    public boolean rangeEquals(long j4, @NotNull ByteString bytes, int i2, int i4) {
        Intrinsics.checkNotNullParameter(bytes, "bytes");
        if (j4 < 0 || i2 < 0 || i4 < 0 || size() - j4 < i4 || bytes.size() - i2 < i4) {
            return false;
        }
        for (int i5 = 0; i5 < i4; i5++) {
            if (getByte(i5 + j4) != bytes.getByte(i2 + i5)) {
                return false;
            }
        }
        return true;
    ...
    public String readString(long j4, @NotNull Charset charset) throws EOFException {
        ...
        if (j4 >= 0 && j4 <= ((long) Integer.MAX_VALUE)) {
            if (this.size >= j4) {
                ...
                int i4 = (int) j4;
                String str = new String(segment.data, i2, i4, charset);
    ...
    public Buffer writeDecimalLong(long j4) {
        ...
        } else if (j4 >= com.join.mgps.data.c.f47286a) {
        ...
        while (j4 != 0) {
            long j5 = 10;
            i4--;
            bArr[i4] = BufferKt.getHEX_DIGIT_BYTES()[(int) (j4 % j5)];
            j4 /= j5;
        }
        if (z3) {
            bArr[i4 - 1] = (byte) 45;
    ...
    public Buffer writeHexadecimalUnsignedLong(long j4) {
        ...
        for (int i5 = (i4 + i2) - 1; i5 >= i4; i5--) {
            bArr[i5] = BufferKt.getHEX_DIGIT_BYTES()[(int) (15 & j4)];
            j4 >>>= 4;
        }
        writableSegment$okio.limit += i2;
        setSize$okio(size() + i2);
    ...
    @Override // okio.BufferedSink
    @NotNull
    public Buffer writeString(@NotNull String string, int i2, int i4, @NotNull Charset charset) {
        Intrinsics.checkNotNullParameter(string, "string");
        Intrinsics.checkNotNullParameter(charset, "charset");
        if (!(i2 >= 0)) {
    ...
    @Override // okio.BufferedSink
    @NotNull
    public Buffer writeUtf8(@NotNull String string, int i2, int i4) {
        Intrinsics.checkNotNullParameter(string, "string");
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(("beginIndex < 0: " + i2).toString());
        }
    ...
    public int read(@NotNull byte[] sink, int i2, int i4) {
        ...
        if (segment != null) {
            ...
            byte[] bArr = segment.data;
            int i5 = segment.pos;
            ArraysKt.copyInto(bArr, sink, i2, i5, i5 + min);
            segment.pos += min;
    ...
    @Override // okio.BufferedSink
    @NotNull
    public Buffer write(@NotNull ByteString byteString, int i2, int i4) {
        Intrinsics.checkNotNullParameter(byteString, "byteString");
        byteString.write$okio(this, i2, i4);
        return this;
    }
    ...
    @Override // okio.BufferedSink
    @NotNull
    public Buffer write(@NotNull byte[] source, int i2, int i4) {
        Intrinsics.checkNotNullParameter(source, "source");
        long j4 = i4;
        ...
        while (i2 < i5) {
            ...
            int i6 = i2 + min;
            ArraysKt.copyInto(source, writableSegment$okio.data, writableSegment$okio.limit, i2, i6);
            writableSegment$okio.limit += min;
            i2 = i6;
        }
                ...
                if (segment != null) {
                    if (size() - j5 < j5) {
                        ...
                        while (size < size3) {
                            ...
                            for (int i2 = (int) ((segment.pos + j5) - j7); i2 < min; i2++) {
                                if (bArr[i2] == b4 && BufferKt.rangeEquals(segment, i2 + 1, internalArray$okio, 1, size2)) {
                                    return (i2 - segment.pos) + j7;
                                }
                            }
                        ...
                        while (j6 < size5) {
                            ...
                            for (int i4 = (int) ((segment.pos + j5) - j6); i4 < min2; i4++) {
                                if (bArr2[i4] == b5 && BufferKt.rangeEquals(segment, i4 + 1, internalArray$okio2, 1, size4)) {
