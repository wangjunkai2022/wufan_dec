...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    @NotNull
    BufferedSink write(@NotNull ByteString byteString, int i2, int i4) throws IOException;
    ...
    @NotNull
    BufferedSink write(@NotNull byte[] bArr, int i2, int i4) throws IOException;
    ...
    @NotNull
    BufferedSink writeString(@NotNull String str, int i2, int i4, @NotNull Charset charset) throws IOException;
    ...
    @NotNull
    BufferedSink writeUtf8(@NotNull String str, int i2, int i4) throws IOException;
