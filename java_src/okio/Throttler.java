...
public final class Throttler {
    ...
    public static /* synthetic */ void bytesPerSecond$default(Throttler throttler, long j4, long j5, long j6, int i2, Object obj) {
        if ((i2 & 2) != 0) {
    ...
    private final long bytesToNanos(long j4) {
        return (j4 * k.f56834a) / this.bytesPerSecond;
    }

    private final long nanosToBytes(long j4) {
        return (j4 * this.bytesPerSecond) / k.f56834a;
    }
