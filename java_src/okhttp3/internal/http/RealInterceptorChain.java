...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(List<Interceptor> list, StreamAllocation streamAllocation, HttpCodec httpCodec, RealConnection realConnection, int i2, Request request, Call call, EventListener eventListener, int i4, int i5, int i6) {
