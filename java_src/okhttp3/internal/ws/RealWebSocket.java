...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public static final class Close {
        ...
        Close(int i2, ByteString byteString, long j4) {
            this.code = i2;
    ...
    synchronized boolean close(int i2, String str, long j4) {
        ...
        if (!this.failed && !this.enqueuedClose) {
            ...
            this.messageAndCloseQueue.add(new Close(i2, byteString, j4));
            runWriter();
            return true;
        }
        return false;
