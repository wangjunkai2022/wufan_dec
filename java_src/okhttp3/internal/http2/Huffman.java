...
class Huffman {
    ...
    private void addCode(int i2, int i4, byte b4) {
        Node node = new Node(i2, b4);
    ...
    public byte[] decode(byte[] bArr) {
        ...
        for (byte b4 : bArr) {
            ...
            i4 += 8;
            while (i4 >= 8) {
                node = node.children[(i2 >>> (i4 - 8)) & 255];
        ...
        while (i4 > 0) {
            Node node2 = node.children[(i2 << (8 - i4)) & 255];
    ...
    public void encode(ByteString byteString, BufferedSink bufferedSink) throws IOException {
        ...
        while (i2 < byteString.size()) {
            ...
            int i5 = CODES[i4];
            byte b5 = CODE_LENGTHS[i4];
            j4 = (j4 << b5) | i5;
            int i6 = b4 + b5;
            while (i6 >= 8) {
                i6 = (i6 == 1 ? 1 : 0) - 8;
                bufferedSink.writeByte((int) (j4 >> i6));
            }
            i2++;
            b4 = i6;
        }
    ...
    public int encodedLength(ByteString byteString) {
        ...
        for (int i2 = 0; i2 < byteString.size(); i2++) {
            j4 += CODE_LENGTHS[byteString.getByte(i2) & 255];
        }
        return (int) ((j4 + 7) >> 3);
    }
