...
public final class Util {
    ...
    private static boolean decodeIpv4Suffix(String str, int i2, int i4, byte[] bArr, int i5) {
        int i6 = i5;
        while (i2 < i4) {
            if (i6 == bArr.length) {
                return false;
            ...
            while (i7 < i4) {
                ...
                if (charAt < '0' || charAt > '9') {
                    break;
                } else if ((i8 == 0 && i2 != i7) || (i8 = ((i8 * 10) + charAt) - 48) > 255) {
                    return false;
                } else {
                    i7++;
                }
    ...
    */
    ...
    public static int delimiterOffset(String str, int i2, int i4, String str2) {
        while (i2 < i4) {
    ...
    public static int skipLeadingAsciiWhitespace(String str, int i2, int i4) {
        while (i2 < i4) {
            char charAt = str.charAt(i2);
    ...
    public static int skipTrailingAsciiWhitespace(String str, int i2, int i4) {
    ...
    public static String trimSubstring(String str, int i2, int i4) {
        int skipLeadingAsciiWhitespace = skipLeadingAsciiWhitespace(str, i2, i4);
        return str.substring(skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace(str, skipLeadingAsciiWhitespace, i4));
    }
    ...
    public static int delimiterOffset(String str, int i2, int i4, char c4) {
        while (i2 < i4) {
            if (str.charAt(i2) == c4) {
                return i2;
            }
