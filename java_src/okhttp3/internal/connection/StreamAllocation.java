...
public final class StreamAllocation {
    ...
    private RealConnection findConnection(int i2, int i4, int i5, int i6, boolean z3) throws IOException {
        ...
        realConnection2.connect(i2, i4, i5, i6, z3, this.call, this.eventListener);
    ...
    private RealConnection findHealthyConnection(int i2, int i4, int i5, int i6, boolean z3, boolean z4) throws IOException {
        while (true) {
            RealConnection findConnection = findConnection(i2, i4, i5, i6, z3);
            synchronized (this.connectionPool) {
