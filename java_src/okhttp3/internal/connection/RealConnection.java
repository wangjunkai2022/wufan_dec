...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int i2, int i4, Call call, EventListener eventListener) throws IOException {
        Socket createSocket;
    ...
    private void connectTunnel(int i2, int i4, int i5, Call call, EventListener eventListener) throws IOException {
        Request createTunnelRequest = createTunnelRequest();
        HttpUrl url = createTunnelRequest.url();
        for (int i6 = 0; i6 < 21; i6++) {
            connectSocket(i2, i4, call, eventListener);
            createTunnelRequest = createTunnel(i4, i5, createTunnelRequest, url);
    ...
    private Request createTunnel(int i2, int i4, Request request, HttpUrl httpUrl) throws IOException {
    ...
    private Request createTunnelRequest() throws IOException {
        ...
        Request authenticate = this.route.address().proxyAuthenticator().authenticate(this.route, new Response.Builder().request(build).protocol(Protocol.HTTP_1_1).code(TTAdConstant.DOWNLOAD_URL_CODE).message("Preemptive Authenticate").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1L).receivedResponseAtMillis(-1L).header("Proxy-Authenticate", "OkHttp-Preemptive").build());
