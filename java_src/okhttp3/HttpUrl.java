...
public final class HttpUrl {
    ...
    static String canonicalize(String str, int i2, int i4, String str2, boolean z3, boolean z4, boolean z5, boolean z6, Charset charset) {
        int i5 = i2;
        while (i5 < i4) {
            int codePointAt = str.codePointAt(i5);
            if (codePointAt >= 32 && codePointAt != 127 && (codePointAt < 128 || !z6)) {
                if (str2.indexOf(codePointAt) == -1 && ((codePointAt != 37 || (z3 && (!z4 || percentEncoded(str, i5, i4)))) && (codePointAt != 43 || !z5))) {
                    i5 += Character.charCount(codePointAt);
                }
            }
            Buffer buffer = new Buffer();
            buffer.writeUtf8(str, i2, i5);
            canonicalize(buffer, str, i5, i4, str2, z3, z4, z5, z6, charset);
    ...
    static boolean percentEncoded(String str, int i2, int i4) {
        int i5 = i2 + 2;
        return i5 < i4 && str.charAt(i2) == '%' && Util.decodeHexDigit(str.charAt(i2 + 1)) != -1 && Util.decodeHexDigit(str.charAt(i5)) != -1;
    }
    ...
    public static final class Builder {
        ...
        private static String canonicalizeHost(String str, int i2, int i4) {
            return Util.canonicalizeHost(HttpUrl.percentDecode(str, i2, i4, false));
        }

        private boolean isDot(String str) {
            return str.equals(g0.f27568a) || str.equalsIgnoreCase("%2e");
        }
        ...
        private static int parsePort(String str, int i2, int i4) {
            int parseInt;
            try {
                parseInt = Integer.parseInt(HttpUrl.canonicalize(str, i2, i4, "", false, false, false, true, null));
        ...
        private static int portColonOffset(String str, int i2, int i4) {
            while (i2 < i4) {
        ...
        private void push(String str, int i2, int i4, boolean z3, boolean z4) {
            String canonicalize = HttpUrl.canonicalize(str, i2, i4, HttpUrl.PATH_SEGMENT_ENCODE_SET, z4, false, false, true, null);
        ...
        */
        ...
        private static int schemeDelimiterOffset(String str, int i2, int i4) {
            if (i4 - i2 < 2) {
                return -1;
            }
            char charAt = str.charAt(i2);
        ...
        private static int slashCount(String str, int i2, int i4) {
            int i5 = 0;
            while (i2 < i4) {
                char charAt = str.charAt(i2);
                if (charAt != '\\' && charAt != '/') {
        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) {
            ...
            if (slashCount < 2 && httpUrl != null && httpUrl.scheme.equals(this.scheme)) {
                ...
                int portColonOffset = portColonOffset(str, i4, delimiterOffset);
                int i5 = portColonOffset + 1;
                if (i5 < delimiterOffset) {
                    this.host = canonicalizeHost(str, i4, portColonOffset);
                    int parsePort = parsePort(str, i5, delimiterOffset);
                    this.port = parsePort;
                    if (parsePort == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str.substring(i5, delimiterOffset) + '\"');
                    }
                } else {
                    this.host = canonicalizeHost(str, i4, portColonOffset);
        ...
        public Builder scheme(String str) {
            ...
            if (str.equalsIgnoreCase(f.f11765a)) {
                this.scheme = f.f11765a;
        ...
        private Builder addPathSegments(String str, boolean z3) {
            ...
            do {
                ...
                push(str, i2, delimiterOffset, delimiterOffset < str.length(), z3);
    ...
    static String percentDecode(String str, int i2, int i4, boolean z3) {
        for (int i5 = i2; i5 < i4; i5++) {
            char charAt = str.charAt(i5);
            if (charAt == '%' || (charAt == '+' && z3)) {
                Buffer buffer = new Buffer();
                buffer.writeUtf8(str, i2, i5);
                percentDecode(buffer, str, i5, i4, z3);
                return buffer.readUtf8();
            }
        }
        return str.substring(i2, i4);
    ...
    static void canonicalize(Buffer buffer, String str, int i2, int i4, String str2, boolean z3, boolean z4, boolean z5, boolean z6, Charset charset) {
        Buffer buffer2 = null;
        while (i2 < i4) {
            ...
            if (!z3 || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                ...
                } else if (codePointAt >= 32 && codePointAt != 127 && ((codePointAt < 128 || !z6) && str2.indexOf(codePointAt) == -1 && (codePointAt != 37 || (z3 && (!z4 || percentEncoded(str, i2, i4)))))) {
    ...
    static void percentDecode(Buffer buffer, String str, int i2, int i4, boolean z3) {
        int i5;
        while (i2 < i4) {
            int codePointAt = str.codePointAt(i2);
            if (codePointAt == 37 && (i5 = i2 + 2) < i4) {
