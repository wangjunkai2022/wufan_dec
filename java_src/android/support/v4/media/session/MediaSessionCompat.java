...
public class MediaSessionCompat {
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void adjustVolume(int i2, int i4, String str) {
                MediaSessionImplBase.this.adjustVolume(i2, i4);
            }
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    if (i2 == 2) {
                        ...
                        streamMaxVolume = mediaSessionImplBase.mAudioManager.getStreamMaxVolume(i4);
                        streamVolume = MediaSessionImplBase.this.mAudioManager.getStreamVolume(i4);
                    }
                }
                return new ParcelableVolumeInfo(i2, i4, i5, streamMaxVolume, streamVolume);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setVolumeTo(int i2, int i4, String str) {
                MediaSessionImplBase.this.setVolumeTo(i2, i4);
            }
            ...
            void postToHandler(int i2, int i4) {
                MediaSessionImplBase.this.postToHandler(i2, i4, 0, null, null);
            }
            ...
            void postToHandler(int i2, Object obj, int i4) {
                MediaSessionImplBase.this.postToHandler(i2, i4, 0, obj, null);
            }
        ...
        void adjustVolume(int i2, int i4) {
            ...
            this.mAudioManager.adjustStreamVolume(this.mLocalStream, i2, i4);
        }
        ...
        void postToHandler(int i2, int i4, int i5, Object obj, Bundle bundle) {
            synchronized (this.mLock) {
                MessageHandler messageHandler = this.mHandler;
                if (messageHandler != null) {
                    Message obtainMessage = messageHandler.obtainMessage(i2, i4, i5, obj);
                    Bundle bundle2 = new Bundle();
        ...
        void setVolumeTo(int i2, int i4) {
            if (this.mVolumeType == 2) {
                VolumeProviderCompat volumeProviderCompat = this.mVolumeProvider;
                if (volumeProviderCompat != null) {
            ...
            this.mAudioManager.setStreamVolume(this.mLocalStream, i2, i4);
        }
