...
public class MediaControllerCompatApi21 {
    ...
    public interface Callback {
        void onAudioInfoChanged(int i2, int i4, int i5, int i6, int i7);
    ...
    public static void adjustVolume(Object obj, int i2, int i4) {
        ((MediaController) obj).adjustVolume(i2, i4);
    }
    ...
    public static void setVolumeTo(Object obj, int i2, int i4) {
        ((MediaController) obj).setVolumeTo(i2, i4);
    }
