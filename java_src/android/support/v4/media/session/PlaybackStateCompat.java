...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setState(int i2, long j4, float f4) {
            return setState(i2, j4, f4, SystemClock.elapsedRealtime());
        }
        ...
        public Builder setState(int i2, long j4, float f4, long j5) {
            this.mState = i2;
            this.mPosition = j4;
            this.mUpdateTime = j5;
            this.mRate = f4;
