...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private static class StubApi21 implements MediaControllerCompatApi21.Callback {
            ...
            public void onAudioInfoChanged(int i2, int i4, int i5, int i6, int i7) {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(i2, i4, i5, i6, i7));
                }
            }
    ...
    public static final class PlaybackInfo {
        ...
        PlaybackInfo(int i2, int i4, int i5, int i6, int i7) {
    ...
    static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + str + g0.f27568a);
            }
        }
    }
    ...
    public void adjustVolume(int i2, int i4) {
        this.mImpl.adjustVolume(i2, i4);
    }
    ...
    public void setVolumeTo(int i2, int i4) {
        this.mImpl.setVolumeTo(i2, i4);
    }
    ...
    static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public void adjustVolume(int i2, int i4) {
            try {
                this.mBinder.adjustVolume(i2, i4, null);
            } catch (RemoteException unused) {
            }
        }
        ...
        public void setVolumeTo(int i2, int i4) {
            try {
                this.mBinder.setVolumeTo(i2, i4, null);
            } catch (RemoteException unused) {
            }
        }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void adjustVolume(int i2, int i4) {
            MediaControllerCompatApi21.adjustVolume(this.mControllerObj, i2, i4);
        }
        ...
        @Override // android.support.v4.media.session.MediaControllerCompat.MediaControllerImpl
        public void setVolumeTo(int i2, int i4) {
            MediaControllerCompatApi21.setVolumeTo(this.mControllerObj, i2, i4);
        }
