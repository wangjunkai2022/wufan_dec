...
public enum CoroutineStart {
    ...
    public final <T> void invoke(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        ...
        if (i2 == 1) {
            b3.a.e(function1, continuation);
        } else if (i2 == 2) {
            ContinuationKt.startCoroutine(function1, continuation);
        } else if (i2 == 3) {
            b3.b.a(function1, continuation);
        } else if (i2 != 4) {
    ...
    @InternalCoroutinesApi
    public final <R, T> void invoke(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r3, @NotNull Continuation<? super T> continuation) {
        int i2 = a.$EnumSwitchMapping$0[ordinal()];
        if (i2 == 1) {
            b3.a.g(function2, r3, continuation, null, 4, null);
        } else if (i2 == 2) {
            ContinuationKt.startCoroutine(function2, r3, continuation);
        } else if (i2 == 3) {
            b3.b.b(function2, r3, continuation);
        } else if (i2 != 4) {
            throw new NoWhenBranchMatchedException();
        }
    }
