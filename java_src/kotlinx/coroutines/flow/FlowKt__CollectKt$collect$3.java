...
public final class FlowKt__CollectKt$collect$3<T> implements g<T> {
    ...
    public Object a(T t3, @NotNull final Continuation<? super Unit> continuation) {
        ...
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.FlowKt__CollectKt$collect$3$emit$1
            ...
            public final Object invokeSuspend(@NotNull Object obj) {
                this.f71306a = obj;
                this.f71308c |= Integer.MIN_VALUE;
                return FlowKt__CollectKt$collect$3.this.emit(null, this);
            }
        };
        InlineMarker.mark(5);
        this.f71305a.invoke(t3, continuation);
    ...
    public Object emit(T t3, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object invoke = this.f71305a.invoke(t3, continuation);
