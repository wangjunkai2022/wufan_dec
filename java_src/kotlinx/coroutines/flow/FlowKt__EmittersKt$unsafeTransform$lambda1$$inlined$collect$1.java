...
public final class FlowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1<T> implements g<T> {

    /* renamed from: a  reason: collision with root package name */
    final /* synthetic */ Function3 f71413a;

    /* renamed from: b  reason: collision with root package name */
    final /* synthetic */ g f71414b;

    public FlowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1(Function3 function3, g gVar) {
        this.f71413a = function3;
        this.f71414b = gVar;
    }
    ...
    public Object emit(T t3, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object invoke = this.f71413a.invoke(this.f71414b, t3, continuation);
