...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<kotlinx.coroutines.channels.w<? super Object>, Continuation<? super Unit>, Object> {
    ...
    private /* synthetic */ Object f71373b;

    /* renamed from: c  reason: collision with root package name */
    final /* synthetic */ f<T> f71374c;

    /* JADX INFO: Add missing generic type declarations: [T] */
    /* compiled from: Collect.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u001b\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0002\u001a\u00028\u0000H\u0096@ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0006¸\u0006\u0007"}, d2 = {"kotlinx/coroutines/flow/FlowKt__DelayKt$sample$2$values$1$a", "Lkotlinx/coroutines/flow/g;", "value", "", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "kotlinx-coroutines-core", "kotlinx/coroutines/flow/FlowKt__CollectKt$collect$3"}, k = 1, mv = {1, 5, 1})
    /* loaded from: classes5.dex */
    public static final class a<T> implements g<T> {

        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ kotlinx.coroutines.channels.w f71375a;
        ...
        public Object emit(T t3, @NotNull Continuation<? super Unit> continuation) {
            ...
            kotlinx.coroutines.channels.w wVar = this.f71375a;
            if (t3 == null) {
    ...
    public FlowKt__DelayKt$sample$2$values$1(f<? extends T> fVar, Continuation<? super FlowKt__DelayKt$sample$2$values$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        FlowKt__DelayKt$sample$2$values$1 flowKt__DelayKt$sample$2$values$1 = new FlowKt__DelayKt$sample$2$values$1(this.f71374c, continuation);
        flowKt__DelayKt$sample$2$values$1.f71373b = obj;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            f<T> fVar = this.f71374c;
            a aVar = new a((kotlinx.coroutines.channels.w) this.f71373b);
            this.f71372a = 1;
