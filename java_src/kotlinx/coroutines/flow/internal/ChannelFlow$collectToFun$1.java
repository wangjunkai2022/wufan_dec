...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0004\u001a\u00020\u0003\"\u0004\b\u0000\u0010\u00002\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00028\u00000\u0001H\u008a@"}, d2 = {"T", "Lkotlinx/coroutines/channels/w;", "it", "", "<anonymous>"}, k = 3, mv = {1, 5, 1})
...
public final class ChannelFlow$collectToFun$1<T> extends SuspendLambda implements Function2<w<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* synthetic */ Object f71952b;

    /* renamed from: c  reason: collision with root package name */
    final /* synthetic */ ChannelFlow<T> f71953c;
    ...
    public ChannelFlow$collectToFun$1(ChannelFlow<T> channelFlow, Continuation<? super ChannelFlow$collectToFun$1> continuation) {
        ...
        this.f71953c = channelFlow;
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    @NotNull
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ChannelFlow$collectToFun$1 channelFlow$collectToFun$1 = new ChannelFlow$collectToFun$1(this.f71953c, continuation);
        channelFlow$collectToFun$1.f71952b = obj;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i2 == 0) {
            ...
            ChannelFlow<T> channelFlow = this.f71953c;
            this.f71951a = 1;
            if (channelFlow.i((w) this.f71952b, this) == coroutine_suspended) {
