...
# virtual methods
.method public J8()Lio/reactivex/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    invoke-virtual {p0, v0}, Lio/reactivex/flowables/a;->K8(I)Lio/reactivex/j;
...
.method public K8(I)Lio/reactivex/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    invoke-virtual {p0, p1, v0}, Lio/reactivex/flowables/a;->L8(ILw2/g;)Lio/reactivex/j;
...
.method public L8(ILw2/g;)Lio/reactivex/j;
    .locals 1
    .param p2    # Lw2/g;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
    ...
    .line 1
    invoke-virtual {p0, p2}, Lio/reactivex/flowables/a;->N8(Lw2/g;)V
    ...
    invoke-direct {v0, p0, p1, p2}, Lio/reactivex/internal/operators/flowable/g;-><init>(Lio/reactivex/flowables/a;ILw2/g;)V
...
.method public final M8()Lio/reactivex/disposables/b;
    .locals 1
    ...
    .line 2
    invoke-virtual {p0, v0}, Lio/reactivex/flowables/a;->N8(Lw2/g;)V
...
.method public abstract N8(Lw2/g;)V
    .param p1    # Lw2/g;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
    .end param
...
.method public O8()Lio/reactivex/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {v0, p0}, Lio/reactivex/internal/operators/flowable/FlowableRefCount;-><init>(Lio/reactivex/flowables/a;)V
...
.method public final P8(I)Lio/reactivex/j;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/flowables/a;->R8(IJLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;)Lio/reactivex/j;
...
.method public final Q8(IJLjava/util/concurrent/TimeUnit;)Lio/reactivex/j;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IJ",
...
.method public final R8(IJLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;)Lio/reactivex/j;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IJ",
...
.method public final S8(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/j;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public final T8(JLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;)Lio/reactivex/j;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
