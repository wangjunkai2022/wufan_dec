...
.method private d(Landroid/graphics/Canvas;FF)V
    ...
    invoke-virtual {v0, v5, v6}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->k(Ljava/lang/String;Landroid/graphics/Paint;)V
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->k(Ljava/lang/String;Landroid/graphics/Paint;)V
...
.method private f(Landroid/graphics/Canvas;FF)V
    ...
    invoke-virtual {p0, v4, v1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->k(Ljava/lang/String;Landroid/graphics/Paint;)V
...
.method private g(Landroid/graphics/Canvas;FFII)V
    .locals 15
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p0, v1, v2}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->k(Ljava/lang/String;Landroid/graphics/Paint;)V
...
.method private h(Landroid/graphics/Canvas;Landroidx/constraintlayout/motion/widget/MotionController;)V
    .locals 6
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {p2, v3, v2, v0}, Landroidx/constraintlayout/motion/widget/MotionController;->f(F[FI)V
...
.method private i(Landroid/graphics/Canvas;IILandroidx/constraintlayout/motion/widget/MotionController;)V
    .locals 19
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 13
    invoke-virtual {v9, v1}, Landroidx/constraintlayout/motion/widget/MotionController;->m(I)Landroidx/constraintlayout/motion/widget/MotionPaths;
    ...
    .line 17
    invoke-direct {v6, v7, v0, v1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->d(Landroid/graphics/Canvas;FF)V
    ...
    .line 19
    invoke-direct/range {v0 .. v5}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->g(Landroid/graphics/Canvas;FFII)V
    ...
    .line 22
    invoke-direct {v6, v7, v5, v4}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->d(Landroid/graphics/Canvas;FF)V
...
.method private j(Landroid/graphics/Canvas;FFFF)V
    .locals 13
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 2
    iget-object v12, v0, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->g:Landroid/graphics/Paint;
...
.method public draw(Landroid/graphics/Canvas;Ljava/util/HashMap;II)V
    ...
    invoke-static {v2}, Landroidx/constraintlayout/motion/widget/MotionLayout;->v(Landroidx/constraintlayout/motion/widget/MotionLayout;)I
    ...
    iget-object v3, p0, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->h:Landroid/graphics/Paint;
    ...
    invoke-virtual {v0, v3, v4}, Landroidx/constraintlayout/motion/widget/MotionController;->d([F[I)I
    ...
    invoke-virtual {v0, v3, v2}, Landroidx/constraintlayout/motion/widget/MotionController;->e([FI)V
    ...
    .line 27
    invoke-direct {p0, p1, v0}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->h(Landroid/graphics/Canvas;Landroidx/constraintlayout/motion/widget/MotionController;)V
...
.method public drawAll(Landroid/graphics/Canvas;IILandroidx/constraintlayout/motion/widget/MotionController;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->b(Landroid/graphics/Canvas;)V
    ...
    .line 4
    :cond_2
    invoke-direct {p0, p1}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->a(Landroid/graphics/Canvas;)V

    .line 5
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/constraintlayout/motion/widget/MotionLayout$DevModeDraw;->i(Landroid/graphics/Canvas;IILandroidx/constraintlayout/motion/widget/MotionController;)V

    return-void
.end method

.method k(Ljava/lang/String;Landroid/graphics/Paint;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
