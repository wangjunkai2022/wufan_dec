...
.method private c(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
    ...
    .line 1
    invoke-direct {p0}, Landroidx/core/widget/TextViewCompat$OreoCallback;->b()Landroid/content/Intent;

    move-result-object v0

    .line 2
    invoke-direct {p0, p2}, Landroidx/core/widget/TextViewCompat$OreoCallback;->f(Landroid/widget/TextView;)Z
...
.method private d(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    invoke-direct {p0, v1, p1}, Landroidx/core/widget/TextViewCompat$OreoCallback;->g(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
...
.method private f(Landroid/widget/TextView;)Z
    .locals 1
...
.method private g(Landroid/content/pm/ResolveInfo;Landroid/content/Context;)Z
    .locals 3
...
.method private h(Landroid/view/Menu;)V
    ...
    .line 21
    :cond_3
    invoke-direct {p0, v0, v1}, Landroidx/core/widget/TextViewCompat$OreoCallback;->d(Landroid/content/Context;Landroid/content/pm/PackageManager;)Ljava/util/List;
    ...
    .line 26
    invoke-direct {p0, v3, v7}, Landroidx/core/widget/TextViewCompat$OreoCallback;->c(Landroid/content/pm/ResolveInfo;Landroid/widget/TextView;)Landroid/content/Intent;
...
# virtual methods
.method e()Landroid/view/ActionMode$Callback;
    .locals 1
...
.method public onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    .line 1
    invoke-direct {p0, p2}, Landroidx/core/widget/TextViewCompat$OreoCallback;->h(Landroid/view/Menu;)V
