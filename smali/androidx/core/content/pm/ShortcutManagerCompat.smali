...
.field private static volatile e:Landroidx/core/content/pm/ShortcutInfoCompatSaver; = null
...
.field private static volatile f:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
...
.field private static final g:Ljava/lang/String; = "androidx.core.content.pm.SHORTCUT_LISTENER"

.field private static final h:Ljava/lang/String; = "androidx.core.content.pm.shortcut_listener_impl"
...
.method public static addDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    .line 7
    :cond_2
    invoke-static {p0}, Landroidx/core/content/pm/ShortcutManagerCompat;->g(Landroid/content/Context;)Landroidx/core/content/pm/ShortcutInfoCompatSaver;
    ...
    .line 8
    invoke-static {p0}, Landroidx/core/content/pm/ShortcutManagerCompat;->f(Landroid/content/Context;)Ljava/util/List;
...
.method static d()Ljava/util/List;
    ...
    .line 1
    sget-object v0, Landroidx/core/content/pm/ShortcutManagerCompat;->f:Ljava/util/List;
...
.method private static f(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 17
    :cond_3
    sget-object p0, Landroidx/core/content/pm/ShortcutManagerCompat;->f:Ljava/util/List;

    if-nez p0, :cond_4

    .line 18
    sput-object v0, Landroidx/core/content/pm/ShortcutManagerCompat;->f:Ljava/util/List;
...
.method private static g(Landroid/content/Context;)Landroidx/core/content/pm/ShortcutInfoCompatSaver;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    sget-object v0, Landroidx/core/content/pm/ShortcutManagerCompat;->e:Landroidx/core/content/pm/ShortcutInfoCompatSaver;
    ...
    sput-object p0, Landroidx/core/content/pm/ShortcutManagerCompat;->e:Landroidx/core/content/pm/ShortcutInfoCompatSaver;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    :goto_0
    sget-object p0, Landroidx/core/content/pm/ShortcutManagerCompat;->e:Landroidx/core/content/pm/ShortcutInfoCompatSaver;
...
.method static h(Ljava/util/List;)V
    ...
    .line 1
    sput-object p0, Landroidx/core/content/pm/ShortcutManagerCompat;->f:Ljava/util/List;

    return-void
.end method

.method static i(Landroidx/core/content/pm/ShortcutInfoCompatSaver;)V
    .locals 0
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
...
.method public static pushDynamicShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Z
    ...
    .line 13
    invoke-static {v3}, Landroidx/core/content/pm/ShortcutManagerCompat$Api25Impl;->a(Ljava/util/List;)Ljava/lang/String;
    ...
    .line 19
    invoke-static {v3}, Landroidx/core/content/pm/ShortcutManagerCompat;->e(Ljava/util/List;)Ljava/lang/String;
