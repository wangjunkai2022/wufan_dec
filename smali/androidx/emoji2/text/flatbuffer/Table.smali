...
.method protected static h(ILjava/nio/ByteBuffer;Landroidx/emoji2/text/flatbuffer/Utf8;)Ljava/lang/String;
    .locals 1
...
.method protected static j(Landroidx/emoji2/text/flatbuffer/Table;ILjava/nio/ByteBuffer;)Landroidx/emoji2/text/flatbuffer/Table;
    .locals 0

    .line 1
    invoke-static {p1, p2}, Landroidx/emoji2/text/flatbuffer/Table;->c(ILjava/nio/ByteBuffer;)I

    move-result p1

    invoke-virtual {p0, p1, p2}, Landroidx/emoji2/text/flatbuffer/Table;->f(ILjava/nio/ByteBuffer;)V

    return-object p0
.end method

.method protected static o(IILjava/nio/ByteBuffer;)I
    .locals 8
...
.method protected static p(I[BLjava/nio/ByteBuffer;)I
    .locals 7
...
.method public __reset()V
    ...
    .line 1
    invoke-virtual {p0, v0, v1}, Landroidx/emoji2/text/flatbuffer/Table;->f(ILjava/nio/ByteBuffer;)V
...
.method protected f(ILjava/nio/ByteBuffer;)V
    .locals 0
...
.method protected g(I)Ljava/lang/String;
    ...
    iget-object v1, p0, Landroidx/emoji2/text/flatbuffer/Table;->e:Landroidx/emoji2/text/flatbuffer/Utf8;

    invoke-static {p1, v0, v1}, Landroidx/emoji2/text/flatbuffer/Table;->h(ILjava/nio/ByteBuffer;Landroidx/emoji2/text/flatbuffer/Utf8;)Ljava/lang/String;
...
.method protected i(Landroidx/emoji2/text/flatbuffer/Table;I)Landroidx/emoji2/text/flatbuffer/Table;
    .locals 1
...
.method protected l(II)Ljava/nio/ByteBuffer;
    .locals 2

    .line 1
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/flatbuffer/Table;->d(I)I
    ...
    .line 3
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/flatbuffer/Table;->k(I)I
    ...
    .line 5
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/flatbuffer/Table;->n(I)I
...
.method protected m(Ljava/nio/ByteBuffer;II)Ljava/nio/ByteBuffer;
    .locals 1

    .line 1
    invoke-virtual {p0, p2}, Landroidx/emoji2/text/flatbuffer/Table;->d(I)I
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p2}, Landroidx/emoji2/text/flatbuffer/Table;->k(I)I
    ...
    .line 4
    invoke-virtual {p0, p2}, Landroidx/emoji2/text/flatbuffer/Table;->n(I)I
...
.method protected q(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/nio/ByteBuffer;)I
    .locals 0
...
.method protected r([ILjava/nio/ByteBuffer;)V
    .locals 4
