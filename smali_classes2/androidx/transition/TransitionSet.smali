...
.field private static final C0:I = 0x8

.field public static final ORDERING_SEQUENTIAL:I = 0x1

.field public static final ORDERING_TOGETHER:I = 0x0
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/transition/TransitionSet;->u0:Ljava/util/ArrayList;

    const/4 v0, 0x1

    .line 3
    iput-boolean v0, p0, Landroidx/transition/TransitionSet;->v0:Z

    const/4 v0, 0x0

    .line 4
    iput-boolean v0, p0, Landroidx/transition/TransitionSet;->x0:Z

    .line 5
    iput v0, p0, Landroidx/transition/TransitionSet;->y0:I
...
.method private H(Landroidx/transition/Transition;)V
    .locals 1
    ...
    .line 1
    iget-object v0, p0, Landroidx/transition/TransitionSet;->u0:Ljava/util/ArrayList;
...
.method private J()V
    ...
    .line 2
    iget-object v1, p0, Landroidx/transition/TransitionSet;->u0:Ljava/util/ArrayList;
...
.method protected C()V
    ...
    .line 4
    :cond_0
    invoke-direct {p0}, Landroidx/transition/TransitionSet;->J()V

    .line 5
    iget-boolean v0, p0, Landroidx/transition/TransitionSet;->v0:Z
    ...
    .line 8
    iget-object v2, p0, Landroidx/transition/TransitionSet;->u0:Ljava/util/ArrayList;
...
.method D(Z)V
    ...
    .line 1
    invoke-super {p0, p1}, Landroidx/transition/Transition;->D(Z)V
    ...
    invoke-virtual {v2, p1}, Landroidx/transition/Transition;->D(Z)V
...
.method bridge synthetic E(Landroid/view/ViewGroup;)Landroidx/transition/Transition;
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, Landroidx/transition/TransitionSet;->I(Landroid/view/ViewGroup;)Landroidx/transition/TransitionSet;
...
.method G(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1
    invoke-super {p0, p1}, Landroidx/transition/Transition;->G(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Landroidx/transition/Transition;->G(Ljava/lang/String;)Ljava/lang/String;
...
.method I(Landroid/view/ViewGroup;)Landroidx/transition/TransitionSet;
    .locals 3

    .line 1
    invoke-super {p0, p1}, Landroidx/transition/Transition;->E(Landroid/view/ViewGroup;)Landroidx/transition/Transition;
    ...
    invoke-virtual {v2, p1}, Landroidx/transition/Transition;->E(Landroid/view/ViewGroup;)Landroidx/transition/Transition;
...
.method public addTransition(Landroidx/transition/Transition;)Landroidx/transition/TransitionSet;
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/transition/TransitionSet;->H(Landroidx/transition/Transition;)V
    ...
    .line 4
    :cond_0
    iget v0, p0, Landroidx/transition/TransitionSet;->y0:I
...
.method public clone()Landroidx/transition/Transition;
    ...
    iput-object v1, v0, Landroidx/transition/TransitionSet;->u0:Ljava/util/ArrayList;
    ...
    .line 5
    iget-object v3, p0, Landroidx/transition/TransitionSet;->u0:Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v3}, Landroidx/transition/TransitionSet;->H(Landroidx/transition/Transition;)V
...
.method protected i(Landroid/view/ViewGroup;Landroidx/transition/TransitionValuesMaps;Landroidx/transition/TransitionValuesMaps;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .line 2
    iget-object v3, v0, Landroidx/transition/TransitionSet;->u0:Ljava/util/ArrayList;
    ...
    .line 3
    iget-object v5, v0, Landroidx/transition/TransitionSet;->u0:Ljava/util/ArrayList;
    ...
    .line 4
    iget-boolean v5, v0, Landroidx/transition/TransitionSet;->v0:Z
    ...
    .line 8
    invoke-virtual/range {v6 .. v11}, Landroidx/transition/Transition;->i(Landroid/view/ViewGroup;Landroidx/transition/TransitionValuesMaps;Landroidx/transition/TransitionValuesMaps;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method o(Landroid/view/ViewGroup;)V
    ...
    .line 1
    invoke-super {p0, p1}, Landroidx/transition/Transition;->o(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v2, p1}, Landroidx/transition/Transition;->o(Landroid/view/ViewGroup;)V
...
.method public setOrdering(I)Landroidx/transition/TransitionSet;
    ...
    .line 1
    iput-boolean p1, p0, Landroidx/transition/TransitionSet;->v0:Z
