...
.method private D(Ljava/io/Serializable;)V
    .locals 4
...
.method private G(Landroidx/versionedparcelable/VersionedParcelable;)V
    .locals 3
...
.method protected static e(Ljava/lang/Throwable;)Ljava/lang/Throwable;
    .locals 1
...
.method private j(Ljava/util/Collection;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 5
    invoke-virtual {p0}, Landroidx/versionedparcelable/VersionedParcel;->r()Ljava/io/Serializable;
    ...
    .line 7
    invoke-virtual {p0}, Landroidx/versionedparcelable/VersionedParcel;->s()Landroidx/versionedparcelable/VersionedParcelable;
...
.method private l(ILjava/lang/String;)Ljava/lang/Exception;
    .locals 0
...
.method private w(Ljava/util/Collection;)V
    ...
    invoke-direct {p0, v0}, Landroidx/versionedparcelable/VersionedParcel;->D(Ljava/io/Serializable;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/versionedparcelable/VersionedParcel;->F(Landroidx/versionedparcelable/VersionedParcelable;)V
...
.method private x(Ljava/util/Collection;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 2
    invoke-direct {p0, p1}, Landroidx/versionedparcelable/VersionedParcel;->w(Ljava/util/Collection;)V
...
.method protected E(Landroidx/versionedparcelable/VersionedParcelable;Landroidx/versionedparcelable/VersionedParcel;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
    ...
    invoke-direct {p0, v0}, Landroidx/versionedparcelable/VersionedParcel;->f(Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method protected F(Landroidx/versionedparcelable/VersionedParcelable;)V
    .locals 1
    ...
    .line 2
    :cond_0
    invoke-direct {p0, p1}, Landroidx/versionedparcelable/VersionedParcel;->G(Landroidx/versionedparcelable/VersionedParcelable;)V
    ...
    .line 4
    invoke-virtual {p0, p1, v0}, Landroidx/versionedparcelable/VersionedParcel;->E(Landroidx/versionedparcelable/VersionedParcelable;Landroidx/versionedparcelable/VersionedParcel;)V
...
.method public readException(Ljava/lang/Exception;I)Ljava/lang/Exception;
    ...
    .line 2
    :cond_0
    invoke-direct {p0}, Landroidx/versionedparcelable/VersionedParcel;->m()I
    ...
    .line 4
    invoke-direct {p0, p2, p1}, Landroidx/versionedparcelable/VersionedParcel;->l(ILjava/lang/String;)Ljava/lang/Exception;
...
.method public readList(Ljava/util/List;I)Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Landroidx/versionedparcelable/VersionedParcel;->j(Ljava/util/Collection;)Ljava/util/Collection;
...
.method public readMap(Ljava/util/Map;I)Ljava/util/Map;
    ...
    .line 6
    invoke-direct {p0, v0}, Landroidx/versionedparcelable/VersionedParcel;->j(Ljava/util/Collection;)Ljava/util/Collection;

    .line 7
    invoke-direct {p0, v1}, Landroidx/versionedparcelable/VersionedParcel;->j(Ljava/util/Collection;)Ljava/util/Collection;
...
.method protected s()Landroidx/versionedparcelable/VersionedParcelable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T::",
...
.method protected t([Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v2}, Landroidx/versionedparcelable/VersionedParcel;->D(Ljava/io/Serializable;)V
    ...
    invoke-virtual {p0, v2}, Landroidx/versionedparcelable/VersionedParcel;->F(Landroidx/versionedparcelable/VersionedParcelable;)V
...
.method protected abstract v(Ljava/lang/CharSequence;)V
.end method
...
.method public writeCharSequence(Ljava/lang/CharSequence;I)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Landroidx/versionedparcelable/VersionedParcel;->v(Ljava/lang/CharSequence;)V
...
.method public writeException(Ljava/lang/Exception;I)V
    ...
    .line 2
    invoke-virtual {p0}, Landroidx/versionedparcelable/VersionedParcel;->C()V
...
.method public writeList(Ljava/util/List;I)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Landroidx/versionedparcelable/VersionedParcel;->x(Ljava/util/Collection;I)V
...
.method public writeMap(Ljava/util/Map;I)V
    ...
    .line 10
    :cond_2
    invoke-direct {p0, p2}, Landroidx/versionedparcelable/VersionedParcel;->w(Ljava/util/Collection;)V

    .line 11
    invoke-direct {p0, v0}, Landroidx/versionedparcelable/VersionedParcel;->w(Ljava/util/Collection;)V
...
.method public writeSerializable(Ljava/io/Serializable;I)V
    ...
    .line 2
    invoke-direct {p0, p1}, Landroidx/versionedparcelable/VersionedParcel;->D(Ljava/io/Serializable;)V
...
.method public writeVersionedParcelable(Landroidx/versionedparcelable/VersionedParcelable;I)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Landroidx/versionedparcelable/VersionedParcel;->F(Landroidx/versionedparcelable/VersionedParcelable;)V

    return-void
.end method

.method protected y([D)V
    .locals 4
