...
.method public synthetic a(Lcom/umeng/analytics/pro/bq;Lcom/umeng/analytics/pro/ar;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/umeng/commonsdk/statistics/proto/c$a;->b(Lcom/umeng/analytics/pro/bq;Lcom/umeng/commonsdk/statistics/proto/c;)V

    return-void
.end method

.method public a(Lcom/umeng/analytics/pro/bq;Lcom/umeng/commonsdk/statistics/proto/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/umeng/analytics/pro/ax;
    ...
    .line 4
    iget-byte v1, v0, Lcom/umeng/analytics/pro/bl;->b:B
    ...
    .line 8
    invoke-static {p1, v1}, Lcom/umeng/analytics/pro/bt;->a(Lcom/umeng/analytics/pro/bq;B)V
    ...
    .line 12
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/bq;->p()Lcom/umeng/analytics/pro/bm;
    ...
    iget v3, v0, Lcom/umeng/analytics/pro/bm;->b:I
    ...
    .line 14
    :goto_1
    iget v1, v0, Lcom/umeng/analytics/pro/bm;->b:I
    ...
    .line 16
    invoke-virtual {v1, p1}, Lcom/umeng/commonsdk/statistics/proto/a;->read(Lcom/umeng/analytics/pro/bq;)V
    ...
    .line 18
    :cond_4
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/bq;->q()V
    ...
    .line 21
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/bq;->n()Lcom/umeng/analytics/pro/bn;
    ...
    iget v5, v0, Lcom/umeng/analytics/pro/bn;->c:I
    ...
    .line 23
    :goto_2
    iget v1, v0, Lcom/umeng/analytics/pro/bn;->c:I
    ...
    .line 26
    invoke-virtual {v3, p1}, Lcom/umeng/commonsdk/statistics/proto/b;->read(Lcom/umeng/analytics/pro/bq;)V
    ...
    .line 28
    :cond_7
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/bq;->o()V
...
.method public synthetic b(Lcom/umeng/analytics/pro/bq;Lcom/umeng/analytics/pro/ar;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/umeng/commonsdk/statistics/proto/c$a;->a(Lcom/umeng/analytics/pro/bq;Lcom/umeng/commonsdk/statistics/proto/c;)V

    return-void
.end method

.method public b(Lcom/umeng/analytics/pro/bq;Lcom/umeng/commonsdk/statistics/proto/c;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/umeng/analytics/pro/ax;
    ...
    .line 3
    invoke-static {}, Lcom/umeng/commonsdk/statistics/proto/c;->o()Lcom/umeng/analytics/pro/bv;
    ...
    .line 5
    invoke-static {}, Lcom/umeng/commonsdk/statistics/proto/c;->p()Lcom/umeng/analytics/pro/bl;
    ...
    invoke-direct {v0, v2, v1, v3}, Lcom/umeng/analytics/pro/bn;-><init>(BBI)V

    .line 8
    invoke-virtual {p1, v0}, Lcom/umeng/analytics/pro/bq;->a(Lcom/umeng/analytics/pro/bn;)V
    ...
    invoke-virtual {p1, v3}, Lcom/umeng/analytics/pro/bq;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1}, Lcom/umeng/commonsdk/statistics/proto/b;->write(Lcom/umeng/analytics/pro/bq;)V

    goto :goto_0

    .line 12
    :cond_0
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/bq;->e()V
    ...
    .line 16
    invoke-static {}, Lcom/umeng/commonsdk/statistics/proto/c;->q()Lcom/umeng/analytics/pro/bl;
    ...
    .line 19
    invoke-virtual {p1, v0}, Lcom/umeng/analytics/pro/bq;->a(Lcom/umeng/analytics/pro/bm;)V
    ...
    .line 21
    invoke-virtual {v1, p1}, Lcom/umeng/commonsdk/statistics/proto/a;->write(Lcom/umeng/analytics/pro/bq;)V

    goto :goto_1

    .line 22
    :cond_2
    invoke-virtual {p1}, Lcom/umeng/analytics/pro/bq;->f()V
    ...
    .line 26
    invoke-static {}, Lcom/umeng/commonsdk/statistics/proto/c;->r()Lcom/umeng/analytics/pro/bl;
    ...
    invoke-virtual {p1, p2}, Lcom/umeng/analytics/pro/bq;->a(Ljava/lang/String;)V
