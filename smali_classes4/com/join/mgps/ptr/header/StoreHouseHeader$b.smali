...
.field final synthetic f:Lcom/join/mgps/ptr/header/StoreHouseHeader;
...
.method private constructor <init>(Lcom/join/mgps/ptr/header/StoreHouseHeader;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->f:Lcom/join/mgps/ptr/header/StoreHouseHeader;
    ...
    .line 2
    iput p1, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->a:I
    ...
    .line 6
    iput-boolean p1, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->e:Z
...
.method private c()V
    ...
    .line 1
    iput-boolean v0, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->e:Z

    const/4 v1, 0x0

    .line 2
    iput v1, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->a:I

    .line 3
    iget-object v1, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->f:Lcom/join/mgps/ptr/header/StoreHouseHeader;

    invoke-static {v1}, Lcom/join/mgps/ptr/header/StoreHouseHeader;->f(Lcom/join/mgps/ptr/header/StoreHouseHeader;)I

    move-result v1

    iget-object v2, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->f:Lcom/join/mgps/ptr/header/StoreHouseHeader;

    iget-object v2, v2, Lcom/join/mgps/ptr/header/StoreHouseHeader;->a:Ljava/util/ArrayList;
    ...
    iget v2, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->d:I
    ...
    iget-object v1, v1, Lcom/join/mgps/ptr/header/StoreHouseHeader;->a:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->size()I

    move-result v1

    iget v2, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->b:I
...
.method private d()V
    ...
    .line 2
    iget-object v0, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->f:Lcom/join/mgps/ptr/header/StoreHouseHeader;
...
.method public run()V
    ...
    .line 1
    iget v0, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->a:I

    iget v1, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->b:I
    ...
    .line 3
    iget v3, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->b:I
    ...
    .line 4
    iget v5, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->a:I
    ...
    .line 5
    :cond_0
    iget-object v5, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->f:Lcom/join/mgps/ptr/header/StoreHouseHeader;

    iget-object v5, v5, Lcom/join/mgps/ptr/header/StoreHouseHeader;->a:Ljava/util/ArrayList;
    ...
    .line 10
    iget-object v4, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->f:Lcom/join/mgps/ptr/header/StoreHouseHeader;
    ...
    iput v0, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->a:I

    .line 13
    iget-boolean v0, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->e:Z
    ...
    iget v1, p0, Lcom/join/mgps/ptr/header/StoreHouseHeader$b;->d:I
