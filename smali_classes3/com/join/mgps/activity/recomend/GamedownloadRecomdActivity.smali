...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->gameDowndatas:Ljava/util/List;

    .line 4
    new-instance v0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity$2;

    new-instance v1, Landroid/os/Handler;

    invoke-direct {v1}, Landroid/os/Handler;-><init>()V

    invoke-direct {v0, p0, v1}, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity$2;-><init>(Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;Landroid/os/Handler;)V
...
.method private initData()V
    ...
    iget-object v2, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->gameid:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lg1/f;->B(Ljava/lang/String;)Lcom/github/snowdream/android/app/downloader/DownloadTask;

    move-result-object v1

    iput-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->downloadTask:Lcom/github/snowdream/android/app/downloader/DownloadTask;
    ...
    invoke-direct {v1, v3}, Lcom/join/mgps/pref/PrefDef_;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, Lcom/github/snowdream/android/app/downloader/DownloadTask;->getActual_size()J
    ...
    .line 15
    invoke-virtual {v1}, Lcom/github/snowdream/android/app/downloader/DownloadTask;->isDisableShowSpeedUpPrompt()Z

    move-result v1

    if-nez v1, :cond_3

    iget-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->context:Landroid/content/Context;
    ...
    invoke-static {v1, v3}, Lcom/join/mgps/Util/UtilsMy;->U(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v1, v3}, Lcom/join/mgps/Util/UtilsMy;->U2(Landroid/content/Context;Lcom/github/snowdream/android/app/downloader/DownloadTask;)V
    ...
    .line 19
    iget-object v3, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->cfgBean:Lcom/join/mgps/dto/DownloadSpeedupCfgBean;

    if-eqz v3, :cond_2

    .line 20
    iget-object v3, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->tip:Landroid/widget/TextView;
    ...
    invoke-virtual {v5}, Lcom/join/mgps/dto/DownloadSpeedupCfgBean;->getTip_text()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v5, "<font color=#5286FA><big>"

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v4, v1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string v1, "</big></font>%"
    ...
    .line 21
    :cond_2
    iget-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->prefDef:Lcom/join/mgps/pref/PrefDef_;
    ...
    .line 23
    iget-object v4, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->downNumber:Landroid/widget/TextView;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "\u4eca\u65e5\u53ef\u52a0\u901f\uff1a <strong><font color=#6193FE>"
    ...
    invoke-virtual {v4, v1, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;Landroid/widget/TextView$BufferType;)V
    ...
    sget-object v3, Lcom/papa/sim/statistic/Event;->AccelerationPopup:Lcom/papa/sim/statistic/Event;
    ...
    .line 25
    iget-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->close3:Landroid/widget/ImageView;
    ...
    .line 26
    :cond_3
    iget-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->speedLayout:Landroid/view/View;

    invoke-virtual {v1, v2}, Landroid/view/View;->setVisibility(I)V

    .line 27
    iget-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->close2:Landroid/view/View;
    ...
    .line 29
    :goto_1
    iget-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->icon:Lcom/facebook/drawee/view/SimpleDraweeView;
    ...
    .line 31
    :goto_2
    iget-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->recyclerView:Landroidx/recyclerview/widget/RecyclerView;
    ...
    .line 32
    new-instance v1, Lcom/join/mgps/activity/mygame/adapter/DetailRecyclerViewChileAdapter;

    iget-object v2, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->gamedatas:Ljava/util/List;

    invoke-direct {v1, p0, v2, v0}, Lcom/join/mgps/activity/mygame/adapter/DetailRecyclerViewChileAdapter;-><init>(Landroid/content/Context;Ljava/util/List;I)V

    iput-object v1, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->adapter:Lcom/join/mgps/activity/mygame/adapter/DetailRecyclerViewChileAdapter;

    .line 33
    iget-object v0, p0, Lcom/join/mgps/activity/recomend/GamedownloadRecomdActivity;->gameid:Ljava/lang/String;

    invoke-virtual {v1, v0}, Lcom/join/mgps/activity/mygame/adapter/DetailRecyclerViewChileAdapter;->setGameId(Ljava/lang/String;)V
...
.method downloadAcc()V
    ...
    invoke-direct {v1, v2, v3}, Lcom/join/mgps/event/i;-><init>(Lcom/github/snowdream/android/app/downloader/DownloadTask;I)V
    ...
    .line 7
    invoke-static {p0, v0}, Lcom/join/mgps/Util/UtilsMy;->r3(Landroid/content/Context;Ljava/lang/String;)V

    .line 8
    invoke-static {p0, v0}, Lcom/join/mgps/Util/UtilsMy;->P1(Landroid/content/Context;Ljava/lang/String;)V
