...
.field final n0:Ljava/util/concurrent/Callable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/Callable<",
            "+",
...
.field o0:Lio/reactivex/disposables/b;
...
.method constructor <init>(Lio/reactivex/g0;Ljava/util/concurrent/Callable;Ljava/util/concurrent/Callable;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/k$b;->p0:Ljava/util/concurrent/atomic/AtomicReference;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/k$b;->K:Ljava/util/concurrent/Callable;

    .line 4
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/k$b;->n0:Ljava/util/concurrent/Callable;
...
.method public dispose()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->o0:Lio/reactivex/disposables/b;

    invoke-interface {v0}, Lio/reactivex/disposables/b;->dispose()V

    .line 4
    invoke-virtual {p0}, Lio/reactivex/internal/operators/observable/k$b;->j()V
...
.method public bridge synthetic f(Lio/reactivex/g0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lio/reactivex/internal/operators/observable/k$b;->i(Lio/reactivex/g0;Ljava/util/Collection;)V
...
.method j()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->p0:Ljava/util/concurrent/atomic/AtomicReference;
...
.method k()V
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->n0:Ljava/util/concurrent/Callable;
    ...
    .line 4
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/k$b;->p0:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 6
    :try_start_2
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/k$b;->q0:Ljava/util/Collection;
    ...
    .line 8
    :cond_0
    iput-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->q0:Ljava/util/Collection;
    ...
    .line 10
    invoke-interface {v1, v2}, Lio/reactivex/e0;->a(Lio/reactivex/g0;)V

    const/4 v0, 0x0

    .line 11
    invoke-virtual {p0, v3, v0, p0}, Lio/reactivex/internal/observers/k;->g(Ljava/lang/Object;ZLio/reactivex/disposables/b;)V
    ...
    .line 15
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->o0:Lio/reactivex/disposables/b;
...
.method public onComplete()V
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/k$b;->q0:Ljava/util/Collection;
    ...
    .line 4
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->q0:Ljava/util/Collection;
...
.method public onSubscribe(Lio/reactivex/disposables/b;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/k$b;->o0:Lio/reactivex/disposables/b;
    ...
    .line 5
    iput-object v2, p0, Lio/reactivex/internal/operators/observable/k$b;->q0:Ljava/util/Collection;

    .line 6
    :try_start_1
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/k$b;->n0:Ljava/util/concurrent/Callable;
    ...
    .line 8
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/k$b;->p0:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 11
    invoke-interface {v2, p1}, Lio/reactivex/e0;->a(Lio/reactivex/g0;)V
