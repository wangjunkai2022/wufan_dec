...
# direct methods
.method public constructor <init>(Ljava/util/concurrent/Callable;Lw2/o;Lw2/g;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->b:Lw2/o;

    .line 4
    iput-object p3, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->c:Lw2/g;
...
.method protected F0(Lio/reactivex/d;)V
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->b:Lw2/o;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->c:Lw2/g;

    iget-boolean v4, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->d:Z

    invoke-direct {v2, p1, v0, v3, v4}, Lio/reactivex/internal/operators/completable/CompletableUsing$UsingObserver;-><init>(Lio/reactivex/d;Ljava/lang/Object;Lw2/g;Z)V

    invoke-interface {v1, v2}, Lio/reactivex/g;->a(Lio/reactivex/d;)V
    ...
    .line 6
    :try_start_2
    iget-object v2, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->c:Lw2/g;

    invoke-interface {v2, v0}, Lw2/g;->accept(Ljava/lang/Object;)V
    :try_end_2
    ...
    .line 11
    :try_start_3
    iget-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->c:Lw2/g;
