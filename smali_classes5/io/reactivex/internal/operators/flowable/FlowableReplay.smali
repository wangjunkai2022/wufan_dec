...
.method private constructor <init>(Ll3/b;Lio/reactivex/j;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->e:Ll3/b;
...
.method public static U8(Lio/reactivex/j;I)Lio/reactivex/flowables/a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 1
    invoke-static {p0}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->Y8(Lio/reactivex/j;)Lio/reactivex/flowables/a;
    ...
    invoke-static {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->X8(Lio/reactivex/j;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/a;
...
.method public static V8(Lio/reactivex/j;JLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;)Lio/reactivex/flowables/a;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 1
    invoke-static/range {v0 .. v5}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->W8(Lio/reactivex/j;JLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;I)Lio/reactivex/flowables/a;
...
.method public static W8(Lio/reactivex/j;JLjava/util/concurrent/TimeUnit;Lio/reactivex/h0;I)Lio/reactivex/flowables/a;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v6}, Lio/reactivex/internal/operators/flowable/FlowableReplay;->X8(Lio/reactivex/j;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/a;
...
.method static X8(Lio/reactivex/j;Ljava/util/concurrent/Callable;)Lio/reactivex/flowables/a;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v2, v1, p0, v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay;-><init>(Ll3/b;Lio/reactivex/j;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/Callable;)V
...
.method public static Y8(Lio/reactivex/j;)Lio/reactivex/flowables/a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static Z8(Ljava/util/concurrent/Callable;Lw2/o;)Lio/reactivex/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<U:",
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay$c;-><init>(Ljava/util/concurrent/Callable;Lw2/o;)V

    return-object v0
.end method

.method public static a9(Lio/reactivex/flowables/a;Lio/reactivex/h0;)Lio/reactivex/flowables/a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 1
    invoke-virtual {p0, p1}, Lio/reactivex/j;->i4(Lio/reactivex/h0;)Lio/reactivex/j;
...
.method public N8(Lw2/g;)V
    ...
    :goto_1
    :try_start_1
    invoke-interface {p1, v0}, Lw2/g;->accept(Ljava/lang/Object;)V
    :try_end_1
    ...
    .line 9
    iget-object v0, v0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method protected h6(Ll3/c;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay;->e:Ll3/b;
