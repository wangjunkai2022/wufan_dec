...
.method static constructor <clinit>()V
    ...
    .line 2
    sput-object v0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->n:[Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;
...
# virtual methods
.method J8(Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method K8()V
    ...
    .line 3
    iget-object v3, v3, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;->a:Ll3/c;
...
.method L8()V
    ...
    .line 2
    :cond_0
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->h:Lx2/o;
    ...
    .line 13
    :cond_6
    iget-boolean v7, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->j:Z

    if-eqz v7, :cond_7

    .line 14
    iget-boolean v10, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->f:Z

    if-nez v10, :cond_7

    .line 15
    iget-object v10, v1, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->k:Ljava/lang/Throwable;

    if-eqz v10, :cond_7

    .line 16
    invoke-virtual {v1, v10}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->M8(Ljava/lang/Throwable;)V
    ...
    .line 19
    invoke-virtual {v1, v0}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->M8(Ljava/lang/Throwable;)V

    goto :goto_6

    .line 20
    :cond_9
    invoke-virtual/range {p0 .. p0}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->K8()V
    ...
    .line 24
    :cond_c
    iget-object v5, v5, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;->a:Ll3/c;

    invoke-interface {v5, v10}, Ll3/c;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v2, v5, v6}, Ll3/d;->request(J)V
    ...
    .line 29
    invoke-virtual {v1, v2}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->M8(Ljava/lang/Throwable;)V
    ...
    .line 35
    invoke-virtual {v1, v6}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->M8(Ljava/lang/Throwable;)V
...
.method M8(Ljava/lang/Throwable;)V
    .locals 9
    ...
    invoke-interface {v3, p1}, Ll3/c;->onError(Ljava/lang/Throwable;)V
...
.method N8(Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public dispose()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->h:Lx2/o;
...
.method protected h6(Ll3/c;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;-><init>(Ll3/c;Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;)V

    .line 2
    invoke-interface {p1, v0}, Ll3/c;->onSubscribe(Ll3/d;)V

    .line 3
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->J8(Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;)Z
    ...
    .line 5
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->N8(Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$MulticastSubscription;)V

    return-void

    .line 6
    :cond_0
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->L8()V
...
.method public onSubscribe(Ll3/d;)V
    ...
    .line 6
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowablePublishMulticast$a;->h:Lx2/o;
