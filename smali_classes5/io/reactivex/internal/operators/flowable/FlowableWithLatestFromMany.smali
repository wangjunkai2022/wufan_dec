...
# direct methods
.method public constructor <init>(Lio/reactivex/j;Ljava/lang/Iterable;Lw2/o;)V
    .locals 0
    ...
    .line 6
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->c:[Ll3/b;

    .line 7
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->d:Ljava/lang/Iterable;

    .line 8
    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->e:Lw2/o;

    return-void
.end method

.method public constructor <init>(Lio/reactivex/j;[Ll3/b;Lw2/o;)V
    .locals 0
    .param p1    # Lio/reactivex/j;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
    ...
    .line 2
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->c:[Ll3/b;
...
.method protected h6(Ll3/c;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->c:[Ll3/b;
    ...
    invoke-direct {v0, v1, v2}, Lio/reactivex/internal/operators/flowable/q0;-><init>(Lio/reactivex/j;Lw2/o;)V

    invoke-virtual {v0, p1}, Lio/reactivex/internal/operators/flowable/q0;->h6(Ll3/c;)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->e:Lw2/o;

    invoke-direct {v1, p1, v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;-><init>(Ll3/c;Lw2/o;I)V

    .line 11
    invoke-interface {p1, v1}, Ll3/c;->onSubscribe(Ll3/d;)V

    .line 12
    invoke-virtual {v1, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;->e([Ll3/b;I)V

    .line 13
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/a;->b:Lio/reactivex/j;

    invoke-virtual {p1, v1}, Lio/reactivex/j;->g6(Lio/reactivex/o;)V
